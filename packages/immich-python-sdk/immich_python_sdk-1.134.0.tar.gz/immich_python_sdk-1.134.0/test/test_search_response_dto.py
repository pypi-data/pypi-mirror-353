    ...
    def make_instance(self, include_optional) -> SearchResponseDto:
        ...
        if include_optional:
            return SearchResponseDto(
                albums = immich_python_sdk.models.search_album_response_dto.SearchAlbumResponseDto(
                    count = 56, 
                    facets = [
                    ...
                    total = 56, ),
                assets = immich_python_sdk.models.search_asset_response_dto.SearchAssetResponseDto(
                    count = 56, 
                    facets = [
                        immich_python_sdk.models.search_facet_response_dto.SearchFacetResponseDto(
                            counts = [
