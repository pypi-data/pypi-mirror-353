...
class ServerFeaturesDto(BaseModel):
    ...
    sidecar: StrictBool
    trash: StrictBool
    __properties: ClassVar[List[str]] = ["clipEncode", "configFile", "facialRecognition", "map", "oauth", "oauthAutoLaunch", "passwordLogin", "reverseGeocoding", "search", "sidecar", "trash"]
