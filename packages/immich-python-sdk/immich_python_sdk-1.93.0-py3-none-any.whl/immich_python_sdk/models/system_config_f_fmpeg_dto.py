...
class SystemConfigFFmpegDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accel", "bframes", "cqMode", "crf", "gopSize", "maxBitrate", "npl", "preset", "refs", "targetAudioCodec", "targetResolution", "targetVideoCodec", "temporalAQ", "threads", "tonemap", "transcode", "twoPass"]
