...
class SystemConfigOAuthDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["autoLaunch", "autoRegister", "buttonText", "clientId", "clientSecret", "enabled", "issuerUrl", "mobileOverrideEnabled", "mobileRedirectUri", "scope", "storageLabelClaim"]
