...
class SmartSearchDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["city", "country", "createdAfter", "createdBefore", "deviceId", "isEncoded", "isFavorite", "isMotion", "isNotInAlbum", "isOffline", "language", "lensModel", "libraryId", "make", "model", "page", "personIds", "query", "rating", "size", "state", "tagIds", "takenAfter", "takenBefore", "trashedAfter", "trashedBefore", "type", "updatedAfter", "updatedBefore", "visibility", "withDeleted", "withExif"]
