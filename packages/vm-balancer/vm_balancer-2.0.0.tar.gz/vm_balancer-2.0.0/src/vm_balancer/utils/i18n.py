...
TRANSLATIONS = {
    'en': {
        ...
        'cli_interval_help': 'Interval between checks in seconds (overrides config value)',
        'cli_cluster_ids_help': 'List of cluster IDs to process (overrides config value)',
        ...
        'balancer_dry_run_mode': 'DRY RUN MODE - no actual migrations will be performed',
        'balancer_interval_mode': 'Running in interval mode, checking every {interval} seconds',
        ...
        'migration_dry_run': '[DRY RUN] Would migrate VM {vm_name} from {source_node} to {target_node}',
        ...
        # Node messages
        'node_overloaded': 'Node {node_name} is overloaded (CPU: {cpu_load}, Memory: {memory_usage}%)',
        ...
        'telegram_disabled': 'Telegram notifications requested but bot_token or chat_id not provided. Notifications disabled.',
        ...
        # SSH monitoring
        'ssh_monitoring_warning': 'SSH monitoring enabled but no private key or password provided',
        'ssh_load_average_debug': 'SSH load average for {host}: {load_1m}, {load_5m}, {load_15m}',
    ...
    'ru': {
        # CLI сообщения
        'cli_description': 'VM Balancer - автоматическая балансировка виртуальных машин',
        ...
        'cli_interval_help': 'Интервал между проверками в секундах (переопределяет значение из конфигурации)',
        'cli_cluster_ids_help': 'Список ID кластеров через запятую для обработки (переопределяет значение из конфигурации)',
        ...
        'balancer_dry_run_mode': 'РЕЖИМ СИМУЛЯЦИИ - реальные миграции выполняться не будут',
        'balancer_interval_mode': 'Работа в режиме интервала, проверка каждые {interval} секунд',
        ...
        'migration_dry_run': '[СИМУЛЯЦИЯ] Будет выполнена миграция VM {vm_name} с {source_node} на {target_node}',
        ...
        # Сообщения узлов
        'node_overloaded': 'Узел {node_name} перегружен (CPU: {cpu_load}, Память: {memory_usage}%)',
        ...
        'node_maintenance': 'Узел {node_name} находится в режиме обслуживания, пропускаем',
        ...
        'telegram_disabled': 'Запрошены Telegram уведомления, но bot_token или chat_id не предоставлены. Уведомления отключены.',
        ...
        # SSH мониторинг
        'ssh_monitoring_warning': 'SSH мониторинг включен, но не предоставлен приватный ключ или пароль',
        'ssh_load_average_debug': 'SSH load average для {host}: {load_1m}, {load_5m}, {load_15m}',
