...
class AsyncNsxt():
    ...
    async def a_get_registration_token(self, expiration_time: datetime) -> Any:
        """
            requests.post
            get registration token for adding new nsx edge or others appliances
        """
        ...
        print(Style.NORMAL + Back.BLACK + Fore.YELLOW + "return nsx registration token (asyncio)")
    ...
    async def a_get_all_vms(self) -> Union[Dict[str, Any], Any]:
        ...
        print(Style.NORMAL + Back.BLACK + Fore.YELLOW + "return all vms found (asyncio)")
