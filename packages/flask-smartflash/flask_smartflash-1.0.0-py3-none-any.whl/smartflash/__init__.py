...
class SmartFlash:
    ...
    def _render_toast(self, msg):
        ...
        exit_animation = msg['options'].get('exit_animation', 
            self.app.config.get('SMARTFLASH_TOAST_EXIT_ANIMATION', 'fadeOut'))
        ...
        icon_map = {
            ...
            'info': '<svg width="20" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>'
        }
    ...
    def _render_popup(self, msg):
        ...
        animation = msg['options'].get('animation', 
            self.app.config.get('SMARTFLASH_POPUP_ANIMATION', 'fadeIn'))
        exit_animation = msg['options'].get('exit_animation',  # NEW
            self.app.config.get('SMARTFLASH_POPUP_EXIT_ANIMATION', 'fadeOut'))
        ...
        icon_map = {
            ...
            'info': '<svg width="32" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/></svg>'
        }
    ...
    #                     // Add micro-delay for smooth animation
    ...
    #                             progress.style.transition = `width ${duration}ms cubic-bezier(0.4, 0, 0.2, 1)`;
    ...
    #                     if (toast) {
    #                         toast.classList.add('smartflash-hide');
    #                         setTimeout(function() {
    #                             if (toast.parentNode) {
    #                                 toast.remove();
    #                             }
    ...
    #                         overlay.querySelector('.smartflash-popup').classList.add('smartflash-hide');
    #                         setTimeout(function() {
