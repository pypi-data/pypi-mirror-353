...
### To see the images Previews go to [GitHub Pages](https://github.com/chimenmagoodness/flask-smartflash.git).

### Toasts:
![SmartFlash Toast Preview Success Image](https://github.com/chimenmagoodness/flask-smartflash/images/taost-success.png)

![SmartFlash Toast Preview Error Image](https://github.com/chimenmagoodness/flask-smartflash/images/toast-error.png)

![SmartFlash Toast Preview Info Image](https://github.com/chimenmagoodness/flask-smartflash/images/toast-info.png)

![SmartFlash Toast Preview Warning Image](https://github.com/chimenmagoodness/flask-smartflash/images/toast-warning.png)


### Pop Ups:
![SmartFlash Popup Preview Success Image](https://github.com/chimenmagoodness/flask-smartflash/images/popup-success.png)

![SmartFlash Popup Preview Error Image](https://github.com/chimenmagoodness/flask-smartflash/images/popup-error.png)

![SmartFlash Popup Preview Info Image](https://github.com/chimenmagoodness/flask-smartflash/images/popup-info.png)

![SmartFlash Popup Preview Warning Image](https://github.com/chimenmagoodness/flask-smartflash/images/popup-warnings.png)
...
```bash
pip install flask_smartflash
```
### or 
```bash
pip install flask_smartflash==1.0.2
```

### PyPi Docs. 
[PyPi Docs for flask smartflash](https://pypi.org/project/flask-smartflash/1.0.2/)
