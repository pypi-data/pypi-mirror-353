...
class OpenAITextToSpeechAdapter(IOpenAIAdapter):
    ...
    def convert_input(self, data) -> tuple[dict, dict | None]:
        ...
        self.input_tokens_number = len(encoding.encode(input_model.text))
    ...
    def convert_output(self, data, processURLMiddleware: Callable[[str], SunraFile]) -> dict:
        ...
        if isinstance(data, str):
            ...
            output_tokens_number = int(audio_duration * factor)
            ...
            return GPT4oMiniTTSOutput(
                ...
                input_tokens_number=self.input_tokens_number,
