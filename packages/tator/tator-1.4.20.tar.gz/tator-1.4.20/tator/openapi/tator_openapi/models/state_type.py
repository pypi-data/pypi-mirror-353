...
class StateType(object):
    ...
    def __init__(self, association=None, attribute_types=None, default_localization=None, delete_child_localizations=False, description=None, dtype=None, effective_permission=None, elemental_id=None, grouping_default=True, id=None, interpolation='latest', media=None, name=None, project=None, visible=None, local_vars_configuration=None):  # noqa: E501
