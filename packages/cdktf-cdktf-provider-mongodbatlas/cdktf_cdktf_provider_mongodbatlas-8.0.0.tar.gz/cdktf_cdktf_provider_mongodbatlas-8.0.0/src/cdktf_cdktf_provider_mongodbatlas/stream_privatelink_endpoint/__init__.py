...
Refer to the Terraform Registry for docs: [`mongodbatlas_stream_privatelink_endpoint`](https://registry.terraform.io/providers/mongodb/mongodbatlas/1.35.1/docs/resources/stream_privatelink_endpoint).
'''
...
class StreamPrivatelinkEndpoint(
    ...
    def __init__(
        ...
        *,
        ...
        :param provider_name: Provider where the Kafka cluster is deployed. Valid values are AWS and AZURE. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.35.1/docs/resources/stream_privatelink_endpoint#provider_name StreamPrivatelinkEndpoint#provider_name}
        :param vendor: Vendor that manages the Kafka cluster. The following are the vendor values per provider:- MSK and CONFLUENT for the AWS provider.- EVENTHUB and CONFLUENT for the AZURE provider. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.35.1/docs/resources/stream_privatelink_endpoint#vendor StreamPrivatelinkEndpoint#vendor}
        :param arn: Amazon Resource Name (ARN). Required for AWS Provider and MSK vendor. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.35.1/docs/resources/stream_privatelink_endpoint#arn StreamPrivatelinkEndpoint#arn}
        :param dns_domain: The domain hostname. Required for the following provider and vendor combinations:- AWS provider with CONFLUENT vendor.- AZURE provider with EVENTHUB or CONFLUENT vendor. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.35.1/docs/resources/stream_privatelink_endpoint#dns_domain StreamPrivatelinkEndpoint#dns_domain}
        :param dns_sub_domain: Sub-Domain name of Confluent cluster. These are typically your availability zones. Required for AWS Provider and CONFLUENT vendor. If your AWS CONFLUENT cluster doesn't use subdomains, you must set this to the empty array []. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.35.1/docs/resources/stream_privatelink_endpoint#dns_sub_domain StreamPrivatelinkEndpoint#dns_sub_domain}
        :param region: The region of the Provider’s cluster. See `AZURE <https://www.mongodb.com/docs/atlas/reference/microsoft-azure/#stream-processing-instances>`_ and `AWS <https://www.mongodb.com/docs/atlas/reference/amazon-aws/#stream-processing-instances>`_ supported regions. When the vendor is ``CONFLUENT``, this is the domain name of Confluent cluster. When the vendor is ``MSK``, this is computed by the API from the provided ``arn``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.35.1/docs/resources/stream_privatelink_endpoint#region StreamPrivatelinkEndpoint#region}
        :param service_endpoint_id: For AZURE EVENTHUB, this is the `namespace endpoint ID <https://learn.microsoft.com/en-us/rest/api/eventhub/namespaces/get>`_. For AWS CONFLUENT cluster, this is the `VPC Endpoint service name <https://docs.confluent.io/cloud/current/networking/private-links/aws-privatelink.html>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.35.1/docs/resources/stream_privatelink_endpoint#service_endpoint_id StreamPrivatelinkEndpoint#service_endpoint_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing StreamPrivatelinkEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/mongodb/mongodbatlas/1.35.1/docs/resources/stream_privatelink_endpoint#import import section} in the documentation of this resource for the id to use
