...
class BaseRepository:
    ...
    def _build_reference_stage(
        ...
        def process_reference(ref, current_pipeline):
            ...
            if is_nested:
                ...
                embed_expr = self._build_dynamic_embedding(alias_parts, joined_var, foreign_field, local_key)
    ...
    def _build_dynamic_embedding(self, alias_parts, joined_var, foreign_field, local_key):
        ...
        return self._build_nested_embedding(f"${alias_parts[0]}", alias_parts[1:], joined_var, foreign_field, local_key)

    def _build_nested_embedding(self, current_expr, remaining_alias_parts, joined_var, foreign_field, local_key):
