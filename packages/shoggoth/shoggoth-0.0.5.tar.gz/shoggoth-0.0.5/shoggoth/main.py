...
class ShoggothRoot(BoxLayout):
    ...
    def __init__(self, **kwargs):
        ...
        bg_file = Path(__file__).parent/'assets'/'parchment2.png'
        try:
...
class ShoggothApp(App):
    ...
    def build(self):
        ...
        folder = Path(__file__).parent/'assets'/'defaults'
        self.assets_monitor = FileMonitor(folder, self.on_file_changed)
