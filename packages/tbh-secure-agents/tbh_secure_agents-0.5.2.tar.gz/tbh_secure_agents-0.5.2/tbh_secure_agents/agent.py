    ...
    def __init__(self,
        ...
        if self.memory_enabled:
            try:
                ...
                self.memory_manager = MemoryManager(config, self.security_profile)
                self.memory_manager.sync_initialize()
                logger.info(f"Memory manager initialized with {self.memory_duration} configuration and {self.security_profile} security profile")
