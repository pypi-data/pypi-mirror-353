...
class ConsulProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param address: The HTTP(S) API address of the agent to use. Defaults to "127.0.0.1:8500". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#address ConsulProvider#address}
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#alias ConsulProvider#alias}
        :param auth_jwt: auth_jwt block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#auth_jwt ConsulProvider#auth_jwt}
        :param ca_file: A path to a PEM-encoded certificate authority used to verify the remote agent's certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#ca_file ConsulProvider#ca_file}
        ...
        :param ca_pem: PEM-encoded certificate authority used to verify the remote agent's certificate. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#ca_pem ConsulProvider#ca_pem}
        :param cert_file: A path to a PEM-encoded certificate provided to the remote agent; requires use of ``key_file`` or ``key_pem``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#cert_file ConsulProvider#cert_file}
        :param cert_pem: PEM-encoded certificate provided to the remote agent; requires use of ``key_file`` or ``key_pem``. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#cert_pem ConsulProvider#cert_pem}
        :param datacenter: The datacenter to use. Defaults to that of the agent. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#datacenter ConsulProvider#datacenter}
        :param header: header block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#header ConsulProvider#header}
        ...
        :param insecure_https: Boolean value to disable SSL certificate verification; setting this value to true is not recommended for production use. Only use this with scheme set to "https". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#insecure_https ConsulProvider#insecure_https}
        :param key_file: A path to a PEM-encoded private key, required if ``cert_file`` or ``cert_pem`` is specified. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#key_file ConsulProvider#key_file}
        :param key_pem: PEM-encoded private key, required if ``cert_file`` or ``cert_pem`` is specified. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#key_pem ConsulProvider#key_pem}
        :param namespace: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#namespace ConsulProvider#namespace}.
        :param scheme: The URL scheme of the agent to use ("http" or "https"). Defaults to "http". Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#scheme ConsulProvider#scheme}
        :param token: The ACL token to use by default when making requests to the agent. Can also be specified with ``CONSUL_HTTP_TOKEN`` or ``CONSUL_TOKEN`` as an environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#token ConsulProvider#token}
        '''
        if __debug__:
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing ConsulProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#import import section} in the documentation of this resource for the id to use
...
class ConsulProviderAuthJwt:
    def __init__(
        ...
        *,
        ...
        '''
        :param auth_method: The name of the auth method to use for login. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#auth_method ConsulProvider#auth_method}
        :param bearer_token: The bearer token to present to the auth method during login for authentication purposes. For the Kubernetes auth method this is a `Service Account Token (JWT) <https://kubernetes.io/docs/reference/access-authn-authz/authentication/#service-account-tokens>`_. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#bearer_token ConsulProvider#bearer_token}
        :param meta: Specifies arbitrary KV metadata linked to the token. Can be useful to track origins. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#meta ConsulProvider#meta}
        :param use_terraform_cloud_workload_identity: Whether to use a `Terraform Workload Identity token <https://developer.hashicorp.com/terraform/cloud-docs/workspaces/dynamic-provider-credentials/workload-identity-tokens>`_. The token will be read from the ``TFC_WORKLOAD_IDENTITY_TOKEN`` environment variable. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#use_terraform_cloud_workload_identity ConsulProvider#use_terraform_cloud_workload_identity}
        '''
        if __debug__:
...
class ConsulProviderHeader:
    def __init__(self, *, name: builtins.str, value: builtins.str) -> None:
        '''
        :param name: The name of the header. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#name ConsulProvider#name}
        :param value: The value of the header. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/consul/2.21.0/docs#value ConsulProvider#value}
        '''
        if __debug__:
