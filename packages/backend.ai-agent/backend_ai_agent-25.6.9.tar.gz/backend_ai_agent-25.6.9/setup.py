...
setup(**{
    ...
    'install_requires': (
        ...
        'async_timeout~=4.0',
        'attrs>=25.3',
        'backend.ai-cli==25.6.9',
        'backend.ai-common==25.6.9',
        'backend.ai-kernel-binary==25.6.9',
        'backend.ai-kernel-helper==25.6.9',
        'backend.ai-kernel==25.6.9',
        'backend.ai-krunner-static-gnu==4.4.0',
        'backend.ai-logging==25.6.9',
        'backend.ai-plugin==25.6.9',
        'cachetools~=5.5.0',
        'callosum~=1.0.3',
        'cattrs~=24.1.1',
        'click~=8.1.7',
