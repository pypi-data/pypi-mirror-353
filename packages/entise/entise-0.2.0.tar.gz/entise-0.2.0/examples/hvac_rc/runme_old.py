...
from src.core.timeseries_generator import TimeSeriesGenerator  # old version
...
objects['hvac'] = 'r1c1'  # comment in for old version
data = {}
data_folder = 'data'
...
summary, df = gen.generate_sequential(data)  # old version
