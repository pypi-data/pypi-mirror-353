...
def toggle(condition: ConditionType | Callable[[dict[str, Any]], bool] | str, if_branch: BasePipelineStep | list[BasePipelineStep], input_state_map: dict[str, str] | None = None, output_state: str | None = None, runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> ConditionalStep:
    ...
    Returns:
        ConditionalStep: An instance of ConditionalStep configured with the provided parameters.
    '''
def subgraph(subgraph: Pipeline, input_state_map: dict[str, str], output_state_map: dict[str, str], runtime_config_map: dict[str, str] | None = None, fixed_args: dict[str, Any] | None = None, name: str | None = None) -> SubgraphStep:
    ...
    Args:
        ...
        input_state_map (dict[str, str]): Mapping of subgraph input keys to parent pipeline state keys.
            Keys that don\'t exist in the parent state will be gracefully ignored.
