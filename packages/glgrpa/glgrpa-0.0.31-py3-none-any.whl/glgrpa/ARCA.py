...
class ARCA(Chrome, Terminal):    
    ...
    def navegar_inicio(self):
        ...
        if self.driver.title == self.titulo_pestaña:
    ...
    def buscar_aplicativo(self, aplicativo:str, intentos:int=0) -> bool:
        """ Busca el aplicativo """
        ...
        # Tengo que probar cuando el aplicativo venga en mayúsculas
