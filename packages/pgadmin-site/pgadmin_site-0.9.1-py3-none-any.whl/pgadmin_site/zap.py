...
def zap(text, 
    ...
    resp = requests.post(oauth_url, headers=headers_auth, data=data_auth, verify=False)
    ...
    resp2 = requests.post(api_url, headers=headers, data=json.dumps(payload), verify=False)
