...
class spark_functions():
    ...
    def extract_query_params(df, url_column: str, param_list: List[str]):
        """
    ...
    def explode_verticle(sdf, column_name: str):
        """
    ...
    def explode_horizontal(sdf, column_name: str, keys_to_expand, prefix=None):
        """
