...
def serve(
    ...
    async def GetTimeSeriesAcos(params: GetTimeSeriesAcosRequest, ctx: Context) -> GetTimeSeriesAcos200Response:
        return await _call_endpoint("acos", params, GetTimeSeriesAcos200Response, ctx)
    ...
    async def GetTimeSeriesAsin(params: GetTimeSeriesAsinRequest, ctx: Context) -> GetTimeSeriesAsin200Response:
        return await _call_endpoint("asin", params, GetTimeSeriesAsin200Response, ctx)
    ...
    async def GetTimeSeriesAtan(params: GetTimeSeriesAtanRequest, ctx: Context) -> GetTimeSeriesAtan200Response:
        return await _call_endpoint("atan", params, GetTimeSeriesAtan200Response, ctx)
    ...
    async def GetTimeSeriesCos(params: GetTimeSeriesCosRequest, ctx: Context) -> GetTimeSeriesCos200Response:
        return await _call_endpoint("cos", params, GetTimeSeriesCos200Response, ctx)
    ...
    async def GetTimeSeriesCosh(params: GetTimeSeriesCoshRequest, ctx: Context) -> GetTimeSeriesCosh200Response:
        return await _call_endpoint("cosh", params, GetTimeSeriesCosh200Response, ctx)
    ...
    async def GetTimeSeriesMaVp(params: GetTimeSeriesMaVpRequest, ctx: Context) -> GetTimeSeriesMaVp200Response:
        return await _call_endpoint("mavp", params, GetTimeSeriesMaVp200Response, ctx)
    ...
    async def GetTimeSeriesSin(params: GetTimeSeriesSinRequest, ctx: Context) -> GetTimeSeriesSin200Response:
        return await _call_endpoint("sin", params, GetTimeSeriesSin200Response, ctx)
    ...
    async def GetTimeSeriesSinh(params: GetTimeSeriesSinhRequest, ctx: Context) -> GetTimeSeriesSinh200Response:
        return await _call_endpoint("sinh", params, GetTimeSeriesSinh200Response, ctx)
    ...
    async def GetTimeSeriesTan(params: GetTimeSeriesTanRequest, ctx: Context) -> GetTimeSeriesTan200Response:
        return await _call_endpoint("tan", params, GetTimeSeriesTan200Response, ctx)
    ...
    async def GetTimeSeriesTanh(params: GetTimeSeriesTanhRequest, ctx: Context) -> GetTimeSeriesTanh200Response:
        return await _call_endpoint("tanh", params, GetTimeSeriesTanh200Response, ctx)
