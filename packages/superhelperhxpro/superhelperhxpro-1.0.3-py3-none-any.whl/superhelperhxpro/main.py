...
def main():
    ...
    parser.add_argument('folder', help='The folder to analyze.')
    subparsers.add_parser('file-activity-graph', help='Visualize file activity over the last year.')
    ...
    if args.command == 'file-activity-graph':
