        ...
        if sys.stdin.isatty() or hasattr(sys, "ps1"):
            ...
            try:
                ...
                raise NotImplemented(
                    '"session.login()" is having difficulty getting input from your environment. This seems to happen mostly in Google Colab. Try using setenv() and session.reload() to set credentials.'
                )
