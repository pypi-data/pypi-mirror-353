...
class AssonantDataHandlerFactory:
    ...
    def create_data_handler(
        ...
        Args:
            ...
            Di ctionary containing extra metadata about timestamps field. Defaults to {}.. Defaults to {}.
...
class AssonantEntryFactory:
    ...
    @staticmethod
    def create_entry(beamline_name: BeamlineName):
        """Create Assonant Entry from a given Beamline for a specific AcquisitionMoment.
        ...
        Returns:
            Entry: Assonant Entry for the respective AcquisitionMoment and BeamlineName.
        """
        try:
            ...
            entry = Entry(beamline=beamline)
        except Exception as e:
            raise AssonantEntryFactoryError(
                f"An Error ocurred when creating an Entry for Beamline '{beamline_name.value}'."
            ) from e
        return entry
