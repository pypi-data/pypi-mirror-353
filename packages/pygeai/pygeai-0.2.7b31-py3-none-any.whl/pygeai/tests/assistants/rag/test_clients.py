...
class TestRAGAssistantClient(unittest.TestCase):
    ...
    """
    def setUp(self):
        # Mock BaseClient initialization to bypass API_KEY and BASE_URL checks
        ...
        self.safe_name = "test_assistant"  # Simplified for test; real URL encoding tested separately
    ...
    def test_delete_all_documents_json_decode_error(self):
        name = "test_assistant"
        expected_text = "Delete all error"
        self.mock_response.json.side_effect = JSONDecodeError("Invalid JSON", "", 0)
        self.mock_response.text = expected_text
        self.client.api_service.delete.return_value = self.mock_response
    ...
    def test_delete_document_json_decode_error(self):
        name = "test_assistant"
        document_id = "doc_123"
        expected_text = "Delete document error"
        self.mock_response.json.side_effect = JSONDecodeError("Invalid JSON", "", 0)
        self.mock_response.text = expected_text
        self.client.api_service.delete.return_value = self.mock_response
