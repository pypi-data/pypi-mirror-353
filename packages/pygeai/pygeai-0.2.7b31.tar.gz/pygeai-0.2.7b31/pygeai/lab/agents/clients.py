...
class AgentClient(BaseClient):
    ...
    def list_agents(
        ...
        try:
            ...
            logger.error(f"Unable to list agents for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
    ...
    def create_agent(
        ...
        try:
            ...
            logger.error(f"Unable to create agent for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def get_agent(
        ...
        try:
            ...
            logger.error(f"Unable to retrieve agent {agent_id} for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def create_sharing_link(
        ...
        try:
            ...
            logger.error(f"Unable to create sharing link for agent {agent_id} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def publish_agent_revision(
        ...
        try:
            ...
            logger.error(f"Unable to publish revision {revision} for agent {agent_id} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def delete_agent(
        ...
        try:
            ...
            logger.error(f"Unable to delete agent {agent_id} from project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def update_agent(
        ...
        try:
            ...
            logger.error(f"Unable to update agent {agent_id} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
