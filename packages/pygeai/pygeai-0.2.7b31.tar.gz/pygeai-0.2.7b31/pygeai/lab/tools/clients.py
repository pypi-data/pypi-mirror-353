...
class ToolClient(BaseClient):
    ...
    def create_tool(
        ...
        try:
            ...
            logger.error(f"Unable to create tool for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
    ...
    def list_tools(
        ...
        try:
            ...
            logger.error(f"Unable to list tools for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def get_tool(
        ...
        try:
            ...
            logger.error(f"Unable to retrieve tool {tool_id} for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def delete_tool(
        ...
        try:
            ...
            logger.error(f"Unable to delete tool {tool_id or tool_name} from project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def update_tool(
        ...
        try:
            ...
            logger.error(f"Unable to update tool {tool_id} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def publish_tool_revision(
        ...
        try:
            ...
            logger.error(f"Unable to publish revision {revision} for tool {tool_id} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def get_parameter(
        ...
        try:
            ...
            logger.error(f"Unable to retrieve parameters for tool {tool_id or tool_public_name} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def set_parameter(
        ...
        try:
            ...
            logger.error(f"Unable to set parameters for tool {tool_id or tool_public_name} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
