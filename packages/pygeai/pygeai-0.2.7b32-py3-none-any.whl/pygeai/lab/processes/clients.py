...
class AgenticProcessClient(BaseClient):
    ...
    def create_process(
        ...
        try:
            ...
            logger.error(f"Unable to create process for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
    ...
    def update_process(
        ...
        try:
            ...
            logger.error(f"Unable to update process {process_id or name} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def get_process(
        ...
        try:
            ...
            logger.error(f"Unable to retrieve process {process_id or process_name} for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def list_processes(
        ...
        try:
            ...
            logger.error(f"Unable to list processes for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def list_process_instances(
        ...
        try:
            ...
            logger.error(f"Unable to list process instances for process {process_id} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def delete_process(
        ...
        try:
            ...
            logger.error(f"Unable to delete process {process_id or process_name} from project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def publish_process_revision(
        ...
        try:
            ...
            logger.error(f"Unable to publish revision {revision} for process {process_id or process_name} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
    ...
    def create_task(
        ...
        try:
            ...
            logger.error(f"Unable to create task for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
    ...
    def get_task(
        ...
        try:
            ...
            logger.error(f"Unable to retrieve task {task_id or task_name} for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def list_tasks(
        ...
        try:
            ...
            logger.error(f"Unable to list tasks for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def update_task(
        ...
        try:
            ...
            logger.error(f"Unable to update task {task_id} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def delete_task(
        ...
        try:
            ...
            logger.error(f"Unable to delete task {task_id or task_name} from project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def publish_task_revision(
        ...
        try:
            ...
            logger.error(f"Unable to publish revision {revision} for task {task_id or task_name} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def start_instance(
        ...
        try:
            ...
            logger.error(f"Unable to start instance for process {process_name} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def abort_instance(
        ...
        try:
            ...
            logger.error(f"Unable to abort instance {instance_id} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def get_instance(
        ...
        try:
            ...
            logger.error(f"Unable to retrieve instance {instance_id} for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def get_instance_history(
        ...
        try:
            ...
            logger.error(f"Unable to retrieve history for instance {instance_id} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def get_thread_information(
        ...
        try:
            ...
            logger.error(f"Unable to retrieve thread information for thread {thread_id} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def send_user_signal(
        ...
        try:
            ...
            logger.error(f"Unable to send user signal {signal_name} to instance {instance_id} in project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def create_kb(
        ...
        try:
            ...
            logger.error(f"Unable to create knowledge base for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def get_kb(
        ...
        try:
            ...
            logger.error(f"Unable to retrieve knowledge base {kb_id or kb_name} for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def list_kbs(
        ...
        try:
            ...
            logger.error(f"Unable to list knowledge bases for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def delete_kb(
        ...
        try:
            ...
            logger.error(f"Unable to delete knowledge base {kb_id or kb_name} from project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            return response.text
    ...
    def list_jobs(
        ...
        try:
            ...
            logger.error(f"Unable to list jobs for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text[:100]}")
            result = response.text
