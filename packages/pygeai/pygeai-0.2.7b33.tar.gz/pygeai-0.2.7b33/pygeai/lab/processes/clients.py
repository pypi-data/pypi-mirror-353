...
class AgenticProcessClient(BaseClient):
    ...
    def delete_kb(
        ...
        try:
            ...
            logger.error(f"Unable to delete knowledge base {kb_id or kb_name} from project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text}")
    ...
    def list_jobs(
        ...
        try:
            ...
            logger.error(f"Unable to list jobs for project {project_id}: JSON parsing error (status {response.status_code}): {e}. Response: {response.text}")
