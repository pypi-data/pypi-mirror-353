...
set_target_properties(highs::highs PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/highs.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/highs.dll"
  )

list(APPEND _cmake_import_check_targets highs::highs )
list(APPEND _cmake_import_check_files_for_highs::highs "${_IMPORT_PREFIX}/lib/highs.lib" "${_IMPORT_PREFIX}/bin/highs.dll" )
