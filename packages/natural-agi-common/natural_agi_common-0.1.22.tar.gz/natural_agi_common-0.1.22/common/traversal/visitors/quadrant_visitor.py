...
class QuadrantVisitor(Visitor):
    ...
    def visit_line(self, line: Vector) -> Dict[str, Any]:
        ...
        self.graph.nodes[line.nx_id]["quadrant"] = quadrant
        self.graph.nodes[line.nx_id]["vector_type"] = vector_type
        self.graph.nodes[line.nx_id]["labels"].append(vector_type)
        self.graph.nodes[line.nx_id]["dx"] = dx
        self.graph.nodes[line.nx_id]["dy"] = dy
        return {
            "quadrant": quadrant,
            "line_id": line.id,
