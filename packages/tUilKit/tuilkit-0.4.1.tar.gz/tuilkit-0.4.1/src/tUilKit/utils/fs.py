...
class FileSystem(FileSystemInterface):
    ...
    def validate_and_create_folder(self, folder_path: str, log_file: str = None, log: bool = True, log_to: str = "both") -> bool:
    ...
    def remove_empty_folders(self, path: str, log_file: str = None, log: bool = True) -> None:
