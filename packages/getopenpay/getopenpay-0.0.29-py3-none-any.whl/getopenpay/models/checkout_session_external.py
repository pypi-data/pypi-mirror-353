...
class CheckoutSessionExternal(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["account_id", "account_name", "amount_subtotal_atom", "amount_total_atom", "client_reference_id", "coupon_id", "created_at", "currency", "custom_fields", "customer_email", "customer_id", "id", "is_deleted", "language", "line_items", "mode", "object", "return_url", "secure_token", "setup_intent", "status", "subscription_id", "subscription_ids", "success_url", "successful_attempt_id", "tax_amount_atom", "trial_end", "trial_from_price", "trial_period_days", "updated_at", "url"]
