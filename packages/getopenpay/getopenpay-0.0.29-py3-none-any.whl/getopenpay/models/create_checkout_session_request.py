...
class CreateCheckoutSessionRequest(BaseModel):
    ...
    line_items: Optional[List[CreateCheckoutLineItem]] = Field(default=None, description="The line items purchased by the customer.")
    ...
    __properties: ClassVar[List[str]] = ["checkout_preferences", "client_reference_id", "coupon_id", "currency", "custom_fields", "customer_email", "customer_id", "language", "line_items", "mode", "return_url", "success_url", "trial_end", "trial_from_price", "trial_period_days"]
