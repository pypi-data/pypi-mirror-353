...
@pytest.mark.asyncio
async def test_admin_login(mock_http_client: MockHttpClient, cli_parser) -> None:
    ...
    with patch("qcogclient.qcog.admin.init_client", return_value=mock_http_client):
...
async def test_admin_create_project_user_and_project_do_not_exist(
    ...
    mock_http_client.set_response(
        "/projects",
        "POST",
        {"response": {"id": "proj-123", "name": "test-project", "description": "A test project"}},
    )
...
@pytest.mark.asyncio
async def test_admin_list_projects(mock_http_client: MockHttpClient, cli_parser) -> None:
...
@pytest.mark.asyncio
async def test_admin_create_api_key_with_project_id(mock_http_client: MockHttpClient, cli_parser) -> None:
...
@pytest.mark.asyncio
async def test_admin_create_api_key_with_basic_auth(mock_http_client: MockHttpClient, cli_parser) -> None:
    ...
    with patch("cli.admin.init_client", return_value=mock_http_client):
        result = await handle_admin_command(args)
...
@pytest.mark.asyncio
async def test_admin_create_environment(mock_http_client: MockHttpClient, cli_parser) -> None:
...
@pytest.mark.asyncio
async def test_admin_get_environment(mock_http_client: MockHttpClient, cli_parser) -> None:
...
@pytest.mark.asyncio
async def test_admin_list_environments(mock_http_client: MockHttpClient, cli_parser) -> None:
...
@pytest.mark.asyncio
async def test_admin_create_experiment(mock_http_client: MockHttpClient, cli_parser) -> None:
...
@pytest.mark.asyncio
async def test_admin_get_experiment(mock_http_client: MockHttpClient, cli_parser) -> None:
...
@pytest.mark.asyncio
async def test_admin_list_experiments(mock_http_client: MockHttpClient, cli_parser) -> None:
...
@pytest.mark.asyncio
async def test_admin_create_user_without_project(mock_http_client: MockHttpClient, cli_parser) -> None:
...
async def test_admin_create_api_key_missing_params_error(
    ...
    with patch("qcogclient.qcog.admin.init_client", return_value=mock_http_client), \
         patch("qcogclient.qcog.admin.AdminClient.api_key", return_value="mock-api-key"):  # noqa: E501
        result = await handle_admin_command(args)
...
# Verify that the correct error message was logged
    assert "Either --project-id or --basic-username and --basic-password must be provided" in caplog.text  # noqa: E501
