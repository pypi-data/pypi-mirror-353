...
class EnhancedObjectConfidenceCNN(nn.Module):
    ...
    def __init__(self, input_size):
        ...
        self.fc_layers = nn.Sequential(
            ...
            nn.Sigmoid()  # Sigmoid instead of Softmax
        )
...
class Trainer:
    ...
    def __init__(self, dataset_path, batch_size=64, img_size=(128, 128), lr=0.001, model_path="classifier.pth"):
        ...
        self.criterion = nn.BCELoss()  # Updated loss function for binary classification
