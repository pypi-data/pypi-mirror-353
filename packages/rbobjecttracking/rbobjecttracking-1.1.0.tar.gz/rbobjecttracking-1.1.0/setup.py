...
def get_version():
    ...
    version_file = os.path.join(os.path.dirname(__file__), "rbot", "version.py")
...
setup(
    ...
    version=get_version(),
    install_requires=["torch", "numpy", "opencv-python", "torchvision", "customtkinter", "cvzone", "rembg"],
    packages=find_packages(),
    author="Samarth Javagal",
    author_email="samarthjavagal@gmail.com",
    description="A python library for single-object tracking.",
