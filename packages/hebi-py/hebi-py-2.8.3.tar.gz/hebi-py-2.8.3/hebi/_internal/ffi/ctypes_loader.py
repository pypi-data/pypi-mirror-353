import ctypes
from .ctypes_defs import HebiMacAddress, HebiRobotModelElementMetadata, HebiRobotModelElementTopology, HebiHighResAngleStruct, HebiIoBankPinStruct, HebiCommandRef, HebiCommandMetadata, HebiFeedbackRef, HebiFeedbackMetadata, HebiInfoRef, HebiInfoMetadata
...
def populate_hebi_funcs(lib):
  ...
  if hasattr(lib, 'hebiGroupSendLayout'):
    ...
    lib_func.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_int64, ctypes.c_int64, ctypes.c_int32]
    lib_func.restype = ctypes.c_int
  else:
  ...
  if hasattr(lib, 'hebiGroupSendLayoutBuffer'):
    ...
    lib_func.argtypes = [ctypes.c_void_p, ctypes.c_char_p, ctypes.c_size_t, ctypes.c_int64, ctypes.c_int64, ctypes.c_int32]
    lib_func.restype = ctypes.c_int
  else:
