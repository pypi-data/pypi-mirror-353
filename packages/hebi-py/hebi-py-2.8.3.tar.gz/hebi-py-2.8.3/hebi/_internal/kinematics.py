...
class KinematicsParserTLS(local):
  ...
  def __init__(self):
    super().__init__()
    self.parsed_joint_strs: 'dict[str, EnumTraits]' = dict()
    self.parsed_frame_type_strs: 'dict[str, EnumTraits]' = dict()
  ...
  def set_joint(self, joint: str, value: 'EnumTraits'):
  ...
  def set_frame_type(self, frame_type: str, value: 'EnumTraits'):
