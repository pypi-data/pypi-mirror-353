...
COMMON_PORTS = {
    ...
    (2132, 'tcp'): 'solera-epmap',
    (2132, 'udp'): 'solera-epmap',
    (2133, 'tcp'): 'zymed-zpp',
    (2133, 'udp'): 'zymed-zpp',
    (2134, 'tcp'): 'avenue',
    (2134, 'udp'): 'avenue',
    ...
    (2157, 'tcp'): 'xnds',
    (2157, 'udp'): 'xnds',
    (2158, 'tcp'): 'touchnetplus',
    (2158, 'udp'): 'touchnetplus',
    (2159, 'tcp'): 'gdbremote',
    (2159, 'udp'): 'gdbremote',
    (2160, 'tcp'): 'apc-2160',
    (2160, 'udp'): 'apc-2160',
    ...
    (2187, 'tcp'): 'ssmc',
    (2187, 'udp'): 'ssmd',
    (2188, 'tcp'): 'radware-rpm',
    (2189, 'tcp'): 'radware-rpm-s',
    ...
    (2211, 'tcp'): 'emwin',
    (2211, 'udp'): 'emwin',
    (2212, 'tcp'): 'leecoposserver',
    (2212, 'udp'): 'leecoposserver',
    (2213, 'tcp'): 'kali',
    (2213, 'udp'): 'kali',
    (2214, 'tcp'): 'rpi',
    (2214, 'udp'): 'rpi',
    ...
    (2220, 'tcp'): 'netiq',
    (2220, 'udp'): 'netiq',
    (2221, 'tcp'): 'ethernet-ip-s',
    (2221, 'udp'): 'ethernet-ip-s',
    (2222, 'tcp'): 'EtherNet/IP-1',
    (2222, 'udp'): 'EtherNet/IP-1',
    (2223, 'tcp'): 'rockwell-csp2',
    ...
    (2370, 'udp'): 'l3-hbmon',
    (2371, 'tcp'): 'rda',
    (2372, 'tcp'): 'lanmessenger',
    (2372, 'udp'): 'lanmessenger',
    (2373, 'tcp'): 'remographlm',
    (2374, 'tcp'): 'hydra',
    (2375, 'tcp'): 'docker',
    (2376, 'tcp'): 'docker-s',
    (2377, 'tcp'): 'swarm',
    ...
    (2463, 'tcp'): 'lsi-raid-mgmt',
    (2463, 'udp'): 'lsi-raid-mgmt',
    (2464, 'tcp'): 'direcpc-si',
    (2464, 'udp'): 'direcpc-si',
    (2465, 'tcp'): 'lbm',
    (2465, 'udp'): 'lbm',
    ...
    (2639, 'tcp'): 'aminet',
    (2639, 'udp'): 'aminet',
    (2640, 'tcp'): 'ami-control',
    (2640, 'udp'): 'ami-control',
    (2641, 'tcp'): 'hdl-srv',
    (2641, 'udp'): 'hdl-srv',
    (2642, 'tcp'): 'tragic',
    (2642, 'udp'): 'tragic',
    ...
    (2723, 'tcp'): 'watchdog-nt',
    (2723, 'udp'): 'watchdog-nt',
    (2724, 'tcp'): 'qotps',
    (2724, 'udp'): 'qotps',
    ...
    (2863, 'tcp'): 'sonardata',
    (2863, 'udp'): 'sonardata',
    (2864, 'tcp'): 'astronova-main',
    (2864, 'udp'): 'astronova-main',
    (2865, 'tcp'): 'pit-vpn',
    (2865, 'udp'): 'pit-vpn',
    (2866, 'tcp'): 'iwlistener',
    (2866, 'udp'): 'iwlistener',
    ...
    (3165, 'tcp'): 'newgenpay',
    (3165, 'udp'): 'newgenpay',
    (3166, 'tcp'): 'sossecollector',
    (3166, 'udp'): 'sossecollector',
    (3167, 'tcp'): 'nowcontact',
    (3167, 'udp'): 'nowcontact',
    (3168, 'tcp'): 'poweronnud',
    (3168, 'udp'): 'poweronnud',
    ...
    (3192, 'tcp'): 'firemonrcc',
    (3192, 'udp'): 'firemonrcc',
    (3193, 'tcp'): 'spandataport',
    (3193, 'udp'): 'spandataport',
    (3194, 'tcp'): 'magbind',
    (3194, 'udp'): 'magbind',
    (3195, 'tcp'): 'ncu-1',
    (3195, 'udp'): 'ncu-1',
    ...
    (3477, 'tcp'): 'ecomm',
    (3477, 'udp'): 'ecomm',
    (3478, 'tcp'): 'stun-behavior',
    (3478, 'udp'): 'stun-behavior',
    (3479, 'tcp'): 'twrpc',
    (3479, 'udp'): 'twrpc',
    (3480, 'tcp'): 'plethora',
    (3480, 'udp'): 'plethora',
    ...
    (3565, 'sctp'): 'm2pa',
    (3565, 'tcp'): 'm2pa',
    (3566, 'tcp'): 'quest-data-hub',
    (3567, 'tcp'): 'dof-eps',
    (3567, 'udp'): 'dof-eps',
    (3568, 'tcp'): 'dof-tunnel-sec',
    (3568, 'udp'): 'dof-tunnel-sec',
    (3569, 'tcp'): 'mbg-ctrl',
    (3569, 'udp'): 'mbg-ctrl',
    ...
    (3612, 'tcp'): 'dataprotector',
    (3612, 'udp'): 'dataprotector',
    ...
    (3635, 'tcp'): 'sdo',
    (3635, 'udp'): 'sdo',
    (3636, 'tcp'): 'servistaitsm',
    (3636, 'udp'): 'servistaitsm',
    (3637, 'tcp'): 'scservp',
    (3637, 'udp'): 'scservp',
    (3638, 'tcp'): 'ehp-backup',
    (3638, 'udp'): 'ehp-backup',
    ...
    (3829, 'tcp'): 'neteh-ext',
    (3829, 'udp'): 'neteh-ext',
    (3830, 'tcp'): 'cernsysmgmtagt',
    (3830, 'udp'): 'cernsysmgmtagt',
    (3831, 'tcp'): 'dvapps',
    (3831, 'udp'): 'dvapps',
    ...
    (4073, 'tcp'): 'iRAPP',
    (4073, 'udp'): 'iRAPP',
    (4074, 'tcp'): 'cequint-cityid',
    (4074, 'udp'): 'cequint-cityid',
    (4075, 'tcp'): 'perimlan',
    (4075, 'udp'): 'perimlan',
    (4076, 'tcp'): 'seraph',
    (4076, 'udp'): 'seraph',
    ...
    (4080, 'tcp'): 'lorica-in',
    (4080, 'udp'): 'lorica-in',
    (4081, 'tcp'): 'lorica-in-sec',
    (4081, 'udp'): 'lorica-in-sec',
    (4082, 'tcp'): 'lorica-out',
    (4082, 'udp'): 'lorica-out',
    (4083, 'tcp'): 'lorica-out-sec',
    (4083, 'udp'): 'lorica-out-sec',
    (4084, 'udp'): 'fortisphere-vm',
    (4085, 'tcp'): 'ezmessagesrv',
    (4086, 'udp'): 'ftsync',
    (4087, 'tcp'): 'applusservice',
    (4088, 'tcp'): 'npsp',
    (4089, 'tcp'): 'opencore',
    (4089, 'udp'): 'opencore',
    (4090, 'tcp'): 'omasgport',
    ...
    (4124, 'tcp'): 'tigv2',
    (4124, 'udp'): 'tigv2',
    (4125, 'tcp'): 'opsview-envoy',
    (4125, 'udp'): 'opsview-envoy',
    (4126, 'tcp'): 'ddrepl',
    (4126, 'udp'): 'ddrepl',
    (4127, 'tcp'): 'unikeypro',
    (4127, 'udp'): 'unikeypro',
    ...
    (4148, 'tcp'): 'hhb-handheld',
    (4148, 'udp'): 'hhb-handheld',
    (4149, 'tcp'): 'agslb',
    (4149, 'udp'): 'agslb',
    (4150, 'tcp'): 'PowerAlert-nsa',
    (4150, 'udp'): 'PowerAlert-nsa',
    (4151, 'tcp'): 'menandmice_noh',
    (4151, 'udp'): 'menandmice_noh',
    (4152, 'tcp'): 'idig_mux',
    (4152, 'udp'): 'idig_mux',
    (4153, 'tcp'): 'mbl-battd',
    (4153, 'udp'): 'mbl-battd',
    ...
    (4155, 'tcp'): 'bzr',
    (4155, 'udp'): 'bzr',
    (4156, 'tcp'): 'stat-results',
    (4156, 'udp'): 'stat-results',
    (4157, 'tcp'): 'stat-scanner',
    (4157, 'udp'): 'stat-scanner',
    (4158, 'tcp'): 'stat-cc',
    (4158, 'udp'): 'stat-cc',
    (4159, 'tcp'): 'nss',
    (4159, 'udp'): 'nss',
    ...
    (4163, 'tcp'): 'silverpeakpeer',
    (4163, 'udp'): 'silverpeakpeer',
    (4164, 'tcp'): 'silverpeakcomm',
    (4164, 'udp'): 'silverpeakcomm',
    (4165, 'tcp'): 'altcp',
    (4165, 'udp'): 'altcp',
    (4166, 'tcp'): 'joost',
    (4166, 'udp'): 'joost',
    ...
    (4169, 'tcp'): 'iadt',
    (4169, 'udp'): 'iadt-disc',
    (4170, 'tcp'): 'd-cinema-csp',
    (4171, 'tcp'): 'ml-svnet',
    (4172, 'tcp'): 'pcoip',
    (4172, 'udp'): 'pcoip',
    (4173, 'udp'): 'mma-discovery',
    (4174, 'tcp'): 'smcluster',
    (4174, 'udp'): 'sm-disc',
    (4175, 'tcp'): 'bccp',
    (4176, 'tcp'): 'tl-ipcproxy',
    (4177, 'tcp'): 'wello',
    (4177, 'udp'): 'wello',
    (4178, 'tcp'): 'storman',
    (4178, 'udp'): 'storman',
    ...
    (4181, 'tcp'): 'macbak',
    (4181, 'udp'): 'macbak',
    (4182, 'tcp'): 'pcptcpservice',
    (4182, 'udp'): 'pcptcpservice',
    (4183, 'tcp'): 'cyborgnet',
    (4183, 'udp'): 'cyborgnet',
    (4184, 'tcp'): 'universe_suite',
    (4184, 'udp'): 'universe_suite',
    (4185, 'tcp'): 'wcpp',
    (4185, 'udp'): 'wcpp',
    (4186, 'tcp'): 'boxbackupstore',
    (4187, 'tcp'): 'csc_proxy',
    (4188, 'tcp'): 'vatata',
    (4188, 'udp'): 'vatata',
    (4189, 'tcp'): 'pcep',
    ...
    (4307, 'tcp'): 'trueconf',
    (4307, 'udp'): 'trueconf',
    (4308, 'tcp'): 'compx-lockview',
    (4308, 'udp'): 'compx-lockview',
    (4309, 'tcp'): 'dserver',
    (4309, 'udp'): 'dserver',
    (4310, 'tcp'): 'mirrtex',
    (4310, 'udp'): 'mirrtex',
    ...
    (4312, 'tcp'): 'pscl-mgt',
    (4313, 'tcp'): 'perrla',
    (4314, 'tcp'): 'choiceview-agt',
    (4316, 'tcp'): 'choiceview-clt',
    (4317, 'tcp'): 'opentelemetry',
    (4319, 'tcp'): 'fox-skytale',
    (4319, 'udp'): 'fox-skytale',
    (4320, 'tcp'): 'fdt-rcatp',
    (4320, 'udp'): 'fdt-rcatp',
    (4321, 'tcp'): 'rwhois',
    (4321, 'udp'): 'rwhois',
    ...
    (4323, 'tcp'): 'trim-ice',
    (4323, 'udp'): 'trim-ice',
    (4325, 'tcp'): 'geognosisadmin',
    (4325, 'udp'): 'geognosisman',
    (4326, 'tcp'): 'geognosis',
    (4326, 'udp'): 'geognosis',
    (4327, 'tcp'): 'jaxer-web',
    (4327, 'udp'): 'jaxer-web',
    (4328, 'tcp'): 'jaxer-manager',
    (4328, 'udp'): 'jaxer-manager',
    (4329, 'tcp'): 'publiqare-sync',
    (4330, 'tcp'): 'dey-sapi',
    (4331, 'tcp'): 'ktickets-rest',
    (4332, 'tcp'): 'getty-focus',
    (4333, 'sctp'): 'ahsp',
    (4333, 'tcp'): 'ahsp',
    (4333, 'udp'): 'ahsp',
    (4334, 'tcp'): 'netconf-ch-ssh',
    (4335, 'tcp'): 'netconf-ch-tls',
    (4336, 'tcp'): 'restconf-ch-tls',
    (4340, 'tcp'): 'gaia',
    (4340, 'udp'): 'gaia',
    (4341, 'udp'): 'lisp-data',
    (4342, 'udp'): 'lisp-control',
    (4343, 'tcp'): 'unicall',
    (4343, 'udp'): 'unicall',
    ...
    (4358, 'tcp'): 'qsnet-nucl',
    (4358, 'udp'): 'qsnet-nucl',
    (4359, 'tcp'): 'omabcastltkm',
    (4359, 'udp'): 'omabcastltkm',
    (4360, 'tcp'): 'matrix_vnet',
    (4361, 'udp'): 'nacnl',
    (4362, 'udp'): 'afore-vdp-disc',
    (4366, 'udp'): 'shadowstream',
    (4368, 'tcp'): 'wxbrief',
    (4368, 'udp'): 'wxbrief',
    (4369, 'tcp'): 'epmd',
    (4369, 'udp'): 'epmd',
    (4370, 'tcp'): 'elpro_tunnel',
    (4370, 'udp'): 'elpro_tunnel',
    (4371, 'tcp'): 'l2c-control',
    (4371, 'udp'): 'l2c-disc',
    (4372, 'tcp'): 'l2c-data',
    (4372, 'udp'): 'l2c-data',
    (4373, 'tcp'): 'remctl',
    ...
    (4379, 'tcp'): 'ctdb',
    (4379, 'udp'): 'ctdb',
    (4389, 'tcp'): 'xandros-cms',
    (4389, 'udp'): 'xandros-cms',
    (4390, 'tcp'): 'wiegand',
    (4390, 'udp'): 'wiegand',
    (4391, 'tcp'): 'apwi-imserver',
    (4392, 'tcp'): 'apwi-rxserver',
    (4393, 'tcp'): 'apwi-rxspooler',
    (4394, 'udp'): 'apwi-disc',
    (4395, 'tcp'): 'omnivisionesx',
    (4395, 'udp'): 'omnivisionesx',
    (4396, 'tcp'): 'fly',
    (4400, 'tcp'): 'ds-srv',
    (4400, 'udp'): 'ds-srv',
    (4401, 'tcp'): 'ds-srvr',
    ...
    (4407, 'tcp'): 'nacagent',
    (4408, 'tcp'): 'slscc',
    (4409, 'tcp'): 'netcabinet-com',
    (4410, 'tcp'): 'itwo-server',
    (4411, 'tcp'): 'found',
    (4412, 'udp'): 'smallchat',
    (4413, 'tcp'): 'avi-nms',
    (4413, 'udp'): 'avi-nms-disc',
    (4414, 'tcp'): 'updog',
    (4415, 'tcp'): 'brcd-vr-req',
    (4416, 'tcp'): 'pjj-player',
    (4416, 'udp'): 'pjj-player-disc',
    (4417, 'tcp'): 'workflowdir',
    (4418, 'udp'): 'axysbridge',
    (4419, 'tcp'): 'cbp',
    (4420, 'tcp'): 'nvme',
    (4420, 'udp'): 'nvme',
    ...
    (4430, 'udp'): 'rsqlserver',
    (4431, 'tcp'): 'wspipe',
    (4432, 'tcp'): 'l-acoustics',
    (4432, 'udp'): 'l-acoustics',
    (4433, 'tcp'): 'vop',
    (4441, 'udp'): 'netblox',
    (4442, 'tcp'): 'saris',
    (4442, 'udp'): 'saris',
    ...
    (4488, 'tcp'): 'awacs-ice',
    (4488, 'udp'): 'awacs-ice',
    (4500, 'tcp'): 'ipsec-nat-t',
    (4500, 'udp'): 'ipsec-nat-t',
    (4502, 'sctp'): 'a25-fap-fgw',
    (4503, 'udp'): 'm-bus-oms',
    (4534, 'udp'): 'armagetronad',
    (4535, 'tcp'): 'ehs',
    (4535, 'udp'): 'ehs',
    (4536, 'tcp'): 'ehs-ssl',
    (4536, 'udp'): 'ehs-ssl',
    ...
    (4551, 'tcp'): 'ieee-mih',
    (4551, 'udp'): 'ieee-mih',
    (4552, 'tcp'): 'menandmice-mon',
    (4552, 'udp'): 'menandmice-mon',
    (4553, 'tcp'): 'icshostsvc',
    (4554, 'tcp'): 'msfrs',
    (4554, 'udp'): 'msfrs',
    (4555, 'tcp'): 'rsip',
    (4555, 'udp'): 'rsip',
    (4556, 'dccp'): 'dtn-bundle',
    (4556, 'tcp'): 'dtn-bundle',
    (4556, 'udp'): 'dtn-bundle',
    (4557, 'udp'): 'mtcevrunqss',
    (4558, 'udp'): 'mtcevrunqman',
    (4559, 'tcp'): 'hylafax',
    (4559, 'udp'): 'hylafax',
    ...
    (4569, 'tcp'): 'iax',
    (4569, 'udp'): 'iax',
    (4570, 'tcp'): 'deploymentmap',
    (4573, 'tcp'): 'cardifftec-back',
    (4590, 'tcp'): 'rid',
    (4591, 'tcp'): 'l3t-at-an',
    (4591, 'udp'): 'l3t-at-an',
    (4592, 'udp'): 'hrpd-ith-at-an',
    (4593, 'tcp'): 'ipt-anri-anri',
    (4593, 'udp'): 'ipt-anri-anri',
    (4594, 'tcp'): 'ias-session',
    (4594, 'udp'): 'ias-session',
    (4595, 'tcp'): 'ias-paging',
    (4595, 'udp'): 'ias-paging',
    (4596, 'tcp'): 'ias-neighbor',
    (4596, 'udp'): 'ias-neighbor',
    ...
    (4601, 'udp'): 'piranha2',
    (4602, 'tcp'): 'mtsserver',
    (4603, 'tcp'): 'menandmice-upg',
    (4604, 'tcp'): 'irp',
    (4605, 'tcp'): 'sixchat',
    (4606, 'tcp'): 'sixid',
    (4621, 'udp'): 'ventoso',
    (4646, 'tcp'): 'dots-signal',
    (4646, 'udp'): 'dots-signal',
    ...
    (4703, 'tcp'): 'npqes-test',
    (4704, 'tcp'): 'assuria-ins',
    (4711, 'sctp'): 'trinity-dist',
    (4711, 'tcp'): 'trinity-dist',
    (4711, 'udp'): 'trinity-dist',
    (4725, 'tcp'): 'truckstar',
    (4725, 'udp'): 'truckstar',
    (4726, 'udp'): 'a26-fap-fgw',
    (4727, 'tcp'): 'fcis',
    (4727, 'udp'): 'fcis-disc',
    (4728, 'tcp'): 'capmux',
    (4728, 'udp'): 'capmux',
    ...
    (4745, 'tcp'): 'fmp',
    (4745, 'udp'): 'fmp',
    (4746, 'udp'): 'intelliadm-disc',
    (4747, 'udp'): 'buschtrommel',
    (4749, 'tcp'): 'profilemac',
    (4749, 'udp'): 'profilemac',
    (4750, 'tcp'): 'ssad',
    (4750, 'udp'): 'ssad',
    ...
    (4787, 'tcp'): 'sia-ctrl-plane',
    (4788, 'tcp'): 'xmcp',
    (4789, 'udp'): 'vxlan',
    (4790, 'udp'): 'vxlan-gpe',
    (4791, 'udp'): 'roce',
    (4792, 'tcp'): 'unified-bus',
    (4792, 'udp'): 'unified-bus',
    (4800, 'tcp'): 'iims',
    (4800, 'udp'): 'iims',
    (4801, 'tcp'): 'iwec',
    (4801, 'udp'): 'iwec',
    ...
    (4802, 'udp'): 'ilss',
    (4803, 'tcp'): 'notateit',
    (4803, 'udp'): 'notateit-disc',
    (4804, 'udp'): 'aja-ntv4-disc',
    (4827, 'tcp'): 'htcp',
    (4827, 'udp'): 'htcp',
    (4837, 'tcp'): 'varadero-0',
    (4837, 'udp'): 'varadero-0',
    ...
    (4845, 'tcp'): 'wcr-remlib',
    (4845, 'udp'): 'wcr-remlib',
    (4846, 'tcp'): 'contamac_icm',
    (4846, 'udp'): 'contamac_icm',
    (4847, 'tcp'): 'wfc',
    (4847, 'udp'): 'wfc',
    ...
    (4851, 'tcp'): 'derby-repli',
    (4851, 'udp'): 'derby-repli',
    ...
    (4871, 'tcp'): 'wired',
    (4871, 'udp'): 'wired',
    (4876, 'tcp'): 'tritium-can',
    (4876, 'udp'): 'tritium-can',
    (4877, 'tcp'): 'lmcs',
    (4877, 'udp'): 'lmcs',
    (4878, 'udp'): 'inst-discovery',
    (4879, 'tcp'): 'wsdl-event',
    (4880, 'tcp'): 'hislip',
    (4881, 'udp'): 'socp-t',
    (4882, 'udp'): 'socp-c',
    ...
    (4885, 'tcp'): 'abbs',
    (4885, 'udp'): 'abbs',
    (4888, 'tcp'): 'xcap-portal',
    (4889, 'tcp'): 'xcap-control',
    (4894, 'tcp'): 'lyskom',
    (4894, 'udp'): 'lyskom',
    ...
    (4900, 'udp'): 'hfcs',
    (4901, 'tcp'): 'flr_agent',
    (4902, 'tcp'): 'magiccontrol',
    (4912, 'tcp'): 'lutap',
    (4913, 'tcp'): 'lutcp',
    (4914, 'tcp'): 'bones',
    (4914, 'udp'): 'bones',
    (4915, 'tcp'): 'frcs',
    (4936, 'udp'): 'an-signaling',
    (4937, 'udp'): 'atsc-mh-ssc',
    (4940, 'tcp'): 'eq-office-4940',
    (4940, 'udp'): 'eq-office-4940',
    (4941, 'tcp'): 'eq-office-4941',
    (4941, 'udp'): 'eq-office-4941',
    (4942, 'tcp'): 'eq-office-4942',
    (4942, 'udp'): 'eq-office-4942',
    (4949, 'tcp'): 'munin',
    (4949, 'udp'): 'munin',
    (4950, 'tcp'): 'sybasesrvmon',
    (4950, 'udp'): 'sybasesrvmon',
    (4951, 'tcp'): 'pwgwims',
    (4951, 'udp'): 'pwgwims',
    (4952, 'tcp'): 'sagxtsds',
    (4952, 'udp'): 'sagxtsds',
    (4953, 'tcp'): 'dbsyncarbiter',
    (4969, 'tcp'): 'ccss-qmm',
    (4969, 'udp'): 'ccss-qmm',
    (4970, 'tcp'): 'ccss-qsm',
    (4970, 'udp'): 'ccss-qsm',
    ...
    (5004, 'dccp'): 'avt-profile-1',
    (5004, 'tcp'): 'avt-profile-1',
    (5004, 'udp'): 'avt-profile-1',
    (5005, 'dccp'): 'avt-profile-2',
    ...
    (5029, 'udp'): 'infobright',
    (5031, 'udp'): 'dmp',
    (5032, 'tcp'): 'signacert-agent',
    (5033, 'tcp'): 'jtnetd-server',
    (5034, 'tcp'): 'jtnetd-status',
    ...
    (5061, 'tcp'): 'sips',
    (5061, 'udp'): 'sips',
    (5062, 'tcp'): 'na-localise',
    (5062, 'udp'): 'na-localise',
    (5063, 'tcp'): 'csrpc',
    (5064, 'tcp'): 'ca-1',
    (5064, 'udp'): 'ca-1',
    (5065, 'tcp'): 'ca-2',
    ...
    (5103, 'tcp'): 'actifio-c2c',
    (5104, 'udp'): 'tinymessage',
    (5105, 'udp'): 'hughes-ap',
    (5106, 'tcp'): 'actifioudsagent',
    (5107, 'tcp'): 'actifioreplic',
    (5111, 'tcp'): 'taep-as-svc',
    (5111, 'udp'): 'taep-as-svc',
    (5112, 'tcp'): 'pm-cmdsvr',
    (5112, 'udp'): 'pm-cmdsvr',
    (5114, 'tcp'): 'ev-services',
    (5115, 'tcp'): 'autobuild',
    (5116, 'udp'): 'emb-proj-cmd',
    (5117, 'tcp'): 'gradecam',
    (5120, 'tcp'): 'barracuda-bbs',
    (5120, 'udp'): 'barracuda-bbs',
    (5133, 'tcp'): 'nbt-pc',
    (5133, 'udp'): 'nbt-pc',
    (5134, 'tcp'): 'ppactivation',
    (5135, 'tcp'): 'erp-scale',
    (5136, 'udp'): 'minotaur-sa',
    (5137, 'tcp'): 'ctsd',
    (5137, 'udp'): 'ctsd',
    (5145, 'tcp'): 'rmonitor_secure',
    (5145, 'udp'): 'rmonitor_secure',
    (5146, 'tcp'): 'social-alarm',
    (5150, 'tcp'): 'atmp',
    (5150, 'udp'): 'atmp',
    (5151, 'tcp'): 'esri_sde',
    (5151, 'udp'): 'esri_sde',
    ...
    (5156, 'tcp'): 'rugameonline',
    (5157, 'tcp'): 'mediat',
    (5161, 'tcp'): 'snmpssh',
    (5162, 'tcp'): 'snmpssh-trap',
    (5163, 'tcp'): 'sbackup',
    (5164, 'tcp'): 'vpa',
    (5164, 'udp'): 'vpa-disc',
    (5165, 'tcp'): 'ife_icorp',
    ...
    (5194, 'tcp'): 'cpscomm',
    (5195, 'tcp'): 'ampl-lic',
    (5196, 'tcp'): 'ampl-tableproxy',
    (5197, 'tcp'): 'tunstall-lwp',
    ...
    (5228, 'tcp'): 'hpvroom',
    (5229, 'tcp'): 'jaxflow',
    (5230, 'tcp'): 'jaxflow-data',
    (5231, 'tcp'): 'crusecontrol',
    (5232, 'tcp'): 'csedaemon',
    (5233, 'tcp'): 'enfs',
    (5234, 'tcp'): 'eenet',
    (5234, 'udp'): 'eenet',
    (5235, 'tcp'): 'galaxy-network',
    (5235, 'udp'): 'galaxy-network',
    (5236, 'tcp'): 'padl2sim',
    (5236, 'udp'): 'padl2sim',
    (5237, 'tcp'): 'mnet-discovery',
    (5237, 'udp'): 'mnet-discovery',
    (5242, 'tcp'): 'attune',
    (5243, 'tcp'): 'xycstatus',
    (5245, 'tcp'): 'downtools',
    (5245, 'udp'): 'downtools-disc',
    ...
    (5270, 'tcp'): 'cartographerxmp',
    (5270, 'udp'): 'cartographerxmp',
    (5271, 'tcp'): 'cuelink',
    (5271, 'udp'): 'cuelink-disc',
    (5272, 'tcp'): 'pk',
    (5272, 'udp'): 'pk',
    (5280, 'tcp'): 'xmpp-bosh',
    (5281, 'tcp'): 'undo-lm',
    ...
    (5317, 'tcp'): 'hpdevms',
    (5318, 'tcp'): 'pkix-cmc',
    (5320, 'tcp'): 'bsfserver-zn',
    (5321, 'tcp'): 'bsfsvr-zn-ssl',
    (5343, 'tcp'): 'kfserver',
    (5343, 'udp'): 'kfserver',
    (5344, 'tcp'): 'xkotodrcp',
    (5344, 'udp'): 'xkotodrcp',
    (5349, 'tcp'): 'stun-behaviors',
    (5349, 'udp'): 'stun-behaviors',
    (5350, 'udp'): 'pcp-multicast',
    (5351, 'udp'): 'pcp',
    (5352, 'tcp'): 'dns-llq',
    (5352, 'udp'): 'dns-llq',
    (5353, 'tcp'): 'mdns',
    ...
    (5359, 'tcp'): 'ms-alerter',
    (5359, 'udp'): 'ms-alerter',
    (5360, 'tcp'): 'ms-sideshow',
    (5360, 'udp'): 'ms-sideshow',
    (5361, 'tcp'): 'ms-s-sideshow',
    (5361, 'udp'): 'ms-s-sideshow',
    (5362, 'tcp'): 'serverwsd2',
    (5362, 'udp'): 'serverwsd2',
    (5363, 'tcp'): 'net-projection',
    (5363, 'udp'): 'net-projection',
    (5364, 'udp'): 'kdnet',
    ...
    (5470, 'tcp'): 'apsolab-col',
    (5471, 'tcp'): 'apsolab-cols',
    (5472, 'tcp'): 'apsolab-tag',
    (5473, 'tcp'): 'apsolab-tags',
    (5474, 'udp'): 'apsolab-rpc',
    (5475, 'tcp'): 'apsolab-data',
    ...
    (5506, 'tcp'): 'amc',
    (5506, 'udp'): 'amc',
    (5507, 'tcp'): 'psl-management',
    (5540, 'tcp'): 'matter',
    (5540, 'udp'): 'matter',
    (5543, 'tcp'): 'qftest-licserve',
    (5550, 'tcp'): 'cbus',
    ...
    (5567, 'tcp'): 'dof-dps-mc-sec',
    (5567, 'udp'): 'dof-dps-mc-sec',
    (5568, 'tcp'): 'sdt',
    (5568, 'udp'): 'sdt',
    (5569, 'tcp'): 'rdmnet-ctrl',
    (5569, 'udp'): 'rdmnet-device',
    (5573, 'tcp'): 'sdmmp',
    (5573, 'udp'): 'sdmmp',
    (5574, 'tcp'): 'lsi-bobcat',
    (5575, 'tcp'): 'ora-oap',
    ...
    (5581, 'tcp'): 'tmosms1',
    (5581, 'udp'): 'tmosms1',
    (5582, 'tcp'): 'fac-restore',
    (5582, 'udp'): 'fac-restore',
    (5583, 'tcp'): 'tmo-icon-sync',
    (5583, 'udp'): 'tmo-icon-sync',
    (5584, 'tcp'): 'bis-web',
    (5584, 'udp'): 'bis-web',
    (5585, 'tcp'): 'bis-sync',
    (5585, 'udp'): 'bis-sync',
    ...
    (5726, 'tcp'): 'ms-ilm-sts',
    (5727, 'tcp'): 'asgenf',
    (5728, 'tcp'): 'io-dist-data',
    (5728, 'udp'): 'io-dist-group',
    (5729, 'tcp'): 'openmail',
    (5729, 'udp'): 'openmail',
    (5730, 'tcp'): 'unieng',
    (5730, 'udp'): 'unieng',
    ...
    (5771, 'tcp'): 'netagent',
    (5771, 'udp'): 'netagent',
    (5777, 'tcp'): 'starfield-io',
    (5777, 'udp'): 'starfield-io',
    (5780, 'tcp'): 'vts-rpc',
    (5781, 'tcp'): '3par-evts',
    (5781, 'udp'): '3par-evts',
    (5782, 'tcp'): '3par-mgmt',
    (5782, 'udp'): '3par-mgmt',
    (5783, 'tcp'): '3par-mgmt-ssl',
    (5783, 'udp'): '3par-mgmt-ssl',
    (5784, 'udp'): 'ibar',
    (5785, 'tcp'): '3par-rcopy',
    (5785, 'udp'): '3par-rcopy',
    (5786, 'udp'): 'cisco-redu',
    (5787, 'udp'): 'waascluster',
    (5793, 'tcp'): 'xtreamx',
    (5793, 'udp'): 'xtreamx',
    (5794, 'udp'): 'spdp',
    (5798, 'tcp'): 'enlabel-dpl',
    (5813, 'tcp'): 'icmpd',
    (5813, 'udp'): 'icmpd',
    (5814, 'tcp'): 'spt-automation',
    (5814, 'udp'): 'spt-automation',
    (5820, 'tcp'): 'autopassdaemon',
    (5841, 'tcp'): 'shiprush-d-ch',
    (5842, 'tcp'): 'reversion',
    (5859, 'tcp'): 'wherehoo',
    (5859, 'udp'): 'wherehoo',
    (5863, 'tcp'): 'ppsuitemsg',
    ...
    (6074, 'udp'): 'max',
    (6075, 'tcp'): 'dpm-acm',
    (6076, 'tcp'): 'msft-dpm-cert',
    (6077, 'tcp'): 'iconstructsrv',
    (6080, 'udp'): 'gue',
    (6081, 'udp'): 'geneve',
    (6082, 'udp'): 'p25cai',
    (6083, 'udp'): 'miami-bcast',
    (6084, 'tcp'): 'reload-config',
    (6085, 'tcp'): 'konspire2b',
    (6085, 'udp'): 'konspire2b',
    (6086, 'tcp'): 'pdtp',
    (6086, 'udp'): 'pdtp',
    ...
    (6112, 'tcp'): 'dtspcd',
    (6112, 'udp'): 'dtspcd',
    (6113, 'tcp'): 'dayliteserver',
    (6114, 'tcp'): 'wrspice',
    (6115, 'tcp'): 'xic',
    (6116, 'tcp'): 'xtlserv',
    (6117, 'tcp'): 'daylitetouch',
    (6118, 'udp'): 'tipc',
    (6121, 'tcp'): 'spdy',
    ...
    (6124, 'tcp'): 'pnbs',
    (6124, 'udp'): 'pnbs',
    (6130, 'tcp'): 'damewaremobgtwy',
    (6133, 'tcp'): 'nbt-wol',
    (6133, 'udp'): 'nbt-wol',
    (6140, 'tcp'): 'pulsonixnls',
    (6140, 'udp'): 'pulsonixnls',
    (6141, 'tcp'): 'meta-corp',
    (6141, 'udp'): 'meta-corp',
    ...
    (6200, 'tcp'): 'lm-x',
    (6200, 'udp'): 'lm-x',
    (6201, 'udp'): 'thermo-calc',
    (6209, 'tcp'): 'qmtps',
    (6209, 'udp'): 'qmtps',
    (6222, 'tcp'): 'radmind',
    (6222, 'udp'): 'radmind',
    (6241, 'tcp'): 'jeol-nsdtp-1',
    (6241, 'udp'): 'jeol-nsddp-1',
    (6242, 'tcp'): 'jeol-nsdtp-2',
    (6242, 'udp'): 'jeol-nsddp-2',
    (6243, 'tcp'): 'jeol-nsdtp-3',
    (6243, 'udp'): 'jeol-nsddp-3',
    (6244, 'tcp'): 'jeol-nsdtp-4',
    (6244, 'udp'): 'jeol-nsddp-4',
    (6251, 'tcp'): 'tl1-raw-ssl',
    (6251, 'udp'): 'tl1-raw-ssl',
    (6252, 'tcp'): 'tl1-ssh',
    (6252, 'udp'): 'tl1-ssh',
    (6253, 'tcp'): 'crip',
    (6253, 'udp'): 'crip',
    ...
    (6355, 'tcp'): 'pmcs',
    (6355, 'udp'): 'pmcs',
    (6360, 'tcp'): 'metaedit-mu',
    (6360, 'udp'): 'metaedit-mu',
    (6363, 'udp'): 'ndn',
    (6370, 'tcp'): 'metaedit-se',
    (6370, 'udp'): 'metaedit-se',
    (6379, 'tcp'): 'redis',
    (6382, 'tcp'): 'metatude-mds',
    (6382, 'udp'): 'metatude-mds',
    (6389, 'tcp'): 'clariion-evr01',
    (6389, 'udp'): 'clariion-evr01',
    (6390, 'tcp'): 'metaedit-ws',
    (6390, 'udp'): 'metaedit-ws',
    (6417, 'tcp'): 'faxcomservice',
    (6417, 'udp'): 'faxcomservice',
    (6418, 'tcp'): 'syserverremote',
    (6419, 'tcp'): 'svdrp',
    (6419, 'udp'): 'svdrp-disc',
    ...
    (6510, 'udp'): 'mcer-port',
    (6511, 'udp'): 'dccp-udp',
    (6513, 'tcp'): 'netconf-tls',
    (6514, 'dccp'): 'syslog-tls',
    (6514, 'tcp'): 'syslog-tls',
    (6514, 'udp'): 'syslog-tls',
    (6515, 'tcp'): 'elipse-rec',
    (6515, 'udp'): 'elipse-rec',
    ...
    (6566, 'tcp'): 'sane-port',
    (6566, 'udp'): 'sane-port',
    (6568, 'tcp'): 'canit_store',
    (6568, 'udp'): 'rp-reputation',
    (6579, 'tcp'): 'affiliate',
    (6579, 'udp'): 'affiliate',
    ...
    (6623, 'tcp'): 'ktelnet',
    (6623, 'udp'): 'ktelnet',
    (6624, 'tcp'): 'datascaler-db',
    (6625, 'tcp'): 'datascaler-ctl',
    ...
    (6629, 'tcp'): 'nexgen-aux',
    (6629, 'udp'): 'nexgen-aux',
    (6632, 'tcp'): 'mxodbc-connect',
    (6633, 'udp'): 'cisco-vpath-tun',
    (6634, 'udp'): 'mpls-pm',
    (6635, 'udp'): 'mpls-udp',
    (6636, 'udp'): 'mpls-udp-dtls',
    (6640, 'tcp'): 'ovsdb',
    (6653, 'tcp'): 'openflow',
    (6653, 'udp'): 'openflow',
    (6655, 'tcp'): 'pcs-sf-ui-man',
    (6656, 'tcp'): 'emgmsg',
    (6657, 'udp'): 'palcom-disc',
    ...
    (6679, 'tcp'): 'osaut',
    (6679, 'udp'): 'osaut',
    (6687, 'tcp'): 'clever-ctrace',
    (6688, 'tcp'): 'clever-tcpip',
    (6689, 'tcp'): 'tsa',
    (6689, 'udp'): 'tsa',
    (6690, 'tcp'): 'cleverdetect',
    (6696, 'udp'): 'babel',
    (6697, 'tcp'): 'ircs-u',
    (6699, 'udp'): 'babel-dtls',
    ...
    (6777, 'tcp'): 'ntz-tracker',
    (6778, 'tcp'): 'ntz-p2p-storage',
    (6784, 'udp'): 'bfd-lag',
    (6785, 'tcp'): 'dgpf-exchg',
    (6785, 'udp'): 'dgpf-exchg',
    (6786, 'tcp'): 'smc-jmx',
    ...
    (6868, 'tcp'): 'acctopus-cc',
    (6868, 'udp'): 'acctopus-st',
    (6888, 'tcp'): 'muse',
    (6888, 'udp'): 'muse',
    (6900, 'tcp'): 'rtimeviewer',
    (6901, 'tcp'): 'jetstream',
    (6924, 'tcp'): 'split-ping',
    (6924, 'udp'): 'split-ping',
    (6935, 'tcp'): 'ethoscan',
    ...
    (6969, 'tcp'): 'acmsoda',
    (6969, 'udp'): 'acmsoda',
    (6970, 'sctp'): 'conductor-mpx',
    (6970, 'tcp'): 'conductor',
    (6980, 'udp'): 'qolyester',
    (6997, 'tcp'): 'MobilitySrv',
    (6997, 'udp'): 'MobilitySrv',
    ...
    (7071, 'udp'): 'iwg1',
    (7072, 'tcp'): 'iba-cfg',
    (7072, 'udp'): 'iba-cfg-disc',
    (7073, 'tcp'): 'martalk',
    (7080, 'tcp'): 'empowerid',
    (7080, 'udp'): 'empowerid',
    (7088, 'udp'): 'zixi-transport',
    (7095, 'udp'): 'jdp-disc',
    (7099, 'tcp'): 'lazy-ptop',
    (7099, 'udp'): 'lazy-ptop',
    ...
    (7165, 'tcp'): 'doc-server',
    (7165, 'udp'): 'doc-server',
    (7166, 'tcp'): 'aruba-server',
    (7166, 'udp'): 'aruba-server',
    (7167, 'tcp'): 'casrmagent',
    (7168, 'tcp'): 'cnckadserver',
    (7169, 'tcp'): 'ccag-pib',
    (7169, 'udp'): 'ccag-pib',
    (7170, 'tcp'): 'nsrp',
    (7170, 'udp'): 'nsrp',
    (7171, 'tcp'): 'drm-production',
    (7171, 'udp'): 'drm-production',
    (7172, 'tcp'): 'metalbend',
    (7173, 'tcp'): 'zsecure',
    (7174, 'tcp'): 'clutild',
    (7174, 'udp'): 'clutild',
    ...
    (7202, 'tcp'): 'pon-ictp',
    (7215, 'tcp'): 'PS-Server',
    (7216, 'tcp'): 'PS-Capture-Pro',
    (7227, 'tcp'): 'ramp',
    (7227, 'udp'): 'ramp',
    (7228, 'tcp'): 'citrixupp',
    (7229, 'tcp'): 'citrixuppg',
    (7234, 'tcp'): 'asa-gateways',
    (7235, 'udp'): 'aspcoordination',
    (7236, 'tcp'): 'display',
    (7237, 'tcp'): 'pads',
    (7244, 'tcp'): 'frc-hicp',
    (7244, 'udp'): 'frc-hicp-disc',
    (7262, 'tcp'): 'cnap',
    (7262, 'udp'): 'cnap',
    ...
    (7277, 'tcp'): 'oma-ilp-s',
    (7277, 'udp'): 'oma-ilp-s',
    (7278, 'tcp'): 'oma-dcdocbs',
    (7278, 'udp'): 'oma-dcdocbs',
    (7279, 'tcp'): 'ctxlic',
    (7279, 'udp'): 'ctxlic',
    ...
    (7549, 'tcp'): 'nls-tl',
    (7549, 'udp'): 'nls-tl',
    (7550, 'udp'): 'cloudsignaling',
    (7551, 'tcp'): 'controlone-con',
    (7560, 'tcp'): 'sncp',
    (7560, 'udp'): 'sncp',
    (7563, 'tcp'): 'cfw',
    (7566, 'tcp'): 'vsi-omega',
    (7566, 'udp'): 'vsi-omega',
    (7569, 'tcp'): 'dell-eql-asm',
    (7570, 'tcp'): 'aries-kfinder',
    (7570, 'udp'): 'aries-kfinder',
    (7574, 'tcp'): 'coherence',
    (7574, 'udp'): 'coherence-disc',
    (7575, 'tcp'): 'wtmi-panel',
    (7588, 'tcp'): 'sun-lm',
    (7588, 'udp'): 'sun-lm',
    (7606, 'tcp'): 'mipi-debug',
    ...
    (7724, 'tcp'): 'nsdeepfreezectl',
    (7724, 'udp'): 'nsdeepfreezectl',
    (7725, 'tcp'): 'nitrogen',
    (7725, 'udp'): 'nitrogen',
    ...
    (7933, 'tcp'): 't2-brm',
    (7933, 'udp'): 't2-brm',
    (7962, 'tcp'): 'generalsync',
    (7962, 'udp'): 'generalsync',
    (7967, 'tcp'): 'supercell',
    (7967, 'udp'): 'supercell',
    ...
    (7981, 'tcp'): 'sossd-collect',
    (7982, 'tcp'): 'sossd-agent',
    (7982, 'udp'): 'sossd-disc',
    (7997, 'tcp'): 'pushns',
    (7998, 'udp'): 'usicontentpush',
    (7999, 'tcp'): 'irdmi2',
    (7999, 'udp'): 'irdmi2',
    (8000, 'tcp'): 'irdmi',
    (8000, 'udp'): 'irdmi',
    ...
    (8003, 'tcp'): 'mcreport',
    (8003, 'udp'): 'mcreport',
    (8004, 'tcp'): 'p2pevolvenet',
    (8005, 'tcp'): 'mxi',
    (8005, 'udp'): 'mxi',
    (8006, 'tcp'): 'wpl-analytics',
    (8006, 'udp'): 'wpl-disc',
    (8007, 'tcp'): 'warppipe',
    (8007, 'udp'): 'warppipe',
    (8008, 'tcp'): 'http-alt',
    ...
    (8027, 'tcp'): 'papachi-p2p-srv',
    (8027, 'udp'): 'papachi-p2p-srv',
    (8032, 'tcp'): 'pro-ed',
    (8032, 'udp'): 'pro-ed',
    (8033, 'tcp'): 'mindprint',
    (8033, 'udp'): 'mindprint',
    (8034, 'tcp'): 'vantronix-mgmt',
    (8034, 'udp'): 'vantronix-mgmt',
    (8040, 'tcp'): 'ampify',
    (8040, 'udp'): 'ampify',
    (8041, 'tcp'): 'enguity-xccetp',
    (8041, 'udp'): 'enguity-xccetp',
    (8042, 'tcp'): 'fs-agent',
    (8043, 'tcp'): 'fs-server',
    (8044, 'tcp'): 'fs-mgmt',
    (8051, 'tcp'): 'rocrail',
    ...
    (8059, 'udp'): 'senomix08',
    (8060, 'udp'): 'aero',
    (8061, 'tcp'): 'nikatron-dev',
    (8066, 'tcp'): 'toad-bi-appsrvr',
    (8067, 'tcp'): 'infi-async',
    (8070, 'tcp'): 'ucs-isc',
    (8074, 'tcp'): 'gadugadu',
    (8074, 'udp'): 'gadugadu',
    ...
    (8230, 'tcp'): 'rexecj',
    (8230, 'udp'): 'rexecj',
    (8231, 'udp'): 'hncp-udp-port',
    (8232, 'udp'): 'hncp-dtls-port',
    (8243, 'tcp'): 'synapse-nhttps',
    (8243, 'udp'): 'synapse-nhttps',
    (8266, 'udp'): 'espeasy-p2p',
    (8270, 'tcp'): 'robot-remote',
    (8276, 'tcp'): 'ms-mcc',
    (8276, 'udp'): 'ms-mcc',
    (8280, 'tcp'): 'synapse-nhttp',
    (8280, 'udp'): 'synapse-nhttp',
    (8282, 'tcp'): 'libelle',
    (8282, 'udp'): 'libelle-disc',
    (8292, 'tcp'): 'blp3',
    (8292, 'udp'): 'blp3',
    (8293, 'tcp'): 'hiperscan-id',
    (8294, 'tcp'): 'blp4',
    (8294, 'udp'): 'blp4',
    (8300, 'tcp'): 'tmi',
    (8300, 'udp'): 'tmi',
    (8301, 'tcp'): 'amberon',
    (8301, 'udp'): 'amberon',
    (8313, 'tcp'): 'hub-open-net',
    (8320, 'tcp'): 'tnp-discover',
    (8320, 'udp'): 'tnp-discover',
    (8321, 'tcp'): 'tnp',
    (8321, 'udp'): 'tnp',
    (8322, 'tcp'): 'garmin-marine',
    (8322, 'udp'): 'garmin-marine',
    ...
    (8432, 'tcp'): 'pgbackrest',
    (8433, 'udp'): 'aws-as2',
    (8442, 'tcp'): 'cybro-a-bus',
    (8442, 'udp'): 'cybro-a-bus',
    ...
    (8615, 'tcp'): 'imink',
    (8665, 'tcp'): 'monetra',
    (8666, 'tcp'): 'monetra-admin',
    (8668, 'tcp'): 'spartan',
    (8675, 'tcp'): 'msi-cps-rm',
    (8675, 'udp'): 'msi-cps-rm-disc',
    (8686, 'tcp'): 'sun-as-jmxrmi',
    (8686, 'udp'): 'sun-as-jmxrmi',
    (8688, 'tcp'): 'openremote-ctrl',
    (8699, 'tcp'): 'vnyx',
    (8710, 'tcp'): 'semi-grpc',
    (8711, 'tcp'): 'nvc',
    (8732, 'udp'): 'dtp-net',
    ...
    (8766, 'tcp'): 'amcs',
    (8766, 'udp'): 'amcs',
    (8767, 'tcp'): 'core-of-source',
    (8768, 'tcp'): 'sandpolis',
    (8769, 'tcp'): 'oktaauthenticat',
    (8770, 'tcp'): 'dpap',
    (8770, 'udp'): 'dpap',
    (8778, 'tcp'): 'uec',
    (8786, 'tcp'): 'msgclnt',
    ...
    (8913, 'udp'): 'dragonfly',
    (8937, 'tcp'): 'twds',
    (8953, 'tcp'): 'ub-dns-control',
    (8954, 'tcp'): 'cumulus-admin',
    (8954, 'udp'): 'cumulus-admin',
    (8980, 'tcp'): 'nod-provider',
    (8980, 'udp'): 'nod-provider',
    (8981, 'udp'): 'nod-client',
    ...
    (8991, 'tcp'): 'https-wmap',
    (8991, 'udp'): 'https-wmap',
    (8997, 'tcp'): 'oracle-ms-ens',
    (8998, 'tcp'): 'canto-roboflow',
    (8999, 'tcp'): 'bctp',
    (8999, 'udp'): 'bctp',
    (9000, 'tcp'): 'cslistener',
    (9000, 'udp'): 'cslistener',
    ...
    (9081, 'udp'): 'cisco-aqos',
    (9082, 'sctp'): 'lcs-ap',
    (9083, 'tcp'): 'emc-pp-mgmtsvc',
    (9084, 'sctp'): 'aurora',
    (9084, 'tcp'): 'aurora',
    (9084, 'udp'): 'aurora',
    (9085, 'tcp'): 'ibm-rsyscon',
    (9085, 'udp'): 'ibm-rsyscon',
    (9086, 'tcp'): 'net2display',
    (9086, 'udp'): 'net2display',
    (9087, 'tcp'): 'classic',
    (9087, 'udp'): 'classic',
    (9088, 'tcp'): 'sqlexec',
    (9088, 'udp'): 'sqlexec',
    ...
    (9105, 'udp'): 'xadmin',
    (9106, 'tcp'): 'astergate',
    (9106, 'udp'): 'astergate-disc',
    (9107, 'tcp'): 'astergatefax',
    (9111, 'tcp'): 'hexxorecore',
    (9111, 'udp'): 'hexxorecore',
    (9119, 'tcp'): 'mxit',
    (9119, 'udp'): 'mxit',
    (9122, 'tcp'): 'grcmp',
    (9123, 'tcp'): 'grcp',
    ...
    (9255, 'tcp'): 'mon',
    (9255, 'udp'): 'mon',
    (9277, 'udp'): 'traingpsdata',
    (9278, 'tcp'): 'pegasus',
    (9278, 'udp'): 'pegasus',
    (9279, 'tcp'): 'pegasus-ctl',
    (9279, 'udp'): 'pegasus-ctl',
    (9280, 'tcp'): 'pgps',
    (9280, 'udp'): 'pgps',
    (9281, 'tcp'): 'swtp-port1',
    (9281, 'udp'): 'swtp-port1',
    ...
    (9397, 'tcp'): 'mpidcagt',
    (9397, 'udp'): 'mpidcagt',
    (9400, 'tcp'): 'sec-t4net-srv',
    (9400, 'udp'): 'sec-t4net-srv',
    (9401, 'tcp'): 'sec-t4net-clt',
    (9401, 'udp'): 'sec-t4net-clt',
    (9402, 'tcp'): 'sec-pc2fax-srv',
    (9402, 'udp'): 'sec-pc2fax-srv',
    (9418, 'tcp'): 'git',
    (9418, 'udp'): 'git',
    (9443, 'tcp'): 'tungsten-https',
    (9443, 'udp'): 'tungsten-https',
    (9444, 'tcp'): 'wso2esb-console',
    (9444, 'udp'): 'wso2esb-console',
    (9445, 'tcp'): 'mindarray-ca',
    (9450, 'tcp'): 'sntlkeyssrvr',
    (9450, 'udp'): 'sntlkeyssrvr',
    (9500, 'tcp'): 'ismserver',
    (9500, 'udp'): 'ismserver',
    (9522, 'udp'): 'sma-spw',
    (9535, 'tcp'): 'mngsuite',
    ...
    (9614, 'tcp'): 'iadt-tls',
    (9616, 'tcp'): 'erunbook_agent',
    (9617, 'tcp'): 'erunbook_server',
    (9618, 'tcp'): 'condor',
    (9618, 'udp'): 'condor',
    (9628, 'tcp'): 'odbcpathway',
    (9628, 'udp'): 'odbcpathway',
    (9629, 'tcp'): 'uniport',
    (9629, 'udp'): 'uniport',
    (9630, 'tcp'): 'peoctlr',
    (9631, 'tcp'): 'peocoll',
    ...
    (9668, 'tcp'): 'tec5-sdctp',
    (9668, 'udp'): 'tec5-sdctp',
    (9694, 'tcp'): 'client-wakeup',
    (9694, 'udp'): 'client-wakeup',
    (9695, 'tcp'): 'ccnx',
    (9695, 'udp'): 'ccnx',
    (9700, 'tcp'): 'board-roar',
    (9700, 'udp'): 'board-roar',
    ...
    (9953, 'udp'): 'acis',
    (9954, 'tcp'): 'hinp',
    (9955, 'tcp'): 'alljoyn-stm',
    (9955, 'udp'): 'alljoyn-mcm',
    (9956, 'udp'): 'alljoyn',
    (9966, 'tcp'): 'odnsp',
    (9966, 'udp'): 'odnsp',
    (9978, 'tcp'): 'xybrid-rt',
    ...
    (10002, 'udp'): 'documentum',
    (10003, 'tcp'): 'documentum_s',
    (10003, 'udp'): 'documentum_s',
    (10004, 'tcp'): 'emcrmirccd',
    (10005, 'tcp'): 'emcrmird',
    (10006, 'tcp'): 'netapp-sync',
    ...
    (10161, 'tcp'): 'snmptls',
    (10161, 'udp'): 'snmpdtls',
    (10162, 'tcp'): 'snmptls-trap',
    (10162, 'udp'): 'snmpdtls-trap',
    (10200, 'tcp'): 'trisoap',
    (10200, 'udp'): 'trisoap',
    (10201, 'tcp'): 'rsms',
    (10201, 'udp'): 'rscs',
    ...
    (10543, 'tcp'): 'MOS-soap',
    (10543, 'udp'): 'MOS-soap',
    (10544, 'tcp'): 'MOS-soap-opt',
    (10544, 'udp'): 'MOS-soap-opt',
    (10548, 'tcp'): 'serverdocs',
    (10631, 'tcp'): 'printopia',
    (10800, 'tcp'): 'gap',
    (10800, 'udp'): 'gap',
    (10805, 'tcp'): 'lpdg',
    ...
    (11095, 'tcp'): 'weave',
    (11095, 'udp'): 'weave',
    (11103, 'tcp'): 'origo-sync',
    (11104, 'tcp'): 'netapp-icmgmt',
    (11105, 'tcp'): 'netapp-icdata',
    (11106, 'tcp'): 'sgi-lk',
    (11106, 'udp'): 'sgi-lk',
    (11108, 'udp'): 'myq-termlink',
    (11109, 'tcp'): 'sgi-dmfmgr',
    (11110, 'tcp'): 'sgi-soap',
    (11111, 'tcp'): 'vce',
    (11111, 'udp'): 'vce',
    (11112, 'tcp'): 'dicom',
    ...
    (11171, 'udp'): 'snss',
    (11172, 'tcp'): 'oemcacao-jmxmp',
    (11173, 'tcp'): 't5-straton',
    (11174, 'tcp'): 'oemcacao-rmi',
    (11175, 'tcp'): 'oemcacao-websvc',
    (11201, 'tcp'): 'smsqp',
    (11201, 'udp'): 'smsqp',
    (11202, 'tcp'): 'dcsl-backup',
    (11208, 'tcp'): 'wifree',
    (11208, 'udp'): 'wifree',
    (11211, 'tcp'): 'memcache',
    (11211, 'udp'): 'memcache',
    ...
    (12012, 'tcp'): 'vipera',
    (12012, 'udp'): 'vipera',
    (12013, 'tcp'): 'vipera-ssl',
    (12013, 'udp'): 'vipera-ssl',
    (12109, 'tcp'): 'rets-ssl',
    (12109, 'udp'): 'rets-ssl',
    ...
    (13217, 'tcp'): 'rs-pias',
    (13217, 'udp'): 'rs-pias',
    (13218, 'tcp'): 'emc-vcas-tcp',
    (13218, 'udp'): 'emc-vcas-udp',
    ...
    (13822, 'udp'): 'dsmcc-ccp',
    (13823, 'tcp'): 'bmdss',
    (13832, 'tcp'): 'a-trust-rpc',
    (13894, 'tcp'): 'ucontrol',
    (13894, 'udp'): 'ucontrol',
    (13929, 'tcp'): 'dta-systems',
    (13929, 'udp'): 'dta-systems',
    (13930, 'tcp'): 'medevolve',
    (14000, 'tcp'): 'scotty-ft',
    (14000, 'udp'): 'scotty-ft',
    (14001, 'sctp'): 'sua',
    ...
    (16385, 'tcp'): 'rdgs',
    (16619, 'tcp'): 'xoms',
    (16665, 'tcp'): 'axon-tunnel',
    (16666, 'udp'): 'vtp',
    (16789, 'tcp'): 'cadsisvr',
    (16900, 'tcp'): 'newbay-snc-mc',
    (16900, 'udp'): 'newbay-snc-mc',
    (16950, 'tcp'): 'sgcip',
    (16950, 'udp'): 'sgcip',
    ...
    (17221, 'udp'): 'avdecc',
    (17222, 'udp'): 'cpsp',
    (17223, 'tcp'): 'isa100-gci',
    (17224, 'udp'): 'trdp-pd',
    (17225, 'tcp'): 'trdp-md',
    (17225, 'udp'): 'trdp-md',
    (17234, 'tcp'): 'integrius-stp',
    (17234, 'udp'): 'integrius-stp',
    (17235, 'tcp'): 'ssh-mgmt',
    (17235, 'udp'): 'ssh-mgmt',
    (17500, 'tcp'): 'db-lsp',
    (17500, 'udp'): 'db-lsp-disc',
    (17555, 'tcp'): 'ailith',
    (17729, 'tcp'): 'ea',
    (17729, 'udp'): 'ea',
    (17754, 'tcp'): 'zep',
    ...
    (19541, 'udp'): 'jcp',
    (19788, 'udp'): 'mle',
    (19790, 'tcp'): 'faircom-db',
    (19998, 'tcp'): 'iec-104-sec',
    (19999, 'sctp'): 'dnp-sec',
    (19999, 'tcp'): 'dnp-sec',
    (19999, 'udp'): 'dnp-sec',
    (20000, 'sctp'): 'dnp',
    ...
    (20005, 'tcp'): 'openwebnet',
    (20005, 'udp'): 'openwebnet',
    (20012, 'udp'): 'ss-idi-disc',
    (20013, 'tcp'): 'ss-idi',
    (20014, 'tcp'): 'opendeploy',
    (20014, 'udp'): 'opendeploy',
    (20034, 'tcp'): 'nburn_id',
    (20034, 'udp'): 'nburn_id',
    (20046, 'tcp'): 'tmophl7mts',
    (20046, 'udp'): 'tmophl7mts',
    (20048, 'tcp'): 'mountd',
    (20048, 'udp'): 'mountd',
    (20049, 'sctp'): 'nfsrdma',
    (20049, 'tcp'): 'nfsrdma',
    ...
    (20670, 'tcp'): 'track',
    (20670, 'udp'): 'track',
    (20810, 'tcp'): 'crtech-nlm',
    (20999, 'tcp'): 'athand-mmp',
    (20999, 'udp'): 'athand-mmp',
    (21000, 'tcp'): 'irtrans',
    (21000, 'udp'): 'irtrans',
    (21010, 'tcp'): 'notezilla-lan',
    (21212, 'tcp'): 'trinket-agent',
    (21213, 'tcp'): 'cohesity-agent',
    (21221, 'tcp'): 'aigairserver',
    (21553, 'tcp'): 'rdm-tfs',
    (21554, 'tcp'): 'dfserver',
    (21554, 'udp'): 'dfserver',
    ...
    (22305, 'tcp'): 'cis',
    (22305, 'udp'): 'cis',
    (22333, 'tcp'): 'showcockpit-net',
    (22333, 'udp'): 'showcockpit-net',
    (22335, 'tcp'): 'shrewd-control',
    (22335, 'udp'): 'shrewd-stream',
    (22343, 'tcp'): 'cis-secure',
    (22343, 'udp'): 'cis-secure',
    (22347, 'tcp'): 'wibukey',
    (22347, 'udp'): 'wibukey',
    (22350, 'tcp'): 'codemeter',
    (22350, 'udp'): 'codemeter',
    (22351, 'tcp'): 'codemeter-cmwan',
    (22537, 'tcp'): 'caldsoft-backup',
    ...
    (23456, 'tcp'): 'aequus',
    (23457, 'tcp'): 'aequus-alt',
    (23546, 'tcp'): 'areaguard-neo',
    (24000, 'tcp'): 'med-ltp',
    (24000, 'udp'): 'med-ltp',
    ...
    (25902, 'tcp'): 'nilinkanalyst',
    (25902, 'udp'): 'nilinkanalyst',
    (25903, 'tcp'): 'niprobe',
    (25903, 'udp'): 'niprobe',
    (25954, 'udp'): 'bf-game',
    (25955, 'udp'): 'bf-master',
    ...
    (28000, 'udp'): 'nxlmd',
    (28001, 'tcp'): 'pqsp',
    (28010, 'tcp'): 'gruber-cashreg',
    (28080, 'tcp'): 'thor-engine',
    (28119, 'udp'): 'a27-ran-ran',
    (28200, 'tcp'): 'voxelstorm',
    (28200, 'udp'): 'voxelstorm',
    (28240, 'tcp'): 'siemensgsm',
    (28240, 'udp'): 'siemensgsm',
    (28589, 'tcp'): 'bosswave',
    (29000, 'tcp'): 'saltd-licensing',
    (29118, 'sctp'): 'sgsap',
    (29167, 'tcp'): 'otmp',
    (29167, 'udp'): 'otmp',
    (29168, 'sctp'): 'sbcap',
    (29169, 'sctp'): 'iuhsctpassoc',
    (29999, 'tcp'): 'bingbang',
    (30000, 'tcp'): 'ndmps',
    ...
    (30003, 'tcp'): 'amicon-fpsu-ra',
    (30003, 'udp'): 'amicon-fpsu-ra',
    (30004, 'udp'): 'amicon-fpsu-s',
    (30100, 'sctp'): 'rwp',
    (30100, 'tcp'): 'rwp',
    (30260, 'tcp'): 'kingdomsonline',
    (30260, 'udp'): 'kingdomsonline',
    (30400, 'tcp'): 'gs-realtime',
    (30832, 'udp'): 'samsung-disc',
    (30999, 'tcp'): 'ovobs',
    (30999, 'udp'): 'ovobs',
    (31016, 'tcp'): 'ka-sddp',
    (31016, 'udp'): 'ka-kdp',
    (31020, 'tcp'): 'autotrac-acp',
    (31029, 'udp'): 'yawn',
    (31337, 'tcp'): 'eldim',
    (31337, 'udp'): 'eldim',
    (31400, 'tcp'): 'pace-licensed',
    (31416, 'tcp'): 'xqosd',
    (31416, 'udp'): 'xqosd',
    (31457, 'tcp'): 'tetrinet',
    (31457, 'udp'): 'tetrinet',
    ...
    (32034, 'tcp'): 'iracinghelper',
    (32034, 'udp'): 'iracinghelper',
    ...
    (32896, 'tcp'): 'idmgratm',
    (32896, 'udp'): 'idmgratm',
    (33000, 'tcp'): 'wg-endpt-comms',
    (33060, 'tcp'): 'mysqlx',
    (33123, 'tcp'): 'aurora-balaena',
    (33123, 'udp'): 'aurora-balaena',
    (33331, 'tcp'): 'diamondport',
    (33331, 'udp'): 'diamondport',
    (33333, 'tcp'): 'dgi-serv',
    (33334, 'tcp'): 'speedtrace',
    (33334, 'udp'): 'speedtrace-disc',
    (33434, 'tcp'): 'traceroute',
    (33434, 'udp'): 'traceroute',
    (33435, 'udp'): 'mtrace',
    (33656, 'tcp'): 'snip-slave',
    (33656, 'udp'): 'snip-slave',
    (33890, 'tcp'): 'digilent-adept',
    ...
    (34567, 'tcp'): 'dhanalakshmi',
    (34567, 'udp'): 'edi_service',
    ...
    (35001, 'udp'): 'rt-viewer',
    (35002, 'tcp'): 'rt-sound',
    (35003, 'tcp'): 'rt-devicemapper',
    (35004, 'tcp'): 'rt-classmanager',
    (35004, 'udp'): 'rt-classmanager',
    (35005, 'tcp'): 'rt-labtracker',
    (35006, 'tcp'): 'rt-helper',
    (35100, 'tcp'): 'axio-disc',
    (35100, 'udp'): 'axio-disc',
    (35354, 'tcp'): 'kitim',
    (35355, 'tcp'): 'altova-lm',
    (35355, 'udp'): 'altova-lm-disc',
    (35356, 'tcp'): 'guttersnex',
    (35357, 'tcp'): 'openstack-id',
    (36001, 'tcp'): 'allpeers',
    (36001, 'udp'): 'allpeers',
    (36411, 'udp'): 'wlcp',
    (36412, 'sctp'): 's1-control',
    (36422, 'sctp'): 'x2-control',
    (36423, 'sctp'): 'slmap',
    (36424, 'sctp'): 'nq-ap',
    (36443, 'sctp'): 'm2ap',
    (36444, 'sctp'): 'm3ap',
    (36462, 'sctp'): 'xw-control',
    (36524, 'tcp'): 'febooti-aw',
    (36602, 'tcp'): 'observium-agent',
    (36700, 'tcp'): 'mapx',
    (36865, 'tcp'): 'kastenxpipe',
    (36865, 'udp'): 'kastenxpipe',
    (37472, 'sctp'): '3gpp-w1ap',
    (37475, 'tcp'): 'neckar',
    (37475, 'udp'): 'neckar',
    (37483, 'tcp'): 'gdrive-sync',
    (37601, 'tcp'): 'eftp',
    (37654, 'tcp'): 'unisys-eportal',
    (37654, 'udp'): 'unisys-eportal',
    (38000, 'tcp'): 'ivs-database',
    (38001, 'tcp'): 'ivs-insertion',
    (38002, 'tcp'): 'cresco-control',
    (38002, 'udp'): 'crescoctrl-disc',
    ...
    (38203, 'tcp'): 'agpolicy',
    (38203, 'udp'): 'agpolicy',
    (38412, 'sctp'): 'ng-control',
    (38422, 'sctp'): 'xn-control',
    (38462, 'sctp'): 'e1-interface',
    (38472, 'sctp'): 'f1-control',
    (38638, 'tcp'): 'psqlmws',
    (38800, 'tcp'): 'sruth',
    (38865, 'tcp'): 'secrmmsafecopya',
    (39063, 'tcp'): 'vroa',
    (39681, 'tcp'): 'turbonote-1',
    (39681, 'udp'): 'turbonote-1',
    (40000, 'tcp'): 'safetynetp',
    (40000, 'udp'): 'safetynetp',
    (40023, 'udp'): 'k-patentssensor',
    (40404, 'tcp'): 'sptx',
    (40841, 'tcp'): 'cscp',
    (40841, 'udp'): 'cscp',
    (40842, 'tcp'): 'csccredir',
    ...
    (41796, 'tcp'): 'crestron-cips',
    (41797, 'tcp'): 'crestron-ctps',
    (42508, 'tcp'): 'candp',
    (42508, 'udp'): 'candp',
    (42509, 'tcp'): 'candrp',
    (42509, 'udp'): 'candrp',
    ...
    (43191, 'tcp'): 'noit-transport',
    (43210, 'tcp'): 'shaperai',
    (43210, 'udp'): 'shaperai-disc',
    (43438, 'udp'): 'hmip-routing',
    (43439, 'tcp'): 'eq3-update',
    (43439, 'udp'): 'eq3-config',
    (43440, 'tcp'): 'ew-mgmt',
    (43440, 'udp'): 'ew-disc-cmd',
    (43441, 'tcp'): 'ciscocsdb',
    (43441, 'udp'): 'ciscocsdb',
    (44123, 'tcp'): 'z-wave-tunnel',
    (44321, 'tcp'): 'pmcd',
    (44321, 'udp'): 'pmcd',
    (44322, 'tcp'): 'pmcdproxy',
    (44322, 'udp'): 'pmcdproxy',
    (44323, 'tcp'): 'pmwebapi',
    (44444, 'tcp'): 'cognex-dataman',
    (44445, 'tcp'): 'acronis-backup',
    (44544, 'udp'): 'domiq',
    (44553, 'tcp'): 'rbr-debug',
    (44553, 'udp'): 'rbr-debug',
    (44600, 'udp'): 'asihpi',
    (44818, 'tcp'): 'EtherNet/IP-2',
    (44818, 'udp'): 'EtherNet/IP-2',
    (44900, 'tcp'): 'm3da',
    (44900, 'udp'): 'm3da-disc',
    (45000, 'tcp'): 'asmp',
    (45000, 'udp'): 'asmp-mon',
    ...
    (45185, 'tcp'): 'witsnet',
    (45185, 'udp'): 'witsnet',
    (45514, 'tcp'): 'cloudcheck',
    (45514, 'udp'): 'cloudcheck-ping',
    (45678, 'tcp'): 'eba',
    (45678, 'udp'): 'eba',
    (45824, 'tcp'): 'dai-shell',
    (45825, 'tcp'): 'qdb2service',
    (45825, 'udp'): 'qdb2service',
    (45966, 'tcp'): 'ssr-servermgr',
    (45966, 'udp'): 'ssr-servermgr',
    (46336, 'tcp'): 'inedo',
    (46998, 'tcp'): 'spremotetablet',
    (46999, 'tcp'): 'mediabox',
    (46999, 'udp'): 'mediabox',
    (47000, 'tcp'): 'mbus',
    (47000, 'udp'): 'mbus',
    (47001, 'tcp'): 'winrm',
    (47100, 'udp'): 'jvl-mactalk',
    (47557, 'tcp'): 'dbbrowse',
    (47557, 'udp'): 'dbbrowse',
    ...
    (48653, 'udp'): 'robotraconteur',
    (49000, 'tcp'): 'matahari',
    (49001, 'tcp'): 'nusrp',
    (49001, 'udp'): 'nusdp-disc',
    (49150, 'tcp'): 'inspider',
}
