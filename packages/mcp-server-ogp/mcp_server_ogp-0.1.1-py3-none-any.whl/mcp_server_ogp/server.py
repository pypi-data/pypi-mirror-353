...
async def ogp_info(url: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # Return only the extracted OGP data
        return ogp_data
        
    except Exception as e:
        # Return empty dict on error to maintain consistent return type
        return {}
...
async def ogp_image(url: str) -> Optional[Image]:
    ...
    The result is returned as a FastMCP Image object, which is more efficient
    than Base64 encoding and provides better integration with the MCP protocol.
    ...
    try:
        ...
        # Return None on any error to maintain consistent return type
        return None
