...
from framework.models.flows import Results, Flows, get_mysql_engine, get_mysql_conn
from config.settings import DATA_DIR, CASES_DIR, TEAMS_WEBHOOK, ROOT_DIR, TEAMS_NOTIFICATION
...
def pytest_configure(config):
    ...
    # 创建表
    if platform.platform() == "Linux":
        Flows.__table__.create(bind=engine, checkfirst=True)
