...
class ItemDomainMachineDesignAllOf(object):
    ...
    def __init__(self, membership_loaded=None, move_to_trash_error_msg=None, move_to_trash_warning_msg=None, assigned_item=None, move_to_trash_row_style=None, status_property_type_name=None, alternate_name=None, is_housed=None, assigned_represented_element=None, location_item=None, local_vars_configuration=None):  # noqa: E501
