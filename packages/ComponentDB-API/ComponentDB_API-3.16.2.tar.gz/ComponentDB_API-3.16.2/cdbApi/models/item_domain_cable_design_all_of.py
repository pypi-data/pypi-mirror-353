...
class ItemDomainCableDesignAllOf(object):
    ...
    def __init__(self, connection_list=None, assigned_item=None, catalog_item=None, inventory_item=None, alternate_name=None, is_housed=None, technical_system_list=None, local_vars_configuration=None):  # noqa: E501
