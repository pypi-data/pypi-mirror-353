...
def get_traits_object(datatype, description: Optional[str] = None) -> t.Union[None, ContextType]:
    ...
    if datatype == "boolean":
        ...
        raise TypeError(f"{datatype} type is not supported. Please only use valid datatype.")
