...
class TestS3ReadFilesBinary:
    ...
    def test_method_run(self, client: Quark) -> None:
        s3_read_files_binary = client.registry.quark.files.s3_read_files_binary.run(
    ...
    def test_raw_response_run(self, client: Quark) -> None:
        response = client.registry.quark.files.s3_read_files_binary.with_raw_response.run(
            access_key_id="access_key_id",
            access_key_secret="access_key_secret",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            url="url",
    ...
    def test_streaming_response_run(self, client: Quark) -> None:
        with client.registry.quark.files.s3_read_files_binary.with_streaming_response.run(
            access_key_id="access_key_id",
            access_key_secret="access_key_secret",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            url="url",
...
class TestAsyncS3ReadFilesBinary:
    ...
    async def test_method_run(self, async_client: AsyncQuark) -> None:
        s3_read_files_binary = await async_client.registry.quark.files.s3_read_files_binary.run(
            access_key_id="access_key_id",
            access_key_secret="access_key_secret",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            url="url",
    ...
    async def test_raw_response_run(self, async_client: AsyncQuark) -> None:
        response = await async_client.registry.quark.files.s3_read_files_binary.with_raw_response.run(
            access_key_id="access_key_id",
            access_key_secret="access_key_secret",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            url="url",
    ...
    async def test_streaming_response_run(self, async_client: AsyncQuark) -> None:
        async with async_client.registry.quark.files.s3_read_files_binary.with_streaming_response.run(
            access_key_id="access_key_id",
            access_key_secret="access_key_secret",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            url="url",
