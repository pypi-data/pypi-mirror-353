...
class TestDataset:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_clear_generated(self, client: Quark) -> None:
        dataset = client.dataset.clear_generated()
        assert_matches_type(SuccessResponseMessage, dataset, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_clear_generated(self, client: Quark) -> None:
        response = client.dataset.with_raw_response.clear_generated()
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_clear_generated(self, client: Quark) -> None:
        with client.dataset.with_streaming_response.clear_generated() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_method_retrieve_file_chunks(self, client: Quark, respx_mock: MockRouter) -> None:
        respx_mock.get(
            "/dataset/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/chunks"
        ).mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        dataset = client.dataset.retrieve_file_chunks(
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_method_retrieve_file_chunks_with_all_params(self, client: Quark, respx_mock: MockRouter) -> None:
        respx_mock.get(
            "/dataset/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/chunks"
        ).mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        dataset = client.dataset.retrieve_file_chunks(
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_retrieve_file_chunks(self, client: Quark, respx_mock: MockRouter) -> None:
        respx_mock.get(
            "/dataset/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/chunks"
        ).mock(return_value=httpx.Response(200, json={"foo": "bar"}))

        dataset = client.dataset.with_raw_response.retrieve_file_chunks(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_streaming_response_retrieve_file_chunks(self, client: Quark, respx_mock: MockRouter) -> None:
        respx_mock.get(
            "/dataset/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/chunks"
        ).mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        with client.dataset.with_streaming_response.retrieve_file_chunks(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as dataset:
            assert not dataset.is_closed
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    def test_path_params_retrieve_file_chunks(self, client: Quark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.dataset.with_raw_response.retrieve_file_chunks(
                file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                id="",
            )
...
class TestAsyncDataset:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_clear_generated(self, async_client: AsyncQuark) -> None:
        dataset = await async_client.dataset.clear_generated()
        assert_matches_type(SuccessResponseMessage, dataset, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_clear_generated(self, async_client: AsyncQuark) -> None:
        response = await async_client.dataset.with_raw_response.clear_generated()
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_clear_generated(self, async_client: AsyncQuark) -> None:
        async with async_client.dataset.with_streaming_response.clear_generated() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_method_retrieve_file_chunks(self, async_client: AsyncQuark, respx_mock: MockRouter) -> None:
        respx_mock.get(
            "/dataset/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/chunks"
        ).mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        dataset = await async_client.dataset.retrieve_file_chunks(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert dataset.is_closed
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_method_retrieve_file_chunks_with_all_params(
        self, async_client: AsyncQuark, respx_mock: MockRouter
    ) -> None:
        respx_mock.get(
            "/dataset/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/chunks"
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_retrieve_file_chunks(self, async_client: AsyncQuark, respx_mock: MockRouter) -> None:
        respx_mock.get(
            "/dataset/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/chunks"
        ).mock(return_value=httpx.Response(200, json={"foo": "bar"}))

        dataset = await async_client.dataset.with_raw_response.retrieve_file_chunks(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_streaming_response_retrieve_file_chunks(
        self, async_client: AsyncQuark, respx_mock: MockRouter
    ) -> None:
        respx_mock.get(
            "/dataset/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e/chunks"
        ).mock(return_value=httpx.Response(200, json={"foo": "bar"}))
        async with async_client.dataset.with_streaming_response.retrieve_file_chunks(
            file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as dataset:
            assert not dataset.is_closed
    ...
    @parametrize
    @pytest.mark.respx(base_url=base_url)
    async def test_path_params_retrieve_file_chunks(self, async_client: AsyncQuark) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.dataset.with_raw_response.retrieve_file_chunks(
                file_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
                id="",
            )
