...
class TestS3ReadCsv:
    ...
    def test_method_run(self, client: Quark) -> None:
        s3_read_csv = client.registry.quark.files.s3_read_csv.run(
    ...
    def test_raw_response_run(self, client: Quark) -> None:
        response = client.registry.quark.files.s3_read_csv.with_raw_response.run(
            access_key_id="access_key_id",
            access_key_secret="access_key_secret",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            url="url",
    ...
    def test_streaming_response_run(self, client: Quark) -> None:
        with client.registry.quark.files.s3_read_csv.with_streaming_response.run(
            access_key_id="access_key_id",
            access_key_secret="access_key_secret",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            url="url",
...
class TestAsyncS3ReadCsv:
    ...
    async def test_method_run(self, async_client: AsyncQuark) -> None:
        s3_read_csv = await async_client.registry.quark.files.s3_read_csv.run(
            access_key_id="access_key_id",
            access_key_secret="access_key_secret",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            url="url",
    ...
    async def test_raw_response_run(self, async_client: AsyncQuark) -> None:
        response = await async_client.registry.quark.files.s3_read_csv.with_raw_response.run(
            access_key_id="access_key_id",
            access_key_secret="access_key_secret",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            url="url",
    ...
    async def test_streaming_response_run(self, async_client: AsyncQuark) -> None:
        async with async_client.registry.quark.files.s3_read_csv.with_streaming_response.run(
            access_key_id="access_key_id",
            access_key_secret="access_key_secret",
            lattice_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            url="url",
