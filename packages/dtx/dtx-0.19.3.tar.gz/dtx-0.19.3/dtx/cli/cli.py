...
class AgentScanner:
    ...
    def _parse_arguments(self):
        ...
        run_parser.add_argument("--url", type=str, default="Agent Url / Model Name")
    ...
    def _load_or_generate_plan(self, plan_file, max_prompts, prompts_per_risk):
        ...
        plan_config = PlanInput(
            dataset=dataset, max_prompts=max_prompts, prompts_per_risk=prompts_per_risk
        )
    ...
    # def _run_tests_initialize_runner(self, agent_type, url, max_prompts, tactics=None):
    #     config = TestRunInput(
    #         agent_type=agent_type,
    #         url=url,
    #         max_prompts=max_prompts,
    #         override_tactics=tactics or [],
    #     )
    ...
    def _generate_plan(self, scope_file, output, max_prompts, prompts_per_risk):
