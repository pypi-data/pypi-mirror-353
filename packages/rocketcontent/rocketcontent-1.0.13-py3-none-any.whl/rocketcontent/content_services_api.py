...
class ContentServicesApi:
    ...
    def archive_metadata(self, file_path, metadata):
        ...
        Args:
            ...
            metadata: [Mandatory] is a ArchiveMetadataBuilder object containing metadata (indexes) for the content.
        """
        archive_obj = ContentArchive(self.config)
        return archive_obj.archive_metadata(file_path, metadata)
