...
def _load_plants(monkeypatch, tmp_path):
    ...
    monkeypatch.setitem(sys.modules, "OCDocker.Toolbox.Conversion", types.ModuleType("OCDocker.Toolbox.Conversion"))
...
def test_get_binding_site(ocplants):
    ...
    center, radius = ocplants.get_binding_site(box, spacing=2.9)
