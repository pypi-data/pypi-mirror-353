...
if typing.TYPE_CHECKING:
    from jivas.agent.action import interact, pulse, list_actions, get_action, update_action, install_action, uninstall_action, invoke_stt_action
else:
    interact, pulse, list_actions, get_action, update_action, install_action, uninstall_action, invoke_stt_action = jac_import('jivas.agent.action', items={'interact': None, 'pulse': None, 'list_actions': None, 'get_action': None, 'update_action': None, 'install_action': None, 'uninstall_action': None, 'invoke_stt_action': None})
if typing.TYPE_CHECKING:
