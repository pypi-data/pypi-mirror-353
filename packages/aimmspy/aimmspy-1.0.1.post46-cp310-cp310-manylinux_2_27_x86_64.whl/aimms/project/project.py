...
class Project:
    ...
    def __init__(self, aimms_path : str = "" , aimms_project_file : str = "", exposed_identifier_set_name : str = "", checked : bool=False, license_folder_path : str = None, license_url: str = None, webui_port : int = 0, index_restriction : bool = False, data_type_preference : DataReturnTypes = DataReturnTypes.DICT):
        ...
        if not license_folder_path and not license_url:
            ...
            if os.path.exists(license_folder_path_developer):
                ...
                license_folder_path = license_folder_path_developer
