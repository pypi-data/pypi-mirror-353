...
class PneumaticConfiguration:
    ...
    def controller_id(self) -> str:
        """int: The MachineMotion controller id."""
        return self._controller_id

    @property
    def device_id(self) -> int:
        """int: The device id of the io module that controls the pneumatic axis."""
        return self._device_id

    @property
    def controller_port(self) -> int:
        """int: The MachineMotion controller port of the io module that controls the pneumatic axis."""
