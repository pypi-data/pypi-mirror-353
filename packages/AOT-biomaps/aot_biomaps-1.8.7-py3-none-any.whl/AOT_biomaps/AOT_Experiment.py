...
class Tomography(Experiment):
    ...
    def __init__(self, acousticType = AOT_biomaps.AOT_Acoustic.WaveType.StructuredWave ,fieldParamPath=None,formatSave = AOT_biomaps.AOT_Acoustic.FormatSave.HDR_IMG, **kwargs):
        super().__init__(**kwargs)
    ...
    def _generate_system_matrixSTRUCT(self, fieldDataPath, fieldParamPath):
        ...
        for i in progress_bar:
            ...
            if os.path.exists(pathField):
                ...
                systemMatrix.append(AcousticField.load_field(fieldDataPath, self.params.acoustic['typeSim']))
            else:
