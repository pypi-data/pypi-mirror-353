"""
===================================================================
Title:          02_XGB_vs_others_MIMICIII_3_classes.py
Description:    Compute results for Table 2 fourth row
Authors:        Fabian Kahl
===================================================================
"""
...
dataset = 'mimic_3' # Dataset name (used in output file naming)
...
for i in range(epochs):
    ...
    # Ordinal Regression
    mod_prob = OrderedModel(y_train_encoded, X_train_df_no_nans, hasconst=False)
