...
class EOProduct(EOGroup):
    ...
    def is_valid(self, validation_mode: "AllowedValidationMode" = "STRUCTURE") -> bool:
        ...
        --------
        EOProduct.validate"""
        from eopf.product import eo_product_validation

        flag, anomalies = eo_product_validation.is_valid_product(self, validation_mode=validation_mode)
        return flag
    ...
    def validate(self, validation_mode: "AllowedValidationMode" = "STRUCTURE") -> None:
        ...
        if not self.is_valid(validation_mode=validation_mode):
            raise InvalidProductError(f"Invalid product {self}")
    ...
    def dump_short_names_to_variables(self) -> None:
        ...
        for key in self.short_names:
            ...
            if eo_var is not None:
                eo_var.attrs[SHORT_NAME] = self.short_names[key]
