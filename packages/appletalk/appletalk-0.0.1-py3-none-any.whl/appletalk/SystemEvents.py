...
def get_focused_windows():
    ...
    '''
    try:
        result = __init__.run_applescript(script)
...
def list_all_visible_windows() -> list[str]:
    ...
    '''
    windows = __init__.run_applescript(script)
    if windows:
...
def get_all_apps():
    ...
    return __init__.run_applescript(script).split(', ')
...
def restart_computer():
    __init__.run_applescript('tell application "System Events" to restart')
def shutdown_computer():
    __init__.run_applescript('tell application "System Events" to shut down')
def sleep_computer():
    __init__.run_applescript('tell application "System Events" to sleep')
def log_out_user():
    __init__.run_applescript('tell application "System Events" to log out')
