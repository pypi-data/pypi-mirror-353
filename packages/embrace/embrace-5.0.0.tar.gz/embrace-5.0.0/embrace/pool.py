...
class ContextManagerWrappedConnection:
    def __init__(self, pool: "ConnectionPoolBase", transaction=False):
        self.conn = None
        self.pool = pool
...
class ConnectionPoolBase:
    ...
    def connect(self, transaction=False):
        ...
        """
        return self.connection_context_manager(self, transaction)
    ...
    def transaction(self):
        ...
        """
        return self.connection_context_manager(self, True)
