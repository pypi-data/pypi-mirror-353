...
class AgentOrchestrator:
    ...
    def add_edge(self, 
                ...
                source_output_path: Optional[Union[str, List[str]]] = None,
        ...
        Args:
            ...
            target_input: Optional name of the input to the target node.
                          If not provided, a default will be determined based on the node type.
            source_output_path: Optional path to a property in the source output dictionary. 
                                Can be a string for a single property or a list of strings for nested properties. 
                                This allows selecting specific properties from dictionary values as they flow through the edge.
        ...
        Note:
            ...
            The source_output_path parameter allows you to select specific properties from the source output dictionary.
            For example, if a node outputs a dictionary with a "tweets" key containing a list of tweet
            dictionaries, you can use source_output_path=["tweets", "0", "text"] to select the text of the
            first tweet.
        """
