...
class WorkflowService:
    ...
    def add_node(self, 
        ...
        # Validate that the node type is one of the supported types
        if node_type not in [NodeType.AGENT, NodeType.FUNCTION, NodeType.INPUT, NodeType.OUTPUT]:
            raise ValueError(f"Unsupported node type: {node_type}. Only AGENT, FUNCTION, INPUT, and OUTPUT node types are supported.")
