...
class WorkflowEdge:
    ...
    source_output_path: Optional[Union[str, List[str]]] = None  # Path to a property in the source output dictionary
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'WorkflowEdge':
        ...
        return cls(
            ...
            source_output_path=data.get("source_output_path") or data.get("property_path"),  # Support backward compatibility
