...
def insert_data_to_chart(html_data: str,
                         ...
                         return_file: bool = True) -> list | None:
    """
    将 html 中的占位符 替换成数据
    并且 导出 生成后的 html 文件
    """
...
def to_chart_one(data_list: list,
    ...
    for d_one in data_list:
        ...
        y_list.append(y)
    if is_area:
        insert_data_to_chart(html_data=to_line_area_html(),
                             name=name,
                             x_list=x_list,
                             y_list=y_list,
                             smooth=sm)
...
def to_chart_pie(data_list: list,
    ...
    insert_data_to_chart(html_data=to_pie_html(),
                         name=name,
                         x_list=x_list_str)
...
def to_chart_bar(data_list: list,
    ...
    for one_data in data_list:
        ...
        x_list.append(x)
        y_list.append(y)
    insert_data_to_chart(html_data=to_bar_html(),
                         name=name,
                         x_list=x_list,
                         y_list=y_list)
...
def to_chart_gantt(x_list: list = None,
    ...
    insert_data_to_chart(html_data=to_gantt_html(),
                         name=name,
                         x_min=x_min,
                         x_max=x_max,
                         x_list=x_list_str,
