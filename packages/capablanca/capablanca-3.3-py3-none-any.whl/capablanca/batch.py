...
def approximate_solutions(inputDirectory, verbose=False, log=False, count=False, bruteForce=False, approximation=False):
    """Find an approximate Dominating Set for several instances.
...
def main():
    ...
    helper = argparse.ArgumentParser(prog="batch_approx", description="Find a 2-Approximate Dominating Set for all undirected graphs encoded in DIMACS format and stored in a directory.")
