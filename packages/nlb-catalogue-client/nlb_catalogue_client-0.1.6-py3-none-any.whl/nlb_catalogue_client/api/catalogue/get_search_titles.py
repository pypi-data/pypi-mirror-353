...
from ...models.not_implemented_error import NotImplementedError_
from ...models.search_titles_response_v2 import SearchTitlesResponseV2
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SearchTitlesResponseV2.from_dict(response.json())
    ...
    if response.status_code == 501:
        response_501 = NotImplementedError_.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        keywords (str):
        source (Union[Unset, str]):  Example: overdrive.
    ...
    Returns:
        Response[Union[BadRequestError, InternalServerError, MethodNotAllowedError, NotFoundError, NotImplementedError_, SearchTitlesResponseV2, ServiceUnavailableError, TooManyRequestsError, UnauthorizedError]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[BadRequestError, InternalServerError, MethodNotAllowedError, NotFoundError, NotImplementedError_, SearchTitlesResponseV2, ServiceUnavailableError, TooManyRequestsError, UnauthorizedError]
    """
