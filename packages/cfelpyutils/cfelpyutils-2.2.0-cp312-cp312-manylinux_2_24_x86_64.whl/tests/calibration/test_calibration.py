...
import pytest
from cfelpyutils.calibration import Agipd1MCalibration

# TODO: Without proper data, there is no way to test this. Find data and implement tests.

@pytest.mark.skip(reason="Test not implemented.")
class TestAgipd1MCalibration():
