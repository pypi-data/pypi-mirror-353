...
class TestUtils(unittest.TestCase):
    ...
    def test_build_query_params_bool_values(self):
        """Test building query params with boolean values."""
        params = {"key1": True, "key2": False, "key3": "value3"}
        result = build_query_params(params)
        self.assertEqual(result, "?key1=true&key2=false&key3=value3")

    def test_build_query_params_int_values(self):
        """Test building query params with integer values."""
        params = {"key1": 123, "key2": "value2"}
        result = build_query_params(params)
        self.assertEqual(result, "?key1=123&key2=value2")

    def test_build_query_params_multiple_params(self):
    ...
    def test_execute_sql_statement_error_without_message(self, mock_sleep):
        ...
        self.assertIn("SQL statement failed: Unknown error", str(context.exception))
