...
from ..ui.ascii_art import display_welcome_screen
...
from ..service import ChuckService
...
class ChuckTUI:
    ...
    def _get_available_commands(self) -> List[str]:
        ...
        try:
            ...
            from ..command_registry import TUI_COMMAND_MAP
    ...
    def run(self) -> None:
        ...
        while self.running:
            try:
                ...
                from ..exceptions import PaginationCancelled
    ...
    def _display_catalogs(self, data: Dict[str, Any]) -> None:
        ...
        from ..ui.table_formatter import display_table
        from ..exceptions import PaginationCancelled
    ...
    def _display_paginated_sql_results(self, data: Dict[str, Any]) -> None:
        ...
        import sys
        from ..commands.sql_external_data import PaginatedSQLResult
        from ..ui.table_formatter import display_table
        from ..exceptions import PaginationCancelled
