...
class LinearModelCase(unittest.TestCase):
    ...
    def test_ols_1(self):
        ...
        mod = LinearModel(1)
        mod.init_param()
        alg = regression(X, Y, mod, h=0.001, n_iter=5000, tol=1.0e-10, n_restart=5)
...
def suite():
    ...
    suite.addTest(unittest.makeSuite(LinearModelCase))
    return suite
