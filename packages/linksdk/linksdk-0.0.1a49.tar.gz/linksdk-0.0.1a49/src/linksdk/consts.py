...
class AudioOutputHwMode(IntFlag):
    OPTICAL = (1, "Optical Out", 1)
    LINE_OUT = (2, "Line Out", 2)
    COAXIAL = (4, "COAX Out", 3)
    HEADPHONES = (8, "Headphone Out", 4)
    SPEAKER_OUT = (16, "Speaker Out", 7)
    OTHER_OUT = (64, "Other Out", 64)

    def __new__(cls, value: int, display_name: str, cmd: int):
