...
WIIM_AMP_OUTPUTMODE = 2
@unique
class AudioOutputHwMode(IntFlag):
    OPTICAL = (1, "Optical Out")
    LINE_OUT = (2, "Line Out")
    COAXIAL = (3, "COAX Out")
    HEADPHONES = (4, "Headphone Out")
    SPEAKER_OUT = (7, "Speaker Out")
    OTHER_OUT = (99, "Other Out")
...
SUPPORTED_OUTPUT_MODES_BY_MODEL = {
    "WiiM Pro": AudioOutputHwMode.LINE_OUT | AudioOutputHwMode.OPTICAL | AudioOutputHwMode.COAXIAL,
    "WiiM Pro Plus": AudioOutputHwMode.LINE_OUT | AudioOutputHwMode.OPTICAL | AudioOutputHwMode.COAXIAL,
    "WiiM Ultra": AudioOutputHwMode.LINE_OUT | AudioOutputHwMode.OPTICAL | AudioOutputHwMode.COAXIAL | AudioOutputHwMode.HEADPHONES,
    "WiiM Amp": WIIM_AMP_OUTPUTMODE,
    "WiiM Amp Pro": AudioOutputHwMode.SPEAKER_OUT,
    "WiiM Amp Ultra": AudioOutputHwMode.SPEAKER_OUT,
    "WiiM CI MOD A80": AudioOutputHwMode.SPEAKER_OUT,
    "WiiM CI MOD S": AudioOutputHwMode.LINE_OUT | AudioOutputHwMode.OPTICAL | AudioOutputHwMode.COAXIAL,
}
