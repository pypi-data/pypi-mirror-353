...
def save_output(df: pd.DataFrame, table_name: str):
    ...
    fdf.to_lakehouse_table(name=table_name, mode="append")
...
def _get_data(table_name: str):
    """
    Get data from the specified delta table and return it as a FabricDataFrame.
    ...
    -------
    FabricDataFrame
        Data from the specified delta table as a FabricDataFrame instance.
    """
    import os
