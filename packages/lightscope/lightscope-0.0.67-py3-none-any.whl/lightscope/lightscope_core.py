...
class Honeypot:
    ...
    def create_listener(self, port):
        ...
        try:
            ...
            self.current_honeypot_ports[port] = True  # Update shared dictionary
            ...
            if port in self.current_honeypot_ports:
                del self.current_honeypot_ports[port]
            return False
...
class Ports:
    ...
    def remove_pkt_from_watch(self, pkt):
        ...
        if pkt.tcp_dport in self.current_honeypot_ports:
            self.Report_unwanted_traffic(pkt, "Honeypot_port_syn", "N/A")
