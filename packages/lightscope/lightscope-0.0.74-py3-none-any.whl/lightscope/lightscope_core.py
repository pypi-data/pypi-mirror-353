...
class Ports:
    def __init__(self,
        ...
        self.unverified_ips={}
        self.verified_ips={}
        self.attempted_ips_no_connection={}
    ...
    def verify_ip(self,pkt_info):
        print(f"verify_ip: {pkt_info.ip_src} {pkt_info.tcp_dport}",flush=True)
        if pkt_info.ip_src in self.unverified_ips:
            self.unverified_ips[pkt_info.ip_src].append(pkt_info.tcp_dport)
        else:
            self.unverified_ips[pkt_info.ip_src]=[pkt_info.tcp_dport]
