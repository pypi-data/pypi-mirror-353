...
class Webhook(BaseModel):
    ...
    url: StrictStr = Field(description="The URL that specifies where the webhooks are sent.")
    __properties: ClassVar[List[str]] = ["events", "expirationDate", "fieldIdsFilter", "id", "issuePropertyKeysFilter", "jqlFilter", "url"]
