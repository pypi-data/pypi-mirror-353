...
const _name: string = "LLama3.1-8B-Instruct"
const _description: string = "A powerful 8B parameter language model from Meta AI's LLaMA 3.1 series, optimized for instruction following and general language tasks"
