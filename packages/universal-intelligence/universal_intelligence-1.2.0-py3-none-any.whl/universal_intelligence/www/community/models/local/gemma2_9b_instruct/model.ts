...
const _name: string = "gemma2-9b-it"
const _description: string = "A powerful 9B parameter language model from Google, optimized for instruction following and general language tasks"
