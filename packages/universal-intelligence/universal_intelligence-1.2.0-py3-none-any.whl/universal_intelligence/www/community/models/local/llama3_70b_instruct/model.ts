...
const _name: string = "Llama-3-70B-Instruct"
const _description: string = "A large and powerful language model by Meta with significant improvements in instruction following, coding, mathematics, and multilingual support"
