...
const _name: string = "gemma2-2b-it"
const _description: string = "A powerful 2B parameter language model from Google, optimized for instruction following and general language tasks"
