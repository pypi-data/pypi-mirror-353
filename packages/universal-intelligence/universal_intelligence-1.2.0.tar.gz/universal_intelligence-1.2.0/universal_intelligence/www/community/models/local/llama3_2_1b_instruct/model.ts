...
const _name: string = "LLama3.2-1B-Instruct"
const _description: string = "A powerful 1B parameter language model from Meta AI's LLaMA 3.2 series, optimized for instruction following and general language tasks"
