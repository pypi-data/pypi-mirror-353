...
const _name: string = "SmolLM2-1.7B-Instruct"
const _description: string = "A powerful 1.7B parameter language model from Hugging Face, optimized for instruction following and general language tasks"
