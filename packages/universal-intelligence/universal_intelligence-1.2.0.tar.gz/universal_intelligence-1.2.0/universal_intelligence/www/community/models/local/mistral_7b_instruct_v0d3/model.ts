...
const _name: string = "Mistral-7B-Instruct-v0.3"
const _description: string = "A powerful 7B parameter language model from Mistral, optimized for instruction following and general language tasks"
