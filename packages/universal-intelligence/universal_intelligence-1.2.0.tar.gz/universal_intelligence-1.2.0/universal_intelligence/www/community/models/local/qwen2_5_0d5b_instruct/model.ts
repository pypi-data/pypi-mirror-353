...
const _name: string = "Qwen2.5-1.5B-Instruct"
const _description: string = "A small yet powerful language model with significant improvements in instruction following, coding, mathematics, and multilingual support"
