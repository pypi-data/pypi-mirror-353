...
SourceContextType = TypeVar("SourceContextType", bound=BaseModel | None)
...
class Source(abc.ABC, Generic[SourceContextType]):
    source: ClassVar[str] = NotImplemented
    context: SourceContextType | None
    ...
    async def initialize(self, context: SourceContextType | None = None) -> None:
