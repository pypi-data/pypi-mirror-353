...
amp_dir = Path("~/Library/Mobile Documents/com~apple~CloudDocs/cleft").expanduser()
llm_directory = amp_dir / "llm"
dotenv_path = amp_dir / ".env"
if not amp_dir.exists: amp_dir.mkdir(parents=True, exist_ok=True)
if not llm_directory.exists(): llm_directory.mkdir(parents=True, exist_ok=True)
