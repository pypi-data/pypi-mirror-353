...
def check_nans(data: Union[np.ndarray, torch.Tensor], threshold: float = 0.5) -> bool:
    ...
    try:
        return any(
            ...
            and (logger.warning(f"Channel {i} exceeds threshold: {nan_ratio:.2%} > {threshold:.0%}") or True)
