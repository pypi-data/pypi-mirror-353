...
from shangshanAI.modelscope.hub.constants import DEFAULT_CREDENTIALS_PATH
from shangshanAI.modelscope.utils.import_utils import is_tf_available, is_torch_available
...
from shangshanAI.modelscope.utils.torch_utils import get_dist_info
import {}
...
class DistributedTestCase(unittest.TestCase):
    ...
    Examples:
        >>> import torch
        >>> from torch import distributed as dist
        >>> from modelscope import init_dist
