...
from shangshanAI.modelscope.utils.ast_utils import FilesAstScanning
from shangshanAI.modelscope.utils.constant import DEFAULT_MODEL_REVISION
from shangshanAI.modelscope.utils.file_utils import get_modelscope_cache_dir
...
class EnvsManager(object):
    ...
    def __init__(self,
        ...
        from shangshanAI.modelscope.utils.hub import read_config
