...
from shangshanAI.modelscope.utils.ast_utils import INDEX_KEY
from shangshanAI.modelscope.utils.import_utils import (LazyImportModule,
                                           is_torch_available,
...
def get_default_automodel(config) -> Optional[type]:
    import shangshanAI.modelscope.utils.hf_util as hf_util
...
def get_hf_automodel_class(model_dir: str,
    ...
    from shangshanAI.modelscope.utils.hf_util import (AutoConfig, AutoModel,
