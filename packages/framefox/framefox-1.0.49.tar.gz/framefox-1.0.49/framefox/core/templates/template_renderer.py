...
class TemplateRenderer:
    ...
    def render(self, template_name: str, context: dict = {}) -> str:
        """
        Renders a template with memory measurement
        """
        ...
        # ✅ MESURE MÉMOIRE : Démarrer la mesure
        start_time = time.time()
        
        # ✅ CORRECTION : Récupérer le profiler de manière plus robuste
        ...
        try:
            ...
            if profiler.is_enabled():
                ...
                if memory_collector:
                    # ✅ IMPORTANT : Vérifier que le collector a la méthode
        ...
        try:
            ...
            # ✅ MESURE MÉMOIRE : Terminer la mesure
            end_time = time.time()
            ...
            if memory_collector and hasattr(memory_collector, 'end_template_measurement'):
                ...
                # ✅ IMPORTANT : Vérifier que add_template_metrics existe
            ...
            # Nettoyer la mesure en cas d'erreur
            if memory_collector and hasattr(memory_collector, 'end_template_measurement'):
