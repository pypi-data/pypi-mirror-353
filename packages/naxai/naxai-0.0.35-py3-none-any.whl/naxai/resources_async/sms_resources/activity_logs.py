"""
Asynchronous SMS activity logs resource for the Naxai SDK.

This module provides asynchronous methods for retrieving and analyzing SMS message
activity logs, including listing messages with various filtering options and retrieving
...
class ActivityLogsResource:
    ...
    async def list(self,
        ...
        Returns:
            ...
            A Pydantic model containing the paginated list of SMS activity logs.
            The response includes:
                - pagination: Information about the current page, total pages, and total items
                - messages: List of BaseMessage objects with detailed information
                  about each SMS message
        ...
        Example:
            ...
            ...     status="delivered"
            ... )
            >>> print(f"Successfully delivered messages in the "
            >>>       f"last week: {len(delivered.messages)}")
        ...
        Note:
            ...
            - Results are typically sorted by sent/received time in descending
