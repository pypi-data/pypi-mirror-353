...
from .headers import ACCEPT_LANGUAGE_MAP, DEFAULT_HEADER_ORDERS, DEFAULT_HEADER_ORDERS_V2
...
class Session:
    ...
    def __init__(
        ...
        allow_redirects: bool = True, verify: bool = False, http2_only: bool = False, sync: bool = True
    ):
        ...
        if self._chrome_version <= 130:
            headers_order = DEFAULT_HEADER_ORDERS
        else:
            headers_order = DEFAULT_HEADER_ORDERS_V2
    ...
    def _process_get_arguments(self, **kwargs):
        ...
        if "auto_sort_headers_type" in kwargs:
            del kwargs["auto_sort_headers_type"]
...
class AsyncSession(Session):
    ...
    def __init__(
        ...
        user_agent: Union[int, Tuple[int, Literal["windows", "macos"], Literal["chrome", "edge"]]] = None,
        cookies: Optional[Dict[str, str]] = None, proxy: Optional[str] = None, ipinfo: dict = {}, timeout: int = 15,
        allow_redirects: bool = True, verify: bool = False, http2_only: bool = False,
    ):
        super().__init__(user_agent, cookies, proxy, ipinfo, timeout, allow_redirects, verify, http2_only, sync=False)
