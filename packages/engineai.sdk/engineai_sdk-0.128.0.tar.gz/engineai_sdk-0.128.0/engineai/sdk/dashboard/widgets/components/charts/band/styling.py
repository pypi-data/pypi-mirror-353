"""Spec base for Chart Style axis bands classes."""
...
class AxisBandStyling(AbstractFactoryLinkItemsHandler):
    """Construct for BandStyling class."""
    ...
    def __init__(
        ...
        *,
        ...
        """Base spec for style a chart axis bands.
