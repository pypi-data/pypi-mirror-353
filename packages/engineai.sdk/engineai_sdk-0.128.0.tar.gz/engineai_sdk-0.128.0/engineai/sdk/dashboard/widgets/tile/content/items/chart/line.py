"""Spec for Tile Widget Line Chart Item."""
...
class LineChartItem(BaseTileChartItem):
    ...
    def __init__(
        ...
        *,
        ...
        styling: Optional[Union[Palette, LineChartItemStyling]] = None,
        ...
        super().__init__(
            styling=(
                ...
                if isinstance(styling, Palette)
                    ...
                    LineChartItemStyling(color_spec=Palette.AQUA_GREEN)
                    if styling is None
                    else styling
                )
            ),
