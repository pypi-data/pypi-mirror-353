...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'schematized_config.cli': { 'schematized_config.cli.OutputType': ('cli.html#outputtype', 'schematized_config/cli.py'),
                                        'schematized_config.cli.OutputType.list': ('cli.html#outputtype.list', 'schematized_config/cli.py'),
                                        'schematized_config.cli.Templates': ('cli.html#templates', 'schematized_config/cli.py'),
                                        'schematized_config.cli._hack_docstring': ('cli.html#_hack_docstring', 'schematized_config/cli.py'),
                                        'schematized_config.cli.generate_code': ('cli.html#generate_code', 'schematized_config/cli.py'),
