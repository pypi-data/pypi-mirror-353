...
def parallelize_api_call(lakehouse_df):  
    ...
    with ThreadPoolExecutor(max_workers=5) as executor:
        ...
        for future in as_completed(future_to_input):
            ...
            print(f"Error processing one {future_to_input[future]}: {e}")     
...
def process_shortcuts():
    ...
    """)   
    final.write.format("delta").mode("overwrite").option("overwriteSchema", "true").saveAsTable("oct_shortcuts")
    return final
        ...
        with ThreadPoolExecutor(max_workers=7) as executor:
            ...
            for i, future in enumerate(futures):
                try:
                    ...
                    print(f"Error in two {functions[i].__name__}: {e}")
                    results.append(None) 
...
def final_optimize_tables():
    ...
    def optimize_table(path):
        try:
            ...
            print(f"Error optimizing 11 {path}: {e}")
...
WorkspaceID = "9c730562-178e-4802-be42-82e5fb735150"
DatasetID = "9d1607f6-3a0c-4c61-9494-feaa7e023b7a"
LakehouseWorkspaceID = "9c730562-178e-4802-be42-82e5fb735150" # Please provide NA if not neccessary. Also, if direct lake model provide as NA
LakehouseID = "b71125e0-969b-4a24-a6ee-44bf35e1fc90" # Please provide NA if not neccessary. Also, if direct lake model provide as NA


# In[59]:


run(WorkspaceID,DatasetID,LakehouseWorkspaceID,LakehouseID)
