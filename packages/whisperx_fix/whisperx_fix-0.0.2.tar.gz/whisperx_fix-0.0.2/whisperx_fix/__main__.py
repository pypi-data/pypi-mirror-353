...
from whisperx_fix.utils import (LANGUAGES, TO_LANGUAGE_CODE, optional_float,
                            optional_int, str2bool, write_vtt, write_srt, write_tsv, write_ass, write_txt)
...
def cli():
    ...
    from whisperx_fix.transcribe import transcribe_task
