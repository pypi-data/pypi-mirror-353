...
class Mounting(BaseModel):
    ...
    pose: PoseInCoordinateSystem = Field(description="The pose offset based on world coordinate system of the mounting.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pose": PoseInCoordinateSystem.from_dict(obj["pose"]) if obj.get("pose") is not None else None
        })
        return _obj
