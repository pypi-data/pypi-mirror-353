...
class MotionGroupInstance(BaseModel):
    ...
    has_inverse_kinematics: StrictBool = Field(description="True if NOVA supports inverse kinematics for this motion group. Inverse kinematics is used to calculate the joint angles from the end effector position. If inverse kinematics is not supported, cartesian jogging is not possible. ")
    __properties: ClassVar[List[str]] = ["motion_group", "controller", "name_from_controller", "model_from_controller", "serial_number", "has_inverse_kinematics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "has_inverse_kinematics": obj.get("has_inverse_kinematics")
        })
        return _obj
