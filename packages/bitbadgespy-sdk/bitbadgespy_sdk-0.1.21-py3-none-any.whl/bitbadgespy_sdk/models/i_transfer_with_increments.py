...
class ITransferWithIncrements(BaseModel):
    ...
    override_timestamp: Optional[NumberType] = Field(default=None, description="Numeric timestamp - value is equal to the milliseconds since the UNIX epoch.", alias="overrideTimestamp")
    ...
    __properties: ClassVar[List[str]] = ["from", "toAddresses", "balances", "precalculateBalancesFromApproval", "merkleProofs", "memo", "prioritizedApprovals", "onlyCheckPrioritizedCollectionApprovals", "onlyCheckPrioritizedIncomingApprovals", "onlyCheckPrioritizedOutgoingApprovals", "overrideTimestamp", "toAddressesLength", "incrementBadgeIdsBy", "incrementOwnershipTimesBy", "durationFromTimestamp"]
