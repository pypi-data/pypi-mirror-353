...
class ITransferActivityDoc(BaseModel):
    ...
    override_timestamp: Optional[NumberType] = Field(default=None, description="Override timestamp?", alias="overrideTimestamp")
    ...
    __properties: ClassVar[List[str]] = ["_docId", "_id", "timestamp", "block", "_notificationsHandled", "private", "to", "from", "balances", "collectionId", "memo", "precalculateBalancesFromApproval", "prioritizedApprovals", "initiatedBy", "txHash", "overrideTimestamp", "coinTransfers", "approvalsUsed"]
