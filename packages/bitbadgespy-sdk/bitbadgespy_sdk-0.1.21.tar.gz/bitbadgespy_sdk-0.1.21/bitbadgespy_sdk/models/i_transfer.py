...
class ITransfer(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["from", "toAddresses", "balances", "precalculateBalancesFromApproval", "merkleProofs", "memo", "prioritizedApprovals", "onlyCheckPrioritizedCollectionApprovals", "onlyCheckPrioritizedIncomingApprovals", "onlyCheckPrioritizedOutgoingApprovals", "overrideTimestamp"]
