...
class IIncrementedBalances(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["startBalances", "incrementBadgeIdsBy", "incrementOwnershipTimesBy", "durationFromTimestamp", "allowOverrideTimestamp", "recurringOwnershipTimes"]
