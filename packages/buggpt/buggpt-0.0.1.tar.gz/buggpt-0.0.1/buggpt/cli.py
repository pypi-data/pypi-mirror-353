...
from buggpt.gui.run import gui_parser, run_gui_args
...
def get_api_parser():
    ...
    api_parser.add_argument("--buggpt-api-key", type=str, default=None, help="Sets an authentication key for your API. (incompatible with --reload and --workers)")
    ...
    api_parser.add_argument("--cookie-browsers", nargs="+", choices=[browser.__name__ for browser in buggpt.cookies.browsers],
...
def main():
    parser = argparse.ArgumentParser(description="Run buggpt")
    subparsers = parser.add_subparsers(dest="mode", help="Mode to run the buggpt in.")
