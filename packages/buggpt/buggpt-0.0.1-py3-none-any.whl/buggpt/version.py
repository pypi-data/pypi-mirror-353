...
class VersionUtils:
    """
    Utility class for managing and comparing package versions of 'buggpt'.
    """
    @cached_property
    def current_version(self) -> str:
        """
        Retrieves the current version of the 'buggpt' package.

        Returns:
            str: The current version of 'buggpt'.
        ...
        version = environ.get("buggpt_VERSION")
        if version:
            return version
    ...
    def latest_version(self) -> str:
        """
        Retrieves the latest version of the 'buggpt' package.

        Returns:
            str: The latest version of 'buggpt'.
        """
    ...
    def check_version(self) -> None:
        """
        Checks if the current version of 'buggpt' is up to date with the latest version.
        ...
        try:
            if self.current_version != self.latest_version:
                print(f'New buggpt version: {self.latest_version} (current: {self.current_version}) | pip install -U buggpt')
        except Exception as e:
            print(f'Failed to check buggpt version: {e}')
