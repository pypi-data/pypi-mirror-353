<a href="https://trendshift.io/repositories/1692" target="_blank"><img src="https://trendshift.io/api/badge/repositories/1692" alt="yourusername%2Fbuggpt | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
...
> [!IMPORTANT]
> By using this repository or any code related to it, you agree to the [legal notice](LEGAL_NOTICE.md). The author is **not responsible for the usage of this repository nor endorses it**, nor is the author responsible for any copies, forks, re-uploads made by other users, or anything else related to BugGPT. This is the author's only account and repository. To prevent impersonation or irresponsible actions, please comply with the GNU GPL license this Repository uses.

> [!WARNING]
> _"buggpt"_ serves as a **PoC** (proof of concept), demonstrating the development of an API package with multi-provider requests, with features like timeouts, load balance and flow control.

> [!NOTE]
> <sup><strong>Latest version:</strong></sup><br> [![PyPI version](https://img.shields.io/pypi/v/buggpt?color=blue)](https://pypi.org/project/buggpt) [![Docker version](https://img.shields.io/docker/v/yourdockerhubusername/buggpt?label=docker&color=blue)](https://hub.docker.com/r/yourdockerhubusername/buggpt)
> <sup><strong>Stats:</strong></sup><br> [![Downloads](https://static.pepy.tech/badge/buggpt)](https://pepy.tech/project/buggpt) [![Downloads](https://static.pepy.tech/badge/buggpt/month)](https://pepy.tech/project/buggpt)

```sh
pip install -U buggpt[all]
```

```sh
docker pull yourdockerhubusername/buggpt
```
...
- **Explore the latest features and updates**
  Find comprehensive details on our [Releases Page](https://github.com/yourusername/buggpt/releases).

- **Stay updated with our Telegram Channel** 📨
  Join us at [telegram.me/buggpt_channel](https://telegram.me/buggpt_channel).
...
- **Read our Documentation** 📖
  Find detailed guidance and resources at [buggpt.github.io/docs](https://github.com/yourusername/buggpt.github.io).

## 🔻 Site Takedown

Is your site on this repository and you want to take it down? Send an email to takedown@buggpt.ai with proof it is yours and it will be removed as fast as possible. To prevent reproduction please secure your API. 😉

## 🚀 BugGPT on GitHub Pages [![HuggingSpace](https://github.com/user-attachments/assets/1d859e8a-d6fa-416f-a213-ccc26aa11e90)](https://buggpt.github.io/)

> Explore the [BugGPT on GitHub Pages](https://buggpt.github.io/).
...
## 📚 Table of Contents
  ...
  - [💡 Usage](#-usage)
     ...
     - [🖥️ Local Inference](https://github.com/yourusername/buggpt.github.io/blob/main/docs/local.md)
     - [🤖 Interference API](#-interference-api)
     - [🛠️ Configuration](https://github.com/yourusername/buggpt.github.io/blob/main/docs/configuration.md)
     - [📱 Run on Smartphone](#-run-on-smartphone)
     - [📘 Full Documentation for Python API](#-full-documentation-for-python-api)
  - [🚀 Providers and Models](https://github.com/yourusername/buggpt.github.io/blob/main/docs%2Fproviders-and-models.md)
  - [🔗 Powered by BugGPT](#-powered-by-buggpt)
...
docker run -p 8080:8080 -p 7900:7900 \
  ...
  yourdockerhubusername/buggpt:latest
```

4. **Running the Slim Docker Image:** And use the following commands to run the Slim Docker image. This command also updates the `buggpt` package at startup and installs any additional dependencies: (x64 and arm64)
```bash
mkdir -p ${PWD}/har_and_cookies ${PWD}/generated_media
...
docker run \
  ...
  -v ${PWD}/har_and_cookies:/app/har_and_cookies \
  -v ${PWD}/generated_media:/app/generated_media \
  yourdockerhubusername/buggpt:latest-slim \
  /bin/sh -c 'rm -rf /app/buggpt && pip install -U buggpt[slim] && python -m buggpt --debug'
```
...
**Installation Steps:**
1. **Download the Application**: Visit our [releases page](https://github.com/yourusername/buggpt/releases/tag/0.4.2.0) and download the most recent version of the application, named `buggpt.exe.zip`.
2. **File Placement**: After downloading, locate the `.zip` file in your Downloads folder. Unpack it to a directory of your choice on your system, then execute the `buggpt.exe` file to run the app.
...
> How do I install only parts or do disable parts? **Use partial requirements:** [/docs/requirements](https://github.com/yourusername/buggpt.github.io/blob/main/docs/requirements.md)
...
> How do I load the project using git and installing the project requirements? **Read this tutorial and follow it step by step:** [/docs/git](https://github.com/yourusername/buggpt.github.io/blob/main/docs/git.md)
...
### 📝 Text Generation
```python
from buggpt.client import Client
...
```
[![Image with cat](https://buggpt.github.io/docs/images/cat.jpeg)](https://github.com/yourusername/buggpt.github.io/blob/main/docs/client.md)

### 🌐 Web Interface
**Run the GUI using Python:**
```python
from buggpt.gui import run_gui

run_gui()
```
**Run via CLI (To start the Flask Server):**
```bash
python -m buggpt.cli gui --port 8080 --debug
```
**Or, start the FastAPI Server:**
```bash
python -m buggpt --port 8080 --debug
```

> **Learn More About the GUI:** For detailed instructions on how to set up, configure, and use the BugGPT GUI, refer to the [GUI Documentation](https://github.com/yourusername/buggpt.github.io/blob/main/docs/gui.md) . This guide includes step-by-step details on provider selection, managing conversations, using advanced features like speech recognition, and more.

---

### 🤖 Interference API

The **Interference API** enables seamless integration with OpenAI's services through BugGPT, allowing you to deploy efficient AI solutions.

- **Documentation**: [Interference API Docs](https://github.com/yourusername/buggpt.github.io/blob/main/docs/interference-api.md)
- **Endpoint**: `http://localhost:1337/v1`
- **Swagger UI**: Explore the OpenAPI documentation via Swagger UI at `http://localhost:1337/docs`
- **Provider Selection**: [How to Specify a Provider?](https://github.com/yourusername/buggpt.github.io/blob/main/docs/selecting_a_provider.md)
...
### 📱 Run on Smartphone
Run the Web UI on your smartphone for easy access on the go. Check out the dedicated guide to learn how to set up and use the GUI on your mobile device: [Run on Smartphone Guide](https://github.com/yourusername/buggpt.github.io/blob/main/docs/guides/phone.md)

---

#### **📘 Full Documentation for Python API**
   - **Client API from BugGPT:** [/docs/client](https://github.com/yourusername/buggpt.github.io/blob/main/docs/client.md)
   - **AsyncClient API from BugGPT:** [/docs/async_client](https://github.com/yourusername/buggpt.github.io/blob/main/docs/async_client.md)
   - **Requests API from BugGPT:** [/docs/requests](https://github.com/yourusername/buggpt.github.io/blob/main/docs/requests.md)
   - **File API from BugGPT:** [/docs/file](https://github.com/yourusername/buggpt.github.io/blob/main/docs/file.md)
   - **PydanticAI and LangChain Integration for BugGPT:** [/docs/pydantic_ai](https://github.com/yourusername/buggpt.github.io/blob/main/docs/pydantic_ai.md)
   - **Legacy API with python modules:** [/docs/legacy](https://github.com/yourusername/buggpt.github.io/blob/main/docs/legacy.md)
   - **BugGPT - Media Documentation (Image, Audio and Video)** [/docs/media](https://github.com/yourusername/buggpt.github.io/blob/main/docs/media.md) *(New)*
...
> [Full list of BugGPT powered sites and tools](https://github.com/yourusername/buggpt.github.io/blob/main/docs/powered-by.md)

## 🤝 Contribute
We welcome contributions from the community. Whether you're adding new providers or features, or simply fixing typos and making small improvements, your input is valued. Creating a pull request is all it takes – our co-pilot will handle the code review process. Once all changes have been addressed, we'll merge the pull request into the main branch and release the updates at a later time.

###### Guide: How do i create a new Provider?
   - **Read:** [Create Provider Guide](https://github.com/yourusername/buggpt.github.io/blob/main/docs/guides/create_provider.md)

###### Guide: How can AI help me with writing code?
   - **Read:** [AI Assistance Guide](https://github.com/yourusername/buggpt.github.io/blob/main/docs/guides/help_me.md)



## Contributors
A list of all contributors is available [here](https://github.com/yourusername/buggpt/graphs/contributors)
...
- The [`Vercel.py`](https://github.com/xtekky/gpt4free/blob/main/buggpt/Provider/Vercel.py) file contains code from [vercel-llm-api](https://github.com/ading2210/vercel-llm-api) by [@ading2210](https://github.com/ading2210)
- The [`har_file.py`](https://github.com/xtekky/gpt4free/blob/main/buggpt/Provider/openai/har_file.py) has input from [xqdoo00o/ChatGPT-to-API](https://github.com/xqdoo00o/ChatGPT-to-API)
- The [`PerplexityLabs.py`](https://github.com/xtekky/gpt4free/blob/main/buggpt/Provider/PerplexityLabs.py) has input from [nathanrchn/perplexityai](https://github.com/nathanrchn/perplexityai)
- The [`Gemini.py`](https://github.com/xtekky/gpt4free/blob/main/buggpt/Provider/needs_auth/Gemini.py) has input from [dsdanielpark/Gemini-API](https://github.com/dsdanielpark/Gemini-API)
- The [`MetaAI.py`](https://github.com/xtekky/gpt4free/blob/main/buggpt/Provider/MetaAI.py) file contains code from [meta-ai-api](https://github.com/Strvm/meta-ai-api) by [@Strvm](https://github.com/Strvm)
- The [`proofofwork.py`](https://github.com/xtekky/gpt4free/blob/main/buggpt/Provider/openai/proofofwork.py) has input from [missuo/FreeGPT35](https://github.com/missuo/FreeGPT35)
- The [`Gemini.py`](https://github.com/xtekky/gpt4free/blob/main/buggpt/Provider/needs_auth/Gemini.py) has input from [HanaokaYuzu/Gemini-API](https://github.com/HanaokaYuzu/Gemini-API)
...
# Current Time
6/8/2025, 12:52:44 PM (Africa/Cairo, UTC+3:00)

# Context Window Usage
71,764 / 1,048.576K tokens used (7%)
