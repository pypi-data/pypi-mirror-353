...
class buggpt(DeepseekAI_JanusPro7b):
    label = "buggpt framework"
    space = "roxky/Janus-Pro-7B"
    url = f"https://huggingface.co/spaces/roxky/buggpt-space"
    api_url = "https://roxky-janus-pro-7b.hf.space"
    url_flux = "https://roxky-buggpt-flux.hf.space/run/predict"
