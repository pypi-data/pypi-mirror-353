...
from vlcishared.arcgis.arcgis_config import ArcGISConfig
...
class ArcGISClient:
    ...
    def __init__(self, config: ArcGISConfig):
        ...
        self.token_provider = ArcGISTokenProvider(config.url_token_provider, config.username, config.password, config.format, config.referer, config.expiration)
