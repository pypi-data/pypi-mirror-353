...
question_urls = multi_generator_url(BlogQuestionAnswer(), create=BlogQuestionAnswerCreateView,
                                    update=BlogQuestionAnswerUpdateView)
urlpatterns = [
              ...
              ] + category_urls + banner_urls + partner_urls + question_urls
