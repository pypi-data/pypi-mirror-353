...
from ..types.api_response_populations import APIResponsePopulations
...
class PopulationsResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> PopulationsResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/semilattice-research/semilattice-client-py#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> PopulationsResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/semilattice-research/semilattice-client-py#with_streaming_response
        """
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=APIResponsePopulations,
        )
