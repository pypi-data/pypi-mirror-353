(
    ...
    function buildDomTree(node, parentIframe = null, isParentHighlighted = false) {
      ...
      // Get attributes for iframe and body elements (keep original logic for these)
      ...
      if (node.nodeType === Node.ELEMENT_NODE) {
        ...
        if (nodeData.isVisible) {
          ...
          if (nodeData.isTopElement) {
            ...
            if(!interactive) {
              console.log(node, nodeData, nodeData.tagName)
            }
            ...
            // Get attributes for interactive elements (moved here after interactive check)
            if (nodeData.isInteractive && node.tagName.toLowerCase() !== 'iframe' && node.tagName.toLowerCase() !== 'body') {
              const attributeNames = node.getAttributeNames?.() || [];
              for (const name of attributeNames) {
                nodeData.attributes[name] = node.getAttribute(name);
              }
