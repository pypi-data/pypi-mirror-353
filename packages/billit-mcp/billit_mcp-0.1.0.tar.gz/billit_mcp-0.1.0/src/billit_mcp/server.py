...
async def get_client() -> BillitAPIClient:
    ...
    return BillitAPIClient(
        api_key=os.getenv("BILLIT_API_KEY", ""),
        base_url=os.getenv("BILLIT_BASE_URL", "https://api.sandbox.billit.be/v1"),
...
async def list_parties(
    ...
    return await client.request("GET", "/party", params=params)
...
async def create_party(party_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    """
    client = await get_client()
    return await client.request("POST", "/party", json=party_data)
...
async def update_party(party_id: int, party_updates: Dict[str, Any]) -> Dict[str, Any]:
    ...
    """
    client = await get_client()
    return await client.request("PATCH", f"/party/{party_id}", json=party_updates)
...
async def list_products(
    ...
    return await client.request("GET", "/product", params=params)
...
async def get_product(product_id: int) -> Dict[str, Any]:
    ...
    """
    client = await get_client()
    return await client.request("GET", f"/product/{product_id}")
...
async def upsert_product(product_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    """
    client = await get_client()
    return await client.request("POST", "/product", json=product_data)
...
async def list_financial_transactions(
    ...
    return await client.request("GET", "/financialtransaction", params=params)
...
async def import_transactions_file(file_path: str) -> Dict[str, Any]:
    ...
    """
    client = await get_client()
    return await client.request("POST", "/financialtransaction/import", json={"file_path": file_path})
...
async def confirm_transaction_import(import_id: str) -> Dict[str, Any]:
    ...
    """
    client = await get_client()
    return await client.request("POST", f"/financialtransaction/import/{import_id}/confirm")
...
async def get_account_information() -> Dict[str, Any]:
    ...
    client = await get_client()
    return await client.request("GET", "/account")
...
async def get_sso_token() -> Dict[str, Any]:
    ...
    client = await get_client()
    return await client.request("GET", "/account/sso")
...
async def get_next_sequence_number(sequence_type: str, consume: bool = False) -> Dict[str, Any]:
    ...
    return await client.request("GET", f"/account/sequence/{sequence_type}", params=params)
...
async def register_company(company_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    """
    client = await get_client()
    return await client.request("POST", "/account/register", json=company_data)
...
async def list_documents(
    ...
    return await client.request("GET", "/document", params=params)
...
async def upload_document(file_path: str, metadata: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return await client.request("POST", "/document/upload", json=data)
...
async def get_document(document_id: int) -> Dict[str, Any]:
    ...
    """
    client = await get_client()
    return await client.request("GET", f"/document/{document_id}")
...
async def download_file(file_id: str) -> Dict[str, Any]:
    ...
    """
    client = await get_client()
    return await client.request("GET", f"/file/{file_id}/download")
...
async def register_peppol_participant(registration_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    """
    client = await get_client()
    return await client.request("POST", "/peppol/register", json=registration_data)
...
async def send_peppol_invoice(order_id: int) -> Dict[str, Any]:
    ...
    """
    client = await get_client()
    return await client.request("POST", f"/peppol/send/{order_id}")
...
async def search_company(keywords: str) -> Dict[str, Any]:
    ...
    return await client.request("GET", "/search/company", params=params)
...
async def get_type_codes(code_type: str) -> Dict[str, Any]:
    ...
    """
    client = await get_client()
    return await client.request("GET", f"/types/{code_type}")
