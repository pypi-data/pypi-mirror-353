...
def _serialize_data_type(data_type: DataType) -> Dict[str, Any]:
    """Serializes a DataType instance to a JSON-compatible dictionary."""
    ...
    if isinstance(data_type, ArrayType):
        serialized["element_type"] = _serialize_data_type(data_type.element_type)
        ...
        serialized["data_type"] = _serialize_data_type(data_type.data_type)
...
def _serialize_struct_field(field: StructField) -> Dict[str, Any]:
    ...
    return {"name": field.name, "data_type": _serialize_data_type(field.data_type)}
...
def _serialize_column_field(column_field: ColumnField) -> Dict[str, Any]:
    ...
    return {
        ...
        "data_type": _serialize_data_type(column_field.data_type),
    }
