...
from langframe.api.types import BooleanType, ColumnField


class WhenExpr(LogicalExpr):
    def __init__(self, expr: LogicalExpr, condition: LogicalExpr, value: LogicalExpr):
        self.expr = expr
    ...
    def children(self) -> List[LogicalExpr]:
        return [self.expr, self.condition, self.value]
