...
from langframe._utils.schema import convert_markdown_schema_to_custom_dtype
...
class MdTransformExpr(LogicalExpr):
    ...
    def to_column_field(self, plan: LogicalPlan) -> ColumnField:
        ...
        schema_type = convert_markdown_schema_to_custom_dtype(schema_obj)
        return ColumnField(name=str(self), data_type=schema_type)
