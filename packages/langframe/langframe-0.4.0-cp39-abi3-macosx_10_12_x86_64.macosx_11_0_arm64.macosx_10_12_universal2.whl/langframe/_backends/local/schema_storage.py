...
from langframe._backends.schema_serde import deserialize_schema, serialize_schema
from langframe.api.types import Schema

# Constants for system schema and table names
SYSTEM_SCHEMA_NAME = "__langframe_system"
...
class SchemaStorage:
    """
    Handles storage and retrieval of schema metadata in the system tables.
    This is particularly important for logical types that can't be directly
    represented in the physical storage system.
    """
    ...
    def initialize_system_schema(self) -> None:
        """
        Initialize the system schema and metadata table for storing table schemas
        including logical type information.
    ...
    def save_schema(self, database_name: str, table_name: str, schema: Schema) -> None:
        """
        Save a table's schema metadata to the system table.
        This is used for storing logical type information that can't be
        directly represented in the physical storage.
