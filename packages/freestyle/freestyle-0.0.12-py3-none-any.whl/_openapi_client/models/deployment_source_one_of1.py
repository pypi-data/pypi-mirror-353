...
class DeploymentSourceOneOf1(BaseModel):
    """
    DeploymentSourceOneOf1
    """ # noqa: E501
    url: StrictStr
    kind: StrictStr
    __properties: ClassVar[List[str]] = ["url", "kind"]

    @field_validator('kind')
    def kind_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['tar']):
            raise ValueError("must be one of enum values ('tar')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeploymentSourceOneOf1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeploymentSourceOneOf1 from a dict"""
        if obj is None:
            return None
