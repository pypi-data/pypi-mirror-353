...
class DeploymentSourceOneOf2(BaseModel):
    """
    ...
    kind: StrictStr
    __properties: ClassVar[List[str]] = ["url", "branch", "dir", "kind"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeploymentSourceOneOf2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeploymentSourceOneOf2 from a dict"""
        if obj is None:
            return None
