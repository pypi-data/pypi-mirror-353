...
from moldenViz.tabulator import Tabulator, _spherical_to_cartersian, _cartesian_to_spherical, array_like_type
...
def test_spherical_cartesian_roundtrip() -> None:
    ...
    x, y, z = _spherical_to_cartersian(r_vals, theta_vals, phi_vals)
