...
class Usergroups(APIObject):
    ...
    def get_usergroups(self) -> list:
        ...
        utils.print_log(
            self._logger,
            f"Calling get_usergroups endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def get_usergroup_by_id(self, usergroup_id: int) -> dict:
        ...
        utils.print_log(
            self._logger,
            f"Calling get_usergroup_by_id endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_get_request(endpoint, include_api_version=False)
    ...
    def get_usergroups_by_name(self, name: str) -> list:
        ...
        utils.print_log(
            self._logger,
            f"Calling get_usergroups_by_name endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_get_request(endpoint, include_api_version=False)
    ...
    def post_usergroups_beyondinsight(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_usergroups_beyondinsight endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def post_usergroups_entraid(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_usergroups_entraid endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_post_request(endpoint, req_body, include_api_version=False)
    ...
    def post_usergroups_ad(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_usergroups_ad endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_post_request(endpoint, req_body, include_api_version=False)
    ...
    def post_usergroups_ldap(
        ...
        utils.print_log(
            self._logger,
            f"Calling post_usergroups_ldap endpoint: {endpoint}",
            logging.DEBUG,
        )
        response = self._run_post_request(endpoint, req_body, include_api_version=False)
    ...
    def delete_usergroup_by_name(self, name: str) -> None:
        ...
        utils.print_log(
            self._logger,
            f"Calling delete_usergroup_by_name endpoint: {endpoint}",
            logging.DEBUG,
        )
    ...
    def delete_usergroup_by_id(self, usergroup_id: int) -> None:
        ...
        utils.print_log(
            self._logger,
            f"Calling delete_usergroup_by_id endpoint: {endpoint}",
            logging.DEBUG,
        )
        self._run_delete_request(endpoint)
