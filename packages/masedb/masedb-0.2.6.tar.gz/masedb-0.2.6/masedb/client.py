            ...
            if 'application/json' in content_type:
                try:
                    ...
                    if 'error' in error_data:
                        error_message = error_data['error']['message'] if 'error' in error_data and 'message' in error_data['error'] else 'Unknown error'
                        error_code = error_data['error']['code'] if 'error' in error_data and 'code' in error_data['error'] else 'UNKNOWN_ERROR'
                        error_details = error_data['error']['details'] if 'error' in error_data and 'details' in error_data['error'] else []
