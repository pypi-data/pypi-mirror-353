...
# TODO Rename Logger to LoggerLocal and create Logger for backward compatability (As we should have two classes with diffrent names LoggerLocal and LoggerRemote)
class Logger(logging.Logger):
    ...
    def is_component_complete(self):
        is_component_complete_result = (getattr(self, 'component_name') is None
