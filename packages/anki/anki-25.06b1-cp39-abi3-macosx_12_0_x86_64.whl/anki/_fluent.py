...
learning cards are cards with a current learning step of one or more days. '''
    ...
    def deck_config_complete(self, num: FluentVariable) -> str:
        r''' {$num}% complete. '''
        return self._translate(11, 31, {"num": num})
...
optimizing the parameters. '''
    ...
    def deck_config_confirm_remove_name(self, name: str) -> str:
        r''' Remove {$name}? '''
        return self._translate(11, 42, {"name": name})
    ...
    def deck_config_daily_limit_will_be_capped(self, cards: int) -> str:
        ...
        return self._translate(11, 45, {"cards": cards})
...
is used to immediately remove a card from learning. '''
    ...
    def deck_config_fsrs_bad_fit_warning(self, ) -> str:
        r''' Your memory is difficult for FSRS to predict. Recommendations:
...
If you follow these suggestions, performance will usually improve over the next few months. '''
    ...
    def deck_config_fsrs_good_fit(self, ) -> str:
        r''' FSRS is well adjusted to your memory. '''
...
is pressed on the final learning step. '''
    ...
    def deck_config_health_check(self, ) -> str:
        r''' Check health when optimizing (slow) '''
...
this option. '''
    ...
    def deck_config_ignore_before_info(self, included: str, total_cards: str) -> str:
        ...
        return self._translate(11, 98, {"included": included, "totalCards": total_cards})
...
the manual before changing this option. '''
    ...
    def deck_config_iterations(self, count: int) -> str:
        r''' Iteration: {$count}... '''
        return self._translate(11, 106, {"count": count})
...
The shorter you set this, the greater your workload will be. '''
    ...
    def deck_config_must_have_400_reviews(self, count: int) -> str:
        ...
        return self._translate(11, 120, {"count": count})
...
be at least 10x smaller than your review limit. '''
    ...
    def deck_config_optimizing_preset(self, current_count: int, total_count: int) -> str:
        ...
        return self._translate(11, 146, {"current_count": current_count, "total_count": total_count})
    ...
    def deck_config_percent_input(self, pct: str) -> str:
        r''' {$pct}% '''
        return self._translate(11, 148, {"pct": pct})


    def deck_config_percent_of_reviews(self, reviews: int, pct: str) -> str:
        r''' {$pct}% of {$reviews} reviews '''
        return self._translate(11, 149, {"reviews": reviews, "pct": pct})
    ...
    def deck_config_predicted_minimum_recommended_retention(self, num: FluentVariable) -> str:
        ...
        return self._translate(11, 151, {"num": num})


    def deck_config_predicted_optimal_retention(self, num: FluentVariable) -> str:
        r''' Minimum recommended retention: {$num} '''
        return self._translate(11, 152, {"num": num})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 172, {"cards": cards, "expected": expected})
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 218, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 219, {"decks": decks})
...
(compared to {$previousDR}% desired retention) '''
        return self._translate(11, 228, {"factor": factor, "previousDR": previous_dr})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_CLEAR_LAST_SIMULATE = (11, 29)
    DECK_CONFIG_CLONE_GROUP = (11, 30)
    DECK_CONFIG_COMPLETE = (11, 31)
    DECK_CONFIG_COMPUTE_BUTTON = (11, 32)
    DECK_CONFIG_COMPUTE_MINIMUM_RECOMMENDED_RETENTION = (11, 33)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION = (11, 34)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP = (11, 35)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP2 = (11, 36)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP3 = (11, 37)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP4 = (11, 38)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS = (11, 39)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS_TOOLTIP = (11, 40)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS_TOOLTIP2 = (11, 41)
    DECK_CONFIG_CONFIRM_REMOVE_NAME = (11, 42)
    DECK_CONFIG_CUSTOM_SCHEDULING = (11, 43)
    DECK_CONFIG_CUSTOM_SCHEDULING_TOOLTIP = (11, 44)
    DECK_CONFIG_DAILY_LIMIT_WILL_BE_CAPPED = (11, 45)
    DECK_CONFIG_DAILY_LIMITS = (11, 46)
    DECK_CONFIG_DAYS_TO_SIMULATE = (11, 47)
    DECK_CONFIG_DECK_ONLY = (11, 48)
    DECK_CONFIG_DEFAULT_NAME = (11, 49)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING = (11, 50)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING_HINT = (11, 51)
    DECK_CONFIG_DESIRED_RETENTION = (11, 52)
    DECK_CONFIG_DESIRED_RETENTION_BELOW_OPTIMAL = (11, 53)
    DECK_CONFIG_DESIRED_RETENTION_TOO_HIGH = (11, 54)
    DECK_CONFIG_DESIRED_RETENTION_TOO_LOW = (11, 55)
    DECK_CONFIG_DESIRED_RETENTION_TOOLTIP = (11, 56)
    DECK_CONFIG_DISABLE_AUTOPLAY = (11, 57)
    DECK_CONFIG_DISABLE_AUTOPLAY_TOOLTIP = (11, 58)
    DECK_CONFIG_DISPLAY_ORDER_WILL_USE_CURRENT_DECK = (11, 59)
    DECK_CONFIG_DO_NOT_BURY = (11, 60)
    DECK_CONFIG_EASY_BONUS_TOOLTIP = (11, 61)
    DECK_CONFIG_EASY_DAYS_CHANGE = (11, 62)
    DECK_CONFIG_EASY_DAYS_FRIDAY = (11, 63)
    DECK_CONFIG_EASY_DAYS_MINIMUM = (11, 64)
    DECK_CONFIG_EASY_DAYS_MONDAY = (11, 65)
    DECK_CONFIG_EASY_DAYS_NO_NORMAL_DAYS = (11, 66)
    DECK_CONFIG_EASY_DAYS_NORMAL = (11, 67)
    DECK_CONFIG_EASY_DAYS_REDUCED = (11, 68)
    DECK_CONFIG_EASY_DAYS_SATURDAY = (11, 69)
    DECK_CONFIG_EASY_DAYS_SUNDAY = (11, 70)
    DECK_CONFIG_EASY_DAYS_THURSDAY = (11, 71)
    DECK_CONFIG_EASY_DAYS_TITLE = (11, 72)
    DECK_CONFIG_EASY_DAYS_TUESDAY = (11, 73)
    DECK_CONFIG_EASY_DAYS_WEDNESDAY = (11, 74)
    DECK_CONFIG_EASY_INTERVAL_TOOLTIP = (11, 75)
    DECK_CONFIG_EVALUATE_BUTTON = (11, 76)
    DECK_CONFIG_FSRS_BAD_FIT_WARNING = (11, 77)
    DECK_CONFIG_FSRS_GOOD_FIT = (11, 78)
    DECK_CONFIG_FSRS_MUST_BE_ENABLED = (11, 79)
    DECK_CONFIG_FSRS_ON_ALL_CLIENTS = (11, 80)
    DECK_CONFIG_FSRS_PARAMS_NO_REVIEWS = (11, 81)
    DECK_CONFIG_FSRS_PARAMS_OPTIMAL = (11, 82)
    DECK_CONFIG_FSRS_SIMULATOR_EXPERIMENTAL = (11, 83)
    DECK_CONFIG_FSRS_SIMULATOR_RADIO_COUNT = (11, 84)
    DECK_CONFIG_FSRS_SIMULATOR_RADIO_MEMORIZED = (11, 85)
    DECK_CONFIG_FSRS_SIMULATOR_Y_AXIS_TITLE_COUNT = (11, 86)
    DECK_CONFIG_FSRS_SIMULATOR_Y_AXIS_TITLE_MEMORIZED = (11, 87)
    DECK_CONFIG_FSRS_SIMULATOR_Y_AXIS_TITLE_TIME = (11, 88)
    DECK_CONFIG_FSRS_TOOLTIP = (11, 89)
    DECK_CONFIG_GET_PARAMS = (11, 90)
    DECK_CONFIG_GOOD_ABOVE_EASY = (11, 91)
    DECK_CONFIG_GRADUATING_INTERVAL_TOOLTIP = (11, 92)
    DECK_CONFIG_HARD_INTERVAL_TOOLTIP = (11, 93)
    DECK_CONFIG_HEALTH_CHECK = (11, 94)
    DECK_CONFIG_HISTORICAL_RETENTION = (11, 95)
    DECK_CONFIG_HISTORICAL_RETENTION_TOOLTIP = (11, 96)
    DECK_CONFIG_IGNORE_BEFORE = (11, 97)
    DECK_CONFIG_IGNORE_BEFORE_INFO = (11, 98)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP = (11, 99)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP_2 = (11, 100)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (11, 101)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (11, 102)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (11, 103)
    DECK_CONFIG_INVALID_PARAMETERS = (11, 104)
    DECK_CONFIG_INVALID_WEIGHTS = (11, 105)
    DECK_CONFIG_ITERATIONS = (11, 106)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (11, 107)
    DECK_CONFIG_LEARNING_STEPS = (11, 108)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (11, 109)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (11, 110)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (11, 111)
    DECK_CONFIG_LIMIT_DECK_V3 = (11, 112)
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 113)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 114)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 115)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 116)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 117)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 118)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 119)
    DECK_CONFIG_MUST_HAVE_400_REVIEWS = (11, 120)
    DECK_CONFIG_NAME_PROMPT = (11, 121)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 122)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 123)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT = (11, 124)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT_TOOLTIP = (11, 125)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 126)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 127)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK_THEN_RANDOM_NOTES = (11, 128)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 129)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 130)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 131)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 132)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 133)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 134)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 135)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 136)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 137)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 138)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 139)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 140)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 141)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 142)
    DECK_CONFIG_NOT_ENOUGH_HISTORY = (11, 143)
    DECK_CONFIG_OPTIMIZE_ALL_TIP = (11, 144)
    DECK_CONFIG_OPTIMIZE_BUTTON = (11, 145)
    DECK_CONFIG_OPTIMIZING_PRESET = (11, 146)
    DECK_CONFIG_ORDERING_TITLE = (11, 147)
    DECK_CONFIG_PERCENT_INPUT = (11, 148)
    DECK_CONFIG_PERCENT_OF_REVIEWS = (11, 149)
    DECK_CONFIG_PLEASE_SAVE_YOUR_CHANGES_FIRST = (11, 150)
    DECK_CONFIG_PREDICTED_MINIMUM_RECOMMENDED_RETENTION = (11, 151)
    DECK_CONFIG_PREDICTED_OPTIMAL_RETENTION = (11, 152)
    DECK_CONFIG_QUESTION_ACTION = (11, 153)
    DECK_CONFIG_QUESTION_ACTION_SHOW_ANSWER = (11, 154)
    DECK_CONFIG_QUESTION_ACTION_SHOW_REMINDER = (11, 155)
    DECK_CONFIG_QUESTION_ACTION_TOOL_TIP = (11, 156)
    DECK_CONFIG_RELEARNING_STEPS = (11, 157)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 158)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 159)
    DECK_CONFIG_REMOVE_GROUP = (11, 160)
    DECK_CONFIG_RENAME_GROUP = (11, 161)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE = (11, 162)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE_TOOLTIP = (11, 163)
    DECK_CONFIG_RESCHEDULE_CARDS_WARNING = (11, 164)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 165)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 166)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 167)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 168)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 169)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 170)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 171)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 172)
    DECK_CONFIG_SAVE_AND_OPTIMIZE = (11, 173)
    DECK_CONFIG_SAVE_BUTTON = (11, 174)
    DECK_CONFIG_SAVE_OPTIONS_TO_PRESET = (11, 175)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 176)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER = (11, 177)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER_TOOLTIP_2 = (11, 178)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION = (11, 179)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP = (11, 180)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_2 = (11, 181)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_3 = (11, 182)
    DECK_CONFIG_SHARED_PRESET = (11, 183)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 184)
    DECK_CONFIG_SHOW_REMINDER = (11, 185)
    DECK_CONFIG_SIMULATE = (11, 186)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 187)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 188)
    DECK_CONFIG_SMOOTH_GRAPH = (11, 189)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 190)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 191)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 192)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 193)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 194)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 195)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 196)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 197)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 198)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 199)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 200)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 201)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 202)
    DECK_CONFIG_SORT_ORDER_RETRIEVABILITY_ASCENDING = (11, 203)
    DECK_CONFIG_SORT_ORDER_RETRIEVABILITY_DESCENDING = (11, 204)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 205)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 206)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 207)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 208)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 209)
    DECK_CONFIG_SUSPEND_LEECHES = (11, 210)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 211)
    DECK_CONFIG_TIME_TO_OPTIMIZE = (11, 212)
    DECK_CONFIG_TIMER_TITLE = (11, 213)
    DECK_CONFIG_TITLE = (11, 214)
    DECK_CONFIG_TODAY_ONLY = (11, 215)
    DECK_CONFIG_TOO_SHORT_MAXIMUM_INTERVAL = (11, 216)
    DECK_CONFIG_UNABLE_TO_DETERMINE_DESIRED_RETENTION = (11, 217)
    DECK_CONFIG_UPDATING_CARDS = (11, 218)
    DECK_CONFIG_USED_BY_DECKS = (11, 219)
    DECK_CONFIG_WAIT_FOR_AUDIO = (11, 220)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP = (11, 221)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP_2 = (11, 222)
    DECK_CONFIG_WEIGHTS = (11, 223)
    DECK_CONFIG_WEIGHTS_TOOLTIP = (11, 224)
    DECK_CONFIG_WEIGHTS_TOOLTIP2 = (11, 225)
    DECK_CONFIG_WHICH_DECK = (11, 226)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 227)
    DECK_CONFIG_WORKLOAD_FACTOR_CHANGE = (11, 228)
    DECK_CONFIG_WORKLOAD_FACTOR_UNCHANGED = (11, 229)
