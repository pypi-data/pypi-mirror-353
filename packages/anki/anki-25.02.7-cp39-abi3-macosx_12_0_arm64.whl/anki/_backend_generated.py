...
class RustBackendGenerated:
 ...
 if the backup encountered an error."""
    ...
    def compute_fsrs_params(self, *, search: str, current_params: Iterable[float], ignore_revlogs_before_ms: int, num_of_relearning_steps: int) -> anki.scheduler_pb2.ComputeFsrsParamsResponse:
        message = anki.scheduler_pb2.ComputeFsrsParamsRequest(search=search, current_params=current_params, ignore_revlogs_before_ms=ignore_revlogs_before_ms, num_of_relearning_steps=num_of_relearning_steps)
    ...
    def compute_optimal_retention(self, *, params: Iterable[float], days_to_simulate: int, max_interval: int, search: str, loss_aversion: float) -> float:
        message = anki.scheduler_pb2.ComputeOptimalRetentionRequest(params=params, days_to_simulate=days_to_simulate, max_interval=max_interval, search=search, loss_aversion=loss_aversion)
    ...
    def simulate_fsrs_review(self, *, params: Iterable[float], desired_retention: float, deck_size: int, days_to_simulate: int, new_limit: int, review_limit: int, max_interval: int, search: str, new_cards_ignore_review_limit: bool) -> anki.scheduler_pb2.SimulateFsrsReviewResponse:
        message = anki.scheduler_pb2.SimulateFsrsReviewRequest(params=params, desired_retention=desired_retention, deck_size=deck_size, days_to_simulate=days_to_simulate, new_limit=new_limit, review_limit=review_limit, max_interval=max_interval, search=search, new_cards_ignore_review_limit=new_cards_ignore_review_limit)
    ...
    def evaluate_params(self, *, params: Iterable[float], search: str, ignore_revlogs_before_ms: int) -> anki.scheduler_pb2.EvaluateParamsResponse:
        message = anki.scheduler_pb2.EvaluateParamsRequest(params=params, search=search, ignore_revlogs_before_ms=ignore_revlogs_before_ms)
 ...
 review (if any). Utilized by the FSRS add-on."""
        return self._run_command(11, 35, message)
 ...
 review (if any). Utilized by the FSRS add-on."""
        ...
        raw_bytes = self._run_command(11, 35, message.SerializeToString())
 ...
 version, that add-on will not be included in the returned list."""
    ...
    def get_change_notetype_info_raw(self, message: bytes) -> bytes:
        return self._run_command(21, 14, message)
    ...
    def get_change_notetype_info(self, *, old_notetype_id: int, new_notetype_id: int) -> anki.notetypes_pb2.ChangeNotetypeInfo:
        ...
        raw_bytes = self._run_command(21, 14, message.SerializeToString())
        output = anki.notetypes_pb2.ChangeNotetypeInfo()
        output.ParseFromString(raw_bytes)
        return output

    def change_notetype_raw(self, message: bytes) -> bytes:
        return self._run_command(21, 15, message)
    ...
    def change_notetype(self, *, note_ids: Iterable[int], new_fields: Iterable[int], new_templates: Iterable[int], old_notetype_id: int, new_notetype_id: int, current_schema: int, old_notetype_name: str, is_cloze: bool) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(21, 15, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output

    def get_field_names_raw(self, message: bytes) -> bytes:
        return self._run_command(21, 16, message)

    def get_field_names(self, ntid: int) -> Sequence[str]:
        message = anki.notetypes_pb2.NotetypeId(ntid=ntid)
        raw_bytes = self._run_command(21, 16, message.SerializeToString())
        output = anki.generic_pb2.StringList()
        output.ParseFromString(raw_bytes)
        return output.vals

    def restore_notetype_to_stock_raw(self, message: bytes) -> bytes:
        return self._run_command(21, 17, message)
    ...
    def restore_notetype_to_stock(self, message: anki.notetypes_pb2.RestoreNotetypeToStockRequest) -> anki.collection_pb2.OpChanges:
        ...
        raw_bytes = self._run_command(21, 17, message.SerializeToString())
        output = anki.collection_pb2.OpChanges()
        output.ParseFromString(raw_bytes)
        return output
    ...
    def html_to_text_line_raw(self, message: bytes) -> bytes:
        return self._run_command(25, 14, message)
    ...
    def html_to_text_line(self, *, text: str, preserve_media_filenames: bool) -> str:
        ...
        raw_bytes = self._run_command(25, 14, message.SerializeToString())
        output = anki.generic_pb2.String()
        output.ParseFromString(raw_bytes)
        return output.val

    def compare_answer_raw(self, message: bytes) -> bytes:
        return self._run_command(25, 15, message)
    ...
    def compare_answer(self, *, expected: str, provided: str, combining: bool) -> str:
        ...
        raw_bytes = self._run_command(25, 15, message.SerializeToString())
        output = anki.generic_pb2.String()
        output.ParseFromString(raw_bytes)
        return output.val

    def extract_cloze_for_typing_raw(self, message: bytes) -> bytes:
        return self._run_command(25, 16, message)
    ...
    def extract_cloze_for_typing(self, *, text: str, ordinal: int) -> str:
        ...
        raw_bytes = self._run_command(25, 16, message.SerializeToString())
        output = anki.generic_pb2.String()
        output.ParseFromString(raw_bytes)
        return output.val
