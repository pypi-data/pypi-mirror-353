...
@typing.final
class ReviewLogs(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    ENTRIES_FIELD_NUMBER: builtins.int
    @property
    def entries(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___CardStatsResponse.StatsRevlogEntry]: ...
    def __init__(
        self,
        *,
        entries: collections.abc.Iterable[global___CardStatsResponse.StatsRevlogEntry] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["entries", b"entries"]) -> None: ...

global___ReviewLogs = ReviewLogs
...
class CardStatsResponse(google.protobuf.message.Message):
    ...
    class StatsRevlogEntry(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["_memory_state", b"_memory_state", "button_chosen", b"button_chosen", "ease", b"ease", "interval", b"interval", "memory_state", b"memory_state", "review_kind", b"review_kind", "taken_secs", b"taken_secs", "time", b"time"]) -> None: ...
    ...
    def HasField(self, field_name: typing.Literal["_desired_retention", b"_desired_retention", "_due_date", b"_due_date", "_due_position", b"_due_position", "_first_review", b"_first_review", "_fsrs_retrievability", b"_fsrs_retrievability", "_latest_review", b"_latest_review", "_memory_state", b"_memory_state", "_original_deck", b"_original_deck", "desired_retention", b"desired_retention", "due_date", b"due_date", "due_position", b"due_position", "first_review", b"first_review", "fsrs_retrievability", b"fsrs_retrievability", "latest_review", b"latest_review", "memory_state", b"memory_state", "original_deck", b"original_deck"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_desired_retention", b"_desired_retention", "_due_date", b"_due_date", "_due_position", b"_due_position", "_first_review", b"_first_review", "_fsrs_retrievability", b"_fsrs_retrievability", "_latest_review", b"_latest_review", "_memory_state", b"_memory_state", "_original_deck", b"_original_deck", "added", b"added", "average_secs", b"average_secs", "card_id", b"card_id", "card_type", b"card_type", "custom_data", b"custom_data", "deck", b"deck", "desired_retention", b"desired_retention", "due_date", b"due_date", "due_position", b"due_position", "ease", b"ease", "first_review", b"first_review", "fsrs_retrievability", b"fsrs_retrievability", "interval", b"interval", "lapses", b"lapses", "latest_review", b"latest_review", "memory_state", b"memory_state", "note_id", b"note_id", "notetype", b"notetype", "original_deck", b"original_deck", "preset", b"preset", "reviews", b"reviews", "revlog", b"revlog", "total_secs", b"total_secs"]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_due_date", b"_due_date"]) -> typing.Literal["due_date"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_due_position", b"_due_position"]) -> typing.Literal["due_position"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_first_review", b"_first_review"]) -> typing.Literal["first_review"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_fsrs_retrievability", b"_fsrs_retrievability"]) -> typing.Literal["fsrs_retrievability"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_latest_review", b"_latest_review"]) -> typing.Literal["latest_review"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_memory_state", b"_memory_state"]) -> typing.Literal["memory_state"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_original_deck", b"_original_deck"]) -> typing.Literal["original_deck"] | None: ...
...
class GraphsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["days", b"days", "search", b"search"]) -> None: ...
...
class GraphsResponse(google.protobuf.message.Message):
    ...
    class Eases(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["average", b"average", "eases", b"eases"]) -> None: ...
    ...
    class Retrievability(google.protobuf.message.Message):
        ...
        AVERAGE_FIELD_NUMBER: builtins.int
        SUM_BY_CARD_FIELD_NUMBER: builtins.int
        SUM_BY_NOTE_FIELD_NUMBER: builtins.int
        average: builtins.float
        sum_by_card: builtins.float
        sum_by_note: builtins.float
        @property
        ...
        def ClearField(self, field_name: typing.Literal["average", b"average", "retrievability", b"retrievability", "sum_by_card", b"sum_by_card", "sum_by_note", b"sum_by_note"]) -> None: ...
    ...
    class FutureDue(google.protobuf.message.Message):
        ...
        DAILY_LOAD_FIELD_NUMBER: builtins.int
        have_backlog: builtins.bool
        daily_load: builtins.int
        @property
        ...
        def ClearField(self, field_name: typing.Literal["daily_load", b"daily_load", "future_due", b"future_due", "have_backlog", b"have_backlog"]) -> None: ...
    ...
    class Today(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["answer_count", b"answer_count", "answer_millis", b"answer_millis", "correct_count", b"correct_count", "early_review_count", b"early_review_count", "learn_count", b"learn_count", "mature_correct", b"mature_correct", "mature_count", b"mature_count", "relearn_count", b"relearn_count", "review_count", b"review_count"]) -> None: ...
    ...
    class Hours(google.protobuf.message.Message):
        ...
        class Hour(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["correct", b"correct", "total", b"total"]) -> None: ...
        ...
        def ClearField(self, field_name: typing.Literal["all_time", b"all_time", "one_month", b"one_month", "one_year", b"one_year", "three_months", b"three_months"]) -> None: ...
    ...
    class ReviewCountsAndTimes(google.protobuf.message.Message):
        ...
        class Reviews(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["filtered", b"filtered", "learn", b"learn", "mature", b"mature", "relearn", b"relearn", "young", b"young"]) -> None: ...
        ...
        def ClearField(self, field_name: typing.Literal["count", b"count", "time", b"time"]) -> None: ...
    ...
    class Buttons(google.protobuf.message.Message):
        ...
        class ButtonCounts(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["learning", b"learning", "mature", b"mature", "young", b"young"]) -> None: ...
        ...
        def HasField(self, field_name: typing.Literal["all_time", b"all_time", "one_month", b"one_month", "one_year", b"one_year", "three_months", b"three_months"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["all_time", b"all_time", "one_month", b"one_month", "one_year", b"one_year", "three_months", b"three_months"]) -> None: ...
    ...
    class CardCounts(google.protobuf.message.Message):
        ...
        class Counts(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing.Literal["buried", b"buried", "learn", b"learn", "mature", b"mature", "newCards", b"newCards", "relearn", b"relearn", "suspended", b"suspended", "young", b"young"]) -> None: ...
        ...
        def HasField(self, field_name: typing.Literal["excluding_inactive", b"excluding_inactive", "including_inactive", b"including_inactive"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["excluding_inactive", b"excluding_inactive", "including_inactive", b"including_inactive"]) -> None: ...

    @typing.final
    class TrueRetentionStats(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor

        @typing.final
        class TrueRetention(google.protobuf.message.Message):
            DESCRIPTOR: google.protobuf.descriptor.Descriptor

            YOUNG_PASSED_FIELD_NUMBER: builtins.int
            YOUNG_FAILED_FIELD_NUMBER: builtins.int
            MATURE_PASSED_FIELD_NUMBER: builtins.int
            MATURE_FAILED_FIELD_NUMBER: builtins.int
            young_passed: builtins.int
            young_failed: builtins.int
            mature_passed: builtins.int
            mature_failed: builtins.int
            def __init__(
                self,
                *,
                young_passed: builtins.int = ...,
            ...
            def ClearField(self, field_name: typing.Literal["mature_failed", b"mature_failed", "mature_passed", b"mature_passed", "young_failed", b"young_failed", "young_passed", b"young_passed"]) -> None: ...
        ...
        ALL_TIME_FIELD_NUMBER: builtins.int
        @property
        def today(self) -> global___GraphsResponse.TrueRetentionStats.TrueRetention: ...
        @property
        def yesterday(self) -> global___GraphsResponse.TrueRetentionStats.TrueRetention: ...
        @property
        def week(self) -> global___GraphsResponse.TrueRetentionStats.TrueRetention: ...
        @property
        def month(self) -> global___GraphsResponse.TrueRetentionStats.TrueRetention: ...
        @property
        def year(self) -> global___GraphsResponse.TrueRetentionStats.TrueRetention: ...
        @property
        def all_time(self) -> global___GraphsResponse.TrueRetentionStats.TrueRetention: ...
        def __init__(
            self,
            *,
            today: global___GraphsResponse.TrueRetentionStats.TrueRetention | None = ...,
            yesterday: global___GraphsResponse.TrueRetentionStats.TrueRetention | None = ...,
            week: global___GraphsResponse.TrueRetentionStats.TrueRetention | None = ...,
            month: global___GraphsResponse.TrueRetentionStats.TrueRetention | None = ...,
            year: global___GraphsResponse.TrueRetentionStats.TrueRetention | None = ...,
            all_time: global___GraphsResponse.TrueRetentionStats.TrueRetention | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing.Literal["all_time", b"all_time", "month", b"month", "today", b"today", "week", b"week", "year", b"year", "yesterday", b"yesterday"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing.Literal["all_time", b"all_time", "month", b"month", "today", b"today", "week", b"week", "year", b"year", "yesterday", b"yesterday"]) -> None: ...
    ...
    TRUE_RETENTION_FIELD_NUMBER: builtins.int
    ...
    @property
    def true_retention(self) -> global___GraphsResponse.TrueRetentionStats: ...
    def __init__(
        self,
        *,
        ...
        true_retention: global___GraphsResponse.TrueRetentionStats | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["added", b"added", "buttons", b"buttons", "card_counts", b"card_counts", "difficulty", b"difficulty", "eases", b"eases", "future_due", b"future_due", "hours", b"hours", "intervals", b"intervals", "retrievability", b"retrievability", "reviews", b"reviews", "stability", b"stability", "today", b"today", "true_retention", b"true_retention"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["added", b"added", "buttons", b"buttons", "card_counts", b"card_counts", "difficulty", b"difficulty", "eases", b"eases", "fsrs", b"fsrs", "future_due", b"future_due", "hours", b"hours", "intervals", b"intervals", "retrievability", b"retrievability", "reviews", b"reviews", "rollover_hour", b"rollover_hour", "stability", b"stability", "today", b"today", "true_retention", b"true_retention"]) -> None: ...
...
class GraphPreferences(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["browser_links_supported", b"browser_links_supported", "calendar_first_day_of_week", b"calendar_first_day_of_week", "card_counts_separate_inactive", b"card_counts_separate_inactive", "future_due_show_backlog", b"future_due_show_backlog"]) -> None: ...
