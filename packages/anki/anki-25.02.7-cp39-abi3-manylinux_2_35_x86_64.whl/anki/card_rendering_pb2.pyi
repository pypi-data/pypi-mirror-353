...
class ExtractAvTagsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["question_side", b"question_side", "text", b"text"]) -> None: ...
...
class ExtractAvTagsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["av_tags", b"av_tags", "text", b"text"]) -> None: ...
...
class AVTag(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["sound_or_video", b"sound_or_video", "tts", b"tts", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["sound_or_video", b"sound_or_video", "tts", b"tts", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["value", b"value"]) -> typing.Literal["sound_or_video", "tts"] | None: ...
...
class TTSTag(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["field_text", b"field_text", "lang", b"lang", "other_args", b"other_args", "speed", b"speed", "voices", b"voices"]) -> None: ...
...
class ExtractLatexRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["expand_clozes", b"expand_clozes", "svg", b"svg", "text", b"text"]) -> None: ...
...
class ExtractLatexResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["latex", b"latex", "text", b"text"]) -> None: ...
...
class ExtractedLatex(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["filename", b"filename", "latex_body", b"latex_body"]) -> None: ...
...
class EmptyCardsReport(google.protobuf.message.Message):
    ...
    class NoteWithEmptyCards(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["card_ids", b"card_ids", "note_id", b"note_id", "will_delete_note", b"will_delete_note"]) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["notes", b"notes", "report", b"report"]) -> None: ...
...
class RenderExistingCardRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["browser", b"browser", "card_id", b"card_id", "partial_render", b"partial_render"]) -> None: ...
...
class RenderUncommittedCardRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["note", b"note", "template", b"template"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["card_ord", b"card_ord", "fill_empty", b"fill_empty", "note", b"note", "partial_render", b"partial_render", "template", b"template"]) -> None: ...
...
class RenderCardResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["answer_nodes", b"answer_nodes", "css", b"css", "latex_svg", b"latex_svg", "question_nodes", b"question_nodes"]) -> None: ...
...
class RenderedTemplateNode(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["replacement", b"replacement", "text", b"text", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["replacement", b"replacement", "text", b"text", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["value", b"value"]) -> typing.Literal["text", "replacement"] | None: ...
...
class RenderedTemplateReplacement(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["current_text", b"current_text", "field_name", b"field_name", "filters", b"filters"]) -> None: ...
...
class RenderMarkdownRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["markdown", b"markdown", "sanitize", b"sanitize"]) -> None: ...
...
class StripHtmlRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["mode", b"mode", "text", b"text"]) -> None: ...
...
class HtmlToTextLineRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["preserve_media_filenames", b"preserve_media_filenames", "text", b"text"]) -> None: ...
...
class CompareAnswerRequest(google.protobuf.message.Message):
    ...
    COMBINING_FIELD_NUMBER: builtins.int
    expected: builtins.str
    provided: builtins.str
    combining: builtins.bool
    def __init__(
        self,
        *,
        expected: builtins.str = ...,
    ...
    def ClearField(self, field_name: typing.Literal["combining", b"combining", "expected", b"expected", "provided", b"provided"]) -> None: ...
...
class ExtractClozeForTypingRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["ordinal", b"ordinal", "text", b"text"]) -> None: ...
...
class AllTtsVoicesRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["validate", b"validate"]) -> None: ...
...
class AllTtsVoicesResponse(google.protobuf.message.Message):
    ...
    class TtsVoice(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing.Literal["_available", b"_available", "available", b"available", "id", b"id", "language", b"language", "name", b"name"]) -> None: ...
    ...
    def ClearField(self, field_name: typing.Literal["voices", b"voices"]) -> None: ...
...
class WriteTtsStreamRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["path", b"path", "speed", b"speed", "text", b"text", "voice_id", b"voice_id"]) -> None: ...
