...
class ComputeFsrsParamsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["current_params", b"current_params", "ignore_revlogs_before_ms", b"ignore_revlogs_before_ms", "num_of_relearning_steps", b"num_of_relearning_steps", "search", b"search"]) -> None: ...
...
class ComputeFsrsParamsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["fsrs_items", b"fsrs_items", "params", b"params"]) -> None: ...
...
class SimulateFsrsReviewRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["days_to_simulate", b"days_to_simulate", "deck_size", b"deck_size", "desired_retention", b"desired_retention", "max_interval", b"max_interval", "new_cards_ignore_review_limit", b"new_cards_ignore_review_limit", "new_limit", b"new_limit", "params", b"params", "review_limit", b"review_limit", "search", b"search"]) -> None: ...
...
class ComputeOptimalRetentionRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["days_to_simulate", b"days_to_simulate", "loss_aversion", b"loss_aversion", "max_interval", b"max_interval", "params", b"params", "search", b"search"]) -> None: ...
...
class GetOptimalRetentionParametersResponse(google.protobuf.message.Message):
    ...
    LEARN_COSTS_FIELD_NUMBER: builtins.int
    REVIEW_COSTS_FIELD_NUMBER: builtins.int
    FIRST_RATING_PROB_FIELD_NUMBER: builtins.int
    REVIEW_RATING_PROB_FIELD_NUMBER: builtins.int
    FIRST_RATING_OFFSETS_FIELD_NUMBER: builtins.int
    FIRST_SESSION_LENS_FIELD_NUMBER: builtins.int
    FORGET_RATING_OFFSET_FIELD_NUMBER: builtins.int
    FORGET_SESSION_LEN_FIELD_NUMBER: builtins.int
    LOSS_AVERSION_FIELD_NUMBER: builtins.int
    ...
    forget_rating_offset: builtins.float
    forget_session_len: builtins.float
    loss_aversion: builtins.float
    learn_limit: builtins.int
    review_limit: builtins.int
    @property
    def learn_costs(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]: ...
    @property
    def review_costs(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]: ...
    @property
    ...
    @property
    def first_rating_offsets(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]: ...
    @property
    def first_session_lens(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]: ...
    def __init__(
        self,
        *,
        deck_size: builtins.int = ...,
        ...
        max_cost_perday: builtins.float = ...,
        max_ivl: builtins.float = ...,
        learn_costs: collections.abc.Iterable[builtins.float] | None = ...,
        review_costs: collections.abc.Iterable[builtins.float] | None = ...,
        ...
        first_rating_offsets: collections.abc.Iterable[builtins.float] | None = ...,
        first_session_lens: collections.abc.Iterable[builtins.float] | None = ...,
        forget_rating_offset: builtins.float = ...,
        forget_session_len: builtins.float = ...,
        loss_aversion: builtins.float = ...,
        learn_limit: builtins.int = ...,
    ...
    def ClearField(self, field_name: typing.Literal["deck_size", b"deck_size", "first_rating_offsets", b"first_rating_offsets", "first_rating_prob", b"first_rating_prob", "first_session_lens", b"first_session_lens", "forget_rating_offset", b"forget_rating_offset", "forget_session_len", b"forget_session_len", "learn_costs", b"learn_costs", "learn_limit", b"learn_limit", "learn_span", b"learn_span", "loss_aversion", b"loss_aversion", "max_cost_perday", b"max_cost_perday", "max_ivl", b"max_ivl", "review_costs", b"review_costs", "review_limit", b"review_limit", "review_rating_prob", b"review_rating_prob"]) -> None: ...
