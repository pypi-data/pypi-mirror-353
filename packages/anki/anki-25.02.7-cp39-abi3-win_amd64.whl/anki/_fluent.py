...
learning cards are cards with a current learning step of one or more days. '''
    ...
    def deck_config_complete(self, num: FluentVariable) -> str:
        r''' {$num}% complete. '''
        return self._translate(11, 30, {"num": num})
...
optimizing the parameters. '''
    ...
    def deck_config_confirm_remove_name(self, name: str) -> str:
        r''' Remove {$name}? '''
        return self._translate(11, 41, {"name": name})
    ...
    def deck_config_daily_limit_will_be_capped(self, cards: int) -> str:
        ...
        return self._translate(11, 44, {"cards": cards})
...
not work correctly if one of your clients is older. '''
    ...
    def deck_config_fsrs_params_no_reviews(self, ) -> str:
        r''' No reviews found. Please check that this preset is assigned to all decks you want to optimize (including subdecks) and try again. '''
...
the manual before changing this option. '''
    ...
    def deck_config_iterations(self, count: int) -> str:
        r''' Iteration: {$count}... '''
        return self._translate(11, 98, {"count": count})
...
The shorter you set this, the greater your workload will be. '''
    ...
    def deck_config_must_have_400_reviews(self, count: int) -> str:
        ...
        return self._translate(11, 112, {"count": count})
...
be at least 10x smaller than your review limit. '''
    ...
    def deck_config_optimizing_preset(self, current_count: int, total_count: int) -> str:
        ...
        return self._translate(11, 138, {"current_count": current_count, "total_count": total_count})
    ...
    def deck_config_percent_input(self, pct: str) -> str:
        r''' {$pct}% '''
        return self._translate(11, 140, {"pct": pct})


    def deck_config_percent_of_reviews(self, reviews: int, pct: str) -> str:
        r''' {$pct}% of {$reviews} reviews '''
        return self._translate(11, 141, {"reviews": reviews, "pct": pct})
    ...
    def deck_config_predicted_minimum_recommended_retention(self, num: FluentVariable) -> str:
        ...
        return self._translate(11, 143, {"num": num})


    def deck_config_predicted_optimal_retention(self, num: FluentVariable) -> str:
        r''' Minimum recommended retention: {$num} '''
        return self._translate(11, 144, {"num": num})
...
sort orders preferable. '''
    ...
    def deck_config_reviews_too_low(self, cards: int, expected: FluentVariable) -> str:
        ...
        return self._translate(11, 164, {"cards": cards, "expected": expected})
...
- `Today only`: Make a temporary change to this deck's limit. '''
    ...
    def deck_config_time_to_optimize(self, ) -> str:
        r''' It's been a while - using the Optimize All button is recommended. '''
    ...
    def deck_config_updating_cards(self, current_cards_count: int, total_cards_count: int) -> str:
        ...
        return self._translate(11, 206, {"current_cards_count": current_cards_count, "total_cards_count": total_cards_count})


    def deck_config_used_by_decks(self, decks: int) -> str:
        r''' used by {$decks} decks '''
        return self._translate(11, 207, {"decks": decks})
...
mapping tool. '''
    ...
    def importing_rows_had_num1d_fields_expected_num2d(self, row: str, found: FluentVariable, expected: FluentVariable) -> str:
        ...
        return self._translate(20, 97, {"row": row, "found": found, "expected": expected})
    ...
    def importing_unable_to_import_filename(self, filename: str) -> str:
        ...
        return self._translate(20, 115, {"filename": filename})
...
If you trust the deck author and wish to proceed, you can add `{$scheme}` to your allowed . '''
...
Please select  before proceeding. '''
    ...
    def statistics_memorized(self, memorized: str) -> str:
        ...
        return self._translate(32, 78, {"memorized": memorized})


    def statistics_minutes_per_day(self, count: int) -> str:
        r''' {$count} minutes/day '''
        return self._translate(32, 79, {"count": count})
    ...
    def statistics_notes(self, notes: int) -> str:
        r''' {$notes} notes '''
        return self._translate(32, 81, {"notes": notes})
    ...
    def statistics_retrievability_tooltip(self, cards: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 89, {"cards": cards, "percent": percent})


    def statistics_reviews(self, reviews: int) -> str:
        r''' {$reviews} reviews '''
        return self._translate(32, 90, {"reviews": reviews})
    ...
    def statistics_reviews_per_day(self, count: int) -> str:
        r''' {$count} reviews/day '''
        return self._translate(32, 92, {"count": count})
    ...
    def statistics_stability_day_range(self, cards: int, days_start: int, days_end: int) -> str:
        ...
        return self._translate(32, 99, {"cards": cards, "daysStart": days_start, "daysEnd": days_end})


    def statistics_stability_day_single(self, cards: int, day: FluentVariable) -> str:
        r''' {$cards} cards with a {$day} day stability '''
        return self._translate(32, 100, {"cards": cards, "day": day})
...
({$secs-per-card}s/card) '''
        return self._translate(32, 102, {"unit": unit, "secs-per-card": secs_per_card, "amount": amount, "cards": cards})
    ...
    def statistics_today_correct_mature(self, correct: int, total: int, percent: FluentVariable) -> str:
        ...
        return self._translate(32, 105, {"correct": correct, "total": total, "percent": percent})
    ...
    def statistics_today_type_counts(self, learn_count: int, review_count: int, relearn_count: int, filtered_count: int) -> str:
        ...
        return self._translate(32, 109, {"learnCount": learn_count, "reviewCount": review_count, "relearnCount": relearn_count, "filteredCount": filtered_count})
...
class LegacyTranslationEnum:
    ...
    DECK_CONFIG_ADVANCED_TITLE = (11, 3)
    DECK_CONFIG_AFFECTS_ENTIRE_COLLECTION = (11, 4)
    DECK_CONFIG_ALWAYS_INCLUDE_QUESTION_AUDIO_TOOLTIP = (11, 5)
    DECK_CONFIG_ANSWER_ACTION = (11, 6)
    DECK_CONFIG_ANSWER_ACTION_TOOLTIP = (11, 7)
    DECK_CONFIG_ANSWER_ACTION_TOOLTIP_2 = (11, 8)
    DECK_CONFIG_ANSWER_AGAIN = (11, 9)
    DECK_CONFIG_ANSWER_GOOD = (11, 10)
    DECK_CONFIG_ANSWER_HARD = (11, 11)
    DECK_CONFIG_APPLY_ALL_PARENT_LIMITS = (11, 12)
    DECK_CONFIG_APPLY_ALL_PARENT_LIMITS_TOOLTIP = (11, 13)
    DECK_CONFIG_AUDIO_TITLE = (11, 14)
    DECK_CONFIG_BURY_IF_NEW = (11, 15)
    DECK_CONFIG_BURY_IF_NEW_OR_REVIEW = (11, 16)
    DECK_CONFIG_BURY_IF_NEW_REVIEW_OR_INTERDAY = (11, 17)
    DECK_CONFIG_BURY_INTERDAY_LEARNING_SIBLINGS = (11, 18)
    DECK_CONFIG_BURY_INTERDAY_LEARNING_TOOLTIP = (11, 19)
    DECK_CONFIG_BURY_NEW_SIBLINGS = (11, 20)
    DECK_CONFIG_BURY_NEW_TOOLTIP = (11, 21)
    DECK_CONFIG_BURY_PRIORITY_TOOLTIP = (11, 22)
    DECK_CONFIG_BURY_REVIEW_SIBLINGS = (11, 23)
    DECK_CONFIG_BURY_REVIEW_TOOLTIP = (11, 24)
    DECK_CONFIG_BURY_SIBLINGS = (11, 25)
    DECK_CONFIG_BURY_TITLE = (11, 26)
    DECK_CONFIG_BURY_TOOLTIP = (11, 27)
    DECK_CONFIG_CLEAR_LAST_SIMULATE = (11, 28)
    DECK_CONFIG_CLONE_GROUP = (11, 29)
    DECK_CONFIG_COMPLETE = (11, 30)
    DECK_CONFIG_COMPUTE_BUTTON = (11, 31)
    DECK_CONFIG_COMPUTE_MINIMUM_RECOMMENDED_RETENTION = (11, 32)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION = (11, 33)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP = (11, 34)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP2 = (11, 35)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP3 = (11, 36)
    DECK_CONFIG_COMPUTE_OPTIMAL_RETENTION_TOOLTIP4 = (11, 37)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS = (11, 38)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS_TOOLTIP = (11, 39)
    DECK_CONFIG_COMPUTE_OPTIMAL_WEIGHTS_TOOLTIP2 = (11, 40)
    DECK_CONFIG_CONFIRM_REMOVE_NAME = (11, 41)
    DECK_CONFIG_CUSTOM_SCHEDULING = (11, 42)
    DECK_CONFIG_CUSTOM_SCHEDULING_TOOLTIP = (11, 43)
    DECK_CONFIG_DAILY_LIMIT_WILL_BE_CAPPED = (11, 44)
    DECK_CONFIG_DAILY_LIMITS = (11, 45)
    DECK_CONFIG_DAYS_TO_SIMULATE = (11, 46)
    DECK_CONFIG_DECK_ONLY = (11, 47)
    DECK_CONFIG_DEFAULT_NAME = (11, 48)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING = (11, 49)
    DECK_CONFIG_DESCRIPTION_NEW_HANDLING_HINT = (11, 50)
    DECK_CONFIG_DESIRED_RETENTION = (11, 51)
    DECK_CONFIG_DESIRED_RETENTION_BELOW_OPTIMAL = (11, 52)
    DECK_CONFIG_DESIRED_RETENTION_TOOLTIP = (11, 53)
    DECK_CONFIG_DISABLE_AUTOPLAY = (11, 54)
    DECK_CONFIG_DISABLE_AUTOPLAY_TOOLTIP = (11, 55)
    DECK_CONFIG_DISPLAY_ORDER_WILL_USE_CURRENT_DECK = (11, 56)
    DECK_CONFIG_DO_NOT_BURY = (11, 57)
    DECK_CONFIG_EASY_BONUS_TOOLTIP = (11, 58)
    DECK_CONFIG_EASY_DAYS_FRIDAY = (11, 59)
    DECK_CONFIG_EASY_DAYS_MINIMUM = (11, 60)
    DECK_CONFIG_EASY_DAYS_MONDAY = (11, 61)
    DECK_CONFIG_EASY_DAYS_NO_NORMAL_DAYS = (11, 62)
    DECK_CONFIG_EASY_DAYS_NORMAL = (11, 63)
    DECK_CONFIG_EASY_DAYS_REDUCED = (11, 64)
    DECK_CONFIG_EASY_DAYS_SATURDAY = (11, 65)
    DECK_CONFIG_EASY_DAYS_SUNDAY = (11, 66)
    DECK_CONFIG_EASY_DAYS_THURSDAY = (11, 67)
    DECK_CONFIG_EASY_DAYS_TITLE = (11, 68)
    DECK_CONFIG_EASY_DAYS_TUESDAY = (11, 69)
    DECK_CONFIG_EASY_DAYS_WEDNESDAY = (11, 70)
    DECK_CONFIG_EASY_INTERVAL_TOOLTIP = (11, 71)
    DECK_CONFIG_EVALUATE_BUTTON = (11, 72)
    DECK_CONFIG_FSRS_MUST_BE_ENABLED = (11, 73)
    DECK_CONFIG_FSRS_ON_ALL_CLIENTS = (11, 74)
    DECK_CONFIG_FSRS_PARAMS_NO_REVIEWS = (11, 75)
    DECK_CONFIG_FSRS_PARAMS_OPTIMAL = (11, 76)
    DECK_CONFIG_FSRS_SIMULATOR_EXPERIMENTAL = (11, 77)
    DECK_CONFIG_FSRS_SIMULATOR_RADIO_COUNT = (11, 78)
    DECK_CONFIG_FSRS_SIMULATOR_RADIO_MEMORIZED = (11, 79)
    DECK_CONFIG_FSRS_SIMULATOR_Y_AXIS_TITLE_COUNT = (11, 80)
    DECK_CONFIG_FSRS_SIMULATOR_Y_AXIS_TITLE_MEMORIZED = (11, 81)
    DECK_CONFIG_FSRS_SIMULATOR_Y_AXIS_TITLE_TIME = (11, 82)
    DECK_CONFIG_FSRS_TOOLTIP = (11, 83)
    DECK_CONFIG_GET_PARAMS = (11, 84)
    DECK_CONFIG_GOOD_ABOVE_EASY = (11, 85)
    DECK_CONFIG_GRADUATING_INTERVAL_TOOLTIP = (11, 86)
    DECK_CONFIG_HARD_INTERVAL_TOOLTIP = (11, 87)
    DECK_CONFIG_HISTORICAL_RETENTION = (11, 88)
    DECK_CONFIG_HISTORICAL_RETENTION_TOOLTIP = (11, 89)
    DECK_CONFIG_IGNORE_BEFORE = (11, 90)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP = (11, 91)
    DECK_CONFIG_IGNORE_BEFORE_TOOLTIP_2 = (11, 92)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY = (11, 93)
    DECK_CONFIG_INTERDAY_STEP_PRIORITY_TOOLTIP = (11, 94)
    DECK_CONFIG_INTERVAL_MODIFIER_TOOLTIP = (11, 95)
    DECK_CONFIG_INVALID_PARAMETERS = (11, 96)
    DECK_CONFIG_INVALID_WEIGHTS = (11, 97)
    DECK_CONFIG_ITERATIONS = (11, 98)
    DECK_CONFIG_LEARNING_STEP_ABOVE_GRADUATING_INTERVAL = (11, 99)
    DECK_CONFIG_LEARNING_STEPS = (11, 100)
    DECK_CONFIG_LEARNING_STEPS_TOOLTIP = (11, 101)
    DECK_CONFIG_LEECH_ACTION_TOOLTIP = (11, 102)
    DECK_CONFIG_LEECH_THRESHOLD_TOOLTIP = (11, 103)
    DECK_CONFIG_LIMIT_DECK_V3 = (11, 104)
    DECK_CONFIG_LIMIT_INTERDAY_BOUND_BY_REVIEWS = (11, 105)
    DECK_CONFIG_LIMIT_NEW_BOUND_BY_REVIEWS = (11, 106)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS = (11, 107)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_ABOVE_RECOMMENDED = (11, 108)
    DECK_CONFIG_MAXIMUM_ANSWER_SECS_TOOLTIP = (11, 109)
    DECK_CONFIG_MAXIMUM_INTERVAL_TOOLTIP = (11, 110)
    DECK_CONFIG_MINIMUM_INTERVAL_TOOLTIP = (11, 111)
    DECK_CONFIG_MUST_HAVE_400_REVIEWS = (11, 112)
    DECK_CONFIG_NAME_PROMPT = (11, 113)
    DECK_CONFIG_NEW_CARD_SORT_ORDER = (11, 114)
    DECK_CONFIG_NEW_CARD_SORT_ORDER_TOOLTIP_2 = (11, 115)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT = (11, 116)
    DECK_CONFIG_NEW_CARDS_IGNORE_REVIEW_LIMIT_TOOLTIP = (11, 117)
    DECK_CONFIG_NEW_GATHER_PRIORITY = (11, 118)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK = (11, 119)
    DECK_CONFIG_NEW_GATHER_PRIORITY_DECK_THEN_RANDOM_NOTES = (11, 120)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_HIGHEST_FIRST = (11, 121)
    DECK_CONFIG_NEW_GATHER_PRIORITY_POSITION_LOWEST_FIRST = (11, 122)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_CARDS = (11, 123)
    DECK_CONFIG_NEW_GATHER_PRIORITY_RANDOM_NOTES = (11, 124)
    DECK_CONFIG_NEW_GATHER_PRIORITY_TOOLTIP_2 = (11, 125)
    DECK_CONFIG_NEW_INSERTION_ORDER = (11, 126)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM = (11, 127)
    DECK_CONFIG_NEW_INSERTION_ORDER_RANDOM_WITH_V3 = (11, 128)
    DECK_CONFIG_NEW_INSERTION_ORDER_SEQUENTIAL = (11, 129)
    DECK_CONFIG_NEW_INSERTION_ORDER_TOOLTIP = (11, 130)
    DECK_CONFIG_NEW_INTERVAL_TOOLTIP = (11, 131)
    DECK_CONFIG_NEW_LIMIT_TOOLTIP = (11, 132)
    DECK_CONFIG_NEW_REVIEW_PRIORITY = (11, 133)
    DECK_CONFIG_NEW_REVIEW_PRIORITY_TOOLTIP = (11, 134)
    DECK_CONFIG_NOT_ENOUGH_HISTORY = (11, 135)
    DECK_CONFIG_OPTIMIZE_ALL_TIP = (11, 136)
    DECK_CONFIG_OPTIMIZE_BUTTON = (11, 137)
    DECK_CONFIG_OPTIMIZING_PRESET = (11, 138)
    DECK_CONFIG_ORDERING_TITLE = (11, 139)
    DECK_CONFIG_PERCENT_INPUT = (11, 140)
    DECK_CONFIG_PERCENT_OF_REVIEWS = (11, 141)
    DECK_CONFIG_PLEASE_SAVE_YOUR_CHANGES_FIRST = (11, 142)
    DECK_CONFIG_PREDICTED_MINIMUM_RECOMMENDED_RETENTION = (11, 143)
    DECK_CONFIG_PREDICTED_OPTIMAL_RETENTION = (11, 144)
    DECK_CONFIG_QUESTION_ACTION = (11, 145)
    DECK_CONFIG_QUESTION_ACTION_SHOW_ANSWER = (11, 146)
    DECK_CONFIG_QUESTION_ACTION_SHOW_REMINDER = (11, 147)
    DECK_CONFIG_QUESTION_ACTION_TOOL_TIP = (11, 148)
    DECK_CONFIG_RELEARNING_STEPS = (11, 149)
    DECK_CONFIG_RELEARNING_STEPS_ABOVE_MINIMUM_INTERVAL = (11, 150)
    DECK_CONFIG_RELEARNING_STEPS_TOOLTIP = (11, 151)
    DECK_CONFIG_REMOVE_GROUP = (11, 152)
    DECK_CONFIG_RENAME_GROUP = (11, 153)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE = (11, 154)
    DECK_CONFIG_RESCHEDULE_CARDS_ON_CHANGE_TOOLTIP = (11, 155)
    DECK_CONFIG_RESCHEDULE_CARDS_WARNING = (11, 156)
    DECK_CONFIG_REVERT_BUTTON_TOOLTIP = (11, 157)
    DECK_CONFIG_REVIEW_LIMIT_TOOLTIP = (11, 158)
    DECK_CONFIG_REVIEW_MIX_MIX_WITH_REVIEWS = (11, 159)
    DECK_CONFIG_REVIEW_MIX_SHOW_AFTER_REVIEWS = (11, 160)
    DECK_CONFIG_REVIEW_MIX_SHOW_BEFORE_REVIEWS = (11, 161)
    DECK_CONFIG_REVIEW_SORT_ORDER = (11, 162)
    DECK_CONFIG_REVIEW_SORT_ORDER_TOOLTIP = (11, 163)
    DECK_CONFIG_REVIEWS_TOO_LOW = (11, 164)
    DECK_CONFIG_SAVE_AND_OPTIMIZE = (11, 165)
    DECK_CONFIG_SAVE_BUTTON = (11, 166)
    DECK_CONFIG_SAVE_TO_ALL_SUBDECKS = (11, 167)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER = (11, 168)
    DECK_CONFIG_SECONDS_TO_SHOW_ANSWER_TOOLTIP_2 = (11, 169)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION = (11, 170)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP = (11, 171)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_2 = (11, 172)
    DECK_CONFIG_SECONDS_TO_SHOW_QUESTION_TOOLTIP_3 = (11, 173)
    DECK_CONFIG_SHARED_PRESET = (11, 174)
    DECK_CONFIG_SHOW_ANSWER_TIMER_TOOLTIP = (11, 175)
    DECK_CONFIG_SHOW_REMINDER = (11, 176)
    DECK_CONFIG_SIMULATE = (11, 177)
    DECK_CONFIG_SKIP_QUESTION_WHEN_REPLAYING = (11, 178)
    DECK_CONFIG_SMALLER_IS_BETTER = (11, 179)
    DECK_CONFIG_SORT_ORDER_ASCENDING_DIFFICULTY = (11, 180)
    DECK_CONFIG_SORT_ORDER_ASCENDING_EASE = (11, 181)
    DECK_CONFIG_SORT_ORDER_ASCENDING_INTERVALS = (11, 182)
    DECK_CONFIG_SORT_ORDER_CARD_TEMPLATE_THEN_RANDOM = (11, 183)
    DECK_CONFIG_SORT_ORDER_DECK_THEN_DUE_DATE = (11, 184)
    DECK_CONFIG_SORT_ORDER_DESCENDING_DIFFICULTY = (11, 185)
    DECK_CONFIG_SORT_ORDER_DESCENDING_EASE = (11, 186)
    DECK_CONFIG_SORT_ORDER_DESCENDING_INTERVALS = (11, 187)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_DECK = (11, 188)
    DECK_CONFIG_SORT_ORDER_DUE_DATE_THEN_RANDOM = (11, 189)
    DECK_CONFIG_SORT_ORDER_GATHER = (11, 190)
    DECK_CONFIG_SORT_ORDER_RANDOM = (11, 191)
    DECK_CONFIG_SORT_ORDER_RANDOM_NOTE_THEN_TEMPLATE = (11, 192)
    DECK_CONFIG_SORT_ORDER_RETRIEVABILITY_ASCENDING = (11, 193)
    DECK_CONFIG_SORT_ORDER_RETRIEVABILITY_DESCENDING = (11, 194)
    DECK_CONFIG_SORT_ORDER_TEMPLATE_THEN_GATHER = (11, 195)
    DECK_CONFIG_STARTING_EASE_TOOLTIP = (11, 196)
    DECK_CONFIG_STEPS_TOO_LARGE_FOR_FSRS = (11, 197)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER = (11, 198)
    DECK_CONFIG_STOP_TIMER_ON_ANSWER_TOOLTIP = (11, 199)
    DECK_CONFIG_TAB_DESCRIPTION = (11, 200)
    DECK_CONFIG_TIME_TO_OPTIMIZE = (11, 201)
    DECK_CONFIG_TIMER_TITLE = (11, 202)
    DECK_CONFIG_TITLE = (11, 203)
    DECK_CONFIG_TODAY_ONLY = (11, 204)
    DECK_CONFIG_UNABLE_TO_DETERMINE_DESIRED_RETENTION = (11, 205)
    DECK_CONFIG_UPDATING_CARDS = (11, 206)
    DECK_CONFIG_USED_BY_DECKS = (11, 207)
    DECK_CONFIG_WAIT_FOR_AUDIO = (11, 208)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP = (11, 209)
    DECK_CONFIG_WAIT_FOR_AUDIO_TOOLTIP_2 = (11, 210)
    DECK_CONFIG_WEIGHTS = (11, 211)
    DECK_CONFIG_WEIGHTS_TOOLTIP = (11, 212)
    DECK_CONFIG_WEIGHTS_TOOLTIP2 = (11, 213)
    DECK_CONFIG_WHICH_DECK = (11, 214)
    DECK_CONFIG_WILL_REQUIRE_FULL_SYNC = (11, 215)
    ...
    IMPORTING_PREVIEW_TRUNCATED = (20, 93)
    IMPORTING_PROCESSED_CARDS = (20, 94)
    IMPORTING_PROCESSED_MEDIA_FILE = (20, 95)
    IMPORTING_PROCESSED_NOTES = (20, 96)
    IMPORTING_ROWS_HAD_NUM1D_FIELDS_EXPECTED_NUM2D = (20, 97)
    IMPORTING_SELECTED_FILE_WAS_NOT_IN_UTF8 = (20, 98)
    IMPORTING_SEMICOLON = (20, 99)
    IMPORTING_SHOW = (20, 100)
    IMPORTING_SKIPPED = (20, 101)
    IMPORTING_STATUS = (20, 102)
    IMPORTING_SUPERMEMO_XML_EXPORT_XML = (20, 103)
    IMPORTING_TAB = (20, 104)
    IMPORTING_TAG_ALL_NOTES = (20, 105)
    IMPORTING_TAG_ALL_NOTES_HELP = (20, 106)
    IMPORTING_TAG_MODIFIED_NOTES = (20, 107)
    IMPORTING_TAG_UPDATED_NOTES = (20, 108)
    IMPORTING_TAG_UPDATED_NOTES_HELP = (20, 109)
    IMPORTING_TEXT_SEPARATED_BY_TABS_OR_SEMICOLONS = (20, 110)
    IMPORTING_THE_FIRST_FIELD_OF_THE_NOTE = (20, 111)
    IMPORTING_THE_PROVIDED_FILE_IS_NOT_A = (20, 112)
    IMPORTING_THIS_FILE_DOES_NOT_APPEAR_TO = (20, 113)
    IMPORTING_THIS_WILL_DELETE_YOUR_EXISTING_COLLECTION = (20, 114)
    IMPORTING_UNABLE_TO_IMPORT_FILENAME = (20, 115)
    IMPORTING_UNABLE_TO_IMPORT_FROM_A_READONLY = (20, 116)
    IMPORTING_UNKNOWN_FILE_FORMAT = (20, 117)
    IMPORTING_UPDATE = (20, 118)
    IMPORTING_UPDATE_ALWAYS = (20, 119)
    IMPORTING_UPDATE_EXISTING_NOTES_WHEN_FIRST_FIELD = (20, 120)
    IMPORTING_UPDATE_IF_NEWER = (20, 121)
    IMPORTING_UPDATE_NEVER = (20, 122)
    IMPORTING_UPDATE_NOTES = (20, 123)
    IMPORTING_UPDATE_NOTES_HELP = (20, 124)
    IMPORTING_UPDATE_NOTETYPES = (20, 125)
    IMPORTING_UPDATE_NOTETYPES_HELP = (20, 126)
    IMPORTING_UPDATED = (20, 127)
    IMPORTING_UPDATES = (20, 128)
    IMPORTING_WITH_DECK_CONFIGS = (20, 129)
    IMPORTING_WITH_DECK_CONFIGS_HELP = (20, 130)
    KEYBOARD_CTRL = (21, 0)
    KEYBOARD_SHIFT = (21, 1)
    ...
    STATISTICS_MEMORIZED = (32, 78)
    STATISTICS_MINUTES_PER_DAY = (32, 79)
    STATISTICS_NO_DATA = (32, 80)
    STATISTICS_NOTES = (32, 81)
    STATISTICS_RANGE_1_YEAR_HISTORY = (32, 82)
    STATISTICS_RANGE_ALL_HISTORY = (32, 83)
    STATISTICS_RANGE_ALL_TIME = (32, 84)
    STATISTICS_RANGE_COLLECTION = (32, 85)
    STATISTICS_RANGE_DECK = (32, 86)
    STATISTICS_RANGE_SEARCH = (32, 87)
    STATISTICS_RETRIEVABILITY_SUBTITLE = (32, 88)
    STATISTICS_RETRIEVABILITY_TOOLTIP = (32, 89)
    STATISTICS_REVIEWS = (32, 90)
    STATISTICS_REVIEWS_COUNT_SUBTITLE = (32, 91)
    STATISTICS_REVIEWS_PER_DAY = (32, 92)
    STATISTICS_REVIEWS_TIME_CHECKBOX = (32, 93)
    STATISTICS_REVIEWS_TIME_SUBTITLE = (32, 94)
    STATISTICS_REVIEWS_TITLE = (32, 95)
    STATISTICS_RUNNING_TOTAL = (32, 96)
    STATISTICS_SAVE_PDF = (32, 97)
    STATISTICS_SAVED = (32, 98)
    STATISTICS_STABILITY_DAY_RANGE = (32, 99)
    STATISTICS_STABILITY_DAY_SINGLE = (32, 100)
    STATISTICS_STATS = (32, 101)
    STATISTICS_STUDIED_TODAY = (32, 102)
    STATISTICS_TITLE = (32, 103)
    STATISTICS_TODAY_AGAIN_COUNT = (32, 104)
    STATISTICS_TODAY_CORRECT_MATURE = (32, 105)
    STATISTICS_TODAY_NO_CARDS = (32, 106)
    STATISTICS_TODAY_NO_MATURE_CARDS = (32, 107)
    STATISTICS_TODAY_TITLE = (32, 108)
    STATISTICS_TODAY_TYPE_COUNTS = (32, 109)
    STATISTICS_TOTAL = (32, 110)
    STATISTICS_TRUE_RETENTION_ALL = (32, 111)
    STATISTICS_TRUE_RETENTION_ALL_TIME = (32, 112)
    STATISTICS_TRUE_RETENTION_COUNT = (32, 113)
    STATISTICS_TRUE_RETENTION_FAIL = (32, 114)
    STATISTICS_TRUE_RETENTION_MATURE = (32, 115)
    STATISTICS_TRUE_RETENTION_MONTH = (32, 116)
    STATISTICS_TRUE_RETENTION_NOT_APPLICABLE = (32, 117)
    STATISTICS_TRUE_RETENTION_PASS = (32, 118)
    STATISTICS_TRUE_RETENTION_RANGE = (32, 119)
    STATISTICS_TRUE_RETENTION_RETENTION = (32, 120)
    STATISTICS_TRUE_RETENTION_SUBTITLE = (32, 121)
    STATISTICS_TRUE_RETENTION_TITLE = (32, 122)
    STATISTICS_TRUE_RETENTION_TODAY = (32, 123)
    STATISTICS_TRUE_RETENTION_TOTAL = (32, 124)
    STATISTICS_TRUE_RETENTION_WEEK = (32, 125)
    STATISTICS_TRUE_RETENTION_YEAR = (32, 126)
    STATISTICS_TRUE_RETENTION_YESTERDAY = (32, 127)
    STATISTICS_TRUE_RETENTION_YOUNG = (32, 128)
    STUDYING_AGAIN = (33, 0)
