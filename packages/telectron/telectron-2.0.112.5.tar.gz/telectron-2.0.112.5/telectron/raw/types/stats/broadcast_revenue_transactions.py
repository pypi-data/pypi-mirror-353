...
class BroadcastRevenueTransactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~telectron.raw.base.stats.BroadcastRevenueTransactions`.
    ...
    Parameters:
        ...
        transactions (List of :obj:`BroadcastRevenueTransaction <telectron.raw.base.BroadcastRevenueTransaction>`):
            N/A
