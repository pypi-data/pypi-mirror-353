...
class PCS:
    ...
    def get_pcs_label(self, llm_labels, w_llms=None, w_mrs=None, possible_labels=None):
        ...
        for i in range(len(w_llms)):
            ...
            print("pcs_label_llm", pcs_label_llm)
            if sum(w_mrs) != 0:
    ...
    def LR(self):
        ...
        model = LinearRegression()  # Ensure positive weights
        model.fit(X, y)
        ...
        if "LLM" in optimize_params and "MR" in optimize_params:
            ...
            print("reshaped_weights", reshaped_weights)
            ...
            print("optimal_llm_weights", optimal_llm_weights)
            print("optimal_mr_weights", optimal_mr_weights)
        elif "LLM" in optimize_params:
            # Only optimize LLM weights
        ...
        print("normalized optimal_llm_weights", optimal_llm_weights)
        ...
        print("final: ", optimal_mr_weights, optimal_llm_weights)
