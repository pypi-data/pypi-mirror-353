...
def get_oauth_credentials():
    ...
    token_path = GOOGLE_ADS_CREDENTIALS_PATH or "/tmp/google_ads_token.json"
    if GOOGLE_ADS_CREDENTIALS_PATH and os.path.exists(token_path) and not os.path.basename(token_path).endswith('.json'):
    ...
    if GOOGLE_ADS_CREDENTIALS_PATH and os.path.exists(token_path):
        try:
