...
class SDLC_DATABRICKS():
    ...
    def generate_pyspark_code(self):
        ...
        try:
            ...
            - Refine the code to match requirements of the technical requirement, donot create random schemas, use inferschema.
            - Use PySpark APIs for data processing.
            - Handle large datasets efficiently.
            - Include transformation, cleaning, and aggregation steps if required based on technical requirement.
            - Follow best practices for PySpark.
            - Provide examples of how to execute the code on a Spark cluster.
            - Write proper imports and pip install magic command.
            ...
            - If generating PySpark, use appropriate DataFrame operations, transformations, and UDFs. Check if the classes derived from imports exist.
            ...
            - Create directory structure based on the databricks directory structure, i.e in single src folder, put the pipeline files, test folder should contain test files.
            - Write mandatorily a set of realistic test cases. Generate sample input data to check the test.
            - Create simple code, donot create too many files in a folder, try to put config, connections in single file to avoid confusion. For example, if config and main code can be kept in single file, donot create multiple files.
            - When generating Python code, do not include src. or any other package prefix in import statements. Use relative imports suitable for Databricks notebooks, where modules are imported directly by their folder/module names (e.g., from module1 import ClassName instead of from src.module1 import ClassName). Assume all modules are available in the same project folder or workspace context.
            ...
            │   └── ...
            │
            ├── requirements.txt      # Project dependencies, keep only required libraries
