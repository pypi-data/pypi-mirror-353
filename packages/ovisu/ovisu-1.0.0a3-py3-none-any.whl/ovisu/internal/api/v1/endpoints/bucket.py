...
from ovisu.internal.api.dependencies.auth import get_auth_user_or_error
from ovisu.internal.api.v1.schema.request.bucket import (
    BucketCreateBody,
    BucketUpdateBody,
    BucketUpdatePayload,
)
from ovisu.internal.api.v1.schema.response import ItemResponse, ListResponse, OkResponse
from ovisu.internal.api.v1.schema.response.bucket import BucketResponse, PathType
from ovisu.internal.common.db import get_db
from ovisu.internal.common.exceptions import AppEx, ErrorCode
from ovisu.internal.config import settings
from ovisu.internal.crud.bucket import bucket_crud
from ovisu.internal.crud.keychain import keychain_crud
from ovisu.internal.models.user import User
from ovisu.internal.service.bucket import (
    get_bucket,
    get_buckets_or_objects,
    preview_file,
)
from ovisu.internal.utils import ping_host, validate_path_accessibility
from ovisu.internal.utils.path import is_s3_path, split_s3_path
