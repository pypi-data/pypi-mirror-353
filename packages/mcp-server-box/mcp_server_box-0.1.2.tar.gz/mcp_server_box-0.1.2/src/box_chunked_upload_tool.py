...
from box_sdk_gen import BoxAPIError as BoxAPIException
...
async def box_chunked_upload_tool(
    ...
    """
    # Import BoxContext here to avoid circular import
...
# Import moved to avoid circular import - BoxContext is imported inside functions where needed