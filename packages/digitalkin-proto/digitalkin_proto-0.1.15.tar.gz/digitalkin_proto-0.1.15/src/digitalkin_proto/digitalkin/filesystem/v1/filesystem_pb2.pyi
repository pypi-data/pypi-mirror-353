...
class File(_message.Message):
    __slots__ = ("file_id", "context", "name", "file_type", "content_type", "size_bytes", "checksum", "metadata", "storage_url", "status", "content")
