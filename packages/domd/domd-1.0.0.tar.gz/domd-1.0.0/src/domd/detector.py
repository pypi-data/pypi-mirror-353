...
class ProjectCommandDetector:
        ...
        if not suggestions:
            suggestions.extend(
                [
                    ...
                    "Consider if this command should be added to .domdignore",
                ]
            )
    ...
    def scan_and_initialize(self) -> List[Dict]:
        ...
        if ignore_file_path.exists():
            print("📋 Found .domdignore file with ignore rules")
        else:
            print("💡 No .domdignore file found - create one to skip specific commands")
    ...
    def test_commands(self, commands: List[Dict]) -> None:
        ...
        print(f"   🚫 Ignored: {len(self.ignored_commands)} (via .domdignore)")
