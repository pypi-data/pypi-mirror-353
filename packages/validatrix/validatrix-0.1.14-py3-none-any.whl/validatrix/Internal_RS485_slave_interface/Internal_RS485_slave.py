...
class Internal_RS485_slave_class:
    def __init__(self,name=None,device_name=None,slave_address=None,
        ...
        self.coils = ModbusSequentialDataBlock(1, [0] * 10000)
        self.discrete_inputs = ModbusSequentialDataBlock(1, [0] * 10000)
    ...
    def data_to_words(value, byteorder='<',wordorder='<',size=2,data_type='Float32'):
        ...
        hex_val= hex(struct.unpack(unpack_format, struct.pack(pack_format, value))[0])    
