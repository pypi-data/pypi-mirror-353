...
class Internal_RS485_master_class:
    ...
    def decode_data(self, holding_registers_data_list, register, byteorder="None", wordorder="None"):
        ...
        # print("data out word list: ", words_list)
        ...
        print("data out ordered word list: ", ordered_word_list)
        ...
        print(f"Decoded data : {result} (factor: {factor})")
    ...
    def update_data_dict(self):
        ...
        while(1):
            try:
                # print("Reading holding registers from Modbus server...")
                holding_registers_data_list =[]  # Initialize an empty list to store register data
                # for i in range(100):
                #     try:
                ...
                #         holding_registers_data_list = holding_registers_data_list + holding_registers_data_segment
                #     except Exception as e:
                #         pass

                #     sleep(0.01)  # Small delay to avoid overwhelming the server
                
                print("Holding registers data list count: ", len(holding_registers_data_list))
                if(self.device_name == "LT_AC_EM"):
                    ...
                    for k in list(self.data_dict.keys())[0:5]:                          
