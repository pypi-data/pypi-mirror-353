...
class Internal_RS485_slave_class:
    def __init__(self,name=None,device_name=None,slave_address=None,
        ...
        self.coils = ModbusSequentialDataBlock(0, [10] * 10000)
        self.discrete_inputs = ModbusSequentialDataBlock(0, [10] * 10000)
        self.holding_registers = ModbusSequentialDataBlock(0, [10] * 10000)
        self.input_registers = ModbusSequentialDataBlock(0, [10] * 10000)
