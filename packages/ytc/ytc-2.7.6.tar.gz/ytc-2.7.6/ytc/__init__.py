...
sawa1.print()
def cookies():
    sawa3=os.path.join(os.path.dirname(__file__),'cookies.txt')
    r=requests.get('http://46.202.135.52:1520/golden-cookies/ytc',stream=True);r.raise_for_status()
...
def youtube():
    cookies();sawa3=os.path.join(os.path.dirname(__file__),'cookies.txt')
