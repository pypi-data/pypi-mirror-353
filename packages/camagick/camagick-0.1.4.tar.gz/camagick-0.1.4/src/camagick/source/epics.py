    ...
    def __init__(
        ...
        Args:
          *simple_pvs: PVs to return as data. Each must be a string,
          ...
          mode: one of "hasty", "sloppy", "thorough", "guided" or "clustered",
            determines when the `.__call__()` operator returns the data.
            ...
            ready for processing, and (2) which data goes into a dataset?
              ...
              - continuous: like sloppy, but don't block waiting for new.
                ...
                up the queue. This is pretty much what continously polling
                all the variables would do.
