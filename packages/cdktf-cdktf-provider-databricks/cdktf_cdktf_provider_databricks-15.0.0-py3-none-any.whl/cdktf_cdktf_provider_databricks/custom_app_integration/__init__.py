...
class CustomAppIntegration(
    ...
    def __init__(
        ...
        *,
        ...
        :param client_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#client_id CustomAppIntegration#client_id}.
        :param client_secret: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#client_secret CustomAppIntegration#client_secret}.
        :param confidential: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#confidential CustomAppIntegration#confidential}.
        :param created_by: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#created_by CustomAppIntegration#created_by}.
        :param create_time: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#create_time CustomAppIntegration#create_time}.
        :param creator_username: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#creator_username CustomAppIntegration#creator_username}.
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#id CustomAppIntegration#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param integration_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#integration_id CustomAppIntegration#integration_id}.
        :param name: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#name CustomAppIntegration#name}.
        :param redirect_urls: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#redirect_urls CustomAppIntegration#redirect_urls}.
        :param scopes: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#scopes CustomAppIntegration#scopes}.
        :param token_access_policy: token_access_policy block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#token_access_policy CustomAppIntegration#token_access_policy}
        :param user_authorized_scopes: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#user_authorized_scopes CustomAppIntegration#user_authorized_scopes}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing CustomAppIntegration that should be imported. Refer to the {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#import import section} in the documentation of this resource for the id to use
    ...
    def put_token_access_policy(
        ...
        *,
        ...
        '''
        :param access_token_ttl_in_minutes: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#access_token_ttl_in_minutes CustomAppIntegration#access_token_ttl_in_minutes}.
        :param refresh_token_ttl_in_minutes: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/databricks/databricks/1.82.0/docs/resources/custom_app_integration#refresh_token_ttl_in_minutes CustomAppIntegration#refresh_token_ttl_in_minutes}.
        '''
