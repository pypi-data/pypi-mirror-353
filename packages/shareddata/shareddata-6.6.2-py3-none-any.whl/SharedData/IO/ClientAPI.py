...
class ClientAPI:
    ...
    def get_table(database, period, source, tablename, 
        ...
        if load_all_pages:
            ...
            for current_page in tqdm(range(2, total_pages + 1), desc="Downloading data:"):
    ...
    def post_table(database, period, source, tablename, 
        ...
        if not value is None:
            ...
            if value.shape[0] > maxrows:
                ...
                for ichunk in tqdm(range(nchunks), desc='Uploading data'):
    ...
    def post_collection(database, period, source, tablename, 
        ...
        if isinstance(value, list) and len(value) > 0:
            ...
            for ichunk in tqdm(range(nchunks), desc='Uploading collection'):
