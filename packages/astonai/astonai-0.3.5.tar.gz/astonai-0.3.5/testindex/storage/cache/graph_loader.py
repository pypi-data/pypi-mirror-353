...
from testindex.storage.cache.micro_cache import MicroCache, CacheConfig
...
class GraphDataLoader:
    ...
    def load_from_offline_json(self, 
        ...
        if knowledge_graph_dir is None:
            knowledge_graph_dir = self.path_resolver.repo_root() / ".testindex" / "knowledge_graph"
        else:
...
def load_and_warm_cache(config: Dict[str, Any], 
    ...
    """
    from testindex.storage.cache.micro_cache import get_micro_cache
