...
| `MCP_HOST` | Web UI 主機名 | 有效的主機名/IP | `127.0.0.1` |
| `MCP_PORT` | Web UI 端口 | 有效端口號 | `8765` |
...
# 指定 Web UI 主機和端口
uvx mcp-feedback-enhanced@latest test --web --host=0.0.0.0 --port=8888    # 指定主機和端口
MCP_HOST=0.0.0.0 MCP_PORT=8888 uvx mcp-feedback-enhanced@latest test      # 通過環境變數指定
