...
class EquipmentRequestType(models.Model):
    ...
    inbound_warehouse_ids = fields.Many2many(
        relation="rel_equipment_request_type_2_inbound_warehouse",
        column1="type_id",
        column2="warehouse_id",
    )
    outbound_warehouse_ids = fields.Many2many(
        relation="rel_equipment_request_type_2_outbound_warehouse",
        column1="type_id",
        column2="warehouse_id",
    )
    route_ids = fields.Many2many(
        relation="rel_equipment_request_type_2_route",
        column1="type_id",
        column2="route_id",
    )
    inbound_location_ids = fields.Many2many(
        relation="rel_equipment_request_type_2_inbound_location",
        column1="type_id",
        column2="location_id",
    )
    outbound_location_ids = fields.Many2many(
        relation="rel_equipment_request_type_2_outbound_location",
        column1="type_id",
        column2="location_id",
    )
