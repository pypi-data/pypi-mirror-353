...
def predict_sa(smiles, model_path=None, standardized=False):
    ...
    return {
        "DeepSA_score": result.iloc[0][sa_column],  # Synthetic accessibility score
...
def predict_sa_from_file(file_or_df, model_path=None, standardized=False, output_path=None):
    ...
    # Add DeepSA_score column for consistency
    if sa_column != 'DeepSA_score':
        result['DeepSA_score'] = result[sa_column]
