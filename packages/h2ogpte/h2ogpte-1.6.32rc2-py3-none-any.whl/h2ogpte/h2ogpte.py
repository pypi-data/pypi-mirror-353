...
class H2OGPTE(H2OGPTESyncBase):
    ...
    def answer_question(
        ...
        **kwargs: Any,
        ...
        response = _rest_to_client_exceptions(
            lambda: self._model_api.answer_question(
    ...
    def summarize_content(
        ...
        **kwargs: Any,
        ...
        model_name = self.get_llm_name_for_rest(llm)
        response = _rest_to_client_exceptions(
            lambda: self._model_api.summarize_content(
                model_name=model_name,
    ...
    def extract_data(
        ...
        **kwargs: Any,
        ...
        model_name = self.get_llm_name_for_rest(llm)
        response = _rest_to_client_exceptions(
            lambda: self._model_api.extract_data(
                model_name=model_name,
    ...
    def cancel_job(self, job_id: str) -> Result:
        ...
        _rest_to_client_exceptions(
            lambda: self._job_api.cancel_job(job_id=job_id, _headers=header)
        )
    ...
    def cancel_user_job(self, job_id: str) -> Result:
        ...
        _rest_to_client_exceptions(
            lambda: self._job_api.cancel_user_job(job_id=job_id, _headers=header)
        )
    ...
    def count_chat_sessions(self) -> int:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.get_chat_session_count(_headers=header)
        )
    ...
    def count_chat_sessions_for_collection(self, collection_id: str) -> int:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.get_chat_session_count_for_collection(
    ...
    def count_collections(self) -> int:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.get_collection_count(_headers=header)
        )
        return response.count
    ...
    def count_documents(self) -> int:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._document_api.get_document_count(_headers=header)
        )
        return response.count
    ...
    def count_documents_owned_by_me(self) -> int:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._document_api.get_document_count(owned=True, _headers=header)
        )
        return response.count
    ...
    def count_documents_in_collection(self, collection_id: str) -> int:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.get_document_count_for_collection(
                collection_id=collection_id, _headers=header
            )
        )
        return response.count
    ...
    def create_chat_session(self, collection_id: Optional[str] = None) -> str:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.create_chat_session(
                collection_id=collection_id, _headers=header
            )
        )
        return response.id
    ...
    def list_embedding_models(self) -> List[str]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.list_embedding_models(_headers=header)
        )
    ...
    def run_selftest(self, llm: str, mode: str) -> dict:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.run_model_self_test(
    ...
    def get_guardrails_settings(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.create_guardrails_settings(
    ...
    def get_agent_tools_dict(self) -> dict:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._agent_api.list_agent_tools(_headers=header)
        )
    ...
    def create_collection(
        ...
        collection = _rest_to_client_exceptions(
            lambda: self._collection_api.create_collection(request, _headers=headers)
        )
    ...
    def set_collection_thumbnail(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.create_update_collection_thumbnail_job(
    ...
    def remove_collection_thumbnail(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.create_delete_collection_thumbnail_job(
                collection_id=collection_id, _headers=header
            )
        )
        return self._wait_for_completion(response.id, timeout=timeout)
    ...
    def create_topic_model(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.create_topic_model_job(
    ...
    def delete_chat_sessions(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.create_delete_chat_session_job(
    ...
    def delete_chat_messages(self, chat_message_ids: Iterable[str]) -> Result:
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._chat_api.delete_messages(
    ...
    def delete_document_summaries(self, summaries_ids: Iterable[str]) -> Result:
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._document_api.delete_document_summaries(
    ...
    def get_collection_questions(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.list_questions_for_collection(
    ...
    def get_chat_session_questions(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.list_questions_for_chat_session(
    ...
    def set_collection_expiry_date(
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._collection_api.update_collection_expiry_date(
                collection_id=collection_id,
    ...
    def remove_collection_expiry_date(self, collection_id: str) -> str:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._collection_api.delete_collection_expiry_date(
                collection_id=collection_id, _headers=header
            )
        )
        return collection_id
    ...
    def set_collection_inactivity_interval(
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._collection_api.update_collection_inactivity_interval(
                collection_id=collection_id,
    ...
    def remove_collection_inactivity_interval(self, collection_id: str) -> str:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._collection_api.delete_collection_inactivity_interval(
                collection_id=collection_id, _headers=header
            )
        )
        return collection_id
    ...
    def set_collection_size_limit(
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._collection_api.set_collection_size_limit(
                collection_id=collection_id,
    ...
    def remove_collection_size_limit(self, collection_id: str) -> str:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._collection_api.remove_collection_size_limit(
                collection_id=collection_id,
                _headers=header,
            )
        )
    ...
    def unarchive_collection(self, collection_id: str) -> str:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._collection_api.unarchive_collection(
                collection_id=collection_id, _headers=header
            )
        )
        return collection_id
    ...
    def archive_collection(self, collection_id: str) -> str:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._collection_api.archive_collection(
                collection_id=collection_id, _headers=header
            )
        )
        return collection_id
    ...
    def delete_collections(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.create_delete_collection_job(
    ...
    def delete_documents(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._document_api.create_delete_document_job(
    ...
    def delete_documents_from_collection(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.create_delete_document_from_collection_job(
                collection_id=collection_id,
    ...
    def import_collection_into_collection(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.create_import_collection_to_collection_job(
                collection_id=collection_id,
    ...
    def import_document_into_collection(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.create_insert_document_to_collection_job(
                collection_id=collection_id,
    ...
    def process_document(
        ...
        response = _rest_to_client_exceptions(
            lambda: self._document_api.create_process_document_job(
        ...
        summary = _rest_to_client_exceptions(
            lambda: self._document_api.get_document_summary(
    ...
    def list_recent_document_summaries(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._document_api.list_document_summaries(
                document_id=document_id,
                offset=offset,
                limit=limit,
                _headers=header,
    ...
    def encode_for_retrieval(
        ...
        if embedding_model is None:
            rest_embedding_model = _rest_to_client_exceptions(
                lambda: self._model_api.get_default_embedding_model(_headers=header)
            )
            embedding_model = rest_embedding_model.id
        result = _rest_to_client_exceptions(
            lambda: self._model_api.encode_chunks_for_retrieval(
    ...
    def get_chunks(self, collection_id: str, chunk_ids: Iterable[int]) -> List[Chunk]:
        ...
        rest_chunks = _rest_to_client_exceptions(
            lambda: self._collection_api.get_collection_chunks(
    ...
    def get_collection(self, collection_id: str) -> Collection:
        ...
        rest_collection = _rest_to_client_exceptions(
            lambda: self._collection_api.get_collection(
                collection_id=collection_id, _headers=header
            )
        )
        ...
        rest_settings = _rest_to_client_exceptions(
            lambda: self._collection_api.get_collection_settings(
                collection_id=collection_id, _headers=header
            )
        )
        ...
        rest_chat_settings = _rest_to_client_exceptions(
            lambda: self._collection_api.get_collection_chat_settings(
                collection_id=collection_id, _headers=header
            )
        )
        ...
        metadata = _rest_to_client_exceptions(
            lambda: self._collection_api.get_collection_metadata(
                collection_id=collection_id, _headers=header
            )
        )
        if metadata != {}:
    ...
    def get_collection_for_chat_session(self, chat_session_id: str) -> Collection:
        ...
        chat_session = _rest_to_client_exceptions(
            lambda: self._chat_api.get_chat_session(chat_session_id, _headers=header)
        )
    ...
    def get_document(self, document_id: str, include_layout: bool = False) -> Document:
        ...
        rest_document = _rest_to_client_exceptions(
            lambda: self._document_api.get_document(
        ...
        if include_layout:
            document.page_layout_dict = _rest_to_client_exceptions(
                lambda: self._document_api.get_document_page_layout(
                    document_id=document_id, _headers=header
                )
            )

        document.meta_data_dict = _rest_to_client_exceptions(
            lambda: self._document_api.get_document_internal_metadata(
                document_id=document_id, _headers=header
            )
        )
        document.user_source_file = _rest_to_client_exceptions(
            lambda: self._document_api.get_document_user_source_file(
                document_id=document_id, _headers=header
            )
        )
        document.page_ocr_model_dict = _rest_to_client_exceptions(
            lambda: self._document_api.get_document_page_ocr_model(
                document_id=document_id, _headers=header
            )
        )
        rest_guardrails_settings = _rest_to_client_exceptions(
            lambda: self._document_api.get_document_guardrails_settings(
                document_id=document_id, _headers=header
            )
        )
    ...
    def get_job(self, job_id: str) -> Job:
        ...
        rest_job = _rest_to_client_exceptions(
            lambda: self._job_api.get_job(job_id=job_id, _headers=header)
        )
    ...
    def get_llm_usage_24h(self) -> float:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.get_usage_stats(
    ...
    def get_llm_usage_24h_by_llm(self) -> List[LLMUsage]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.get_usage_stats_by_model(
                interval="24 hours", _headers=header
            )
        )
    ...
    def get_llm_usage_6h(self) -> float:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.get_usage_stats(interval="6 hours", _headers=header)
        )
        return response.current
    ...
    def get_llm_usage_with_limits(self, interval: str) -> LLMUsageLimit:
        ...
        header = self._get_auth_header()
        usage = _rest_to_client_exceptions(
            lambda: self._model_api.get_usage_stats(interval=interval, _headers=header)
        )
        return LLMUsageLimit(**usage.to_dict())
    ...
    def get_llm_usage_by_user(self, interval: str) -> List[UserWithLLMUsage]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.get_usage_stats_by_user(
                interval=interval, _headers=header
            )
        )
    ...
    def get_llm_usage_by_llm_and_user(self, interval: str) -> List[LLMWithUserUsage]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.get_usage_stats_by_model_and_user(
                interval=interval, _headers=header
            )
        )
    ...
    def get_llm_performance_by_llm(self, interval: str) -> List[LLMPerformance]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.get_performance_stats_by_model(
                interval=interval, _headers=header
            )
        )
    ...
    def get_scheduler_stats(self) -> SchedulerStats:
        ...
        rest_stats = _rest_to_client_exceptions(
            lambda: self._job_api.count_pending_jobs(_headers=header)
        )
    ...
    def ingest_from_file_system(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._ingestion_api.create_ingest_from_file_system_job(
                collection_id=collection_id,
    ...
    def ingest_from_plain_text(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._ingestion_api.create_ingest_from_plain_text_job(
                collection_id=collection_id,
                body=plain_text,
                file_name=file_name,
                gen_doc_summaries=gen_doc_summaries,
    ...
    def ingest_from_s3(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._ingestion_api.create_ingest_from_s3_job(
                collection_id=collection_id,
    ...
    def ingest_from_gcs(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._ingestion_api.create_ingest_from_gcs_job(
                collection_id=collection_id,
    ...
    def ingest_from_azure_blob_storage(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._ingestion_api.create_ingest_from_azure_blob_storage_job(
                collection_id=collection_id,
    ...
    def ingest_uploads(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._ingestion_api.create_ingest_upload_job(
                collection_id=collection_id,
    ...
    def ingest_website(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._ingestion_api.create_ingest_from_website_job(
                collection_id=collection_id,
    ...
    def ingest_agent_only_to_standard(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._ingestion_api.create_ingest_agent_only_to_standard_job(
                collection_id=collection_id,
                document_id=document_id,
                gen_doc_summaries=gen_doc_summaries,
                gen_doc_questions=gen_doc_questions,
    ...
    def list_chat_messages(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.get_chat_session_messages(
    ...
    def list_chat_message_references(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.get_message_references(
    ...
    def list_list_chat_message_meta(self, message_id: str) -> List[ChatMessageMeta]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.get_message_meta(
    ...
    def list_chat_sessions_for_collection(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.list_chat_sessions_for_collection(
    ...
    def list_chat_sessions_for_document(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._document_api.list_chat_sessions_for_document(
    ...
    def rename_chat_session(self, chat_session_id: str, name: str):
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._chat_api.update_chat_session(
    ...
    def list_collections_for_document(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._document_api.list_collections_for_document(
                document_id=document_id, offset=offset, limit=limit, _headers=header
            )
        )
    ...
    def list_documents_in_collection(
        ...
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.list_documents_for_collection(
                collection_id=collection_id,
                offset=offset,
                limit=limit,
    ...
    def list_jobs(self) -> List[Job]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._job_api.list_jobs(_headers=header)
        )
    ...
    def list_all_jobs(self) -> List[UserJobs]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._job_api.list_user_jobs(_headers=header)
        )
    ...
    def list_recent_chat_sessions(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.list_chat_sessions(
    ...
    def list_question_reply_feedback_data(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.list_question_answer_feedbacks(
                offset=offset, limit=limit, _headers=header
            )
        )
    ...
    def update_question_reply_feedback(
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._chat_api.update_question_answer_feedback(
                answer_id=reply_id,
    ...
    def count_question_reply_feedback(self) -> int:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.get_question_answer_feedback_count(_headers=header)
        )
        return response.count
    ...
    def list_recent_collections(self, offset: int, limit: int) -> List[CollectionInfo]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.list_collections(
                offset=offset, limit=limit, _headers=header
            )
        )
    ...
    def list_all_collections_sort(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.list_all_collections(
                offset=offset,
                limit=limit,
                sort_column=sort_column,
                ascending=ascending,
    ...
    def list_collection_permissions(self, collection_id: str) -> List[SharePermission]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.get_collection_permissions(
                collection_id=collection_id,
                _headers=header,
            )
        )
    ...
    def list_users(self, offset: int, limit: int) -> List[User]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._permission_api.list_users(
                offset=offset,
                limit=limit,
                _headers=header,
            )
    ...
    def share_collection(
        ...
        result = _get_share_permission_status(
            lambda: _rest_to_client_exceptions(
                lambda: self._collection_api.share_collection(
                    collection_id=collection_id,
    ...
    def unshare_collection(
        ...
        result = _get_share_permission_status(
            lambda: _rest_to_client_exceptions(
                lambda: self._collection_api.unshare_collection(
                    collection_id=collection_id,
                    username=permission.username,
                    _headers=header,
                )
    ...
    def unshare_collection_for_all(self, collection_id: str) -> ShareResponseStatus:
        ...
        result = _get_share_permission_status(
            lambda: _rest_to_client_exceptions(
                lambda: self._collection_api.unshare_collection_for_all(
                    collection_id=collection_id,
                    _headers=header,
                )
            )
    ...
    def make_collection_public(self, collection_id: str):
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._collection_api.update_collection_privacy(
                collection_id=collection_id,
    ...
    def share_collection_with_group(
        ...
        result = _get_share_permission_status(
            lambda: _rest_to_client_exceptions(
                lambda: self._collection_api.share_collection_with_group(
                    collection_id=collection_id,
    ...
    def unshare_collection_from_group(
        ...
        result = _get_share_permission_status(
            lambda: _rest_to_client_exceptions(
                lambda: self._collection_api.unshare_collection_from_group(
                    collection_id=collection_id,
                    group_id=permission.group_id,
                    _headers=header,
                )
    ...
    def list_recent_documents(
        ...
        if metadata_filter and len(metadata_filter) > 0:
            metadata_filter_json = json.dumps(metadata_filter)
        response = _rest_to_client_exceptions(
            lambda: self._document_api.list_documents(
                offset=offset,
                limit=limit,
                metadata_filter=metadata_filter_json,
                _headers=header,
    ...
    def match_chunks(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.match_collection_chunks(
                collection_id=collection_id,
    ...
    def search_chunks(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._collection_api.search_collection_chunks(
                collection_id=collection_id,
    ...
    def list_document_chunks(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._document_api.list_document_chunks(
                collection_id=collection_id,
                document_id=document_id,
                _headers=header,
            )
    ...
    def set_chat_message_votes(self, chat_message_id: str, votes: int) -> Result:
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._chat_api.set_message_votes(
    ...
    def update_collection(self, collection_id: str, name: str, description: str) -> str:
        ...
        collection = _rest_to_client_exceptions(
            lambda: self._collection_api.update_collection(
                collection_id=collection_id,
    ...
    def reset_collection_prompt_settings(self, collection_id: str) -> str:
        ...
        _rest_to_client_exceptions(
            lambda: self._collection_api.reset_collection_prompt_settings(
                collection_id=collection_id,
                _headers=header,
            )
        )
    ...
    def update_collection_settings(
        ...
        _rest_to_client_exceptions(
            lambda: self._collection_api.update_collection_settings(
                collection_id=collection_id,
    ...
    def update_collection_metadata(
        ...
        _rest_to_client_exceptions(
            lambda: self._collection_api.update_collection_metadata(
                collection_id=collection_id,
    ...
    def update_document_name(self, document_id: str, name: str) -> str:
        ...
        document = _rest_to_client_exceptions(
            lambda: self._document_api.update_document(
                document_id=document_id,
    ...
    def update_document_metadata(
        ...
        _rest_to_client_exceptions(
            lambda: self._document_api.update_document_metadata(
    ...
    def get_llms(self) -> List[Dict[str, Any]]:
        ...
        models = _rest_to_client_exceptions(
            lambda: self._model_api.list_models(_headers=header)
        )
    ...
    def get_vision_capable_llm_names(self) -> List[str]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.get_vision_capable_model_names(_headers=header)
        )
        return response
    ...
    def get_llm_and_auto_vision_llm_names(self) -> Dict[str, str]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.get_model_to_vision_model_mapping(_headers=header)
        )
        return response
    ...
    def get_reasoning_capable_llm_names(self) -> List[str]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.get_reasoning_capable_model_names(_headers=header)
        )
        return response
    ...
    def get_llm_and_auto_reasoning_llm_names(self) -> Dict[str, str]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._model_api.get_model_to_reasoning_model_mapping(
                _headers=header
            )
        )
        return response
    ...
    def list_recent_prompt_templates(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._prompt_template_api.list_prompt_templates(
                offset=offset,
                limit=limit,
                _headers=header,
            )
    ...
    def get_prompt_template(self, id: Optional[str] = None) -> PromptTemplate:
        ...
        if id is None:
            response = _rest_to_client_exceptions(
                lambda: self._prompt_template_api.get_default_prompt_template(
                    _headers=header
                )
            )
        else:
            response = _rest_to_client_exceptions(
                lambda: self._prompt_template_api.get_prompt_template(
    ...
    def delete_prompt_templates(self, ids: Iterable[str]) -> Result:
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._prompt_template_api.delete_prompt_template(
    ...
    def update_prompt_template(
        ...
        response = _rest_to_client_exceptions(
            lambda: self._prompt_template_api.update_prompt_template(
    ...
    def create_prompt_template(
        ...
        response = _rest_to_client_exceptions(
            lambda: self._prompt_template_api.create_prompt_template(
    ...
    def count_prompt_templates(self) -> int:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._prompt_template_api.get_prompt_template_count(_headers=header)
        )
        return response.count
    ...
    def share_prompt(
        ...
        result = _get_share_permission_status(
            lambda: _rest_to_client_exceptions(
                lambda: self._prompt_template_api.share_prompt_template(
    ...
    def unshare_prompt(
        ...
        result = _get_share_permission_status(
            lambda: _rest_to_client_exceptions(
                lambda: self._prompt_template_api.unshare_prompt_template(
                    prompt_template_id=prompt_id,
                    username=permission.username,
                    _headers=header,
                )
    ...
    def unshare_prompt_for_all(self, prompt_id: str) -> ShareResponseStatus:
        ...
        result = _get_share_permission_status(
            lambda: _rest_to_client_exceptions(
                lambda: self._prompt_template_api.unshare_prompt_template_for_all(
    ...
    def list_prompt_permissions(self, prompt_id: str) -> List[SharePermission]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._prompt_template_api.get_prompt_template_permissions(
                prompt_template_id=prompt_id, _headers=header
            )
        )
        return [SharePermission(**d.to_dict()) for d in response]
    ...
    def set_collection_prompt_template(
        ...
        if prompt_template_id is None:
            response = _rest_to_client_exceptions(
                lambda: self._collection_api.delete_collection_prompt_template(
                    collection_id=collection_id, _headers=header
                )
            )
        else:
            ...
            response = _rest_to_client_exceptions(
                lambda: self._collection_api.update_collection_prompt_template(
                    collection_id=collection_id,
    ...
    def set_chat_session_prompt_template(
        ...
        if prompt_template_id is None:
            response = _rest_to_client_exceptions(
                lambda: self._chat_api.delete_chat_session_prompt_template(
                    session_id=chat_session_id,
                    _headers=header,
                )
            )
            ...
            response = _rest_to_client_exceptions(
                lambda: self._chat_api.update_chat_session_prompt_template(
                    session_id=chat_session_id,
                    prompt_template_change_request=rest.PromptTemplateChangeRequest(
                        prompt_template_id=prompt_template_id,
                    ),
    ...
    def get_chat_session_prompt_template(
        ...
        rest_session = _rest_to_client_exceptions(
            lambda: self._chat_api.get_chat_session(
                session_id=chat_session_id,
                _headers=header,
            )
        )
    ...
    def set_chat_session_collection(
        ...
        if collection_id is None:
            response = _rest_to_client_exceptions(
                lambda: self._chat_api.delete_chat_session_collection(
                    session_id=chat_session_id, _headers=header
                )
            )
        else:
            response = _rest_to_client_exceptions(
                lambda: self._chat_api.update_chat_session_collection(
                    session_id=chat_session_id,
    ...
    def tag_document(self, document_id: str, tag_name: str) -> str:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._document_api.create_tag_on_document(
                document_id=document_id,
    ...
    def untag_document(self, document_id: str, tag_name: str) -> str:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._document_api.delete_tag_from_document(
    ...
    def get_tag(self, tag_name: str) -> Tag:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._tag_api.get_tag(tag_name=tag_name, _headers=header)
        )
    ...
    def create_tag(self, tag_name: str) -> str:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._tag_api.create_tag(
    ...
    def update_tag(self, tag_name: str, description: str, format: str) -> str:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._tag_api.update_tag(
                tag_name=tag_name,
    ...
    def list_all_tags(self) -> List[Tag]:
        ...
        response = _rest_to_client_exceptions(
            lambda: self._tag_api.list_tags(_headers=header)
        )
    ...
    def list_documents_from_tags(
        ...
        response = _rest_to_client_exceptions(
            lambda: self._tag_api.list_documents_for_tags(
    ...
    def add_user_document_permission(
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._permission_api.add_user_document_permission(
                document_id=document_id,
                user_id=user_id,
                _headers=header,
            )
    ...
    def list_system_permissions(self) -> List[UserPermission]:
        ...
        rest_permissions = _rest_to_client_exceptions(
            lambda: self._permission_api.list_permissions(_headers=header)
        )
    ...
    def list_system_roles(self) -> List[UserRole]:
        ...
        rest_roles = _rest_to_client_exceptions(
            lambda: self._permission_api.list_roles(_headers=header)
        )
    ...
    def list_system_groups(self) -> List[UserGroup]:
        ...
        rest_groups = _rest_to_client_exceptions(
            lambda: self._permission_api.list_groups(_headers=header)
        )
    ...
    def list_user_roles(self, user_id: Optional[str] = None) -> List[UserRole]:
        ...
        if user_id:
            rest_roles = _rest_to_client_exceptions(
                lambda: self._permission_api.get_user_roles(
                    user_id=user_id, _headers=header
                )
            )
        else:
            rest_roles = _rest_to_client_exceptions(
                lambda: self._permission_api.get_current_user_roles(_headers=header)
            )
        return [UserRole(**r.to_dict()) for r in rest_roles]
    ...
    def list_group_roles(self, group_id: str) -> List[UserRole]:
        ...
        header = self._get_auth_header()
        rest_roles = _rest_to_client_exceptions(
            lambda: self._permission_api.get_group_roles(
    ...
    def list_user_permissions(
        ...
        if user_id:
            rest_permissions = _rest_to_client_exceptions(
                lambda: self._permission_api.get_user_permissions(
                    user_id=user_id, _headers=header
                )
            )
        else:
            rest_permissions = _rest_to_client_exceptions(
                lambda: self._permission_api.get_current_user_permissions(
                    _headers=header
                )
            )
        return [UserPermission(**p.to_dict()) for p in rest_permissions]
    ...
    def list_group_permissions(self, group_id: str) -> List[UserPermission]:
        ...
        header = self._get_auth_header()
        rest_permissions = _rest_to_client_exceptions(
            lambda: self._permission_api.get_group_permissions(
                group_id=group_id, _headers=header
            )
        )
        return [UserPermission(**p.to_dict()) for p in rest_permissions]
    ...
    def list_group_permissions_by_name(
        ...
        header = self._get_auth_header()
        rest_permissions = _rest_to_client_exceptions(
            lambda: self._permission_api.list_permissions(
    ...
    def add_role_to_user(self, user_id: str, roles: List[str]) -> List[UserRole]:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._permission_api.assign_roles_to_user(
    ...
    def reset_roles_for_user(self, user_id: str, roles: List[str]) -> List[UserRole]:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._permission_api.reset_user_roles(
                user_id=user_id,
    ...
    def remove_role_from_user(self, user_id: str, roles: List[str]) -> List[UserRole]:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._permission_api.remove_roles_from_user(
                user_id=user_id, role_names=roles, _headers=header
            )
        )
        return self.list_user_roles(user_id=user_id)
    ...
    def add_role_to_group(self, group_id: str, roles: List[str]) -> List[UserRole]:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._permission_api.assign_roles_to_group(
    ...
    def reset_roles_for_group(self, group_id: str, roles: List[str]) -> List[UserRole]:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._permission_api.reset_group_roles(
                group_id=group_id,
                roles_reset_request=rest.RolesResetRequest(new_roles=roles),
                _headers=header,
            )
    ...
    def remove_role_from_group(self, group_id: str, roles: List[str]) -> List[UserRole]:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._permission_api.remove_roles_from_group(
                group_id=group_id, role_names=roles, _headers=header
            )
        )
        return self.list_group_roles(group_id=group_id)
    ...
    def is_permission_granted(self, permission: str) -> bool:
        ...
        header = self._get_auth_header()
        result = _rest_to_client_exceptions(
            lambda: self._permission_api.is_permission_granted(
    ...
    def is_collection_permission_granted(
        ...
        header = self._get_auth_header()
        result = _rest_to_client_exceptions(
            lambda: self._permission_api.is_collection_permission_granted(
                collection_id=collection_id,
                permission_check_request=rest.PermissionCheckRequest(
                    permission=permission
                ),
    ...
    def create_user_role(self, name: str, description: str) -> UserRole:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._permission_api.create_role(
    ...
    def create_user_group(self, name: str, description: str) -> UserGroup:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._permission_api.create_group(
    ...
    def delete_user_roles_by_ids(self, roles_ids: Iterable[str]) -> Result:
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._permission_api.delete_roles(
                    role_ids=roles_ids,
                    _headers=header,
                )
            )
    ...
    def delete_user_roles_by_names(self, roles_names: Iterable[str]) -> Result:
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._permission_api.delete_roles_by_names(
                    names=roles_names,
                    _headers=header,
                )
            )
    ...
    def delete_user_groups_by_ids(self, groups_ids: Iterable[str]) -> Result:
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._permission_api.delete_groups(
    ...
    def delete_user_groups_by_names(self, groups_names: Iterable[str]) -> Result:
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._permission_api.delete_groups_by_names(
                    names=groups_names,
                    _headers=header,
                )
            )
    ...
    def assign_permissions_to_role(
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._permission_api.set_role_permissions(
                    role_id=role_name,
    ...
    def set_global_configuration(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._configuration_api.set_global_configuration(
                key_name=key_name,
    ...
    def get_global_configurations_by_admin(self) -> List[ConfigItem]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._configuration_api.list_global_configurations(
                as_admin=True,
                _headers=header,
            )
        )
    ...
    def bulk_delete_global_configurations(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._configuration_api.delete_global_configurations(
                key_names=key_names,
                _headers=header,
            )
        )
    ...
    def set_user_configuration_for_user(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._configuration_api.set_user_configuration(
                key_name=key_name,
                user_id=user_id,
    ...
    def get_user_configurations_for_user(self, user_id: str) -> List[UserConfigItem]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._configuration_api.list_user_configurations(
                user_id=user_id,
                _headers=header,
            )
        )
    ...
    def get_user_configurations(self) -> List[UserConfigItem]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._configuration_api.list_current_user_configurations(
                _headers=header
            )
        )
        return [UserConfigItem(**c.to_dict()) for c in response]
    ...
    def bulk_delete_user_configurations_for_user(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._configuration_api.delete_user_configurations(
                user_id=user_id,
                key_names=key_names,
                _headers=header,
            )
    ...
    def reset_user_configurations_for_user(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._configuration_api.reset_user_configuration(
                user_id=user_id,
                key_name=key_name,
                _headers=header,
            )
    ...
    def delete_agent_directories(self, chat_session_id: str) -> bool:
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._chat_api.delete_agent_server_directories(
    ...
    def get_all_directory_stats(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.list_all_agent_server_directories_stats(
                session_id=chat_session_id,
    ...
    def get_directory_stats(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.get_agent_server_directory_stats(
                session_id=chat_session_id,
                detail_level=detail_level,
    ...
    def get_h2ogpt_system_stats(self) -> dict:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._system_api.get_h2ogpt_system_info(_headers=header)
        )
        return response.to_dict()
    ...
    def create_api_key_for_user(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._api_keys_api.create_api_key_for_user(
    ...
    def deactivate_api_key(self, api_key_id: str) -> Result:
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._api_keys_api.deactivate_api_key(
                    key_id=api_key_id,
                    _headers=header,
                )
            )
    ...
    def list_all_api_keys(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._api_keys_api.list_all_api_keys(
                offset=offset,
                limit=limit,
                filter=key_filter,
                _headers=header,
    ...
    def set_api_key_expiration(
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._api_keys_api.update_api_key_expiry(
                    key_id=api_key_id,
    ...
    def delete_api_keys(self, api_key_ids: List[str]) -> Result:
        ...
        for api_key_id in api_key_ids:
            _rest_to_client_exceptions(
                lambda: self._api_keys_api.delete_api_key(
                    key_id=api_key_id,
                    _headers=header,
                )
            )
    ...
    def get_agent_server_files(self, chat_session_id: str) -> List[dict]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._chat_api.list_agent_server_files(
                session_id=chat_session_id,
                _headers=header,
            )
        )
    ...
    def delete_agent_server_files(self, chat_session_id: str) -> bool:
        ...
        result = _get_result(
            lambda: _rest_to_client_exceptions(
                lambda: self._chat_api.delete_agent_server_files(
                    session_id=chat_session_id,
                    _headers=header,
                )
            )
    ...
    def get_user_all_agent_directories(
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._agent_api.list_agent_directory_stats(
                offset=offset,
                limit=limit,
    ...
    def get_agent_tool_preference(self) -> List[str]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._agent_api.list_agent_tool_preference(_headers=header)
        )
        return response
    ...
    def update_agent_tool_preference(self, reference_value: List[str]) -> None:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._agent_api.update_agent_tool_preference(
    ...
    def delete_agent_tool_preference(self) -> None:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._agent_api.delete_agent_tool_preference(_headers=header)
        )
        ...
        for agent_key in agent_keys:
            try:
                ...
                agent_key = _rest_to_client_exceptions(
                    lambda: self._agent_api.create_agent_key(
    ...
    def get_agent_keys(self) -> List[dict]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._agent_api.list_agent_keys(_headers=header)
        )
    ...
    def update_agent_key(
        ...
        try:
            ...
            agent_key = _rest_to_client_exceptions(
                lambda: self._agent_api.update_agent_key(
    ...
    def delete_agent_keys(self, key_ids: List[str]) -> None:
        ...
        header = self._get_auth_header()
        _rest_to_client_exceptions(
            lambda: self._agent_api.delete_agent_keys(
                key_ids=key_ids,
                _headers=header,
            )
        )
    ...
    def assign_agent_key_for_tool(
        ...
        for association in tool_dict_list:
            ...
            response = _rest_to_client_exceptions(
                lambda: self._agent_api.create_agent_key_tool_associations(
    ...
    def get_agent_key_tool_associations(self) -> List[dict]:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._agent_api.list_agent_key_tool_associations(_headers=header)
        )
    ...
    def delete_agent_tool_association(self, associate_ids: List[str]) -> int:
        ...
        header = self._get_auth_header()
        response = _rest_to_client_exceptions(
            lambda: self._agent_api.delete_agent_tool_association(
