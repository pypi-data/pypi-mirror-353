...
class JuliusPipeline:
    def __init__(self, pipeline: InitPipeline, registry, logs_buffer: io.StringIO, pauses: Dict[str, Dict[str, asyncio.Future]], storage: Optional['LocalStorage'] = None, fail_storage: Optional[FailStorage] = None, hash: Optional[str] = None):
