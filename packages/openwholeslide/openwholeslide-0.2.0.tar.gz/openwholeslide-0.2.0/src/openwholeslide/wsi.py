...
class WholeSlide:
    ...
    def read_full(self, resolution: Optional[float] = None, magnification: Optional[float] = None) -> SlideRegion:
        """Return a SlideRegion object that has access to the WSI data at the required resolution or magnification.
        ...
        return SlideRegion(
            wsi=self, location=FloatVector(x=0, y=0), dimensions=FloatVector(x=1, y=1), resolution=resolution
        )
    ...
    def read_region(
        ...
        return SlideRegion(wsi=self, location=location, dimensions=dimensions, resolution=resolution)
    ...
    def read_region_absolute(
        ...
        return SlideRegion(wsi=self, location=rel_location, dimensions=rel_dimensions, resolution=resolution)
