...
from codecraft.notion_command import NotionCommand
...
"""
    ...
    def cmd_review(self, args=""):
        ...
        from codecraft.review.command import ReviewCommand
        cmd = ReviewCommand(self.io, self.coder)
        cmd.execute(args)
        
    def cmd_notion(self, args=""):
        "Manage TODOs using Notion Kanban board integration"
        cmd = NotionCommand(self.io, self.coder)
        cmd.execute(args)
