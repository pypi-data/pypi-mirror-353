...
from codecraft import __version__, urls, utils
from codecraft.dump import dump  # noqa: F401

codecraft_user_agent = f"CodeCraft/{__version__} +{urls.website}"
...
def install_playwright(io):
    ...
    pip_cmd = utils.get_pip_install(["codecraft-chat[playwright]"])
...
class Scraper:
    ...
    def scrape_with_playwright(self, url):
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                user_agent = user_agent.replace("headless", "")
                user_agent += " " + codecraft_user_agent
    ...
    def scrape_with_httpx(self, url):
        ...
        headers = {"User-Agent": f"Mozilla./5.0 ({codecraft_user_agent})"}
        try:
            with httpx.Client(
