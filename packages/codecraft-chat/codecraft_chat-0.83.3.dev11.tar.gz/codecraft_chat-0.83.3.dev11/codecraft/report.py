...
from codecraft.urls import github_issues
from codecraft.versioncheck import VERSION_CHECK_FNAME
...
def report_github_issue(issue_text, title=None, confirm=True):
    ...
    :return: None
    """
    version_info = f"CodeCraft version: {__version__}\n"
    ...
    if confirm:
        ...
        print()
        print("Please consider reporting this bug to help improve codecraft!")
