...
from codecraft.models import model_info_manager
...
class Analytics:
    ...
    def get_data_file_path(self):
        try:
            data_file = Path.home() / ".codecraft" / "analytics.json"
    ...
    def posthog_error(self):
        ...
        # https://github.com/CodeCraft-AI/codecraft/issues/2532
        self.ph = None
