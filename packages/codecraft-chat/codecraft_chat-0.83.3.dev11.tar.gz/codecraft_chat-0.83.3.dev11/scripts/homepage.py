...
# Badge tooltip texts
GITHUB_STARS_TOOLTIP = "Total number of GitHub stars the CodeCraft project has received"
PYPI_DOWNLOADS_TOOLTIP = "Total number of installations via pip from PyPI"
TOKENS_WEEKLY_TOOLTIP = "Number of tokens processed weekly by CodeCraft users"
OPENROUTER_TOOLTIP = "CodeCraft's ranking among applications on the OpenRouter platform"
SINGULARITY_TOOLTIP = "Percentage of the new code in CodeCraft's last release written by CodeCraft itself"

# Cache settings
CACHE_DIR = os.path.expanduser("~/.cache/codecraft-badges")
...
def get_downloads_from_bigquery(credentials_path=None, package_name="codecraft-chat"):
    """
...
def get_total_downloads(
    api_key=None, package_name="codecraft-chat", use_bigquery=False, credentials_path=None
):
    """
...
def get_github_stars(repo="paul-gauthier/codecraft"):
    """
...
def get_latest_release_codecraft_percentage():
    """
    Get the percentage of code written by CodeCraft in the LATEST release
    ...
    try:
        ...
        if latest_release:
            percentage = latest_release.get("codecraft_percentage", 0)
...
def generate_badges_md(downloads, stars, codecraft_percentage):
    """
    ...
    # Round codecraft percentage to whole number
    codecraft_percent_rounded = round(codecraft_percentage)

    markdown = f"""  <a href="https://github.com/CodeCraft-AI/codecraft/stargazers"><img alt="GitHub Stars" title="{GITHUB_STARS_TOOLTIP}"
src="https://img.shields.io/github/stars/CodeCraft-AI/codecraft?style=flat-square&logo=github&color=f1c40f&labelColor=555555"/></a>
  <a href="https://pypi.org/project/codecraft-chat/"><img alt="PyPI Downloads" title="{PYPI_DOWNLOADS_TOOLTIP}"
...
src="https://img.shields.io/badge/🏆%20OpenRouter-Top%2020-9b59b6?style=flat-square&labelColor=555555"/></a>
  <a href="https://codecraft.chat/HISTORY.html"><img alt="Singularity" title="{SINGULARITY_TOOLTIP}"
src="https://img.shields.io/badge/🔄%20Singularity-{codecraft_percent_rounded}%25-e74c3c?style=flat-square&labelColor=555555"/></a>"""  # noqa
...
def get_badges_md():
    ...
    total_downloads = get_total_downloads(api_key, "codecraft-chat", use_bigquery, credentials_path)

    # Get GitHub stars for the default repo
    stars = get_github_stars("paul-gauthier/codecraft")

    # Get CodeCraft contribution percentage in latest release
    percentage, _ = get_latest_release_codecraft_percentage()
...
def get_badges_html():
    ...
    codecraft_percent_rounded = round(percentage)

    # Generate HTML badges
    html = f"""<a href="https://github.com/CodeCraft-AI/codecraft" class="github-badge badge-stars" title="{GITHUB_STARS_TOOLTIP}">
    <span class="badge-label">⭐ GitHub Stars</span>
    <span class="badge-value">{stars_formatted}</span>
</a>
<a href="https://pypi.org/project/codecraft-chat/" class="github-badge badge-installs" title="{PYPI_DOWNLOADS_TOOLTIP}">
...
<a href="/HISTORY.html" class="github-badge badge-coded" title="{SINGULARITY_TOOLTIP}">
    ...
    <span class="badge-value">{codecraft_percent_rounded}%</span>
</a>"""  # noqa
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Get total downloads and GitHub stars for codecraft")
    parser.add_argument(
        "--api-key",
        help=(
    ...
    parser.add_argument(
        "--package", default="codecraft-chat", help="Package name (default: codecraft-chat)"
    )
    parser.add_argument(
        "--github-repo",
        default="paul-gauthier/codecraft",
        help="GitHub repository (default: paul-gauthier/codecraft)",
    )
    ...
    # Get CodeCraft contribution percentage in latest release
    percentage, version = get_latest_release_codecraft_percentage()
    print(f"CodeCraft wrote {percentage:.2f}% of code in the LATEST release ({version})")
