...
class BenchmarkPlotter:
    ...
    def set_labels_and_style(self, ax: plt.Axes):
        ...
        ax.set_ylabel(
            "CodeCraft code editing benchmark,\npercent completed correctly", fontsize=18, color="#555"
        )
    ...
    def save_and_display(self, fig: plt.Figure):
        plt.savefig("codecraft/website/assets/models-over-time.png")
        plt.savefig("codecraft/website/assets/models-over-time.svg")
        imgcat(fig)
...
def main():
    ...
    models = plotter.load_data("codecraft/website/_data/edit_leaderboard.yml")
    ...
    plotter.plot("codecraft/website/_data/edit_leaderboard.yml")
