...
def get_dirs_from_leaderboard():
    ...
    with open("codecraft/website/_data/polyglot_leaderboard.yml") as f:
...
def load_results(dirname):
    ...
    for fname in benchmark_dir.glob("*/exercises/practice/*/.codecraft.results.json"):
        error = False
        try:
                ...
                pass_rate = next(
                    (
                        ...
                        for entry in yaml.safe_load(
                            open("codecraft/website/_data/polyglot_leaderboard.yml")
                        )
