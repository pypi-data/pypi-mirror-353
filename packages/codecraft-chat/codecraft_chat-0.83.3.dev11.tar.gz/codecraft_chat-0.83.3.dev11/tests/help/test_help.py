...
from codecraft.help import Help, fname_to_url
...
class TestHelp(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        codecraft.coders.HelpCoder.run = help_coder_run

        def run_help_command():
            try:
                commands.cmd_help("hi")
            except codecraft.commands.SwitchCoder:
                pass
            else:
    ...
    def test_ask_without_mock(self):
        ...
        self.assertIn("codecraft", result.lower())
    ...
    def test_fname_to_url_unix(self):
        ...
        self.assertEqual(fname_to_url("website/docs/index.md"), "https://codecraft.chat/docs")
        self.assertEqual(
        ...
        self.assertEqual(
            fname_to_url("/home/user/project/website/docs/index.md"), "https://codecraft.chat/docs"
        )
        self.assertEqual(
    ...
    def test_fname_to_url_windows(self):
        ...
        self.assertEqual(fname_to_url(r"website\docs\index.md"), "https://codecraft.chat/docs")
        self.assertEqual(
        ...
        self.assertEqual(
            fname_to_url(r"C:\Users\user\project\website\docs\index.md"), "https://codecraft.chat/docs"
        )
        self.assertEqual(
