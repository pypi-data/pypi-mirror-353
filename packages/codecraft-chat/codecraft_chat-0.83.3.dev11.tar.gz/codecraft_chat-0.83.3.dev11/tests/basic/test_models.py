...
class TestModels(unittest.TestCase):
    def setUp(self):
        ...
        from codecraft.models import MODEL_SETTINGS
    ...
    @patch("codecraft.models.check_for_dependencies")
    ...
    @patch("codecraft.models.check_pip_install_extra")
    def test_check_for_dependencies_bedrock(self, mock_check_pip):
        ...
        from codecraft.models import check_for_dependencies
    ...
    def test_codecraft_extra_model_settings(self):
        import tempfile
    ...
    @patch("codecraft.models.litellm.completion")
