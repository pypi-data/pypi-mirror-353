...
from codecraft.dump import dump  # noqa
...
class TestDeprecated(TestCase):
    ...
    @patch("codecraft.io.InputOutput.tool_warning")
    ...
    def test_deprecated_args_show_warnings(self, mock_offer_url, mock_tool_warning):
        ...
        for flag in deprecated_flags:
            ...
            with patch("codecraft.models.Model"), self.subTest(flag=flag):
                main(
    ...
    def test_model_alias_in_warning(self, mock_offer_url, mock_tool_warning):
        ...
        with patch("codecraft.models.MODEL_ALIASES", {"gpt4": "gpt-4-0613"}):
            with patch("codecraft.models.Model"):
                main(
