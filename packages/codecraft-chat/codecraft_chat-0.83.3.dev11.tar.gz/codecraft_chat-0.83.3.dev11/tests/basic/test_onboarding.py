...
from codecraft.onboarding import (
...
class TestOnboarding(unittest.TestCase):
    ...
    @patch("codecraft.onboarding.check_openrouter_tier")
    ...
    @patch("codecraft.onboarding.check_openrouter_tier", return_value=True)  # Assume free tier
    ...
    @patch("codecraft.onboarding.check_openrouter_tier", return_value=False)  # Assume paid tier
    @patch.dict(os.environ, {"OPENROUTER_API_KEY": "or_key"}, clear=True)
    ...
    @patch("codecraft.onboarding.check_openrouter_tier", return_value=False)  # Paid
    @patch.dict(
    ...
    @patch("codecraft.onboarding.try_to_select_default_model", return_value="gpt-4o")
    @patch("codecraft.onboarding.offer_openrouter_oauth")
    ...
    @patch(
        "codecraft.onboarding.try_to_select_default_model", side_effect=[None, None]
    )  # Fails first, fails after oauth attempt
    @patch(
        "codecraft.onboarding.offer_openrouter_oauth", return_value=False
    ...
    @patch(
        "codecraft.onboarding.try_to_select_default_model",
        side_effect=[None, "openrouter/google/gemini-2.5-pro-exp-03-25:free"],
    )  # Fails first, succeeds after oauth
    @patch(
        "codecraft.onboarding.offer_openrouter_oauth", return_value=True
    ...
    @patch("codecraft.onboarding.start_openrouter_oauth_flow", return_value="new_or_key")
    ...
    @patch("codecraft.onboarding.start_openrouter_oauth_flow", return_value=None)  # OAuth fails
    @patch.dict(os.environ, {}, clear=True)
    ...
    @patch("codecraft.onboarding.start_openrouter_oauth_flow")
