...
class AnalysisEntities(Collection):
    """
        .. note::
            :class: toggle
    ...
    def __init__(self, com_object):
        ...
        self.analysis_entities = com_object
    ...
    def remove(self, i_index: cat_variant) -> None:
        ...
        # # vba_code = """
        # # Public Function remove(analysis_entities)
        # #     Dim iIndex (2)
        # #     analysis_entities.Remove iIndex
        # #     remove = iIndex
        # # End Function
        # # """
    ...
    def __repr__(self):
        return f'AnalysisEntities(name="{self.name}")'
