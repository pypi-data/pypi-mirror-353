            ...
            try:
                ...
                if seeds is not None:
                    ...
                    if len(unique_scores) == 1:
                        ...
                        seeds_to_record = {
                            "best": seed_list[0],
                            "worst": seed_list[min(1, len(seed_list) - 1)],  # Second seed, or first if only one
                            "average": seed_list[min(2, len(seed_list) - 1)],  # Third seed, or available
                        }
                    else:
                        ...
                        avg_seed, _ = min(
                            scores.items(),
                            key=lambda x: abs(x[1] - sum(scores.values()) / len(scores)),
                        )
                        seeds_to_record = {
                            "best": best_seed,
                            "worst": worst_seed,
