...
def main():
    ...
    helper = argparse.ArgumentParser(prog="test_edge", description="The Loynaz Testing Application using randomly generated, large sparse matrices.")
    ...
    for i in range(num_tests):
        ...
        output = f"{i + 1}-Loynaz Test: {answer}" 
        utils.println(output, logger, args.log)
