...
def approximate_solutions(inputDirectory, verbose=False, log=False, count=False, bruteForce=False, approximation=False):
    """Finds an approximate edge dominating set for several instances.
...
def main():
    ...
    helper = argparse.ArgumentParser(prog="batch_edge", description="Compute the Approximate Edge Dominating Set for all undirected graphs encoded in DIMACS format and stored in a directory.")
