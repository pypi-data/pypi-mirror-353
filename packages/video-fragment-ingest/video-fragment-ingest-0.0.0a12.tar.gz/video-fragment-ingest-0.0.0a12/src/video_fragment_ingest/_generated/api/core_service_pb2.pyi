...
class GraphRequest(_message.Message):
    __slots__ = ("user", "customer", "facility", "device", "camera", "contact", "incident", "api_key", "user_session", "level", "location", "floor_plan", "zone", "event", "activity_log", "coordinate", "device_cluster", "rule_setting", "mask", "campus", "speaker", "multi_lens_camera", "furniture", "decomposer_region", "work_hours", "permission", "role", "user_group", "shift", "object_of_interest_tracking_job", "inference_frame", "camera_manufacturer", "camera_model", "incident_event", "badge_reader", "system_event", "authorized_badge_holder", "vape_detector", "wall", "door", "depth", "kv_map")
...
class GraphResponse(_message.Message):
    __slots__ = ("user", "customer", "facility", "device", "camera", "contact", "incident", "api_key", "user_session", "level", "location", "floor_plan", "zone", "event", "activity_log", "coordinate", "device_cluster", "rule_setting", "mask", "campus", "speaker", "multi_lens_camera", "work_hours", "permission", "role", "user_group", "shift", "object_of_interest_tracking_job", "inference_frame", "camera_manufacturer", "camera_model", "incident_event", "badge_reader", "system_event", "authorized_badge_holder", "vape_detector", "completed")
    USER_FIELD_NUMBER: _ClassVar[int]
    CUSTOMER_FIELD_NUMBER: _ClassVar[int]
    FACILITY_FIELD_NUMBER: _ClassVar[int]
    DEVICE_FIELD_NUMBER: _ClassVar[int]
...
class ZoneList(_message.Message):
    __slots__ = ("zones", "unassigned_cameras", "time_zone", "facility_wide_rules", "unassigned_badge_readers", "unassigned_vape_detectors")
...
class UpdateIncidentRequest(_message.Message):
    __slots__ = ("incident", "description")
    INCIDENT_FIELD_NUMBER: _ClassVar[int]
...
class IncidentListRequest(_message.Message):
    __slots__ = ("start_index", "size", "customer_id", "statuses", "query", "user", "facility_ids", "rule_ids", "from_timestamp", "to_timestamp", "start_time", "end_time")
...
class EventListRequest(_message.Message):
    __slots__ = ("start_index", "size", "incident_id", "asc", "from_timestamp", "to_timestamp")
    START_INDEX_FIELD_NUMBER: _ClassVar[int]
    SIZE_FIELD_NUMBER: _ClassVar[int]
...
class PauseRulesRequest(_message.Message):
    __slots__ = ("duration", "rules", "facility_id")
...
class PagingRequest(_message.Message):
    __slots__ = ("start_index", "user", "incident", "event")
    START_INDEX_FIELD_NUMBER: _ClassVar[int]
    USER_FIELD_NUMBER: _ClassVar[int]
    INCIDENT_FIELD_NUMBER: _ClassVar[int]
    EVENT_FIELD_NUMBER: _ClassVar[int]
...
class IncidentSharing(_message.Message):
    __slots__ = ("incident", "email", "phone", "sender")
    INCIDENT_FIELD_NUMBER: _ClassVar[int]
...
class CustomIncidentRequest(_message.Message):
    __slots__ = ("title", "frame", "user", "facility", "image_data")
...
class SystemEventListRequest(_message.Message):
    __slots__ = ("start_index", "size", "user", "facility_ids", "from_timestamp", "to_timestamp", "start_time", "end_time")
    START_INDEX_FIELD_NUMBER: _ClassVar[int]
    SIZE_FIELD_NUMBER: _ClassVar[int]
    USER_FIELD_NUMBER: _ClassVar[int]
    FACILITY_IDS_FIELD_NUMBER: _ClassVar[int]
