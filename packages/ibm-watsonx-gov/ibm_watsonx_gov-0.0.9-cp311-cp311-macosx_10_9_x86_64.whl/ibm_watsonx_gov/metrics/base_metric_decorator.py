...
class BaseMetricDecorator():
    ...
    def __init__(self, api_client: APIClient = None, configuration: AgenticAIConfiguration = None,
                 compute_online: bool = True, metric_results: list[AgentMetricResult] = [],
    ...
    def compute_helper(self, *, func: Callable,
        ...
        if self.compute_online:
            ...
            final_metrics = _resolve_metric_dependencies(metrics=metrics, metric_groups=metric_groups)
            metric_result = _evaluate_metrics(configuration=_configuration, data=_data,
                                              metrics=final_metrics, api_client=self.api_client).to_dict()
