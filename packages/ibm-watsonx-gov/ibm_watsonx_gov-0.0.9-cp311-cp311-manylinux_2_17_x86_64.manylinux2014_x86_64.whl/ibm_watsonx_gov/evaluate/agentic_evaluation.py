...
from ibm_watsonx_gov.metrics import (AnswerRelevanceMetric,
                                     ...
                                     FaithfulnessMetric, HitRateMetric,
...
class AgenticEvaluation(BaseModel):
    ...
    def __compute_helper(self, *, func: Callable,
        ...
        metric_result = _evaluate_metrics(configuration=_configuration, data=_data,
                                          metrics=final_metrics, api_client=api_client).to_dict()
    ...
    def evaluate_tool_calling_hallucination(self,
        ...
        def wrapper(func, instance, args, kwargs):
            ...
            try:
                ...
                raise Exception(
                    f"There was an error while evaluating tool_calling_hallucination metric on {func.__name__},") from ex
