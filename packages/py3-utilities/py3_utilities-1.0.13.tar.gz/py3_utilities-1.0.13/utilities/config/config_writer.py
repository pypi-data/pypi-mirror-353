...
def _dict_to_xml_element(name: str, data: Any) -> ET.Element:
    """
    Recursively converts a dictionary or list into an XML Element.
    """
...
def write_config(
    ...
    """
    Writes configuration data to a file in the given format.

    :param config: Dictionary or SimpleNamespace to write.
    :param filename: Target file path.
    :param format: One of 'json', 'yaml', 'toml', 'ini', or 'xml'.
    :param exclude_keys: List of top-level keys to exclude from output.
