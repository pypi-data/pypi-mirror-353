...
import frogml_proto.qwak.administration.authenticated_user.v1.credentials_pb2
import frogml_proto.qwak.batch_job.v1.batch_job_events_pb2
...
class BatchJobExecutionSize(google.protobuf.message.Message):
    ...
    @property
    def pod_compute_resources(self) -> frogml_proto.qwak.user_application.common.v0.resources_pb2.PodComputeResources:
    ...
    def __init__(
        ...
        *,
        number_of_pods: builtins.int = ...,
        pod_compute_resources: frogml_proto.qwak.user_application.common.v0.resources_pb2.PodComputeResources | None = ...,
        template_id: builtins.str = ...,
    ) -> None: ...
...
class GetBatchJobUploadDetailsResponse(google.protobuf.message.Message):
    ...
    """The bucket name to use"""
    @property
    def credentials(self) -> frogml_proto.qwak.administration.authenticated_user.v1.credentials_pb2.AwsTemporaryCredentials:
    ...
    def __init__(
        ...
        *,
        ...
        output_path: builtins.str = ...,
        bucket: builtins.str = ...,
        credentials: frogml_proto.qwak.administration.authenticated_user.v1.credentials_pb2.AwsTemporaryCredentials | None = ...,
    ) -> None: ...
