...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='project',
            name='label_config',
            field=models.TextField(blank=True, help_text='Label config in XML format', null=True, verbose_name='label config'),
        ),
        migrations.AlterField(
            model_name='project',
        ...
        migrations.AddField(
         ...
         migrations.AddField(
            ...
            field=models.JSONField(default=dict, help_text='general dict serialized project crawler', verbose_name='project crawler'),
        ),
        migrations.AlterField(
            model_name='projecttemplate',
