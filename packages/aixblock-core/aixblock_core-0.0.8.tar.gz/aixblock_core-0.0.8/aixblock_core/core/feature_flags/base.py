...
from aixblock_core.core.utils.params import get_bool_env, get_all_env_with_prefix
from aixblock_core.core.utils.io import find_node
...
if settings.FEATURE_FLAGS_FROM_FILE:
    ...
    package_name = 'aixblock_core' if settings.VERSION_EDITION == 'Community' else 'aixblock_core_enterprise'
...
def _get_user_repr(user):
    ...
    if user.active_organization is not None and user.active_organization.created_by is not None:
