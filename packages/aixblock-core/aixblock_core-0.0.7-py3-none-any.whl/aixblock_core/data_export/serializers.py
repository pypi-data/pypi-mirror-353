...
# from aixblock_tools.core.label_config import is_video_object_tracking
...
# from aixblock_tools.postprocessing.video import extract_key_frames
...
class BaseExportDataSerializer(FlexFieldsModelSerializer):
    ...
    def to_representation(self, task):
        ...
        try:
            ...
            resolved_uri = storage.resolve_uri(data['$undefined$'], 10)
            if resolved_uri:
                data['$undefined$'] = resolved_uri
...
class ExportDatasetRequestSerializer(serializers.Serializer):
