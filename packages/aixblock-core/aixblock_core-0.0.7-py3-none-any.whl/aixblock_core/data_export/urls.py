...
_api_urlpatterns = [
    ...
    path("<int:pk>/export-custom", api.ExportAPICustom.as_view(), name="project-export-custom"),
    path(
        "<int:pk>/export/formats",
        api.ExportFormatsListAPI.as_view(),
        name="project-export-formats",
    ),
    # Previously exported results
    path(
        "<int:pk>/export/files",
        api.ProjectExportFiles.as_view(),
        name="project-export-files",
    ),
    path("<int:pk>/exports/", api.ExportListAPI.as_view(), name="project-exports-list"),
    path(
        "<int:pk>/exports/<int:export_pk>",
        api.ExportDetailAPI.as_view(),
        name="project-exports-detail",
    ),
    path(
        "<int:pk>/exports/<int:export_pk>/download",
        api.ExportDownloadAPI.as_view(),
        name="project-exports-download",
    ),
]
