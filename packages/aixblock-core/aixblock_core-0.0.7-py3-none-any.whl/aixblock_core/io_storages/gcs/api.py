...
class GCSImportStorageDetailAPI(ImportStorageDetailAPI):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        import_intance = GCSImportStorage.objects.filter(id=import_id).first()
        GCSExportStorage.objects.filter(id=import_intance.export_storage).delete()

        return super(GCSImportStorageDetailAPI, self).delete(request, *args, **kwargs)
