...
class RedisImportStorageDetailAPI(ImportStorageDetailAPI):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        import_intance = RedisImportStorage.objects.filter(id=import_id).first()
        RedisExportStorage.objects.filter(id=import_intance.export_storage).delete()

        return super(RedisImportStorageDetailAPI, self).delete(request, *args, **kwargs)
