...
urlpatterns = [
    ...
    path("api/projects/<int:pk>/replace-user", api.ReplaceUserAPI.as_view(), name='project-replace-user'),
    ...
    path("projects/claim_task", api.ClaimTaskAPI.as_view(), name='project-claim-task'),
]
