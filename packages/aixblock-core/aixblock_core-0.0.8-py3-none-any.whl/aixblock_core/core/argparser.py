...
def parse_input_args(input_args):
    ...
    root_parser.add_argument('--version', dest='version', action='store_true', help='Show AiXBlock version')
    root_parser.add_argument(
        '-b', '--no-browser', dest='no_browser', action='store_true', help='Do not open browser when starting AiXBlock'
    )
    root_parser.add_argument(
    ...
    root_parser.add_argument(
        ...
        type=str,
        default='',
        help='AiXBlock full hostname for generating imported task urls, sample task urls, static loading, etc.\n'
    ...
    parser = argparse.ArgumentParser(description='AiXBlock', parents=[root_parser])
    ...
    parser_start = subparsers.add_parser('start', help='Start AiXBlock server', parents=[root_parser])
