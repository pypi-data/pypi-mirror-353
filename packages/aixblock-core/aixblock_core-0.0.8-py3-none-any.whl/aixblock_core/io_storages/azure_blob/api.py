...
class AzureBlobImportStorageDetailAPI(ImportStorageDetailAPI):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        import_intance = AzureBlobImportStorage.objects.filter(id=import_id).first()
        AzureBlobExportStorage.objects.filter(id=import_intance.export_storage).delete()

        return super(AzureBlobImportStorageDetailAPI, self).delete(request, *args, **kwargs)
