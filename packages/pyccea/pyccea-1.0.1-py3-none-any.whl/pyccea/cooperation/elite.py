...
class SingleEliteCollaboration(Collaboration):
    ...
    def get_collaborators(self,
                          ...
                          fitness: list):
        """Set the collaborators of the individual given as a parameter as random individuals
        among the k best individuals in each subpopulation in the previous generation.
        ...
        """
        collaborators = [None] * len(previous_subpops)
        ...
        for i in range(len(previous_subpops)):
            ...
            # individuals of the subpopulation in the previous generation
                ...
                collaborator_pool = previous_subpops[i][ranking][:self.sample_size].copy()
