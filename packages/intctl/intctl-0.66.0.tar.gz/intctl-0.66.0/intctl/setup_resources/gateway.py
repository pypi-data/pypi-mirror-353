...
metadata:
  ...
  annotations:
    # Tells the cert-controller which ManagedCertificate CR to manage
...
spec:
  ...
  - name: https
    ...
    tls:
      mode: Terminate
      certificateRefs:
      - kind: Secret               # MUST be Secret for gke-l7-gxlb
        group: ""                  # empty group for core.v1 Secret
        name: {gateway_name}-cert  # Secret auto-generated from ManagedCertificate
    allowedRoutes:
      namespaces: {{ from: All }}
  addresses:
  - type: NamedAddress
