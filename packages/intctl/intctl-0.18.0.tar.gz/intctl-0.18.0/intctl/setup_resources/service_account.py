...
#TODO check for existing key if there is an existing key retrieve and use that one instead of creating a new one. 
    ...
    secret_name = f"{cfg['organization_uuid']}-{cfg['workspace_uuid']}-sa-key"
