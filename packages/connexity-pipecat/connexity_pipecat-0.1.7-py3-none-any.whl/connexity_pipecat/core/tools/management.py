...
from connexity_pipecat.core.tools.functions.call_management import (
    transfer_call,
    end_call,
    get_weekday,
    await_call_transfer,
)
from connexity_pipecat.core.tools.functions.scheduling import (
...
def get_supported_function_names() -> List[str]:
    ...
    """
    # `dict.keys()` returns a dynamic view; convert to list for a static copy.
...
# --------------------------------------------------------------------------- #
# Dynamic loader for external tool handlers & YAML presets                    #
# --------------------------------------------------------------------------- #

def register_custom_tools(
    handlers: str | None = "path/to/handlers/folder",
    function_configurations: str | None = "path/to/func/config",
) -> None:
    """
    ...
    # ------------------------------------------------------------------ #
    # 3.  Validation: every preset needs an implementation                #
    # ------------------------------------------------------------------ #
