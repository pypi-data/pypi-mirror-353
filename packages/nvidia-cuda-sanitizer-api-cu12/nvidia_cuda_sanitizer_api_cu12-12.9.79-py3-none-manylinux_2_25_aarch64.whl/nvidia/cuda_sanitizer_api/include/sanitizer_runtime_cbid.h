...
typedef enum SANITIZER_CBID_RUNTIME_API_enum {
    ...
    SANITIZER_CBID_RUNTIME_API_cudaMemcpyBatchAsync                                        = 482,
    SANITIZER_CBID_RUNTIME_API_cudaMemcpyBatchAsync_ptsz                                   = 483,
    SANITIZER_CBID_RUNTIME_API_cudaMemcpy3DBatchAsync                                      = 484,
    SANITIZER_CBID_RUNTIME_API_cudaMemcpy3DBatchAsync_ptsz                                 = 485,
    SANITIZER_CBID_RUNTIME_API_cudaEventElapsedTime_v2                                     = 486,
    SANITIZER_CBID_RUNTIME_API_SIZE                                                        = 487,
