...
class OcrService:
    ...
    def __init__(self, config: RettxConfig):
        ...
        validate_config_fields(config, required_fields, 'OcrService')
        ...
        try:
            ...
            logger.debug("OCR Service initialized successfully with Azure Document Analysis")
        except Exception as e:
            logger.error(f"Failed to initialize DocumentAnalysisClient: {e}")
            raise ValueError(f"OcrService initialization failed: {e}") from e
