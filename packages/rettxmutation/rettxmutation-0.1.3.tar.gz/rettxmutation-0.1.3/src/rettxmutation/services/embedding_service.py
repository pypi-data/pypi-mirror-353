...
class EmbeddingService:
    ...
    def __init__(self, embedding_client: EmbeddingClient):
        """
        Initialize the embedding service with an Azure OpenAI embedding client.

        Args:
            embedding_client: Configured EmbeddingClient for Azure OpenAI integration
            
        Raises:
            ValueError: If embedding_client is None
        """
        if embedding_client is None:
            raise ValueError("EmbeddingClient is required for EmbeddingService")
