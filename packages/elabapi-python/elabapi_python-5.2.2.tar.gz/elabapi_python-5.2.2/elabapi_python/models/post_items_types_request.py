...
class PostItemsTypesRequest(BaseModel):
    """
    PostItemsTypesRequest
    """ # noqa: E501
    ...
    color: Optional[StrictStr] = Field(default='A random suitable color', description="Hexadecimal color code for the category")
    __properties: ClassVar[List[str]] = ["body", "canread", "canwrite", "category", "date", "content_type", "custom_id", "metadata", "rating", "state", "status", "tags", "title", "template", "userid", "canread_is_immutable", "canwrite_is_immutable", "color"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostItemsTypesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostItemsTypesRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "color": obj.get("color") if obj.get("color") is not None else 'A random suitable color'
        })
        return _obj
