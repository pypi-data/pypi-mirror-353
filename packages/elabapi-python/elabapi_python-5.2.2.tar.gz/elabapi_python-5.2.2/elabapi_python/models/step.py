...
class Step(BaseModel):
    ...
    finished_time: Optional[StrictStr] = None
    deadline: Optional[StrictStr] = None
    deadline_notif: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "item_id", "body", "ordering", "finished", "finished_time", "deadline", "deadline_notif"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deadline_notif": obj.get("deadline_notif")
        })
        return _obj
