...
class ItemsApi:
    ...
    def delete_item(
        self,
        id: Annotated[StrictInt, Field(description="ID of the item")],
    ...
    def patch_item(
        self,
        id: Annotated[StrictInt, Field(description="ID of the item")],
        patch_item_request: Annotated[Optional[PatchItemRequest], Field(description="Parameters for patching an item")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID of the item (required)
        :type id: int
        :param patch_item_request: Parameters for patching an item
        :type patch_item_request: PatchItemRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _patch_item_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patch_item_request is not None:
            _body_params = patch_item_request
    ...
    def post_item(
        self,
        entity_editable: Annotated[Optional[EntityEditable], Field(description="Parameters for creating an item")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param entity_editable: Parameters for creating an item
        :type entity_editable: EntityEditable
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_item_serialize(
            entity_editable=entity_editable,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_item_without_preload_content(
        self,
        entity_editable: Annotated[Optional[EntityEditable], Field(description="Parameters for creating an item")] = None,
        _request_timeout: Union[
            None,
    ...
    def _post_item_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if entity_editable is not None:
            _body_params = entity_editable
    ...
    def post_item_by_id(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier of the item to duplicate.")],
        post_item_by_id_request: Annotated[Optional[PostItemByIdRequest], Field(description="Parameters for duplicating an item")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type id: int
        :param post_item_by_id_request: Parameters for duplicating an item
        :type post_item_by_id_request: PostItemByIdRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._post_item_by_id_serialize(
            id=id,
            post_item_by_id_request=post_item_by_id_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def post_item_by_id_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier of the item to duplicate.")],
        post_item_by_id_request: Annotated[Optional[PostItemByIdRequest], Field(description="Parameters for duplicating an item")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def post_item_by_id_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="The unique identifier of the item to duplicate.")],
        post_item_by_id_request: Annotated[Optional[PostItemByIdRequest], Field(description="Parameters for duplicating an item")] = None,
        _request_timeout: Union[
    ...
    def _post_item_by_id_serialize(
        self,
        id,
        post_item_by_id_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_item_by_id_request is not None:
            _body_params = post_item_by_id_request
    ...
    def read_items(
        ...
        related: Annotated[Optional[StrictInt], Field(description="Look only for entries linked to this item id. ")] = None,
        ...
        :type extended: str
        :param related: Look only for entries linked to this item id. 
        :type related: int
        ...
        _param = self._read_items_serialize(
            q=q,
            extended=extended,
            related=related,
    ...
    @validate_call
    def read_items_without_preload_content(
        self,
        q: Annotated[Optional[StrictStr], Field(description="Search for a term in title, body or elabid. ")] = None,
        extended: Annotated[Optional[StrictStr], Field(description="Extended search (advanced query). ")] = None,
        related: Annotated[Optional[StrictInt], Field(description="Look only for entries linked to this item id. ")] = None,
