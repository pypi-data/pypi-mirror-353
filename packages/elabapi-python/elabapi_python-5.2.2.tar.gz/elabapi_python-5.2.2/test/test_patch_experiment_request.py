...
class TestPatchExperimentRequest(unittest.TestCase):
    """PatchExperimentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatchExperimentRequest:
        """Test PatchExperimentRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchExperimentRequest`
        """
        model = PatchExperimentRequest()
        if include_optional:
            return PatchExperimentRequest(
                action = 'bloxberg',
                passphrase = 'hunter2',
                meaning = 40,
    ...
    def testPatchExperimentRequest(self):
        """Test PatchExperimentRequest"""
