...
class TestEntityTemplateEditable(unittest.TestCase):
    """EntityTemplateEditable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntityTemplateEditable:
        """Test EntityTemplateEditable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityTemplateEditable`
        """
        model = EntityTemplateEditable()
        if include_optional:
            return EntityTemplateEditable(
    ...
    def testEntityTemplateEditable(self):
        """Test EntityTemplateEditable"""
