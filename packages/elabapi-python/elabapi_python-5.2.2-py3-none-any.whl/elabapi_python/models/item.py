...
class Item(BaseModel):
    ...
    canbook: Optional[StrictStr] = None
    book_max_minutes: Optional[StrictInt] = None
    book_max_slots: Optional[StrictInt] = None
    book_can_overlap: Optional[StrictInt] = None
    book_users_can_in_past: Optional[StrictInt] = None
    book_is_cancellable: Optional[StrictInt] = None
    book_cancel_minutes: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["body", "canread", "canwrite", "category", "date", "content_type", "custom_id", "metadata", "rating", "state", "status", "tags", "title", "template", "userid", "access_key", "body_html", "category_color", "category_title", "comments", "compounds", "created_at", "elabid", "exclusive_edit_mode", "experiments_links", "firstname", "fullname", "has_attachement", "id", "items_links", "lastchangeby", "lastname", "locked", "lockedby", "locked_at", "modified_at", "next_step", "orcid", "page", "recent_comment", "related_experiments_links", "related_items_links", "sharelink", "status_color", "status_title", "steps", "tags_id", "team", "timestamped", "timestampedby", "timestamped_at", "type", "up_item_id", "uploads", "is_bookable", "canbook", "book_max_minutes", "book_max_slots", "book_can_overlap", "book_users_can_in_past", "book_is_cancellable", "book_cancel_minutes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "canbook": obj.get("canbook"),
            "book_max_minutes": obj.get("book_max_minutes"),
            "book_max_slots": obj.get("book_max_slots"),
            "book_can_overlap": obj.get("book_can_overlap"),
            "book_users_can_in_past": obj.get("book_users_can_in_past"),
            "book_is_cancellable": obj.get("book_is_cancellable"),
            "book_cancel_minutes": obj.get("book_cancel_minutes")
        })
        return _obj
