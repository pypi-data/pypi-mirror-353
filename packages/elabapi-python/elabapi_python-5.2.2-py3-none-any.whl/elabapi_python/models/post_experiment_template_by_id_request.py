...
class PostExperimentTemplateByIdRequest(BaseModel):
    """
    PostExperimentTemplateByIdRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["action", "copyFiles"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostExperimentTemplateByIdRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostExperimentTemplateByIdRequest from a dict"""
        if obj is None:
            return None
