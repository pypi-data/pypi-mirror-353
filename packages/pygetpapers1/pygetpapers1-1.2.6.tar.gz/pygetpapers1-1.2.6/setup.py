...
import configparser
import os
with open(os.path.join(os.path.dirname(__file__), "pygetpapers1", "config.ini")) as f:
    config_file = f.read()
...
setup(
    ...
    packages=[
        'pygetpapers1','pygetpapers1.repository'
    ],
    package_dir={'pygetpapers1':
                 'pygetpapers1',
                 },
    ...
    entry_points={
        'console_scripts': [
            'pygetpapers1=pygetpapers1.pygetpapers1:main',
        ],
    },
    python_requires='>=3.5',
