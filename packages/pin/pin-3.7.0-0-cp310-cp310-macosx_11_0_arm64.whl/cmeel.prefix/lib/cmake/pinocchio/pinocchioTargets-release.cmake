...
set_target_properties(pinocchio::pinocchio_default PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libpinocchio_default.3.7.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libpinocchio_default.3.7.0.dylib"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio_default )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio_default "${_IMPORT_PREFIX}/lib/libpinocchio_default.3.7.0.dylib" )
...
set_target_properties(pinocchio::pinocchio_collision PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libpinocchio_collision.3.7.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libpinocchio_collision.3.7.0.dylib"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio_collision )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio_collision "${_IMPORT_PREFIX}/lib/libpinocchio_collision.3.7.0.dylib" )
...
set_target_properties(pinocchio::pinocchio_visualizers PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libpinocchio_visualizers.3.7.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libpinocchio_visualizers.3.7.0.dylib"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio_visualizers )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio_visualizers "${_IMPORT_PREFIX}/lib/libpinocchio_visualizers.3.7.0.dylib" )
...
set_target_properties(pinocchio::pinocchio_parsers PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libpinocchio_parsers.3.7.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libpinocchio_parsers.3.7.0.dylib"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio_parsers )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio_parsers "${_IMPORT_PREFIX}/lib/libpinocchio_parsers.3.7.0.dylib" )
...
set_target_properties(pinocchio::pinocchio_pywrap_default PROPERTIES
  IMPORTED_LOCATION_RELEASE "${PACKAGE_PREFIX_DIR}/lib/python3.10/site-packages/pinocchio/pinocchio_pywrap_default.3.7.0.cpython-310-darwin.so"
  IMPORTED_SONAME_RELEASE "@rpath/pinocchio_pywrap_default.3.7.0.cpython-310-darwin.so"
  )

list(APPEND _cmake_import_check_targets pinocchio::pinocchio_pywrap_default )
list(APPEND _cmake_import_check_files_for_pinocchio::pinocchio_pywrap_default "${PACKAGE_PREFIX_DIR}/lib/python3.10/site-packages/pinocchio/pinocchio_pywrap_default.3.7.0.cpython-310-darwin.so" )
