...
from smtpymailer.types import guess_type_by_extension
...
def convert_html_to_plain_text(html_text: str) -> str:
    ...
    h.ignore_links = True
    h.strong_mark = "**"  # Retain bold markers
    h.emphasis_mark = "*"  # Retain italic markers
    h.ul_item_mark = ""
    ...
    # Remove excess whitespace but preserve one blank line
    plain_text = re.sub(r"\n\s*\n+", "\n\n", plain_text)
