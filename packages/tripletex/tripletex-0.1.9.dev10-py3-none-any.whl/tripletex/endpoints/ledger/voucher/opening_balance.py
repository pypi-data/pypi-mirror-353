...
class TripletexVoucherOpeningBalance(TripletexGroup):
    """API methods for interacting with opening balance vouchers."""

    _resource_path = "openingBalance"
    _datamodel = VoucherOpeningBalance
    _api_response_model = VoucherOpeningBalanceResponse
