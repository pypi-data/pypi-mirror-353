...
async def list_app_ids():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to list app_ids: {str(e)}")
...
async def list_project_ids():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to list project_ids: {str(e)}")
...
async def list_ticket_ids():
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to list ticket_ids: {str(e)}") 