...
from config import (
    ...
    EMBEDDING_MODEL_ENDPOINT, CHAT_COMPLETIONS_ENDPOINT,
...
async def synthesize_search_results(query_text: str, chunks: List[RetrievedChunk], client: httpx.AsyncClient) -> Optional[str]:
    if not chunks:
        return None
...
async def startup_event():
    ...
    try:
        ...
        if QDRANT_COLLECTION_NAME not in collection_names:
            ...
            qdrant_client.create_collection(**collection_params)
