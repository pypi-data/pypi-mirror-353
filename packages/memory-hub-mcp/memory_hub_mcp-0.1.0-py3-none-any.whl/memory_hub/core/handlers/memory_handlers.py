...
async def add_memory(memory_item: MemoryItemIn, client: httpx.AsyncClient):
    """
...
async def search_memories(search_request: MemorySearchRequest, client: httpx.AsyncClient):
    """
