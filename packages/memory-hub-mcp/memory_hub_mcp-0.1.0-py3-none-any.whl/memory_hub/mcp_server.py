...
from .core.services import startup_event
        ...
        async def call_tool(name: str, arguments: Dict[str, Any]) -> List[TextContent | ImageContent | EmbeddedResource]:
            ...
            try:
                if name == "add_memory":
                    ...
                    result = await add_memory_handler(memory_item, self.http_client)
                    return [TextContent(
                        type="text",
                    ...
                    result = await search_memories_handler(search_request, self.http_client)
                    ...
                    result = await list_app_ids_handler()
                    return [TextContent(
                        type="text", 
                    ...
                    result = await list_project_ids_handler()
                    return [TextContent(
                        type="text",
                    ...
                    result = await list_ticket_ids_handler()
                    return [TextContent(
                        type="text",
...
def create_server() -> MemoryHubMCPServer:
    """Factory function to create server instance"""
    return MemoryHubMCPServer() 