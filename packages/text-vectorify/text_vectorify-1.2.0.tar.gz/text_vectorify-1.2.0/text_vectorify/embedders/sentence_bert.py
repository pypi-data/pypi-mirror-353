...
class SentenceBertEmbedder(BaseEmbedder):
    """Sentence-BERT embedder for text vectorization"""
    ...
    def load_model(self):
        ...
        try:
            ...
            model_cache_dir = self.cache_dir / "models" / "sentence_transformers"
            ...
            logger.info(f"SentenceBERT model loaded: {self.model_name}")
        except ImportError:
