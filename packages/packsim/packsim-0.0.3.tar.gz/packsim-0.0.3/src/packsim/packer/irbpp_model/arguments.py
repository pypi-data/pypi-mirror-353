...
def get_args():
    ...
    parser.add_argument('--save-interval', default=100, help='How often to save the model.')
    ...
    # args.bin_dimension = np.round([0.5, 0.5, 0.50], decimals=6)
    # args.bin_dimension = np.round([0.05, 0.05, 0.10], decimals=6)
