...
class ColumnInfoMixin:
    ...
    def resolve_fronted_config_for_class(cls, class_name: str) -> Model | None:
        ...
        frontend_config = cls._first_frontend_config(class_name)
    ...
    @classmethod
    def _first_frontend_config(cls, class_name: str) -> Model | None:
        return None
        from amsdal.contrib.frontend_configs.models.frontend_model_config import FrontendModelConfig
    ...
    async def aresolve_fronted_config_for_class(cls, class_name: str) -> Model | None:
        ...
        frontend_config = await cls._afirst_frontend_config(class_name)
    ...
    @classmethod
    async def _afirst_frontend_config(cls, class_name: str) -> Model | None:
        return None
        from amsdal.contrib.frontend_configs.models.frontend_model_config import FrontendModelConfig
