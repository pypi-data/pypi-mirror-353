...
db_name = "ifls"
data_source = {"morningstar_xml":"asset_morningstar_regional_asset_allocation"}
...
class PortfolioListsColumn:
    def __init__(self):
        ...
        self.target_field_path = ["Portfolio.PortfolioBreakdown.RegionalAssetAllocation.AssetAllocationBreakdown"]
