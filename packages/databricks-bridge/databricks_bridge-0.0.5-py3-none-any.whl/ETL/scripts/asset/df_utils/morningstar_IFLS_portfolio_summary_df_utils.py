...
db_name = "ifls"
data_source = {"morningstar_xml":"asset_morningstar_portfolio_summary"}
...
class PortfolioListsColumn:
    def __init__(self):
        ...
        self.target_field_path = [
                                    "Portfolio.PortfolioSummary.AggregatedHoldingAggregate"]
...
class MorningstarXMLTable(TablesDynamic):
    ...
    def get_spark_schema():
        return StructType([
            ...
            StructField('sale_position', StringType()), 
            StructField('number_of_holding', StringType()),
            StructField('number_of_stock_holding', StringType()),
            StructField('number_of_bond_holding', StringType()),
