...
db_name = "ifls"
data_source = {"morningstar_xml":"asset_morningstar_credit_rating"}
...
class PortfolioListsColumn:
    def __init__(self):
        ...
        self.target_field_path = ["Portfolio.PortfolioBreakdown.CreditRatingBreakdownCalculated.BreakdownValue"]
...
class MorningstarXMLTable(TablesDynamic):
    ...
    def get_spark_schema():
        return StructType([
            ...
            StructField('credit_rating_type', StringType()), 
            StructField('credit_rating_value', StringType())
            ])
