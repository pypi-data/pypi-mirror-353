...
from ETL.scripts.pod_tracking.df_utils.profiles_pod_bc_df_utils import PodBCTable

set_logger_level_error(locals())
script_path = f"{os.path.abspath('')}/profiles_pod_bc.py"
etl_data_name = "profiles_pod_bc"
