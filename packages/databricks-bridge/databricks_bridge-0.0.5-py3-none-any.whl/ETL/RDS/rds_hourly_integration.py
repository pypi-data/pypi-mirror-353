...
from ETL.RDS.rds_df_utils.rds_hourly_df_utils import RDSConfigTable, db_name, checkpoint_dir

set_logger_level_error(locals())
script_path = f"{os.path.abspath('')}/rds_hourly_integration.py"
...
@log_general_info(
    env=locals(),
    etl_data="rds_hourly_integration",
