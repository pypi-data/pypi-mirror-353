...
from ETL.scripts.asset.df_utils.morningstar_IFLS_df_utils import ColumnClasses, MorningstarXMLTable, db_name

script_path = f"{os.path.abspath('')}/morningstar_IFLS.py"
