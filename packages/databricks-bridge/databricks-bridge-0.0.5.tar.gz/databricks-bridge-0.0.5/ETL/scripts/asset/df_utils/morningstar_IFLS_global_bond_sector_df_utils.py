...
db_name = "ifls"
data_source = {"morningstar_xml":"asset_morningstar_global_bond_sector"}
...
class PortfolioListsColumn:
    def __init__(self):
        ...
        self.target_field_path = ["Portfolio.PortfolioBreakdown.GlobalBondSector.GlobalBondSectorBreakdown"]
