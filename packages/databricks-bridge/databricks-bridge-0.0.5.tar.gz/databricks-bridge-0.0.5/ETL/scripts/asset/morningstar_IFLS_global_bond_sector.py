...
from ETL.scripts.asset.df_utils.morningstar_IFLS_global_bond_sector_df_utils import ColumnClasses, MorningstarXMLTable, db_name

script_path = f"{os.path.abspath('')}/morningstar_IFLS_global_bond_sector.py"
...
@log_general_info(
    env=locals(),
    etl_data="morningstar_IFLS_global_bond_sector",
