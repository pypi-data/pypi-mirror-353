...
from ETL.scripts.asset.df_utils.morningstar_IFLS_portfolio_summary_df_utils import ColumnClasses, MorningstarXMLTable, db_name

script_path = f"{os.path.abspath('')}/morningstar_IFLS_portfolio_summary.py"
...
@log_general_info(
    env=locals(),
    etl_data="morningstar_IFLS_portfolio_summary",
