...
class DDL:
    ...
    def get_data_from_server(self, uid: str, client_address: str, timeout_ms: int = 5000) -> tuple[bytes, str | None]:
        """
        ...
        Args:
            ...
            client_address (str): The full address (e.g., "tcp://localhost:5555")
