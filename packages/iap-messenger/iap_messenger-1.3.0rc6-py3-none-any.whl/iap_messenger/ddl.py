...
class DDL:
    ...
    def _server_loop(self) -> None:
        ...
        while True:
            LOGGER.debug("DDL Server waiting for request...")
            #  Wait for next request from client
            uid_request = socket.recv_string()
            LOGGER.info(f"DDL received {uid_request}...")
            data_to_send = self.datastore[uid_request]
            LOGGER.info(f"DDL Serving {uid_request}...")
            #  Send reply back to client
            socket.send(data_to_send)
            LOGGER.info(f"DDL Served {uid_request}")

    # def _server_loop_nok(self) -> None:
    #     """
    ...
    #             LOGGER.debug("Server polling for incoming requests...")
    ...
    #                 LOGGER.debug("Server received a request.")
    ...
    #                     break
    #                 else:
    #                     LOGGER.debug("Server loop: No incoming requests, continuing to poll.")
