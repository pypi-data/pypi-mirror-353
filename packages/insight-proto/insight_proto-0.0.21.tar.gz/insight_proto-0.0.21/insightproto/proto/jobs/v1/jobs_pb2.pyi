...
class Trigger(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["author", b"author", "source", b"source"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["author", b"author", "reference_id", b"reference_id", "source", b"source", "text", b"text"]) -> None: ...
