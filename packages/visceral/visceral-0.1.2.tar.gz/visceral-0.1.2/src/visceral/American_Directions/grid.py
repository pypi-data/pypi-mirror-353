...
@retry_on_json_error
def grid_question_AMI(openai_model, prompt,sync_layer, general_tagged):
        schema = """
        {
        "ask_logic": "", 
        ...
        parsed_text = openai_model.client_open_ai.chat.completions.create(
            ...
            messages=[
                ...
                Important: do not include option numbers in the column and row labels. Intelligently determine which options should be assigned to rows and which should be assigned to columns.
...
@retry_on_json_error
def grid_logic_AMI(openai_model, input_json,user_logic, input_text, logic_tagged):
