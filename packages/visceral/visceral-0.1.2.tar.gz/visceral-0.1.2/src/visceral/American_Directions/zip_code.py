...
@retry_on_json_error
def zip_code_question_AMI(oepnai_model, prompt,sync_layer, general_tagged):
        schema = """
        {
...
@retry_on_json_error
def zip_code_logic_AMI(openai_model, input_json,user_logic,input_text, logic_tagged):
