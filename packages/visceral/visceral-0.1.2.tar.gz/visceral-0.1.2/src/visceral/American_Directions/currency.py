...
@retry_on_json_error
def currency_question_AMI(openai_model, prompt,sync_layer,general_tagged):
        schema = """
       {
        ...
        parsed_text = openai_model.client_open_ai.chat.completions.create(
           ...
           Parsing Rules:
            ...
            Input:
            ```
            QM. Demo Currecny question 2 ? aijsdajs
            ```
            ...
            {{
                "ask_logic": "",
                "questionLabel": "QM",
                "question": "Demo Currecny question 2 ? aijsdajs",
                "type": "currency",
                "currency": "USD"
            }}
            ```
...
@retry_on_json_error
def currency_logic_AMI(openai_model, input_json,user_logic, input_text,logic_tagged):
