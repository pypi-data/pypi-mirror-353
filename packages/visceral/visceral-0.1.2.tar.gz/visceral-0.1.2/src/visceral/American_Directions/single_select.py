...
@retry_on_json_error
def single_select_question_AMI(openai_model, prompt,sync_layer,general_tagged):
        schema = """
        {
        ...
        parsed_text = openai_model.client_open_ai.chat.completions.create(
            ...
            messages=[
                ...
                - capture the question label correctly.
...
@retry_on_json_error
def single_select_logic_AMI(openai_model,input_json,user_logic, input_text,logic_tagged):
