...
@retry_on_json_error
def single_text_question(openai_model, prompt,sync_layer, general_tagged):
        schema = """
        {
...
@retry_on_json_error
def single_text_logic(openai_model, input_json,user_logic,input_text, logic_tagged):
