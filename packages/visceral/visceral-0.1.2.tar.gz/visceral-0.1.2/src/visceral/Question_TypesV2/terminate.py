...
@retry_on_json_error 
def terminate_question(openai_model, prompt,general_tagged):
        schema = """
        {
        ...
        parsed_text = openai_model.client_open_ai.chat.completions.create(
            ...
            messages=[
                ...
                2. Question Text:  
                - Capture the main question text that we will show to the user taking the survey.  
                - Do not include unnecessary information that is not displayed to the user.  
