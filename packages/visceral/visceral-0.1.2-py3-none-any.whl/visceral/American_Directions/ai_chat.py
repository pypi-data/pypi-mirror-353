...
@retry_on_json_error
def ai_question_AMI(openai_model, prompt,sync_layer,general_tagged):
        schema = """
        {
        ...
        parsed_text = openai_model.client_open_ai.chat.completions.create(
            ...
            messages=[
                ...
                7. Please capture the text after Ref if is given in the inpuit text into a field called "Ref" for exmaple if the input text has : Ref:PHONEINTRO then your output should have "Ref":"PHONEINTRO"
