...
@retry_on_json_error
def grid_question(openai_model, prompt):
        schema = """
        {
        "ask_logic": "", 
        ...
        parsed_text = openai_model.client_open_ai.chat.completions.create(
            ...
            messages=[
                ...
                Do not include option numbers in the column and row labels. Intelligently determine which options should be assigned to rows and which should be assigned to columns.
...
@retry_on_json_error
def grid_logic(openai_model, input_json,user_logic, input_text):
