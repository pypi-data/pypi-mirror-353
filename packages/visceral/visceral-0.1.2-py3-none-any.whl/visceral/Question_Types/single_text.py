...
def single_text_question(openai_model, prompt):
        schema = """
        {
        ...
        parsed_text = openai_model.client_open_ai.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "You are a precise survey question parser that captures every detail without losing any information. The most important thing is that we should not delete even a single dot. You are dealing with single_text question type"},
                {"role": "user", "content": f"""
                ...
                "what if your name? `{{"(Disqualify if name=="XYZ")": None}}`"
                ...
                important: make sure to capture any ask_logic in the question.
                the ask if logic can be in brackets or without brackets.
...
def single_text_logic(openai_model, input_json,user_logic):
    ...
    parsed_text = openai_model.client_open_ai.chat.completions.create(
        ...
        messages=[
            ...
            {{
                    ...
                    "type":"single_text",
                    "extra_text":"",
                    "single_text_logic": {{"Terminating":"QM=="XYZ"}}
            ...
            Important: there can be multiple logics in the single_text_logic, so please add all that you can infer. 
