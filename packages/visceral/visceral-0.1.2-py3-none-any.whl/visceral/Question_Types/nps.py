...
def nps_question(openai_model, prompt):
        ...
        parsed_text = openai_model.client_open_ai.chat.completions.create(
            ...
            messages=[
                ...
                only if you've captured the ask if logic in ask_logic, then you dont need to have it in the question text.
...
def nps_logic(openai_model, input_json,user_logic):
    ...
    parsed_text = openai_model.client_open_ai.chat.completions.create(
        ...
        messages=[
            ...
            You will primarily see logics captured in `{{}}`. you goal is to understand if that logic falls in the above 3 categories of logics we support for the nps. 
