...
@retry_on_json_error
def zip_code_question(oepnai_model, prompt,sync_layer, general_tagged):
        schema = """
        {
            ...
            "type":zip_code",
            "country": string #capture the country if mentioned in the text, else by default it will be "USA"
        }
        """
        ...
        parsed_text = oepnai_model.client_open_ai.chat.completions.create(
            ...
            messages=[
                ...
                ```
                Ask if Q3==0 \n
                QM. Demo Zip code Question? Disqualify if QM=="XYZ" \n 
                ```
                ...
                {{
                    ...
                    "questionLabel": "QM",
                    "question": "Demo Zip code Question? `{{"Disqualify if QM=="XYZ"": None}}` \n random text",
                    "extra_text":"",
                    "type":"zip_code",
                    "country":"USA"
...
@retry_on_json_error
def zip_code_logic(openai_model, input_json,user_logic,input_text, logic_tagged):
    ...
    parsed_text = openai_model.client_open_ai.chat.completions.create(
        ...
        messages=[
            ...
            You will receive a JSON containing a zipcode question. 
            ...
            In the question if you observe any logic that we support. Then please add another field saying zip_code_logic and the key value pair will be the following. 
            ...
            - If you observe any logic that we support, add a new field called `"zip_code_logic"` with the following format:
            ...
            Important: There can be multiple logics in the zip_code_logic field, so ensure that you add all the logics you can infer from the provided data.
