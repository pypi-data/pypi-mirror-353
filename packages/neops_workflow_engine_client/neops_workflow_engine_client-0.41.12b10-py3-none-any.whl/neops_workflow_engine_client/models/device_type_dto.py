...
class DeviceTypeDto(BaseModel):
    ...
    first_seen_at: Optional[StrictStr] = Field(default=None, alias="firstSeenAt")
    ...
    inventory_updated_at: Optional[StrictStr] = Field(default=None, alias="inventoryUpdatedAt")
