...
#   timestamp: 2025-06-05T22:04:55+00:00
...
from pydantic import Field as PydanticField, RootModel
...
class FieldBase(TableauModel):
    fieldCaption: Annotated[
        str,
        PydanticField(
            description='Either the name of a specific PydanticField in the data source, or, in the case of a calculation, a user-supplied name for the calculation.'
        ),
    ]
    ...
    sortPriority: Annotated[
        Optional[int],
        PydanticField(
            description='To enable sorting on a specific PydanticField, provide a sortPriority for that field, and that field will be sorted. The sortPriority provides a ranking of how to sort fields when multiple fields are being sorted. The highest priority (lowest number) field is sorted first. If only one field is being sorted, then any value may be used for sortPriority. SortPriority should be an integer greater than 0.'
        ),
    ] = None
...
class CalculatedField(FieldBase):
    calculation: Annotated[
        str,
        PydanticField(
            description='A Tableau calculation that will be returned as a PydanticField in the query.'
        ),
    ]
    fieldCaption: Optional[Any] = None
    fieldAlias: Optional[Any] = None
