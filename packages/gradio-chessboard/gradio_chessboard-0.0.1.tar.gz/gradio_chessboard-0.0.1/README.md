...
- **As output:** Is passed, a chess.Board object if payload is provided, otherwise None.
- **As input:** Should return, a chess.Board object representing the current state of the chessboard, or None if no value is provided.
