...
VALID_ENV_EXTENSIONS: Set[str] = {
    '', '.env', '.txt', '.conf', '.config', '.cfg'
}
...
LOGGED_OPERATIONS: Set[str] = {
    'load', 'get', 'set', 'delete', 'clear', 'scan',
    'validate', 'parse', 'access', 'integrity_check'
}

# Security events to monitor
SECURITY_EVENTS: Set[str] = {
    'path_traversal_attempt', 'oversized_file', 'invalid_input',
    'unauthorized_access', 'integrity_violation', 'suspicious_pattern',
    'rate_limit_exceeded', 'session_violation'
}
