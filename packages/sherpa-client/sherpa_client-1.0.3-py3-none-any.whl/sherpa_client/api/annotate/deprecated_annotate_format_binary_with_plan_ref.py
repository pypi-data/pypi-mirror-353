...
from ...models.deprecated_annotate_format_binary_with_plan_ref_body import (
...
def _get_kwargs(
    ...
    plan_name: str,
    *,
    body: DeprecatedAnnotateFormatBinaryWithPlanRefBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{project_name}/plans/{plan_name}/_annotate_format_binary".format(
