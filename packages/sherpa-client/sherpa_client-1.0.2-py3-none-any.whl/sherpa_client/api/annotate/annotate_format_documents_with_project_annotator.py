...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/annotate/projects/{project_name}/annotators/{annotator}/_annotate_format_documents".format(
    ...
    _body = []
    for componentsschemas_input_document_array_item_data in body:
        componentsschemas_input_document_array_item = (
            componentsschemas_input_document_array_item_data.to_dict()
        )
        _body.append(componentsschemas_input_document_array_item)
