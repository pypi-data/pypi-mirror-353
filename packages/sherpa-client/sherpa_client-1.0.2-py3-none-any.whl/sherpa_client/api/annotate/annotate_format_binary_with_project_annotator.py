...
from ...models.annotate_format_binary_with_project_annotator_body import (
...
def _get_kwargs(
    ...
    annotator: str,
    *,
    body: AnnotateFormatBinaryWithProjectAnnotatorBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/annotate/projects/{project_name}/annotators/{annotator}/_annotate_format_binary".format(
