...
if TYPE_CHECKING:
    from ..models.new_theme import NewTheme


T = TypeVar("T", bound="CreateThemeForm")
...
class CreateThemeForm:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_theme, Unset):
            ...
            theme = NewTheme.from_dict(_theme)

        create_theme_form = cls(
