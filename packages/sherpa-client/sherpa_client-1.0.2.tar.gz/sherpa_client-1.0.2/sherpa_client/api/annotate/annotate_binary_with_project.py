...
from ...models.annotate_binary_with_project_body import AnnotateBinaryWithProjectBody
...
def _get_kwargs(
    project_name: str,
    *,
    body: AnnotateBinaryWithProjectBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/annotate/projects/{project_name}/_annotate_binary".format(
