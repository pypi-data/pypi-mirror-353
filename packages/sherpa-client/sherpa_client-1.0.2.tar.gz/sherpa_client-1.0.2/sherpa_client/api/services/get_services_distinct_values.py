...
from ...models.get_services_distinct_values_response_200_item import (
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = GetServicesDistinctValuesResponse200Item.from_dict(
...
def sync(
    *,
    ...
    Returns:
        list['GetServicesDistinctValuesResponse200Item']
    """
