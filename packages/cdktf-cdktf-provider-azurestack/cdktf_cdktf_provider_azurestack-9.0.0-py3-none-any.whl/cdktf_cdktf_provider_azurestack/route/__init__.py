...
class Route(
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Route that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/azurestack/1.0.0/docs/resources/route#import import section} in the documentation of this resource for the id to use
        :param provider: ? Optional instance of the provider where the Route to import is found.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b36c22d096af56bba04e74ae87665e917d0fae9a07b1378f2941efa865f2e2ed)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
...
def _typecheckingstub__b36c22d096af56bba04e74ae87665e917d0fae9a07b1378f2941efa865f2e2ed(
    scope: _constructs_77d1e7e8.Construct,
    import_to_id: builtins.str,
    import_from_id: builtins.str,
    provider: typing.Optional[_cdktf_9a9027ec.TerraformProvider] = None,
