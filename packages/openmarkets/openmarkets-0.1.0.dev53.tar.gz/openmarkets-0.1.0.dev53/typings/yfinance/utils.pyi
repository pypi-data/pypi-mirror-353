...
def is_isin(string): ...
def get_all_by_isin(isin, proxy=..., session: Incomplete | None = None): ...
def get_ticker_by_isin(isin, proxy=..., session: Incomplete | None = None): ...
def get_info_by_isin(isin, proxy=..., session: Incomplete | None = None): ...
def get_news_by_isin(isin, proxy=..., session: Incomplete | None = None): ...
...
def format_annual_financial_statement(
    ...
    annual_dicts,
    annual_order,
    ttm_dicts: Incomplete | None = None,
    ttm_order: Incomplete | None = None,
): ...
def format_quarterly_financial_statement(_statement, level_detail, order): ...
def camel2title(
    strings: list[str], sep: str = ' ', acronyms: list[str] | None = None
) -> list[str]: ...
