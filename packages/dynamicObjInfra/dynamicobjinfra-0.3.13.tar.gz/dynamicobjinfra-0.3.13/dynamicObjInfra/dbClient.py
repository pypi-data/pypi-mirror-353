...
class DBClient(metaclass=Singleton):
    ...
    @validate_base_obj_cls
    def loadFromDB(self, cls, field_value, field_name: str = 'id', locale: str = None, gender: str | None = None):
        if (self.useRedisCache and cls.isCached):
    ...
    def _applyTranslations(self, obj: BaseObj, locale: str, gender: str | None):
