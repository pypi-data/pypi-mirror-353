...
# Example from https://github.com/psf/monochromatic/issues/3229
...
# https://github.com/psf/monochromatic/pull/3370 causes an infinite recursion.
assert (
    long_module.long_class.long_func().another_func()
    == long_module.long_class.long_func()["some_key"].another_func(arg1)
)

# Regression test for https://github.com/psf/monochromatic/issues/3414.
