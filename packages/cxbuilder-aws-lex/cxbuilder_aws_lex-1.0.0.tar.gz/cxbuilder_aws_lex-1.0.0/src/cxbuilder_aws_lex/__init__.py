...
class Locale(metaclass=jsii.JSIIMeta, jsii_type="@cxbuilder/aws-lex.Locale"):
    ...
    def add_permission(self, bot_alias_arn: builtins.str) -> None:
        '''
        :param bot_alias_arn: -
        '''
        if __debug__:
        ...
        return typing.cast(None, jsii.invoke(self, "addPermission", [bot_alias_arn]))
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"dialog": "dialog", "fn": "fn", "fulfillment": "fulfillment"},
)
class LocaleCodeHook:
    def __init__(
        self,
        *,
        dialog: builtins.bool,
    ...
    @builtins.property
    def dialog(self) -> builtins.bool:
        '''Whether to invoke the lambda for each dialog turn.'''
        result = self._values.get("dialog")
        assert result is not None, "Required property 'dialog' is missing"
