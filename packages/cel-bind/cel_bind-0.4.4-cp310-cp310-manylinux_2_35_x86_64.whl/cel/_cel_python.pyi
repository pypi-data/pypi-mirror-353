...
class Compiler:
    ...
    """
    def __init__(self, arg0: DescriptorPool, arg1: dict[str, BoolType | IntType | UintType | DoubleType | StringType | BytesType | NullType | Descriptor | ListType], arg2: FunctionRegistry | None) -> None:
        ...
...
class Interpreter:
    ...
    def evaluate(self, expr_plan: CelExpression, environment: dict[str, typing.Any]) -> bool | int | int | float | str | bytes | None | dict | list:
        ...
        """
class ListType:
    def __init__(self, arg0: BoolType | IntType | UintType | DoubleType | StringType | BytesType | NullType | ... | ListType) -> None:
        ...
class NullType:
    def __init__(self) -> None:
        ...
