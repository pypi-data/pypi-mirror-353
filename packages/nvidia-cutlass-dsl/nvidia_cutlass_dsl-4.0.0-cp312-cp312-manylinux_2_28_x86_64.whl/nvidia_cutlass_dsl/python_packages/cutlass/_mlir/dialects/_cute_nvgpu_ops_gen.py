...
class ArchMmaSM80Op(_ods_ir.OpView):
  ...
  def __init__(self, res, shape_MNK, a_type, b_type, opA, opB, opC, *, int_overflow=None, binary_op=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_1289')) else
      _ods_ir.AttrBuilder.get('anonymous_1289')(a_type, context=_ods_context))
    attributes["b_type"] = (b_type if (
    isinstance(b_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1289')) else
      _ods_ir.AttrBuilder.get('anonymous_1289')(b_type, context=_ods_context))
...
class ArchMmaSM80SparseOp(_ods_ir.OpView):
  ...
  def __init__(self, res, shape_MNK, a_type, b_type, c_type, metadata, opA, opB, opC, opE, *, int_overflow=None, loc=None, ip=None):
    ...
    attributes["a_type"] = (a_type if (
    isinstance(a_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1296')) else
      _ods_ir.AttrBuilder.get('anonymous_1296')(a_type, context=_ods_context))
    attributes["b_type"] = (b_type if (
    isinstance(b_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1296')) else
      _ods_ir.AttrBuilder.get('anonymous_1296')(b_type, context=_ods_context))
    attributes["c_type"] = (c_type if (
    isinstance(c_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1299')) else
      _ods_ir.AttrBuilder.get('anonymous_1299')(c_type, context=_ods_context))
    attributes["metadata"] = (metadata if (
    isinstance(metadata, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1302')) else
      _ods_ir.AttrBuilder.get('anonymous_1302')(metadata, context=_ods_context))
    if int_overflow is not None: attributes["int_overflow"] = (int_overflow if (
        isinstance(int_overflow, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('CuteMMAIntOverflowAttr')) else
          _ods_ir.AttrBuilder.get('CuteMMAIntOverflowAttr')(int_overflow, context=_ods_context))
...
class ArchMmaSM89Op(_ods_ir.OpView):
  ...
  def __init__(self, res, shape_MNK, a_type, b_type, opA, opB, opC, *, loc=None, ip=None):
    ...
    attributes["a_type"] = (a_type if (
    isinstance(a_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1308')) else
      _ods_ir.AttrBuilder.get('anonymous_1308')(a_type, context=_ods_context))
    attributes["b_type"] = (b_type if (
    isinstance(b_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1308')) else
      _ods_ir.AttrBuilder.get('anonymous_1308')(b_type, context=_ods_context))
    results.extend(res)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
class ArchMmaSM90Op(_ods_ir.OpView):
  ...
  def __init__(self, res, shapeMNK, a_op, a_type, a_major, b_op, b_type, b_major, c_op, cd_type, accum, *, a_neg=None, b_neg=None, saturate=None, loc=None, ip=None):
    ...
    attributes["a_type"] = (a_type if (
    isinstance(a_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1338')) else
      _ods_ir.AttrBuilder.get('anonymous_1338')(a_type, context=_ods_context))
    ...
    isinstance(b_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1338')) else
      _ods_ir.AttrBuilder.get('anonymous_1338')(b_type, context=_ods_context))
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_1341')) else
      _ods_ir.AttrBuilder.get('anonymous_1341')(cd_type, context=_ods_context))
...
class ArchMmaSM120BlockScaledOp(_ods_ir.OpView):
  ...
  def __init__(self, res, shape_MNK, vec_size, a_type, b_type, sf_type, opA, opB, opC, sfA, sfB, *, byte_id_a=None, byte_id_b=None, thread_id_a=None, thread_id_b=None, loc=None, ip=None):
    ...
    attributes["a_type"] = (a_type if (
    isinstance(a_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1319')) else
      _ods_ir.AttrBuilder.get('anonymous_1319')(a_type, context=_ods_context))
    attributes["b_type"] = (b_type if (
    isinstance(b_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1319')) else
      _ods_ir.AttrBuilder.get('anonymous_1319')(b_type, context=_ods_context))
    attributes["sf_type"] = (sf_type if (
    isinstance(sf_type, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('anonymous_1322')) else
      _ods_ir.AttrBuilder.get('anonymous_1322')(sf_type, context=_ods_context))
    results.append(res)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
@_ods_cext.register_operation(_Dialect)
class AtomGetCountingTensorOp(_ods_ir.OpView):
  OPERATION_NAME = "cute_nvgpu.atom.get_counting_tensor"
...
def atom_get_counting_tensor(atom, shape, *, offset_b=None, layout_b=None, loc=None, ip=None) -> _ods_ir.Value:
  return AtomGetCountingTensorOp(atom=atom, shape=shape, offset_b=offset_b, layout_b=layout_b, loc=loc, ip=ip).result
...
@_ods_cext.register_operation(_Dialect)
class AtomMmaMakeSM90Op(_ods_ir.OpView):
  OPERATION_NAME = "cute_nvgpu.make_sm90_mma"

  _ODS_REGIONS = (0, True)

  def __init__(self, result, accum_c, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(accum_c))
    _ods_context = _ods_get_default_loc_context(loc)
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
def make_sm90_mma(result, accum_c, *, loc=None, ip=None) -> _ods_ir.Value:
  return AtomMmaMakeSM90Op(result=result, accum_c=accum_c, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class AtomMmaMakeSM100UMMABlockScaledOp(_ods_ir.OpView):
  OPERATION_NAME = "cute_nvgpu.make_sm100_mma_bs"

  _ODS_REGIONS = (0, True)

  def __init__(self, result, accum_c, neg_a, neg_b, sf_a, sf_b, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    operands.append(_get_op_result_or_value(accum_c))
    operands.append(_get_op_result_or_value(neg_a))
    operands.append(_get_op_result_or_value(neg_b))
    operands.append(_get_op_result_or_value(sf_a))
    operands.append(_get_op_result_or_value(sf_b))
    _ods_context = _ods_get_default_loc_context(loc)
    results.append(result)
...
def make_sm100_mma_bs(result, accum_c, neg_a, neg_b, sf_a, sf_b, *, loc=None, ip=None) -> _ods_ir.Value:
  return AtomMmaMakeSM100UMMABlockScaledOp(result=result, accum_c=accum_c, neg_a=neg_a, neg_b=neg_b, sf_a=sf_a, sf_b=sf_b, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class AtomMmaMakeSM100UMMABlockScaledSparseOp(_ods_ir.OpView):
  OPERATION_NAME = "cute_nvgpu.make_SM100_mma_bs_sp"

  _ODS_REGIONS = (0, True)

  def __init__(self, result, accum_c, neg_a, neg_b, sf_a, sf_b, e, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    operands.append(_get_op_result_or_value(sf_a))
    operands.append(_get_op_result_or_value(sf_b))
    operands.append(_get_op_result_or_value(e))
    _ods_context = _ods_get_default_loc_context(loc)
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
...
def make_SM100_mma_bs_sp(result, accum_c, neg_a, neg_b, sf_a, sf_b, e, *, loc=None, ip=None) -> _ods_ir.Value:
  return AtomMmaMakeSM100UMMABlockScaledSparseOp(result=result, accum_c=accum_c, neg_a=neg_a, neg_b=neg_b, sf_a=sf_a, sf_b=sf_b, e=e, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class AtomMmaMakeSM100UMMAOp(_ods_ir.OpView):
  OPERATION_NAME = "cute_nvgpu.make_sm100_mma"

  _ODS_REGIONS = (0, True)

  def __init__(self, result, accum_c, neg_a, neg_b, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def make_sm100_mma(result, accum_c, neg_a, neg_b, *, loc=None, ip=None) -> _ods_ir.Value:
  return AtomMmaMakeSM100UMMAOp(result=result, accum_c=accum_c, neg_a=neg_a, neg_b=neg_b, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class AtomMmaMakeSM100UMMASparseOp(_ods_ir.OpView):
  OPERATION_NAME = "cute_nvgpu.make_sm100_mma_sp"

  _ODS_REGIONS = (0, True)

  def __init__(self, result, accum_c, neg_a, neg_b, e, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def make_sm100_mma_sp(result, accum_c, neg_a, neg_b, e, *, loc=None, ip=None) -> _ods_ir.Value:
  return AtomMmaMakeSM100UMMASparseOp(result=result, accum_c=accum_c, neg_a=neg_a, neg_b=neg_b, e=e, loc=loc, ip=ip).result
...
class MakeTmaDescTiledOp(_ods_ir.OpView):
  ...
  def __init__(self, result, gmem_view, smem_layout, cta_value_tile, mode, *, num_multicast=None, tma_internal_type=None, tma_desc_addr=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if tma_desc_addr is not None: operands.append(_get_op_result_or_value(tma_desc_addr))
    _ods_context = _ods_get_default_loc_context(loc)
    attributes["mode"] = (mode if (
    isinstance(mode, _ods_ir.Attribute) or
    not _ods_ir.AttrBuilder.contains('CuteTmaLoadModeAttr')) else
    ...
    if num_multicast is not None: attributes["num_multicast"] = (num_multicast if (
        ...
        not _ods_ir.AttrBuilder.contains('I32Attr')) else
          _ods_ir.AttrBuilder.get('I32Attr')(num_multicast, context=_ods_context))
    if tma_internal_type is not None: attributes["tma_internal_type"] = (tma_internal_type if (
        isinstance(tma_internal_type, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('TypeAttr')) else
          _ods_ir.AttrBuilder.get('TypeAttr')(tma_internal_type, context=_ods_context))
    results.append(result)
    _ods_successors = None
    super().__init__(self.build_generic(attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip))
  ...
  @builtins.property
  def tma_internal_type(self):
    if "tma_internal_type" not in self.operation.attributes:
      return None
    return self.operation.attributes["tma_internal_type"]

  @tma_internal_type.setter
  def tma_internal_type(self, value):
    if value is not None:
      self.operation.attributes["tma_internal_type"] = value
    elif "tma_internal_type" in self.operation.attributes:
      del self.operation.attributes["tma_internal_type"]

  @tma_internal_type.deleter
  def tma_internal_type(self):
    del self.operation.attributes["tma_internal_type"]
...
def make_tma_desc_tiled(result, gmem_view, smem_layout, cta_value_tile, mode, *, num_multicast=None, tma_internal_type=None, tma_desc_addr=None, loc=None, ip=None) -> _ods_ir.Value:
  return MakeTmaDescTiledOp(result=result, gmem_view=gmem_view, smem_layout=smem_layout, cta_value_tile=cta_value_tile, mode=mode, num_multicast=num_multicast, tma_internal_type=tma_internal_type, tma_desc_addr=tma_desc_addr, loc=loc, ip=ip).result
...
def make_umma_smem_desc(src, layout, major, *, loc=None, ip=None) -> _ods_ir.Value:
  return MakeUMMASmemDescOp(src=src, layout=layout, major=major, loc=loc, ip=ip).result
