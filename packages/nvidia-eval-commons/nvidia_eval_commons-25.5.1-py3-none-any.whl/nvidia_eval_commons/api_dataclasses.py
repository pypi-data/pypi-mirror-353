...
class ApiEndpoint(BaseModel):
    ...
    type: Optional[EndpointType] = Field(description="The type of the target", default=None)
...
class ConfigParams(BaseModel):
    limit_samples: Optional[int | float] = Field(description="Limit number of evaluation samples", default=None)
...
class Score(BaseModel):
    ...
    stats: ScoreStats = Field(
        description="Statistics associated with this metric"
    )
...
class GroupResult(BaseModel):
    ...
    groups: Optional[Dict[str, "GroupResult"]] = Field(default=None, description="The results for the subgroups.")
    metrics: Dict[str, MetricResult] = Field(
        default_factory=dict,
