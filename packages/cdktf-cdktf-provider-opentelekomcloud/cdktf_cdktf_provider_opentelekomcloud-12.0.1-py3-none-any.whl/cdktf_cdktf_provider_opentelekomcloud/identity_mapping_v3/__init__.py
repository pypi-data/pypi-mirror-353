...
Refer to the Terraform Registry for docs: [`opentelekomcloud_identity_mapping_v3`](https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.40/docs/resources/identity_mapping_v3).
'''
...
class IdentityMappingV3(
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.40/docs/resources/identity_mapping_v3 opentelekomcloud_identity_mapping_v3} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param mapping_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.40/docs/resources/identity_mapping_v3#mapping_id IdentityMappingV3#mapping_id}.
        :param rules: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.40/docs/resources/identity_mapping_v3#rules IdentityMappingV3#rules}.
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing IdentityMappingV3 that should be imported. Refer to the {@link https://registry.terraform.io/providers/opentelekomcloud/opentelekomcloud/1.36.40/docs/resources/identity_mapping_v3#import import section} in the documentation of this resource for the id to use
