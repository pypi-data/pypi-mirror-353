...
print(f"inventory: {sq1.inventory.vendor()} {sq1.inventory.model()} {sq1.inventory.serial()}")

sur = system.sur
print(f"probing SUR: {sur.probe()}")
print(f"inventory: {sur.inventory.vendor()} {sur.inventory.model()} {sur.inventory.serial()}")

spv = system.spv
print(f"probing SPV: {spv.probe()}")
print(f"inventory: {spv.inventory.vendor()} {spv.inventory.model()} {spv.inventory.serial()}")
...
# SPV Test
print(f"modem1 control lines {spv.modem1.num_lines()}")
print(f"modem1 control lines {spv.modem2.num_lines()}")
print(f"modem1 control lines {spv.modem3.num_lines()}")
