...
$Id: step.py 5172 2025-03-12 23:32:53Z felipe.souza $
"""
...
def setUpStep(self, factory, name, label=None, weight=None,
    ...
    for attr, value in list(kws.items()):
        setattr(step, attr, value)
    return step


@implementer(interfaces.IDialogStep)
...
@implementer(interfaces.IJSONRPCStep)
