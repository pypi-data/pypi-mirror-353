            ...
            try:
                ...
                if hasattr(result, 'usage') and result.usage:
                    if hasattr(result.usage, 'prompt_tokens'):
                        span.set_attribute("openai.usage.prompt_tokens", result.usage.prompt_tokens)
                    if hasattr(result.usage, 'completion_tokens'):
                        span.set_attribute("openai.usage.completion_tokens", result.usage.completion_tokens)
