...
class Savable(Resource):    
    ...
    def _serialize(self, edata: Savable, serializer:Callable, full:bool=False, _rec_depth:int=None, lambda_func:Callable=None) -> Dict[str, str]:
        res = {}
        for field_name, field_type in edata.annotations.items():
            ...
            field_val = serializer(field_val, field_type, field_name, full, _rec_depth, lambda_func)
