...
def init(name = ...,client_config = ...,log_level = ...) -> None:
    r"""
    ...
    Args:
        name (str): A unique identifier for your application
        client_config (Optional[TracePublishClientConfig]): Configuration options for the TracePublishClient.
            Can include: url, batch_size, batch_timeout_ms.
        log_level (Optional[str]): Logging level to enable, None disables logging.
    ...
    Examples:
        ...
        >>> init()
        >>>
        >>> # Initialize with defaults and name "my_app"
        >>> init("my_app")
        >>>
        >>>
