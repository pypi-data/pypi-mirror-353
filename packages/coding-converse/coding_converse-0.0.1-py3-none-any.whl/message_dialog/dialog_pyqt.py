...
class ModernMessageDialog(QDialog):
    ...
    def __init__(self, message: str, title: str = "消息对话框", placeholder: str = "请输入您的回复...", parent=None):
    ...
    def setup_ui(self):
        ...
        self.setFixedSize(450, 350)  # 稍微缩小窗口
        self.setModal(True)
        ...
        self.message_label.setFont(QFont("Microsoft YaHei", 10))  # 稍小字体
        ...
        # 回复标签
        reply_label = QLabel("您的回复：")
        reply_label.setFont(QFont("Microsoft YaHei", 10))
        reply_label.setStyleSheet("color: #495057; margin-bottom: 5px;")
        main_layout.addWidget(reply_label)
        
        # 文本输入框 - 更紧凑
        self.text_edit = QTextEdit()
        self.text_edit.setPlaceholderText(self.placeholder)
        self.text_edit.setFont(QFont("Microsoft YaHei", 9))  # 稍小字体
        self.text_edit.setFixedHeight(100)  # 减小高度
        ...
        button_layout.setSpacing(10)  # 减小按钮间距
        
        # 左侧弹性空间
        button_layout.addItem(QSpacerItem(20, 10, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum))
        
        # 忽略按钮 - 更小更紧凑
        self.ignore_button = QPushButton("忽略")
        self.ignore_button.setFixedSize(70, 28)  # 显著减小按钮尺寸
        self.ignore_button.setFont(QFont("Microsoft YaHei", 9))  # 更小字体
        ...
        """)
        self.ignore_button.clicked.connect(self.ignore_response)
        button_layout.addWidget(self.ignore_button)
        
        # 回复按钮 - 更小更紧凑
        self.reply_button = QPushButton("回复")
        self.reply_button.setFixedSize(70, 28)  # 显著减小按钮尺寸
        self.reply_button.setFont(QFont("Microsoft YaHei", 9))  # 更小字体
        ...
        """)
        self.reply_button.clicked.connect(self.submit_response)
...
def show_message_dialog(message: str, title: str = "消息对话框", placeholder: str = "请输入您的回复...") -> str:
    """显示消息对话框
