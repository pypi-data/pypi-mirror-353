...
class Tester:
    ...
    async def reply(self, replied_msg: Message, msg_text: str, parse_mode: str=None) -> BotResponse:
        sent_msg = await self.bot.send_message(self.test_chat_id, msg_text, \
                            reply_to_message_id=replied_msg.message_id, parse_mode=parse_mode)
        return self._msg(sent_msg, parse_mode)
