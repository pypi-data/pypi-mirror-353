...
class TestEventQueue:
    ...
    def test_add_event_queue_full(self):
        ...
        # Fill the queue
        event1 = UnredactedEvent(id="1", event_type="mcp:tools/call", project_id="p1", session_id="s1", timestamp=datetime.now())
        event2 = UnredactedEvent(id="2", event_type="mcp:tools/call", project_id="p1", session_id="s1", timestamp=datetime.now())
        event3 = UnredactedEvent(id="3", event_type="mcp:tools/call", project_id="p1", session_id="s1", timestamp=datetime.now())
    ...
    def test_add_event_queue_full_drops_new_event(self):
        ...
        # Fill the queue
        event1 = UnredactedEvent(id="event-1", event_type="mcp:tools/call", project_id="p1", session_id="s1", timestamp=datetime.now())
        event2 = UnredactedEvent(id="event-2", event_type="mcp:tools/call", project_id="p1", session_id="s1", timestamp=datetime.now())
