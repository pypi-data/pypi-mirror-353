...
def generate_ksuid(use_milliseconds: bool = False, dt: Optional[datetime] = None) -> str:
    """
...
def generate_prefixed_ksuid(prefix: str, use_milliseconds: bool = False, dt: Optional[datetime] = None) -> str:
    """
...
def parse_prefixed_ksuid(prefixed_ksuid: str, use_milliseconds: bool = False) -> tuple[str, Ksuid]:
    """
