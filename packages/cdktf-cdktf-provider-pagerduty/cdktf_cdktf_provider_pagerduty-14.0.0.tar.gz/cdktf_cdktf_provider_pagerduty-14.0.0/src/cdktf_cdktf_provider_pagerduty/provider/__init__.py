...
class PagerdutyProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param alias: Alias name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.26.0/docs#alias PagerdutyProvider#alias}
        :param api_url_override: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.26.0/docs#api_url_override PagerdutyProvider#api_url_override}.
        :param insecure_tls: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.26.0/docs#insecure_tls PagerdutyProvider#insecure_tls}.
        :param service_region: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.26.0/docs#service_region PagerdutyProvider#service_region}.
        :param skip_credentials_validation: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.26.0/docs#skip_credentials_validation PagerdutyProvider#skip_credentials_validation}.
        :param token: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.26.0/docs#token PagerdutyProvider#token}.
        :param use_app_oauth_scoped_token: use_app_oauth_scoped_token block. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.26.0/docs#use_app_oauth_scoped_token PagerdutyProvider#use_app_oauth_scoped_token}
        :param user_token: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.26.0/docs#user_token PagerdutyProvider#user_token}.
        '''
        if __debug__:
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing PagerdutyProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.26.0/docs#import import section} in the documentation of this resource for the id to use
...
class PagerdutyProviderUseAppOauthScopedToken:
    def __init__(
        ...
        *,
        ...
        '''
        :param pd_client_id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.26.0/docs#pd_client_id PagerdutyProvider#pd_client_id}.
        :param pd_client_secret: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.26.0/docs#pd_client_secret PagerdutyProvider#pd_client_secret}.
        :param pd_subdomain: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/pagerduty/pagerduty/3.26.0/docs#pd_subdomain PagerdutyProvider#pd_subdomain}.
        '''
        if __debug__:
