...
setuptools.setup(
    ...
    version="1.0.1",                        # Version - Updated release - README Updated
    ...
    download_url='https://github.com/dodo-saba/fit2gpx/archive/refs/tags/v1.0.0.tar.gz', # Package downloaded from GitHub
