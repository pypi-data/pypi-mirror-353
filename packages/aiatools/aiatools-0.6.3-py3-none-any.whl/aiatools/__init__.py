...
"""
AIA Tools provides a set of Python classes to interface with application sources exported from
...
def _aia_main():
    """
    The main program for aiatools. See aiatool --help for more information.
    """
