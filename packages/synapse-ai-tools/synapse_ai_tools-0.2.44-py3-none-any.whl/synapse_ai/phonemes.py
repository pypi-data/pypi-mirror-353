...
def embeddings(input_dim:int, output_dim:int, std:Union[int, float], pad:bool=True, seed:int=23) -> np.array:
    """
    ...
    Args:
        ...
        std (int or float): Inverse scaling factor for the standard deviation. Larger values reduce the spread.
