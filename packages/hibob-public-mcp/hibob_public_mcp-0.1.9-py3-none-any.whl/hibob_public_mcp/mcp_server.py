...
def hibob_people_search(fields: list = None, filters: list = None) -> dict:
    ...
    Parameters:
        ...
        "showInactive": true to the filters to get all employees including inactive ones - use this to show new hires, or terminated employees, or employees on leave statues

        Example:
        hibob_people_search(fields=["root.id", "root.firstName", "root.surname", "root.email"], filters=[{"fieldPath": "root.id", "operator": "equals", "values": ["EMPLOYEE_ID"]}, {"fieldPath": "root.showInactive", "operator": "equals", "values": [true]}])
