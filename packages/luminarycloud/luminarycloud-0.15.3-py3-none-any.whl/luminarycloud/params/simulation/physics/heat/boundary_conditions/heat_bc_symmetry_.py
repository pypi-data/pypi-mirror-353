...
class HeatBcSymmetry(BoundaryConditionsHeat):
    ...
    def _to_proto(self) -> clientpb.BoundaryConditionsHeat:
        ...
        _proto.heat_physical_boundary = clientpb.HeatPhysicalBoundary.HEAT_BC_SYMMETRY
        return _proto

    def _from_proto(self, proto: clientpb.BoundaryConditionsHeat) -> None:
        super()._from_proto(proto)
        assert proto.heat_physical_boundary == clientpb.HeatPhysicalBoundary.HEAT_BC_SYMMETRY
        return None
