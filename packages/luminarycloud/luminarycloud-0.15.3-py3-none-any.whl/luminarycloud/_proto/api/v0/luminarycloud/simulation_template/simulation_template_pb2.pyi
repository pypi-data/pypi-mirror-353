...
class ListSimulationTemplatesResponse(google.protobuf.message.Message):
    ...
    def simulation_templates(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SimulationTemplate]:
        """Required. The request list of simulation templates."""
    def __init__(
        self,
        *,
...
class UpdateSimulationTemplateRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_name", b"_name", "_parameters", b"_parameters", "name", b"name", "parameters", b"parameters"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_name", b"_name", "_parameters", b"_parameters", "id", b"id", "name", b"name", "parameters", b"parameters"]) -> None: ...
    @typing.overload
