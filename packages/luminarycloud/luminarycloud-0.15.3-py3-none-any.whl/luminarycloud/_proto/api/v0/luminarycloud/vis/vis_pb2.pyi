...
class SurfaceLIC(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["field", b"field", "geometry", b"geometry", "lic_type", b"lic_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["contrast", b"contrast", "field", b"field", "geometry", b"geometry", "lic_type", b"lic_type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["lic_type", b"lic_type"]) -> typing_extensions.Literal["geometry"] | None: ...
...
class Filter(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["clip", b"clip", "contour", b"contour", "glyph", b"glyph", "slice", b"slice", "streamlines", b"streamlines", "surface_lic", b"surface_lic", "threshold", b"threshold", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["clip", b"clip", "contour", b"contour", "glyph", b"glyph", "id", b"id", "name", b"name", "slice", b"slice", "streamlines", b"streamlines", "surface_lic", b"surface_lic", "threshold", b"threshold", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value", b"value"]) -> typing_extensions.Literal["slice", "clip", "contour", "threshold", "streamlines", "glyph", "surface_lic"] | None: ...
...
class ExtractSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_background_properties", b"_background_properties", "_supersampling_ratio", b"_supersampling_ratio", "animation_properties", b"animation_properties", "axes_grid_properties", b"axes_grid_properties", "background_properties", b"background_properties", "entity_type", b"entity_type", "global_display_attributes", b"global_display_attributes", "supersampling_ratio", b"supersampling_ratio", "triad_properties", b"triad_properties"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_background_properties", b"_background_properties", "_supersampling_ratio", b"_supersampling_ratio", "animation_properties", b"animation_properties", "axes_grid_properties", b"axes_grid_properties", "background_properties", b"background_properties", "color_maps", b"color_maps", "description", b"description", "display_attributes", b"display_attributes", "entity_type", b"entity_type", "filter_connections", b"filter_connections", "filters", b"filters", "global_display_attributes", b"global_display_attributes", "name", b"name", "supersampling_ratio", b"supersampling_ratio", "triad_properties", b"triad_properties"]) -> None: ...
    @typing.overload
