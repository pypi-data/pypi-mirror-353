...
def fin_read_ins_date_range(instrument_id: str, period: str) -> Tuple[str, str]:
    '''
    获取合数据起止日期
    Args:
        instrument_id:合约编码
    ...
    Returns:
        _type_: [str, str]
    '''
    return FinDataClient.instance().findata_handle().fin_read_ins_date_range(ReadInsDateRangeData(instrument_id=instrument_id, period=period))
