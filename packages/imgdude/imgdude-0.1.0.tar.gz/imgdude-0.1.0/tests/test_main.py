"""Tests for the imgdude main application."""
...
def test_get_image_unsupported_extension():
    """Test getting an image with unsupported extension."""
...
def test_get_original_image():
    """Test getting an original image."""
...
def test_invalid_width_parameter():
    """Test providing an invalid width parameter."""
...
def test_trusted_hosts_middleware():
    """Test the trusted hosts middleware."""
...
def test_skip_resize_for_small_images():
    """Test that resize is skipped for already small images."""
...
def test_connection_semaphore():
    """Test the connection semaphore limits concurrent connections."""
...
def test_thread_pools():
    """Test the thread pools are initialized with correct sizes."""
