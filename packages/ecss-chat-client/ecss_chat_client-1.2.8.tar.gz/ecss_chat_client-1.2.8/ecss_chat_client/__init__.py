...
class Client:
    def __init__(self, server, username, password, port='3443', proto='https'):
        self.username = username
        self.password = password
        self.proto = proto
        self.base_url = f'{self.proto}://{server}:{port}/api/v1'
        self.short_url = f'{self.proto}://{server}:{port}/api'
