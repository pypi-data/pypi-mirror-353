...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateUser = channel.unary_unary(
                '/apexnova.identity.user.UserService/CreateUser',
        ...
        self.ReadUser = channel.unary_unary(
                '/apexnova.identity.user.UserService/ReadUser',
        ...
        self.UpdateUser = channel.unary_unary(
                '/apexnova.identity.user.UserService/UpdateUser',
        ...
        self.DeleteUser = channel.unary_unary(
                '/apexnova.identity.user.UserService/DeleteUser',
        ...
        self.ReadUsersStream = channel.unary_stream(
                '/apexnova.identity.user.UserService/ReadUsersStream',
...
def add_UserServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'apexnova.identity.user.UserService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('apexnova.identity.user.UserService', rpc_method_handlers)
