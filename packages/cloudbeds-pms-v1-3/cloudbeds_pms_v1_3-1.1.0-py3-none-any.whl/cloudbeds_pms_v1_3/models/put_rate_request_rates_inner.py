...
class PutRateRequestRatesInner(BaseModel):
    """
    PutRateRequestRatesInner
    """ # noqa: E501
    rate_id: Optional[StrictStr] = Field(default=None, description="Rate ID", alias="rateID")
    interval: Optional[List[PutRateRequestRatesInnerIntervalInner]] = Field(default=None, description="Rate update details")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "interval": [PutRateRequestRatesInnerIntervalInner.from_dict(_item) for _item in obj["interval"]] if obj.get("interval") is not None else None
        })
        return _obj
