...
class GetReservationDeparturesResponseDataInner(BaseModel):
    """
    ...
    guest_id: Optional[StrictStr] = Field(default=None, description="Guest ID, can be used to get the corresponding guest details from \"reservationDetails\".", alias="guestID")
    ...
    reservation_details: Optional[List[Dict[str, Any]]] = Field(default=None, description="Reservation details, please check response from \"getReservation\" method", alias="reservationDetails")
    __properties: ClassVar[List[str]] = ["guestName", "guestID", "balance", "reservationID", "reservationDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reservationDetails": obj.get("reservationDetails")
        })
        return _obj
