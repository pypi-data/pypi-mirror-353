...
class GetAsyncApiJobResponseDataInner(BaseModel):
    """
    ...
    updates: Optional[List[GetAsyncApiJobResponseDataInnerUpdatesInner]] = Field(default=None, description="Array of actions produced from this job")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "updates": [GetAsyncApiJobResponseDataInnerUpdatesInner.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None
        })
        return _obj
