...
class GetHouseAccountDetailsResponseDataRecordsInner(BaseModel):
    """
    ...
    notes: Optional[StrictStr] = Field(default=None, description="Record notes")
    quantity: Optional[StrictStr] = Field(default=None, description="Quantity of items (for product type record)")
    debit: Optional[StrictStr] = Field(default=None, description="Debit amount (non formatted)")
    credit: Optional[StrictStr] = Field(default=None, description="Credit amount (non formatted)")
    debit_formatter: Optional[StrictStr] = Field(default=None, description="Debit amount (formatted)", alias="debitFormatter")
    credit_formatted: Optional[StrictStr] = Field(default=None, description="Credit amount (formatted)", alias="creditFormatted")
    currency: Optional[StrictStr] = Field(default=None, description="Currency string")
    transaction_code: Optional[StrictStr] = Field(default=None, description="Transaction code", alias="transactionCode")
    ...
    transaction_date: Optional[date] = Field(default=None, description="Transaction date", alias="transactionDate")
    transaction_date_time: Optional[datetime] = Field(default=None, description="Transaction date and time", alias="transactionDateTime")
    __properties: ClassVar[List[str]] = ["propertyID", "transactionID", "userName", "description", "notes", "quantity", "debit", "credit", "debitFormatter", "creditFormatted", "currency", "transactionCode", "parentTransactionID", "transactionDate", "transactionDateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "debitFormatter": obj.get("debitFormatter"),
            "creditFormatted": obj.get("creditFormatted"),
