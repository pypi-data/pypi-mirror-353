...
class GetHouseAccountDetailsResponseData(BaseModel):
    """
    Includes records list for House Account and summary info covering the date range specified
    """ # noqa: E501
    total: Optional[List[GetHouseAccountDetailsResponseDataTotalInner]] = Field(default=None, description="Section with summary records info")
    records: Optional[List[GetHouseAccountDetailsResponseDataRecordsInner]] = Field(default=None, description="Section with records list")
    __properties: ClassVar[List[str]] = ["total", "records"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": [GetHouseAccountDetailsResponseDataTotalInner.from_dict(_item) for _item in obj["total"]] if obj.get("total") is not None else None,
            "records": [GetHouseAccountDetailsResponseDataRecordsInner.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
