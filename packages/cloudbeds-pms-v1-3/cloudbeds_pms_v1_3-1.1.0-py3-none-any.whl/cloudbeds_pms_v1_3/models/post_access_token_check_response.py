...
class PostAccessTokenCheckResponse(BaseModel):
    """
    PostAccessTokenCheckResponse
    """ # noqa: E501
    success: Optional[StrictStr] = Field(default=None, description="True if the access_token is valid. False otherwise.")
