...
class GetPaymentsResponse(BaseModel):
    ...
    data: Optional[List[GetPaymentsResponseDataInner]] = Field(default=None, description="Transaction list")
    count: Optional[StrictInt] = Field(default=None, description="Number of results returned, based on pagination")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GetPaymentsResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "count": obj.get("count"),
            "total": obj.get("total"),
