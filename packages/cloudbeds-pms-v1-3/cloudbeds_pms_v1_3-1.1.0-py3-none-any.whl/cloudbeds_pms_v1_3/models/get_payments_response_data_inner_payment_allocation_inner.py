...
class GetPaymentsResponseDataInnerPaymentAllocationInner(BaseModel):
    """
    GetPaymentsResponseDataInnerPaymentAllocationInner
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="² Type of item described in allocation")
    reference: Optional[StrictStr] = Field(default=None, description="² Reference of item described in allocation")
    name: Optional[StrictStr] = Field(default=None, description="² Name of item described in allocation")
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="² Amount of allocated of payment total")
    taxes: Optional[List[StrictStr]] = Field(default=None, description="² Taxes of allocated payment. Values are an array numeric of taxes IDs")
    fees: Optional[List[StrictStr]] = Field(default=None, description="² Fees of allocated payment. Values are an array numeric of fees IDs")
    __properties: ClassVar[List[str]] = ["type", "reference", "name", "amount", "taxes", "fees"]
