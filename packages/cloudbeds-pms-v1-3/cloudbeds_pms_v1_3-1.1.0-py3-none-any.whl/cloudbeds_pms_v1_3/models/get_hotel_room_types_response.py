...
class GetHotelRoomTypesResponse(BaseModel):
    """
    ...
    data: Optional[List[StrictStr]] = Field(default=None, description="Room Types details")
    ...
    __properties: ClassVar[List[str]] = ["success", "count", "data", "total", "message"]
