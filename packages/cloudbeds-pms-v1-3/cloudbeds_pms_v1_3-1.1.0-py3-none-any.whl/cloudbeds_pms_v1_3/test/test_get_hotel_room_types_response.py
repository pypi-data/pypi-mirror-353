...
class TestGetHotelRoomTypesResponse(unittest.TestCase):
    """GetHotelRoomTypesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetHotelRoomTypesResponse:
        """Test GetHotelRoomTypesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetHotelRoomTypesResponse`
        """
        model = GetHotelRoomTypesResponse()
        if include_optional:
            return GetHotelRoomTypesResponse(
                success = True,
                count = 56,
                data = [
                    ''
    ...
    def testGetHotelRoomTypesResponse(self):
        """Test GetHotelRoomTypesResponse"""
