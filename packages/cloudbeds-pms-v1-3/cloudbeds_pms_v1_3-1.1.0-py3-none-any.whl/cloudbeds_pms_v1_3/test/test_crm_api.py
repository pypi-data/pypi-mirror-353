...
class TestCRMApi(unittest.TestCase):
    ...
    def test_crm_cache_remove_post(self) -> None:
        """Test case for crm_cache_remove_post

        PostCRMCacheRemove
        """
        pass

    def test_crm_cache_update_post(self) -> None:
        """Test case for crm_cache_update_post
