...
class TestPutRateResponse(unittest.TestCase):
    """PutRateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutRateResponse:
        """Test PutRateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutRateResponse`
        """
        model = PutRateResponse()
        if include_optional:
            return PutRateResponse(
                success = True,
                job_reference_id = '',
                message = ''
            )
