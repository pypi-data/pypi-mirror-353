...
class TestPostCRMCacheUpdateResponse(unittest.TestCase):
    """PostCRMCacheUpdateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostCRMCacheUpdateResponse:
        """Test PostCRMCacheUpdateResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostCRMCacheUpdateResponse`
        """
        model = PostCRMCacheUpdateResponse()
        if include_optional:
            return PostCRMCacheUpdateResponse(
                success = True
            )
        else:
            return PostCRMCacheUpdateResponse(
    ...
    def testPostCRMCacheUpdateResponse(self):
        """Test PostCRMCacheUpdateResponse"""
