...
class TestGetImportDummyReservationsResponse(unittest.TestCase):
    """GetImportDummyReservationsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetImportDummyReservationsResponse:
        """Test GetImportDummyReservationsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetImportDummyReservationsResponse`
        """
        model = GetImportDummyReservationsResponse()
        if include_optional:
            return GetImportDummyReservationsResponse(
                success = True,
                data = [
                    ''
                    ]
    ...
    def testGetImportDummyReservationsResponse(self):
        """Test GetImportDummyReservationsResponse"""
