...
class TestPostRoomTypeResponseData(unittest.TestCase):
    """PostRoomTypeResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostRoomTypeResponseData:
        """Test PostRoomTypeResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostRoomTypeResponseData`
        """
        model = PostRoomTypeResponseData()
        if include_optional:
            return PostRoomTypeResponseData(
                room_type_id = ''
            )
        else:
            return PostRoomTypeResponseData(
    ...
    def testPostRoomTypeResponseData(self):
        """Test PostRoomTypeResponseData"""
