...
class TestPostPutRateRequest(unittest.TestCase):
    """PostPutRateRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostPutRateRequest:
        """Test PostPutRateRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostPutRateRequest`
        """
        model = PostPutRateRequest()
        if include_optional:
            return PostPutRateRequest(
                rates = [
                    cloudbeds_pms_v1_3.models.post_put_rate_request_rates_inner.PostPutRateRequest_rates_inner(
                        rate_id = '', 
                        interval = [
    ...
    def testPostPutRateRequest(self):
        """Test PostPutRateRequest"""
