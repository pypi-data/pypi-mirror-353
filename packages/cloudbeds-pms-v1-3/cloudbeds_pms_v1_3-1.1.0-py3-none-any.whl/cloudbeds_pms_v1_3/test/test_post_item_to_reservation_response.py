...
class TestPostItemToReservationResponse(unittest.TestCase):
    """PostItemToReservationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostItemToReservationResponse:
        """Test PostItemToReservationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostItemToReservationResponse`
        """
        model = PostItemToReservationResponse()
        if include_optional:
            return PostItemToReservationResponse(
                success = True,
    ...
    def testPostItemToReservationResponse(self):
        """Test PostItemToReservationResponse"""
