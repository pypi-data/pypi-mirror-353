...
class TestGetPendingTransactionsResponseDataInner(unittest.TestCase):
    """GetPendingTransactionsResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPendingTransactionsResponseDataInner:
        """Test GetPendingTransactionsResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPendingTransactionsResponseDataInner`
        """
        model = GetPendingTransactionsResponseDataInner()
        if include_optional:
            return GetPendingTransactionsResponseDataInner(
                property_id = '',
                reservation_id = '',
                sub_reservation_id = '',
                house_account_id = '',
    ...
    def testGetPendingTransactionsResponseDataInner(self):
        """Test GetPendingTransactionsResponseDataInner"""
