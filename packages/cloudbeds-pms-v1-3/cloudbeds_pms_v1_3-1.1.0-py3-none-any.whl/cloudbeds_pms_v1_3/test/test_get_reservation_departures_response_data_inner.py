...
class TestGetReservationDeparturesResponseDataInner(unittest.TestCase):
    """GetReservationDeparturesResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservationDeparturesResponseDataInner:
        """Test GetReservationDeparturesResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservationDeparturesResponseDataInner`
        """
        model = GetReservationDeparturesResponseDataInner()
        if include_optional:
            return GetReservationDeparturesResponseDataInner(
                guest_name = '',
                guest_id = '',
                balance = 1.337,
                reservation_id = '',
    ...
    def testGetReservationDeparturesResponseDataInner(self):
        """Test GetReservationDeparturesResponseDataInner"""
