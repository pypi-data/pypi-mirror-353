...
class TestPostReservationCheckInResponse(unittest.TestCase):
    """PostReservationCheckInResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostReservationCheckInResponse:
        """Test PostReservationCheckInResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostReservationCheckInResponse`
        """
        model = PostReservationCheckInResponse()
        if include_optional:
            return PostReservationCheckInResponse(
                success = True,
                message = ''
            )
        else:
    ...
    def testPostReservationCheckInResponse(self):
        """Test PostReservationCheckInResponse"""
