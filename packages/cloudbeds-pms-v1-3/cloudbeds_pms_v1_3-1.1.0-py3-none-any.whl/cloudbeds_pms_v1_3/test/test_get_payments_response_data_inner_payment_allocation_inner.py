...
class TestGetPaymentsResponseDataInnerPaymentAllocationInner(unittest.TestCase):
    """GetPaymentsResponseDataInnerPaymentAllocationInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPaymentsResponseDataInnerPaymentAllocationInner:
        """Test GetPaymentsResponseDataInnerPaymentAllocationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPaymentsResponseDataInnerPaymentAllocationInner`
        """
        model = GetPaymentsResponseDataInnerPaymentAllocationInner()
        if include_optional:
            return GetPaymentsResponseDataInnerPaymentAllocationInner(
                type = '',
                reference = '',
                name = '',
                amount = 1.337,
    ...
    def testGetPaymentsResponseDataInnerPaymentAllocationInner(self):
        """Test GetPaymentsResponseDataInnerPaymentAllocationInner"""
