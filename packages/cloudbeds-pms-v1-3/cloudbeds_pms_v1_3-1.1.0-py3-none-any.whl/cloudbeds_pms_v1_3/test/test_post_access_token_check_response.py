...
class TestPostAccessTokenCheckResponse(unittest.TestCase):
    """PostAccessTokenCheckResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostAccessTokenCheckResponse:
        """Test PostAccessTokenCheckResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostAccessTokenCheckResponse`
        """
        model = PostAccessTokenCheckResponse()
        if include_optional:
            return PostAccessTokenCheckResponse(
                success = ''
            )
        else:
            return PostAccessTokenCheckResponse(
    ...
    def testPostAccessTokenCheckResponse(self):
        """Test PostAccessTokenCheckResponse"""
