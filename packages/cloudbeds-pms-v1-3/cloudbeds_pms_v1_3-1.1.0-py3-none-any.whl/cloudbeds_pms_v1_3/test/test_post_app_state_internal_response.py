...
class TestPostAppStateInternalResponse(unittest.TestCase):
    """PostAppStateInternalResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostAppStateInternalResponse:
        """Test PostAppStateInternalResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostAppStateInternalResponse`
        """
        model = PostAppStateInternalResponse()
        if include_optional:
            return PostAppStateInternalResponse(
                success = True
            )
        else:
            return PostAppStateInternalResponse(
    ...
    def testPostAppStateInternalResponse(self):
        """Test PostAppStateInternalResponse"""
