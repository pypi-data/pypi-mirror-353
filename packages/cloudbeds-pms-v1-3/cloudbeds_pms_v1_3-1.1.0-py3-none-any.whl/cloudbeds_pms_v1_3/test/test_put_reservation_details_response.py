...
class TestPutReservationDetailsResponse(unittest.TestCase):
    """PutReservationDetailsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutReservationDetailsResponse:
        """Test PutReservationDetailsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutReservationDetailsResponse`
        """
        model = PutReservationDetailsResponse()
        if include_optional:
            return PutReservationDetailsResponse(
                success = True,
                message = '',
                data = None
            )
    ...
    def testPutReservationDetailsResponse(self):
        """Test PutReservationDetailsResponse"""
