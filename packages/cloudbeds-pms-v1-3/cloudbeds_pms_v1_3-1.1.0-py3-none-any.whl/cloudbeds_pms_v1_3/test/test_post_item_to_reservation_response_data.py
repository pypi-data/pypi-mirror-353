...
class TestPostItemToReservationResponseData(unittest.TestCase):
    """PostItemToReservationResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostItemToReservationResponseData:
        """Test PostItemToReservationResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostItemToReservationResponseData`
        """
        model = PostItemToReservationResponseData()
        if include_optional:
            return PostItemToReservationResponseData(
                sold_product_id = '',
                transaction_id = '',
                transaction_status = '',
    ...
    def testPostItemToReservationResponseData(self):
        """Test PostItemToReservationResponseData"""
