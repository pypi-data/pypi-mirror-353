...
class TestGetAdjustmentResponseData(unittest.TestCase):
    """GetAdjustmentResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdjustmentResponseData:
        """Test GetAdjustmentResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdjustmentResponseData`
        """
        model = GetAdjustmentResponseData()
        if include_optional:
            return GetAdjustmentResponseData(
                adjustment_id = '',
                property_id = '',
    ...
    def testGetAdjustmentResponseData(self):
        """Test GetAdjustmentResponseData"""
