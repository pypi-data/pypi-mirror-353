...
class TestGetAsyncApiJobResponseDataInnerUpdatesInnerAutoRelease(unittest.TestCase):
    """GetAsyncApiJobResponseDataInnerUpdatesInnerAutoRelease unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAsyncApiJobResponseDataInnerUpdatesInnerAutoRelease:
        """Test GetAsyncApiJobResponseDataInnerUpdatesInnerAutoRelease
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAsyncApiJobResponseDataInnerUpdatesInnerAutoRelease`
        """
        model = GetAsyncApiJobResponseDataInnerUpdatesInnerAutoRelease()
        if include_optional:
            return GetAsyncApiJobResponseDataInnerUpdatesInnerAutoRelease(
    ...
    def testGetAsyncApiJobResponseDataInnerUpdatesInnerAutoRelease(self):
        """Test GetAsyncApiJobResponseDataInnerUpdatesInnerAutoRelease"""
