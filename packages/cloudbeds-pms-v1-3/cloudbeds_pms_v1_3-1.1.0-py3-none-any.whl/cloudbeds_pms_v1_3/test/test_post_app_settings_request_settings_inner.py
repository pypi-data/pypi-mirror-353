...
class TestPostAppSettingsRequestSettingsInner(unittest.TestCase):
    """PostAppSettingsRequestSettingsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostAppSettingsRequestSettingsInner:
        """Test PostAppSettingsRequestSettingsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostAppSettingsRequestSettingsInner`
        """
        model = PostAppSettingsRequestSettingsInner()
        if include_optional:
            return PostAppSettingsRequestSettingsInner(
                name = '',
                value = ''
            )
        else:
    ...
    def testPostAppSettingsRequestSettingsInner(self):
        """Test PostAppSettingsRequestSettingsInner"""
