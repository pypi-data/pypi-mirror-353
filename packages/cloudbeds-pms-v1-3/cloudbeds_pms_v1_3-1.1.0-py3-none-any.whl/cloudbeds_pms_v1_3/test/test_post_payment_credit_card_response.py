...
class TestPostPaymentCreditCardResponse(unittest.TestCase):
    """PostPaymentCreditCardResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostPaymentCreditCardResponse:
        """Test PostPaymentCreditCardResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostPaymentCreditCardResponse`
        """
        model = PostPaymentCreditCardResponse()
        if include_optional:
    ...
    def testPostPaymentCreditCardResponse(self):
        """Test PostPaymentCreditCardResponse"""
