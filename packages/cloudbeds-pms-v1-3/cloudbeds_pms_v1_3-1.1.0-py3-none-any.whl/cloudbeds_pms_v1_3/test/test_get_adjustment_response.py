...
class TestGetAdjustmentResponse(unittest.TestCase):
    """GetAdjustmentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdjustmentResponse:
        """Test GetAdjustmentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdjustmentResponse`
        """
        model = GetAdjustmentResponse()
        if include_optional:
            return GetAdjustmentResponse(
                success = True,
                data = cloudbeds_pms_v1_3.models.get_adjustment_response_data.GetAdjustmentResponse_data(
                    adjustment_id = '', 
                    property_id = '', 
    ...
    def testGetAdjustmentResponse(self):
        """Test GetAdjustmentResponse"""
