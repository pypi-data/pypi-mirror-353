...
class TestPostReservationCheckOutResponse(unittest.TestCase):
    """PostReservationCheckOutResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostReservationCheckOutResponse:
        """Test PostReservationCheckOutResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostReservationCheckOutResponse`
        """
        model = PostReservationCheckOutResponse()
        if include_optional:
            return PostReservationCheckOutResponse(
                success = True,
                message = ''
            )
        else:
    ...
    def testPostReservationCheckOutResponse(self):
        """Test PostReservationCheckOutResponse"""
