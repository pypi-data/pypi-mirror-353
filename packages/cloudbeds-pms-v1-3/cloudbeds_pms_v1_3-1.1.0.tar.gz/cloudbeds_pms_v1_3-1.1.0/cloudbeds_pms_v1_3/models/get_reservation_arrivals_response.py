...
class GetReservationArrivalsResponse(BaseModel):
    """
    ...
    data: Optional[List[GetReservationArrivalsResponseDataInner]] = Field(default=None, description="Details for the arrivals scheduled for today")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GetReservationArrivalsResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
