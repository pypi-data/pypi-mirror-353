...
class GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerAvailability(BaseModel):
    """
    ...
    guest_pricing: Optional[GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerAvailabilityGuestPricing] = Field(default=None, alias="guestPricing")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if block_remaining (nullable) is None
        # and model_fields_set contains the field
        if self.block_remaining is None and "block_remaining" in self.model_fields_set:
            _dict['blockRemaining'] = None
        ...
        # set to None if block_confirmed (nullable) is None
        # and model_fields_set contains the field
        if self.block_confirmed is None and "block_confirmed" in self.model_fields_set:
            _dict['blockConfirmed'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rate": obj.get("rate"),
            "guestPricing": GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerAvailabilityGuestPricing.from_dict(obj["guestPricing"]) if obj.get("guestPricing") is not None else None
        })
        return _obj
