...
class GetReservationDeparturesResponse(BaseModel):
    """
    ...
    data: Optional[List[GetReservationDeparturesResponseDataInner]] = Field(default=None, description="Details for the arrivals scheduled for today")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GetReservationDeparturesResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
