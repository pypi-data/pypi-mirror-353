...
class PostPutRateRequest(BaseModel):
    """
    PostPutRateRequest
    """ # noqa: E501
    rates: Optional[List[PostPutRateRequestRatesInner]] = Field(default=None, description="Array of rates to update")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rates": [PostPutRateRequestRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
        return _obj
