...
class PostAppSettingsRequestSettingsInner(BaseModel):
    """
    PostAppSettingsRequestSettingsInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="A name of a setting option")
    value: Optional[StrictStr] = Field(default=None, description="A value of a setting option")
