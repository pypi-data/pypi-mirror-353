...
class GetPendingTransactionsResponse(BaseModel):
    """
    GetPendingTransactionsResponse
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, description="Returns if the request could be completed")
    data: Optional[List[GetPendingTransactionsResponseDataInner]] = Field(default=None, description="Transaction list covering the date range specified")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GetPendingTransactionsResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "count": obj.get("count"),
            "total": obj.get("total"),
