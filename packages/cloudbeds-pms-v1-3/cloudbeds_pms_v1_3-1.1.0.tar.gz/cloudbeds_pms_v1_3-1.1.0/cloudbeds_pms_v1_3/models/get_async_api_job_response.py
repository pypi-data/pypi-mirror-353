...
class GetAsyncApiJobResponse(BaseModel):
    """
    ...
    data: Optional[List[GetAsyncApiJobResponseDataInner]] = Field(default=None, description="Job details")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [GetAsyncApiJobResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
