...
class PostRoomTypeResponseData(BaseModel):
    """
    Details for the new accommodation type
    """ # noqa: E501
    room_type_id: Optional[StrictStr] = Field(default=None, description="ID for the newly-created accommodation type", alias="roomTypeId")
    __properties: ClassVar[List[str]] = ["roomTypeId"]
