...
class TestGetReservationArrivalsResponseDataInner(unittest.TestCase):
    """GetReservationArrivalsResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservationArrivalsResponseDataInner:
        ...
        # uncomment below to create an instance of `GetReservationArrivalsResponseDataInner`
        """
        model = GetReservationArrivalsResponseDataInner()
        if include_optional:
            return GetReservationArrivalsResponseDataInner(
                guest_id = '',
                guest_name = '',
                room_id = '',
                balance = 1.337,
    ...
    def testGetReservationArrivalsResponseDataInner(self):
        """Test GetReservationArrivalsResponseDataInner"""
