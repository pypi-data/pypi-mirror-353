...
class TestPostCRMCacheRemoveResponse(unittest.TestCase):
    """PostCRMCacheRemoveResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostCRMCacheRemoveResponse:
        """Test PostCRMCacheRemoveResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostCRMCacheRemoveResponse`
        """
        model = PostCRMCacheRemoveResponse()
        if include_optional:
            return PostCRMCacheRemoveResponse(
                success = True
            )
        else:
            return PostCRMCacheRemoveResponse(
    ...
    def testPostCRMCacheRemoveResponse(self):
        """Test PostCRMCacheRemoveResponse"""
