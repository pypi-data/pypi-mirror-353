...
class TestPostItemToReservationRequestPaymentsInner(unittest.TestCase):
    """PostItemToReservationRequestPaymentsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostItemToReservationRequestPaymentsInner:
        ...
        # uncomment below to create an instance of `PostItemToReservationRequestPaymentsInner`
        """
        model = PostItemToReservationRequestPaymentsInner()
        if include_optional:
            return PostItemToReservationRequestPaymentsInner(
                payment_type = '',
                amount = 1.337,
                notes = ''
            )
    ...
    def testPostItemToReservationRequestPaymentsInner(self):
        """Test PostItemToReservationRequestPaymentsInner"""
