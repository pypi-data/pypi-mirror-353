    ...
    def make_instance(self, include_optional) -> GetGuestResponse:
        ...
        if include_optional:
            return GetGuestResponse(
                success = True,
                data = cloudbeds_pms_v1_3.models.get_guest_response_data.GetGuestResponse_data(
                    first_name = '', 
                    last_name = '', 
                    gender = 'M', 
                    email = '', 
                    ...
                    custom_fields = [
                        cloudbeds_pms_v1_3.models.get_guest_response_data_custom_fields_inner.GetGuestResponse_data_customFields_inner(
                            custom_field_name = '', 
                            custom_field_value = '', )
                        ], 
                    special_requests = '', 
