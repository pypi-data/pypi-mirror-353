...
class TestPutReservationDetailsRequestCustomFieldsInner(unittest.TestCase):
    """PutReservationDetailsRequestCustomFieldsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutReservationDetailsRequestCustomFieldsInner:
        """Test PutReservationDetailsRequestCustomFieldsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutReservationDetailsRequestCustomFieldsInner`
        """
        model = PutReservationDetailsRequestCustomFieldsInner()
        if include_optional:
            return PutReservationDetailsRequestCustomFieldsInner(
                custom_field_name = '',
                custom_field_value = ''
            )
        else:
    ...
    def testPutReservationDetailsRequestCustomFieldsInner(self):
        """Test PutReservationDetailsRequestCustomFieldsInner"""
