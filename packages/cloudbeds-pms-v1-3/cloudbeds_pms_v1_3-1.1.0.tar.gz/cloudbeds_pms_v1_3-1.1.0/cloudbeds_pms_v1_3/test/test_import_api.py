...
class TestImportApi(unittest.TestCase):
    ...
    def test_import_dummy_reservations_get(self) -> None:
        """Test case for import_dummy_reservations_get

        GetImportDummyReservations
        """
        pass

    def test_import_tours_get(self) -> None:
        """Test case for import_tours_get
