...
class TestPostAppSettingsResponse(unittest.TestCase):
    """PostAppSettingsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostAppSettingsResponse:
        """Test PostAppSettingsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostAppSettingsResponse`
        """
        model = PostAppSettingsResponse()
        if include_optional:
            return PostAppSettingsResponse(
                success = True,
                data = None
            )
        else:
    ...
    def testPostAppSettingsResponse(self):
        """Test PostAppSettingsResponse"""
