...
class TestGetHouseAccountDetailsResponse(unittest.TestCase):
    """GetHouseAccountDetailsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetHouseAccountDetailsResponse:
        """Test GetHouseAccountDetailsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetHouseAccountDetailsResponse`
        """
        model = GetHouseAccountDetailsResponse()
        if include_optional:
            return GetHouseAccountDetailsResponse(
                success = True,
                data = cloudbeds_pms_v1_3.models.get_house_account_details_response_data.GetHouseAccountDetailsResponse_data(
                    total = [
                        cloudbeds_pms_v1_3.models.get_house_account_details_response_data_total_inner.GetHouseAccountDetailsResponse_data_total_inner(
                            count = 56, 
                            quantity = '', 
                            debit = '', 
                            credit = '', )
                    ...
                    records = [
                        cloudbeds_pms_v1_3.models.get_house_account_details_response_data_records_inner.GetHouseAccountDetailsResponse_data_records_inner(
                            property_id = '', 
                            transaction_id = '', 
                            user_name = '', 
                            description = '', 
    ...
    def testGetHouseAccountDetailsResponse(self):
        """Test GetHouseAccountDetailsResponse"""
