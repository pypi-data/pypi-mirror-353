    ...
    def make_instance(self, include_optional) -> GetInvoiceResponse:
        ...
        if include_optional:
            return GetInvoiceResponse(
                success = True,
                data = cloudbeds_pms_v1_3.models.get_invoice_response_data.GetInvoiceResponse_data(
                    invoice_id = '', 
                    reservation_id = '', 
                    prefix = '', 
                    number = 56, 
                    ...
                    document_issue_date = '', 
                    status = '', 
                    billed_to = cloudbeds_pms_v1_3.models.get_invoice_response_data_billed_to.GetInvoiceResponse_data_billedTo(
                        id = '', 
                        type = 'guest', ), 
                    items = [
                        cloudbeds_pms_v1_3.models.get_invoice_response_data_items_inner.GetInvoiceResponse_data_items_inner(
                            description = '', 
                            type = '', 
                            quantity = 56, 
                            total_amount = '', 
                            ...
                            fees = [
                                cloudbeds_pms_v1_3.models.get_invoice_response_data_items_inner_fees_inner.GetInvoiceResponse_data_items_inner_fees_inner(
                                    name = '', 
                                    amount = '', 
                                    code = '', 
                                    fee_id = '', )
