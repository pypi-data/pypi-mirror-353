...
class TestGetAdjustmentsResponseData(unittest.TestCase):
    """GetAdjustmentsResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAdjustmentsResponseData:
        """Test GetAdjustmentsResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAdjustmentsResponseData`
        """
        model = GetAdjustmentsResponseData()
        if include_optional:
            return GetAdjustmentsResponseData(
                adjustment_id = '',
    ...
    def testGetAdjustmentsResponseData(self):
        """Test GetAdjustmentsResponseData"""
