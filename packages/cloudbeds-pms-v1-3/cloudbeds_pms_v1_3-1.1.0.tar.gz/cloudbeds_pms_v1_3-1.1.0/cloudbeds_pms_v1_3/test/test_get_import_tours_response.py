...
class TestGetImportToursResponse(unittest.TestCase):
    """GetImportToursResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetImportToursResponse:
        """Test GetImportToursResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetImportToursResponse`
        """
        model = GetImportToursResponse()
        if include_optional:
            return GetImportToursResponse(
                success = True,
                data = [
                    ''
                    ]
    ...
    def testGetImportToursResponse(self):
        """Test GetImportToursResponse"""
