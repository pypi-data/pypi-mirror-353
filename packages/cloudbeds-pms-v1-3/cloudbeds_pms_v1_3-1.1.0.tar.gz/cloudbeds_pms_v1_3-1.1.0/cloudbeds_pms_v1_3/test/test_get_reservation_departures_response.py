...
class TestGetReservationDeparturesResponse(unittest.TestCase):
    """GetReservationDeparturesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservationDeparturesResponse:
        """Test GetReservationDeparturesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservationDeparturesResponse`
        """
        model = GetReservationDeparturesResponse()
        if include_optional:
            return GetReservationDeparturesResponse(
                success = True,
                data = [
                    cloudbeds_pms_v1_3.models.get_reservation_departures_response_data_inner.GetReservationDeparturesResponse_data_inner(
                        guest_name = '', 
                        guest_id = '', 
                        balance = 1.337, 
                        reservation_id = '', 
    ...
    def testGetReservationDeparturesResponse(self):
        """Test GetReservationDeparturesResponse"""
