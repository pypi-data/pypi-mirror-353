...
class TestGetReservationInHouseResponse(unittest.TestCase):
    """GetReservationInHouseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservationInHouseResponse:
        """Test GetReservationInHouseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservationInHouseResponse`
        """
        model = GetReservationInHouseResponse()
        if include_optional:
            return GetReservationInHouseResponse(
                success = True,
                data = [
                    cloudbeds_pms_v1_3.models.get_reservation_in_house_response_data_inner.GetReservationInHouseResponse_data_inner(
                        guest_id = '', 
                        guest_name = '', 
                        main_guest_id = '', 
                        main_guest_name = '', 
                        balance = 1.337, 
                        reservation_id = '', 
                        room_check_out = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
    ...
    def testGetReservationInHouseResponse(self):
        """Test GetReservationInHouseResponse"""
