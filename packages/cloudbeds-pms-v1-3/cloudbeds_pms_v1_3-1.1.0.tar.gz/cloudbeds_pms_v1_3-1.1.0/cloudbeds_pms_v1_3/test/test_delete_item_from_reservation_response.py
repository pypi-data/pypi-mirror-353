...
class TestDeleteItemFromReservationResponse(unittest.TestCase):
    """DeleteItemFromReservationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteItemFromReservationResponse:
        """Test DeleteItemFromReservationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteItemFromReservationResponse`
        """
        model = DeleteItemFromReservationResponse()
        if include_optional:
            return DeleteItemFromReservationResponse(
                success = True,
                message = ''
            )
        else:
    ...
    def testDeleteItemFromReservationResponse(self):
        """Test DeleteItemFromReservationResponse"""
