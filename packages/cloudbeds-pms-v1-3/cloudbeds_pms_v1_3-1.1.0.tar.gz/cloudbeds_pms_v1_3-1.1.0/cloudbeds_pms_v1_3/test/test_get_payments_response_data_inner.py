...
class TestGetPaymentsResponseDataInner(unittest.TestCase):
    """GetPaymentsResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPaymentsResponseDataInner:
        """Test GetPaymentsResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPaymentsResponseDataInner`
        """
        model = GetPaymentsResponseDataInner()
        if include_optional:
            return GetPaymentsResponseDataInner(
                transaction_id = '',
                payment_id = '',
                property_id = '',
    ...
    def testGetPaymentsResponseDataInner(self):
        """Test GetPaymentsResponseDataInner"""
