...
class TestPutRateRequestRatesInner(unittest.TestCase):
    """PutRateRequestRatesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutRateRequestRatesInner:
        """Test PutRateRequestRatesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutRateRequestRatesInner`
        """
        model = PutRateRequestRatesInner()
        if include_optional:
            return PutRateRequestRatesInner(
                rate_id = '',
                interval = [
                    cloudbeds_pms_v1_3.models.put_rate_request_rates_inner_interval_inner.PutRateRequest_rates_inner_interval_inner(
    ...
    def testPutRateRequestRatesInner(self):
        """Test PutRateRequestRatesInner"""
