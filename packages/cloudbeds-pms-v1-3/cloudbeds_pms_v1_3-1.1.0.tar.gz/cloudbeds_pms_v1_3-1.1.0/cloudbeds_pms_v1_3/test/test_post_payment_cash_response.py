...
class TestPostPaymentCashResponse(unittest.TestCase):
    """PostPaymentCashResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostPaymentCashResponse:
        """Test PostPaymentCashResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostPaymentCashResponse`
        """
        model = PostPaymentCashResponse()
        if include_optional:
            return PostPaymentCashResponse(
                success = True,
                message = ''
            )
        else:
    ...
    def testPostPaymentCashResponse(self):
        """Test PostPaymentCashResponse"""
