...
class TestPostBulkAppPropertySettingsResponse(unittest.TestCase):
    """PostBulkAppPropertySettingsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostBulkAppPropertySettingsResponse:
        """Test PostBulkAppPropertySettingsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostBulkAppPropertySettingsResponse`
        """
        model = PostBulkAppPropertySettingsResponse()
        if include_optional:
            return PostBulkAppPropertySettingsResponse(
                success = True
            )
        else:
            return PostBulkAppPropertySettingsResponse(
    ...
    def testPostBulkAppPropertySettingsResponse(self):
        """Test PostBulkAppPropertySettingsResponse"""
