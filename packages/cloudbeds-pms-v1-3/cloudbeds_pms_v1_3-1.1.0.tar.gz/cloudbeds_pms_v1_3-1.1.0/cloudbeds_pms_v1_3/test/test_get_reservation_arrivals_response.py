...
class TestGetReservationArrivalsResponse(unittest.TestCase):
    """GetReservationArrivalsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservationArrivalsResponse:
        """Test GetReservationArrivalsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservationArrivalsResponse`
        """
        model = GetReservationArrivalsResponse()
        if include_optional:
            return GetReservationArrivalsResponse(
                success = True,
                data = [
                    cloudbeds_pms_v1_3.models.get_reservation_arrivals_response_data_inner.GetReservationArrivalsResponse_data_inner(
                        guest_id = '', 
                        guest_name = '', 
                        room_id = '', 
                        balance = 1.337, 
    ...
    def testGetReservationArrivalsResponse(self):
        """Test GetReservationArrivalsResponse"""
