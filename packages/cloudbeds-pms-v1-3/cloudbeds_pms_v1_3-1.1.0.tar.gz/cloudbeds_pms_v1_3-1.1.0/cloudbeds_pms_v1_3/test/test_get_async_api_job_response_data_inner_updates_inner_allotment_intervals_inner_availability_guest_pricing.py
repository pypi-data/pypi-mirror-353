...
class TestGetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerAvailabilityGuestPricing(unittest.TestCase):
    """GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerAvailabilityGuestPricing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerAvailabilityGuestPricing:
        """Test GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerAvailabilityGuestPricing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerAvailabilityGuestPricing`
        """
        model = GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerAvailabilityGuestPricing()
        if include_optional:
            return GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerAvailabilityGuestPricing(
                adult1 = '',
                adult2 = '',
                adult3 = '',
                child1 = '',
    ...
    def testGetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerAvailabilityGuestPricing(self):
        """Test GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerAvailabilityGuestPricing"""
