...
class TestPostRoomTypeResponse(unittest.TestCase):
    """PostRoomTypeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostRoomTypeResponse:
        """Test PostRoomTypeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostRoomTypeResponse`
        """
        model = PostRoomTypeResponse()
        if include_optional:
            return PostRoomTypeResponse(
                success = True,
                data = cloudbeds_pms_v1_3.models.post_room_type_response_data.PostRoomTypeResponse_data(
                    room_type_id = '', ),
                message = ''
            )
        else:
    ...
    def testPostRoomTypeResponse(self):
        """Test PostRoomTypeResponse"""
