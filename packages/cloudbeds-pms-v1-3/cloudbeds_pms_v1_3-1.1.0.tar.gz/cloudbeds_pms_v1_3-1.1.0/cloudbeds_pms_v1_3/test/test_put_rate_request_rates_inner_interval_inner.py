...
class TestPutRateRequestRatesInnerIntervalInner(unittest.TestCase):
    """PutRateRequestRatesInnerIntervalInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutRateRequestRatesInnerIntervalInner:
        """Test PutRateRequestRatesInnerIntervalInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutRateRequestRatesInnerIntervalInner`
        """
        model = PutRateRequestRatesInnerIntervalInner()
        if include_optional:
            return PutRateRequestRatesInnerIntervalInner(
    ...
    def testPutRateRequestRatesInnerIntervalInner(self):
        """Test PutRateRequestRatesInnerIntervalInner"""
