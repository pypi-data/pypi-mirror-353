...
class TestGetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerRestrictions(unittest.TestCase):
    """GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerRestrictions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerRestrictions:
        ...
        # uncomment below to create an instance of `GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerRestrictions`
        """
        model = GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerRestrictions()
        if include_optional:
            return GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerRestrictions(
                min_los = 56,
                max_los = 56,
                cut_off_days = 56,
    ...
    def testGetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerRestrictions(self):
        """Test GetAsyncApiJobResponseDataInnerUpdatesInnerAllotmentIntervalsInnerRestrictions"""
