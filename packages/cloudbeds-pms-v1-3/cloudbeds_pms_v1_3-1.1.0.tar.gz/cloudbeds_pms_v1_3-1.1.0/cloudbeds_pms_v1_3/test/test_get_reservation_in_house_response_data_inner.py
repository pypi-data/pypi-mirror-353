...
class TestGetReservationInHouseResponseDataInner(unittest.TestCase):
    """GetReservationInHouseResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetReservationInHouseResponseDataInner:
        """Test GetReservationInHouseResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetReservationInHouseResponseDataInner`
        """
        model = GetReservationInHouseResponseDataInner()
        if include_optional:
            return GetReservationInHouseResponseDataInner(
                guest_id = '',
                guest_name = '',
                main_guest_id = '',
                main_guest_name = '',
    ...
    def testGetReservationInHouseResponseDataInner(self):
        """Test GetReservationInHouseResponseDataInner"""
