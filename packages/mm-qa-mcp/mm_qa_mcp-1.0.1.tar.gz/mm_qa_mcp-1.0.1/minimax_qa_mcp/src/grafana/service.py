...
class GetFromGrafana:
    def __init__(self, scene, psm="", from_time=None, to_time=None):
        ...
        self.cluster = "ali-wulan-prod-01"
        self.name_space = "inspo-prod"
        ...
        if to_time is None and from_time is None:
            ...
            from_formatted_time = (datetime.now(timezone(timedelta(hours=8))) - timedelta(hours=9)).isoformat()
...
if __name__ == '__main__':
    ...
    msgs = ["386661566928728065", "outputMsg"]
    # print("test")
